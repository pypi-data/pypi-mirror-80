...
class V1Agent(object):
    ...
    def __init__(self, uuid=None, name=None, description=None, tags=None, disabled=None, namespace=None, version_api=None, content=None, concurrency=None, created_at=None, updated_at=None, status=None, settings=None, local_vars_configuration=None):  # noqa: E501
