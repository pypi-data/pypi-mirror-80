...
def helicsCreateValueFederate(fed_name     , fi                    )                       :
    """
...
def helicsCreateMessageFederate(fed_name     , fi                    )                         :
    """
...
def helicsCreateCombinationFederate(fed_name     , fi                    )                             :
    """
...
def helicsFederateSetGlobal(fed                , value_name     , value     ):
    """
...
def helicsFederateAddDependency(fed                , fed_name     ):
    """
...
def helicsFederateLogLevelMessage(fed                , loglevel                , log_message     ):
    """
...
def helicsCoreSetGlobal(core            , value_name     , value     ):
    """
...
def helicsBrokerSetGlobal(broker              , value_name     , value     ):
    """
...
def helicsMessageResize(message               , newSize     ):
    """
...
def helicsMessageAppendData(message               , data         , inputDataLength     ):
    """
...
def helicsFilterSet(filter              , prop     , val       ):
    """
...
def helicsFilterSetString(filter              , prop     , val     ):
    """
...
def helicsFilterAddDestinationTarget(filter              , dest     ):
    """
...
def helicsPublicationPublishNamedPoint(pub                   , string     , val       ):
    """
...
def helicsInputSetDefaultNamedPoint(ipt             , string     , val       ):
    """
...
def helicsFederateSetLoggingCallback(fed                , logger, userdata):
    """
