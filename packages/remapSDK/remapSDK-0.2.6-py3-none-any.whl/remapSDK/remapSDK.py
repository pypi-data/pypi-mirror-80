...
class Sdk:
    ...
    def getSchedule(self):
        return self.DIR_BASE+self.SCHEDULE_FILE
    ...
    def sendOutput(self, jsonoutput):
        ...
        payload = {
            ...
            "status": "FINISHED",
            "distributionType": jsonoutput['distributionType'],
            "distributionParams": jsonoutput['distributionParams'],
            "RULUnit": jsonoutput['rulUnit'],
            "RULValue": jsonoutput['rulValue'],
            "confidenceInterval": {
                "max": jsonoutput['confidenceIntervalMax'],
                "min": jsonoutput['confidenceIntervalMin'],
            },
