...
print("----------------------------------------------------")
print("DMT v0.2")
print("Copyright Mario Krattenmacher and Markus Müller")
print("contact:")
print("Markus  : metroid120@googlemail.com")
print("Mario   : Mario.Krattenmacher@web.de")
print("license : GPL-3.0-or-later, see DMT directory")
print("modules : all (developer mode)")
print("----------------------------------------------------")
...
unit_registry.load_definitions(
    os.path.join(path_core, "dmt_units.txt")
)
...
try:
    ...
    from .data_reader_py      import read_data, read_ADS_bin, read_DEVICE_bin, read_elpa, read_mdm, read_hdf
...
try:
    from DMT.TRADICA  import InpTradica, DevTradica, EvalTradica # intermediate: import from module
    from DMT.TRADICA  import TechTradica # intermediate: import from module
except ImportError:
    pass
