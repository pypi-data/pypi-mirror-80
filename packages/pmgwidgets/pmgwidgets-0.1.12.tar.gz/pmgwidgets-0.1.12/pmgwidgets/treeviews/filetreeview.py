import os
from PyQt5.QtCore import Qt, QModelIndex, pyqtSignal, QLocale
...
class PMGFilesTreeview(QTreeView):
    ...
    def setup_ui(self):
        ...
        :return:
        '''
        from pmgwidgets.platform.translation import add_translation_file
        path = os.path.join(os.path.dirname(__file__), 'translations', 'qt_{0}.qm'.format(QLocale.system().name()))
        self.translator = add_translation_file(path)
