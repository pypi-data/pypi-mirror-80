...
# @pytest.mark.parametrize("trend", [False])
# @pytest.mark.parametrize("seasonal", [5])
# @pytest.mark.parametrize(
#     "freq_seasonal",
#     [
#         # None,
...
# )
# @pytest.mark.parametrize(
#     "exog_train,exog_predict", [(None, None), EXOG_SINGLE_TUPLE]  # (None, None), EXOG_SINGLE_TUPLE, EXOG_DOUBLE_TUPLE]
# )
