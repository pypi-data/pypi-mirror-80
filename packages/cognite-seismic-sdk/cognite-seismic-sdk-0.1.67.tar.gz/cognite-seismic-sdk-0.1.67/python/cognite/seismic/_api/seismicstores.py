...
class SeismicStoreAPI(API):
    ...
    def search(
        ...
        *,
        ...
        Args:
            ...
            external_id (str|None): Seismic store external id
    ...
    def edit(
        ...
        *,
        ...
        Edit a seismic store, providing either an id or an external id.
        The name and the metadata can be edited.

        Args:
            id (int | None): The id of the seismic store
            external_id (str | None): The external id of the seismic store
        ...
        request = EditSeismicStoreRequest(identifier=identifier)
