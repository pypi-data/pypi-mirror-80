        ...
        >
          ...
          ${this._filteredData.length?n.f`
                <div
                  ...
                  @scroll=${this._saveScrollPos}
                >
                  ${Object(l.a)({items:this.hasFab?[...this._filteredData,{empty:!0}]:this._filteredData,renderItem:(e,t)=>e.empty?n.f` <div class="mdc-data-table__row"></div> `:n.f`
                        <div
                          aria-rowindex=${t}
                          role="row"
                          .rowId="${e[this.id]}"
    ...
    `}},{kind:"get",static:!0,key:"styles",value:function(){return[n.c,i.c`
      ...
      >
        <a href="/config/zha/group-add" slot="fab">
          ...
          >
            <ha-svg-icon slot="icon" path=${c.kb}></ha-svg-icon>
          </mwc-fab>
        </a>
      </hass-tabs-subpage-data-table>
    `}},{kind:"method",key:"_fetchGroups",value:async function(){this._groups=(await Object(a.k)(this.hass)).sort(s.e)}},{kind:"method",key:"_handleRowClicked",value:function(e){const t=e.detail.id;Object(o.a)(this,"/config/zha/group/"+t)}},{kind:"get",static:!0,key:"styles",value:function(){return[d.c,n.c`
        a {
          color: var(--primary-color);
        }
      `]}}]}}),n.a)}}]);
//# sourceMappingURL=chunk.da14735c83fc82baefd4.js.map