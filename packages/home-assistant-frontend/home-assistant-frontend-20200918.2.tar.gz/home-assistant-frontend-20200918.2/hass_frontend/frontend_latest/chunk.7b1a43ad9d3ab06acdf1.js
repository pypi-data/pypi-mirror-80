      ...
      >
        ...
        ${this.filter&&n.g`
          <mwc-icon-button
            ...
            title="Clear"
          >
            <ha-svg-icon path=${s.v}></ha-svg-icon>
          </mwc-icon-button>
        `}
      </paper-input>
