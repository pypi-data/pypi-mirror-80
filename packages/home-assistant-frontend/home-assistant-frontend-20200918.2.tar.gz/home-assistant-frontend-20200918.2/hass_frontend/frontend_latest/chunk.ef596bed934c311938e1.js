          ...
          <div class="column">
            ${Object(f.a)(this.hass,"scene")?i.f`
                  <ha-card
                    ...
                    >${(null===(r=this._related)||void 0===r||null===(n=r.scene)||void 0===n?void 0:n.length)?this._related.scene.map(e=>{const t=this.hass.states[e];return t?i.f`
                                <div>
                                  <a
            ...
            ${Object(f.a)(this.hass,"script")?i.f`
                  <ha-card
                    ...
                    >${(null===(o=this._related)||void 0===o||null===(a=o.script)||void 0===a?void 0:a.length)?this._related.script.map(e=>{const t=this.hass.states[e];return t?i.f`
                                <a
