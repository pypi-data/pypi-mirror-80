...
class TpcDarkCountRateApi(object):
    ...
    def patch_tpc_dark_count_rate_item(self, tpcdarkcountrate_id, tpc_dark_count_rate, **kwargs):  # noqa: E501
        """Updates a TpcDarkCountRate document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_tpc_dark_count_rate_item(tpcdarkcountrate_id, tpc_dark_count_rate, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_tpc_dark_count_rate_item_with_http_info(tpcdarkcountrate_id, tpc_dark_count_rate, **kwargs)  # noqa: E501

    def patch_tpc_dark_count_rate_item_with_http_info(self, tpcdarkcountrate_id, tpc_dark_count_rate, **kwargs):  # noqa: E501
        """Updates a TpcDarkCountRate document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_tpc_dark_count_rate_item_with_http_info(tpcdarkcountrate_id, tpc_dark_count_rate, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_tpc_dark_count_rate_item" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'tpcdarkcountrate_id' is set
        if self.api_client.client_side_validation and ('tpcdarkcountrate_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['tpcdarkcountrate_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `tpcdarkcountrate_id` when calling `patch_tpc_dark_count_rate_item`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('tpc_dark_count_rate' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `tpc_dark_count_rate` when calling `patch_tpc_dark_count_rate_item`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/tpc/dark_counts_rates/{tpcdarkcountrateId}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
