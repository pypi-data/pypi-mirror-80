...
class TpcVoltageMapName1tApi(object):
    ...
    def get_tpc_voltage_map_name1ts(self, **kwargs):  # noqa: E501
        """Retrieves one or more TpcVoltageMapName1ts  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tpc_voltage_map_name1ts(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_tpc_voltage_map_name1ts_with_http_info(**kwargs)  # noqa: E501

    def get_tpc_voltage_map_name1ts_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves one or more TpcVoltageMapName1ts  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_tpc_voltage_map_name1ts_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_tpc_voltage_map_name1ts" % key
                )
