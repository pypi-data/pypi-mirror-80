...
import xepmts
from xepmts.models.inline_response20042 import InlineResponse20042  # noqa: E501
...
class TestInlineResponse20042(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = xepmts.models.inline_response20042.InlineResponse20042()  # noqa: E501
        if include_optional :
            return InlineResponse20042(
                items = [
                    xepmts.models.tpc_voltage_change1_t.TpcVoltageChange1T(
                        timestamp = '0', 
                        detector = 'tpc', 
                        experiment = 'xenon1t', 
                        pmt_index = 56, 
