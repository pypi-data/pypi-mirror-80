...
class MuvetoVoltageMapName1TApi(object):
    ...
    def get_muveto_voltage_map_names1_t(self, **kwargs):  # noqa: E501
        """Retrieves one or more MuvetoVoltageMapNames1T  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_muveto_voltage_map_names1_t(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_muveto_voltage_map_names1_t_with_http_info(**kwargs)  # noqa: E501

    def get_muveto_voltage_map_names1_t_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves one or more MuvetoVoltageMapNames1T  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_muveto_voltage_map_names1_t_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_muveto_voltage_map_names1_t" % key
                )
        ...
        return self.api_client.call_api(
            '/xenon1t/muveto/voltage_maps/names', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
