...
class TpcPmt1tApi(object):
    ...
    def patch_tpc_pmt1t_item(self, tpcpmt1t_id, tpc_pmt1t, **kwargs):  # noqa: E501
        """Updates a TpcPmt1t document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_tpc_pmt1t_item(tpcpmt1t_id, tpc_pmt1t, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_tpc_pmt1t_item_with_http_info(tpcpmt1t_id, tpc_pmt1t, **kwargs)  # noqa: E501

    def patch_tpc_pmt1t_item_with_http_info(self, tpcpmt1t_id, tpc_pmt1t, **kwargs):  # noqa: E501
        """Updates a TpcPmt1t document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_tpc_pmt1t_item_with_http_info(tpcpmt1t_id, tpc_pmt1t, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_tpc_pmt1t_item" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'tpcpmt1t_id' is set
        if self.api_client.client_side_validation and ('tpcpmt1t_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['tpcpmt1t_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `tpcpmt1t_id` when calling `patch_tpc_pmt1t_item`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('tpc_pmt1t' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `tpc_pmt1t` when calling `patch_tpc_pmt1t_item`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/xenon1t/tpc/pmts/{tpcpmt1tId}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
