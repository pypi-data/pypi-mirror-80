...
class NvetoGainMeasurementApi(object):
    ...
    def patch_nveto_gain_measurement_item(self, nvetogainmeasurement_id, nveto_gain_measurement, **kwargs):  # noqa: E501
        """Updates a NvetoGainMeasurement document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_nveto_gain_measurement_item(nvetogainmeasurement_id, nveto_gain_measurement, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_nveto_gain_measurement_item_with_http_info(nvetogainmeasurement_id, nveto_gain_measurement, **kwargs)  # noqa: E501

    def patch_nveto_gain_measurement_item_with_http_info(self, nvetogainmeasurement_id, nveto_gain_measurement, **kwargs):  # noqa: E501
        """Updates a NvetoGainMeasurement document  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_nveto_gain_measurement_item_with_http_info(nvetogainmeasurement_id, nveto_gain_measurement, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method patch_nveto_gain_measurement_item" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'nvetogainmeasurement_id' is set
        if self.api_client.client_side_validation and ('nvetogainmeasurement_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['nvetogainmeasurement_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `nvetogainmeasurement_id` when calling `patch_nveto_gain_measurement_item`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('nveto_gain_measurement' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `nveto_gain_measurement` when calling `patch_nveto_gain_measurement_item`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/nveto/gain_measurements/{nvetogainmeasurementId}', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
