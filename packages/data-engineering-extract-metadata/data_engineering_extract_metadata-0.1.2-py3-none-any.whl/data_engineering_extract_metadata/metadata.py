    ...
    for table in tables:
        try:
            ...
            if cursor.rowcount > 0:
                ...
                print(f"No rows in {table} from {schema}")
...
def get_table_meta(
    ...
    derived_columns = [
        ...
        },
        {
            ...
            "type": "datetime",
            "description": "When this record started to "
            "be the current data for this primary key",
            "nullable": False,
        },
        {
            "name": "mojap_end_datetime",
            "type": "datetime",
            "description": "When this record stopped being the "
            "current data for this primary key",
            "nullable": False,
        },
        {
            "name": "mojap_latest_record",
            "type": "boolean",
            "description": "Whether this record is currently "
            "the latest one for this primary key",
            "nullable": False,
        },
        {
            "name": "mojap_image_tag",
            "type": "character",
            "description": "A tag of the docker image used "
            "to run the pipeline tasks, if relevant",
            "nullable": False,
        },
    ]
