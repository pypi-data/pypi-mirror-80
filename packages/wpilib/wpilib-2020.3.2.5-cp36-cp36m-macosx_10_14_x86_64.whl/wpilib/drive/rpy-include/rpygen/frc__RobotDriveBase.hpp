...
RPYBUILD_OVERLOAD_PURE_NAME(RobotDriveBase,PYBIND11_TYPE(void), CxxBase, "stopMotor", StopMotor,);    }
#endif
...
;
        RPYBUILD_OVERLOAD_PURE_CUSTOM_NAME(RobotDriveBase,PYBIND11_TYPE(void), CxxBase, "getDescription", GetDescription,desc);    }
#endif
