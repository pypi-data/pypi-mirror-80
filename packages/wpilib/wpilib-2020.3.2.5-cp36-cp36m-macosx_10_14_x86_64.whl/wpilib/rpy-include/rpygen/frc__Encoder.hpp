...
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(int), CxxBase, "get", Get,);    }
#endif
...
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(double), CxxBase, "getPeriod", GetPeriod,);    }
#endif

#ifndef RPYGEN_DISABLE_SetMaxPeriod_d
    void SetMaxPeriod(double maxPeriod) override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(void), CxxBase, "setMaxPeriod", SetMaxPeriod,maxPeriod);    }
#endif

#ifndef RPYGEN_DISABLE_KGetStopped_v
    bool GetStopped() const override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(bool), CxxBase, "getStopped", GetStopped,);    }
#endif

#ifndef RPYGEN_DISABLE_KGetDirection_v
    bool GetDirection() const override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(bool), CxxBase, "getDirection", GetDirection,);    }
#endif
