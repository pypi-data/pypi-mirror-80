...
class Spline3():
    ...
    class ControlVector():
        ...
        @typing.overload
        def __init__(self, x: typing.List[float[2]], y: typing.List[float[2]]) -> None: ...
        @property
        def x(self) -> typing.List[float[2]]:
            """
            :type: typing.List[float[2]]
            """
        @x.setter
        def x(self, arg0: typing.List[float[2]]) -> None:
            pass
        @property
        def y(self) -> typing.List[float[2]]:
            """
            :type: typing.List[float[2]]
            """
        @y.setter
        def y(self, arg0: typing.List[float[2]]) -> None:
            pass
        pass
    def __init__(self) -> None: ...
    def getPoint(self, t: float) -> typing.Tuple[wpilib.geometry._geometry.Pose2d, radians_per_meter]: 
        """
...
class Spline5():
    ...
    class ControlVector():
        ...
        def __init__(self) -> None: ...
        @typing.overload
        def __init__(self, x: typing.List[float[3]], y: typing.List[float[3]]) -> None: ...
        @property
        def x(self) -> typing.List[float[3]]:
            """
            :type: typing.List[float[3]]
            """
        @x.setter
        def x(self, arg0: typing.List[float[3]]) -> None:
            pass
        @property
        def y(self) -> typing.List[float[3]]:
            """
            :type: typing.List[float[3]]
            """
        @y.setter
        def y(self, arg0: typing.List[float[3]]) -> None:
            pass
        pass
    def __init__(self) -> None: ...
    def getPoint(self, t: float) -> typing.Tuple[wpilib.geometry._geometry.Pose2d, radians_per_meter]: 
...
class CubicHermiteSpline(Spline3):
    ...
    """
    def __init__(self, xInitialControlVector: typing.List[float[2]], xFinalControlVector: typing.List[float[2]], yInitialControlVector: typing.List[float[2]], yFinalControlVector: typing.List[float[2]]) -> None: 
        """
...
class QuinticHermiteSpline(Spline5):
    ...
    """
    def __init__(self, xInitialControlVector: typing.List[float[3]], xFinalControlVector: typing.List[float[3]], yInitialControlVector: typing.List[float[3]], yFinalControlVector: typing.List[float[3]]) -> None: 
        """
...
class SplineHelper():
    ...
    def __init__(self) -> None: ...
    @staticmethod
    def cubicControlVectorsFromWaypoints(start: wpilib.geometry._geometry.Pose2d, interiorWaypoints: typing.List[wpilib.geometry._geometry.Translation2d], end: wpilib.geometry._geometry.Pose2d) -> typing.List[Spline3.ControlVector[2]]: 
        """
        ...
        """
    @staticmethod
    def cubicSplinesFromControlVectors(start: Spline3.ControlVector, waypoints: typing.List[wpilib.geometry._geometry.Translation2d], end: Spline3.ControlVector) -> typing.List[CubicHermiteSpline]: 
        """
        ...
        """
    @staticmethod
    def quinticControlVectorsFromWaypoints(waypoints: typing.List[wpilib.geometry._geometry.Pose2d]) -> typing.List[Spline5.ControlVector]: 
        """
...
class SplineParameterizer():
    ...
    @staticmethod
    @typing.overload
    def parameterize(spline: Spline3, t0: float = 0.0, t1: float = 1.0) -> typing.List[typing.Tuple[wpilib.geometry._geometry.Pose2d, radians_per_meter]]: 
        """
    ...
    @staticmethod
    @typing.overload
    def parameterize(spline: Spline5, t0: float = 0.0, t1: float = 1.0) -> typing.List[typing.Tuple[wpilib.geometry._geometry.Pose2d, radians_per_meter]]: ...
    pass
