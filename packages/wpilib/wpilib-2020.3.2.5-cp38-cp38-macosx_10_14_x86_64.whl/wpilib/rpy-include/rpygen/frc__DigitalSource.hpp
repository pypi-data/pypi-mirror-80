...
RPYBUILD_OVERLOAD_PURE_NAME(DigitalSource,PYBIND11_TYPE(HAL_Handle), CxxBase, "getPortHandleForRouting", GetPortHandleForRouting,);    }
#endif

#ifndef RPYGEN_DISABLE_KGetAnalogTriggerTypeForRouting_v
    AnalogTriggerType GetAnalogTriggerTypeForRouting() const override {
RPYBUILD_OVERLOAD_PURE_NAME(DigitalSource,PYBIND11_TYPE(AnalogTriggerType), CxxBase, "getAnalogTriggerTypeForRouting", GetAnalogTriggerTypeForRouting,);    }
#endif

#ifndef RPYGEN_DISABLE_KIsAnalogTrigger_v
    bool IsAnalogTrigger() const override {
RPYBUILD_OVERLOAD_PURE_NAME(DigitalSource,PYBIND11_TYPE(bool), CxxBase, "isAnalogTrigger", IsAnalogTrigger,);    }
#endif

#ifndef RPYGEN_DISABLE_KGetChannel_v
    int GetChannel() const override {
RPYBUILD_OVERLOAD_PURE_NAME(DigitalSource,PYBIND11_TYPE(int), CxxBase, "getChannel", GetChannel,);    }
#endif
