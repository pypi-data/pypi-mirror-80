import wpilib.controller._controller.trajectory
import typing
import Trajectory
...
import wpilib.spline._spline
import wpilib.spline._spline.Spline3
import wpilib.spline._spline.Spline5
...
class Trajectory():
    ...
    class State():
        ...
        def __eq__(self, arg0: Trajectory.State) -> bool: 
            ...
            """
        def __init__(self, t: seconds = 0.0, velocity: meters_per_second = 0.0, acceleration: meters_per_second_squared = 0.0, pose: wpilib.geometry._geometry.Pose2d = Pose2d(Translation2d(x=0.000000, y=0.000000), Rotation2d(0.000000)), curvature: radians_per_meter = 0.0) -> None: 
            """
            __init__(self: wpilib.controller._controller.trajectory.Trajectory.State, t: seconds = 0.0, velocity: meters_per_second = 0.0, acceleration: meters_per_second_squared = 0.0, pose: wpilib.geometry._geometry.Pose2d = Pose2d(Translation2d(x=0.000000, y=0.000000), Rotation2d(0.000000)), curvature: radians_per_meter = 0.0) -> None
            """
        ...
        def curvature(self, arg0: radians_per_meter) -> None:
            pass
        @property
        def pose(self) -> wpilib.geometry._geometry.Pose2d:
            """
            :type: wpilib.geometry._geometry.Pose2d
            """
        @pose.setter
        def pose(self, arg0: wpilib.geometry._geometry.Pose2d) -> None:
            pass
        @property
        def t(self) -> seconds:
            """
    ...
    def initialPose(self) -> wpilib.geometry._geometry.Pose2d: 
        """
        Returns the initial pose of the trajectory.

        :returns: The initial pose of the trajectory.
        """
    def relativeTo(self, pose: wpilib.geometry._geometry.Pose2d) -> Trajectory: 
        """
    ...
    def totalTime(self) -> seconds: 
        ...
        """
    def transformBy(self, transform: wpilib.geometry._geometry.Transform2d) -> Trajectory: 
        """
...
class TrajectoryConfig():
    ...
    def __init__(self, maxVelocity: meters_per_second, maxAcceleration: meters_per_second_squared) -> None: 
        ...
        """
    @typing.overload
    def addConstraint(self, constraint: wpilib.controller._controller.constraints.CentripetalAccelerationConstraint) -> None: 
        """
        ...
        """
    @typing.overload
    def addConstraint(self, constraint: wpilib.controller._controller.constraints.DifferentialDriveKinematicsConstraint) -> None: ...
    @typing.overload
    def addConstraint(self, constraint: wpilib.controller._controller.constraints.DifferentialDriveVoltageConstraint) -> None: ...
    @typing.overload
    def addConstraint(self, constraint: wpilib.controller._controller.constraints.MecanumDriveKinematicsConstraint) -> None: ...
    ...
    def setEndVelocity(self, endVelocity: meters_per_second) -> None: 
        ...
        """
    @typing.overload
    def setKinematics(self, kinematics: wpilib.kinematics._kinematics.DifferentialDriveKinematics) -> None: 
        """
        ...
        """
    @typing.overload
    def setKinematics(self, kinematics: wpilib.kinematics._kinematics.MecanumDriveKinematics) -> None: ...
...
class TrajectoryGenerator():
    ...
    @staticmethod
    @typing.overload
    def generateTrajectory(controlVectors: typing.List[wpilib.spline._spline.Spline5.ControlVector], config: TrajectoryConfig) -> Trajectory: 
        """
    ...
    @staticmethod
    @typing.overload
    def generateTrajectory(initial: wpilib.spline._spline.Spline3.ControlVector, interiorWaypoints: typing.List[wpilib.geometry._geometry.Translation2d], end: wpilib.spline._spline.Spline3.ControlVector, config: TrajectoryConfig) -> Trajectory: ...
    @staticmethod
    @typing.overload
    def generateTrajectory(start: wpilib.geometry._geometry.Pose2d, interiorWaypoints: typing.List[wpilib.geometry._geometry.Translation2d], end: wpilib.geometry._geometry.Pose2d, config: TrajectoryConfig) -> Trajectory: ...
    @staticmethod
    @typing.overload
    def generateTrajectory(waypoints: typing.List[wpilib.geometry._geometry.Pose2d], config: TrajectoryConfig) -> Trajectory: ...
    @staticmethod
    ...
    @staticmethod
    @typing.overload
    def splinePointsFromSplines(splines: typing.List[wpilib.spline._spline.CubicHermiteSpline]) -> typing.List[typing.Tuple[wpilib.geometry._geometry.Pose2d, radians_per_meter]]: 
        """
    ...
    @staticmethod
    @typing.overload
    def splinePointsFromSplines(splines: typing.List[wpilib.spline._spline.QuinticHermiteSpline]) -> typing.List[typing.Tuple[wpilib.geometry._geometry.Pose2d, radians_per_meter]]: ...
    pass
...
class TrapezoidProfile():
    ...
    class Constraints():
        ...
        def __init__(self) -> None: ...
        @typing.overload
        def __init__(self, maxVelocity: units_per_second, maxAcceleration: units_per_second_squared) -> None: ...
        pass
    class State():
