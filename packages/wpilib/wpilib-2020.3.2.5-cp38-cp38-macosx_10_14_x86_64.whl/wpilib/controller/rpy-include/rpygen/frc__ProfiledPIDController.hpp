...
struct bind_frc__ProfiledPIDController {
    ...
    py::class_<typename frc::ProfiledPIDController<Distance>, std::shared_ptr<typename frc::ProfiledPIDController<Distance>>, rpygen::Pyfrc__ProfiledPIDController<typename frc::ProfiledPIDController<Distance>, Distance>, Sendable> cls_ProfiledPIDController;
