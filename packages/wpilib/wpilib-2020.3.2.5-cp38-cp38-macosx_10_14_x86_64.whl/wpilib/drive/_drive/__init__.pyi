...
class RobotDriveBase(wpilib._wpilib.MotorSafety, wpilib._wpilib.ErrorBase):
    ...
    class MotorType():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kFrontLeft': MotorType.kFrontLeft, 'kFrontRight': MotorType.kFrontRight, 'kRearLeft': MotorType.kRearLeft, 'kRearRight': MotorType.kRearRight, 'kLeft': MotorType.kFrontLeft, 'kRight': MotorType.kFrontRight, 'kBack': MotorType.kRearLeft}
        kBack: wpilib.drive._drive.RobotDriveBase.MotorType # value = MotorType.kRearLeft
        kFrontLeft: wpilib.drive._drive.RobotDriveBase.MotorType # value = MotorType.kFrontLeft
        kFrontRight: wpilib.drive._drive.RobotDriveBase.MotorType # value = MotorType.kFrontRight
        kLeft: wpilib.drive._drive.RobotDriveBase.MotorType # value = MotorType.kFrontLeft
        kRearLeft: wpilib.drive._drive.RobotDriveBase.MotorType # value = MotorType.kRearLeft
        kRearRight: wpilib.drive._drive.RobotDriveBase.MotorType # value = MotorType.kRearRight
        kRight: wpilib.drive._drive.RobotDriveBase.MotorType # value = MotorType.kFrontRight
        pass
