...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '2.9.0-alpha.1600627029+bfdccb30'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 2.9.0-alpha.1600627029+bfdccb30`
                """)
            else:
                raise
