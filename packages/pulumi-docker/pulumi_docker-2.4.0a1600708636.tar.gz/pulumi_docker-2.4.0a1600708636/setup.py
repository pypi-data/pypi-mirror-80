...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.4.0-alpha.1600708636+73907d9d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.4.0-alpha.1600708636+73907d9d`
                """)
            else:
                raise
