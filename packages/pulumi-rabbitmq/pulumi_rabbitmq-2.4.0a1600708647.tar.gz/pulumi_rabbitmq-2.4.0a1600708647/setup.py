...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', '2.4.0-alpha.1600708647+c0c7f8eb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq 2.4.0-alpha.1600708647+c0c7f8eb`
                """)
            else:
                raise
