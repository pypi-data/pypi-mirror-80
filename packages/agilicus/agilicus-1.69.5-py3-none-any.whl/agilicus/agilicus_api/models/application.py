...
class Application(object):
    ...
    def __init__(self, created=None, id=None, name=None, description=None, category=None, image=None, image_username=None, image_password=None, image_credentials_type=None, environments=None, org_id=None, contact_email=None, monitoring_config=None, port=5000, healthcheck_uri=None, roles=None, definitions=None, assignments=None, owned=None, maintained=None, assigned=None, published='no', default_role_id=None, default_role_name=None, icon_url=None, updated=None, location=None, local_vars_configuration=None):  # noqa: E501
