...
"""
    ...
    The version of the OpenAPI document: 2020.09.22
...
class PolicyCondition(object):
    ...
    def __init__(self, condition_type=None, inverted=False, value=None, operator=None, field=None, local_vars_configuration=None):  # noqa: E501
    ...
    def condition_type(self, condition_type):
        ...
        allowed_values = ["type_client_id_list", "type_org_id_list", "type_user_id_list", "type_upstream_idp_list", "type_ip_in_cidr_list", "type_last_successful_mfa", "type_amr_claim", "type_object_attribute"]  # noqa: E501
    ...
    def inverted(self):
        ...
        Whether to invert the condition (ie the not operator). If the condition is `a == b` inverting the condition results in `not (a == b)`  # noqa: E501
    ...
    def operator(self, operator):
        ...
        :type: str
        """
        allowed_values = ["equals", "greater_than", "less_than", "in"]  # noqa: E501
