...
@overload
def rate(m: OsuMapObj, rate: float, inplace: bool = False) -> OsuMapObj: ...
@overload
def rate(m: QuaMapObj, rate: float, inplace: bool = False) -> QuaMapObj: ...
@overload
def rate(s: SMMapSetObj, rate: float, inplace: bool = False) -> SMMapSetObj: ...
