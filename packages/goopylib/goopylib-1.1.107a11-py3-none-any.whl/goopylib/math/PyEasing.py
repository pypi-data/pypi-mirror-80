...
def py_ease_poly_in(t=None, power=2):
    if t is not None:
        return _py_ease_poly_in(t, power)
    else:
        def closure(time):
...
def py_ease_poly_out(t=None, power=2):
    if t is not None:
        return _py_ease_poly_out(t, power)
    else:
        def closure(time):
...
def py_ease_poly(t=None, power_in=2, power_out=2):
    if t is not None:
        return _py_ease_poly(t, power_in, power_out)
    else:
        def closure(time):
...
def py_ease_circle_in(t=None, factor=0.5):
    if t is not None:
        return _py_ease_circle_in(t, factor)
    else:
        def closure(time):
...
def py_ease_circle_out(t=None, factor=0.5):
    if t is not None:
        return _py_ease_circle_out(t, factor)
    else:
        def closure(time):
...
def py_ease_back_out(t=None, factor=1.70158):
    if t is not None:
        return _py_ease_back_out(t, factor)
    else:
        def closure(time):
...
def py_ease_back(t=None, factor_in=1.70158, factor_out=1.70158):
    if t is not None:
        return _py_ease_back(t, factor_in, factor_out)
    else:
        def closure(time):
...
def py_ease_bounce_in(t=None, bounces=None):
    if t is not None:
        return _py_ease_bounce_in(t, bounces)
    else:
        def closure(time):
...
def py_ease_bounce(t=None, bounces_in=None, bounces_out=None):
    if t is not None:
        return _py_ease_bounce(t, bounces_in, bounces_out)
    else:
        def closure(time):
...
def py_ease_elastic_in(t=None, period=0.2, amplitude=1):
    if t is not None:
        return _py_ease_elastic_in(t, period, amplitude)
    else:
        def closure(time):
...
def py_ease_elastic_out(t=None, period=0.2, amplitude=1):
    if t is not None:
        return _py_ease_elastic_out(t, period, amplitude)
    else:
        def closure(time):
...
def py_ease_elastic(t=None, period_in=0.2, amplitude_in=1, period_out=0.2, amplitude_out=1):
    if t is not None:
        return _py_ease_elastic(t, period_in, amplitude_in, period_out, amplitude_out)
    else:
        def closure(time):
...
def py_ease_exponential_in(t=None, base=2):
    if t is not None:
        return _py_ease_exponential_in(t, base)
    else:
        def closure(time):
...
def py_ease_exponential_out(t=None, base=2):
    if t is not None:
        return _py_ease_exponential_out(t, base)
    else:
        def closure(time):
...
def py_ease_exponential(t=None, base_in=2, base_out=2):
    if t is not None:
        return _py_ease_exponential(t, base_in, base_out)
    else:
        def closure(time):
