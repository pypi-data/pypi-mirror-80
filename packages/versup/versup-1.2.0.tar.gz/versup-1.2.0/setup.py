...
install_requires = \
['click>=7.0,<8.0', 'colorama>=0.4.3,<0.5.0', 'semver>=2.8,<3.0']

extras_require = \
{':python_version >= "2.7" and python_version < "3.0"': ['gitpython>=2.1,<3.0'],
 ':python_version >= "3" and python_version < "4"': ['gitpython>=3.0,<4.0']}
