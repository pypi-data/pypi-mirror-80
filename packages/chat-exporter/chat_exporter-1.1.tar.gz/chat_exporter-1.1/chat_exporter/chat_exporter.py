...
total = read_file("chat_exporter_html/base.html")
msg = read_file("chat_exporter_html/message.html")
bot_tag = read_file("chat_exporter_html/bot-tag.html")
msg_embed = read_file("chat_exporter_html/message-embed.html")
msg_embed_field = read_file("chat_exporter_html/message-embed-field.html")
img_attachment = read_file("chat_exporter_html/image-attachment.html")
msg_attachment = read_file("chat_exporter_html/message_attachment.html")
emoji = read_file("chat_exporter_html/emoji_attachment.html")
custom_emoji = read_file("chat_exporter_html/custom_emoji_attachment.html")
continue_message = read_file("chat_exporter_html/continue_message.html")
end_message = read_file("chat_exporter_html/end_message.html")
embed_footer = read_file("chat_exporter_html/embed_footer.html")
