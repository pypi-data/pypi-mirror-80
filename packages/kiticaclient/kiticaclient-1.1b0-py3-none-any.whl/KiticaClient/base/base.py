...
class BaseClient:
    ...
    def __init__(self, kiticaUri):
        ...
        self.driverPath = self._set_default_webdriver_path()
    ...
    def linux(self):
        """
        Linux OS Webdriver PATH.
        """
        print('OS :Linux')
        return '~/kitica/webdrivers'
    ...
    def win32(self):
        ...
        """
        print('OS :Windows')
        return 'c:/kitica/webdrivers'

    def darwin(self):
        """
        macOS Webdriver PATH.
        """
        print('OS :macOS')
        return '~/kitica/webdrivers'

    def _set_default_webdriver_path(self):
        """
