...
class DataConnection(BaseDataConnection):
    ...
    location: Union[S3Location, FSLocation, CP4DAssetLocation, WMLSAssetLocation, CloudAssetLocation, WSDAssetLocation],
    ...
    def __init__(self,
        ...
        elif isinstance(location, (CP4DAssetLocation, WMLSAssetLocation, CloudAssetLocation, WSDAssetLocation, DeploymentOutputAssetLocation)):
    ...
    def _from_dict(cls, _dict: dict) -> 'DataConnection':
        ...
        if _dict['type'] == DataConnectionTypes.S3:
            ...
            if 'project_id=' in _dict['location']['href']:
...
class CloudAssetLocation(DSLocation):
    """
