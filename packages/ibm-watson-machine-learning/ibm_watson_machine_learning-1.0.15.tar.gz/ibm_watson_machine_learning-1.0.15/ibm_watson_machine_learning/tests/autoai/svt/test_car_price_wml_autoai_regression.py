...
from ibm_watson_machine_learning.helpers.connections import S3Connection, S3Location, DataConnection, WMLSAssetLocation,\
    CloudAssetLocation, FSLocation, DeploymentOutputAssetLocation
...
class TestAutoAIRemote(unittest.TestCase):
    ...
    def test_00a_space_cleanup(self):
        ...
        TestAutoAIRemote.space_id = get_space_id(self.wml_client, self.space_name,
                                     cos_resource_instance_id=self.cos_resource_instance_id)
        TestAutoAIRemote.project_id = None
        TestAutoAIRemote.wml_client.set.default_space(TestAutoAIRemote.space_id)
    ...
    def test_21_deploy_pipepline_lale_type(self):
    ...
    def test_32__deploy__batch_deploy_blale_pipeline_from_autoai_on_wml(self):
