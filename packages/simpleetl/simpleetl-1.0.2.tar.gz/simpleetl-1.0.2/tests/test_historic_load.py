...
class TestHistoricLoad(unittest.TestCase):
    ...
    def test_historicload(self):
        ...
        stats2_output = {'facts_inserted': 10, 'facts_updated': 89, 'facts_deleted': 10, 'historic_inserted': 10,
                         'historic_updated': 89, 'historic_deleted': 10,
                         'rows_read': 100, 'rows_parsed': 100}
        stats3_output = {'facts_inserted': 30, 'facts_updated': 69, 'facts_deleted': 30, 'historic_inserted': 30,
                         'historic_updated': 69, 'historic_deleted': 59, 'rows_read': 100, 'rows_parsed': 100}
        ...
        stats3 = etlrun(5)
        stats3_parsed = {key: stats3[key] for key in stats2_output.keys()}
        self.assertDictEqual(stats3_output, stats3_parsed)
