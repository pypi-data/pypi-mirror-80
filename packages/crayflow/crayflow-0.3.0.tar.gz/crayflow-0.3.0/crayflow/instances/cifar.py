...
download_cifar10 = lambda path: download(path, CIFAR_10_PATH, root_url=CIFAR_ROOT_URL)
download_cifar100 = lambda path: download(path, CIFAR_100_PATH, root_url=CIFAR_ROOT_URL)
