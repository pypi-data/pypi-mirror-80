...
class RecordTreeViewFilter(RecordTreeViewBase):
    ...
    def __init__(self, shared, filter_, fields, **kwargs):
...
class TreeViewFilter(Gtk.Box):
    ...
    def __init__(self, shared, treeview):
        super().__init__(visible=True, orientation=Gtk.Orientation.VERTICAL)

        self.filter_ = Record()
        self.filter_treeview = RecordTreeViewFilter(shared, self.filter_, treeview.fields)
