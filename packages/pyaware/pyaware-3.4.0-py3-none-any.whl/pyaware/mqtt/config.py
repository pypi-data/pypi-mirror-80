...
def default_gcp_parsers():
    return {
        "telemetry": {
            ...
            "transforms": [{"name": "remove_keys", "keys": {"raw_values"}}],
        ...
        "topology": {
            ...
            "topic": "/devices/{device_id}/topology",
        },
...
def default_local_parsers():
    return {
        ...
        "errors": {"topic": "devices/{device_id}/errors"},
        "commands": {"topic": "devices/{device_id}/commands"},
        "command_response": {"topic": "devices/{device_id}/events/telemetry/commands"},
        "topology": {
            "model": {"name": "TopologyV2"},
            "topic": "devices/{device_id}/topology",
        },
        "gateway_heartbeat": {
            ...
            "topic": "gateways/{device_id}/heartbeat",
        },
        "state": {"model": {"name": "StateV1"}, "topic": "gateways/{device_id}/state"},
    }
...
class LocalConfig(MQTTConfigBase):
    ...
    parsers: dict = field(default_factory=default_local_parsers)
    subscribe_qos: int = 1
    publish_qos: int = 0
    token_life = 0
