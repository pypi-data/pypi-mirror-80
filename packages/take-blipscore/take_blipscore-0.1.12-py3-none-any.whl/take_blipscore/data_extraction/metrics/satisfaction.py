...
class Satisfaction(PipelineCaller):
    ...
    def get_rate(self) -> float:
        ...
        for category, actions in self.category_action["satisfaction"].items():
            ...
            try:
                ...
                ts_score.append(out["result"]["model_input"]["satisfaction_rate"])
            except Exception as e:
                # TODO: <insert better solution here>
                pass
