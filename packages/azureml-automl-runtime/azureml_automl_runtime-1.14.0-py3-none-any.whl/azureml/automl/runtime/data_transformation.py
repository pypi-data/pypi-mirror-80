...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import AutoMLInternal, InvalidArgumentType, \
    TimeseriesLeadingNans, TimeseriesLaggingNans, InputDatasetEmpty
...
def create_transformed_data_context_no_streaming(raw_data_context: RawDataContext,
    ...
    # After NaNs are handled from _remove_nan_rows_in_X_y(),
...
def _get_data_snapshot_helper(data: Union[pd.DataFrame, pd.Series],
                              column_names_and_types: Optional[Dict[str, np.dtype]] = None) -> str:
