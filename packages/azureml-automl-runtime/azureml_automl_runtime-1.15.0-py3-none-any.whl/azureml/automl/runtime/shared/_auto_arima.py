...
IMPORT_ERROR = "Unable to import pmdarima."
try:
    # Optional import of pmdarima.
    import pmdarima
except Exception:
    # If pmdarima is not installed we will throw error during
    # model fitting.
...
class AutoArima(_MultiGrainForecastBase):
    ...
    def _fit_single_grain_impl(self, X_pred_grain: pd.DataFrame, grain_level: GrainType) -> Any:
        ...
        """
        self._raise_import_error_maybe('pmdarima')
