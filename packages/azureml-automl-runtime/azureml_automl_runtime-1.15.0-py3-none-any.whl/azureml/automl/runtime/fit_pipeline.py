                ...
                with logging_utilities.log_activity(
                    ...
                    try:
                        ...
                        with tracer.start_as_current_span(
                                ...
                                user_facing_name=constants.TelemetryConstants.MetadataUploading
                        ):
                            _save_artifacts(
...
def _check_fit_output_result(fit_output: FitOutput) -> None:
    ...
    if fit_output.score in [None, np.nan, constants.Defaults.DEFAULT_PIPELINE_SCORE]:
        message = "An unexpected error ocurred when getting the {} score.".format(fit_output.primary_metric)
