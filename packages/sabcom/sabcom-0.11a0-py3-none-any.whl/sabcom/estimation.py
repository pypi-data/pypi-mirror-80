...
def ls_model_performance(input_params, input_folder_path, mc_runs, output_folder_path, scenario):
    """
    ...
    costs = []
    for seed in range(mc_runs): #TODO get output_folder path, scenario as input parameters.....
