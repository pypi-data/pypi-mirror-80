...
def sample(**kwargs):
    ...
    with open('hypercube.json', 'w') as f:
        json.dump(problems, f)

    click.echo('Sampling {} samples done, check out the samples here: {}'.format(n_samples, 'hypercube.json'))
...
def estimate(**kwargs):
    ...
    with open(os.path.join(kwargs.get('input_folder_path'), 'estimated_parameters.json'), 'w') as f:
