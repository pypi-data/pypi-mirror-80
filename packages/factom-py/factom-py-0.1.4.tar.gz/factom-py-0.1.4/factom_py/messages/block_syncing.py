...
import factom_py.blockchains.mainnet
import factom_py.primitives as primitives
from factom_py.blockchains import Blockchain
from factom_py.blocks import (
    DirectoryBlock,
    AdminBlock,
    FactoidBlock,
    EntryCreditBlock,
...
from factom_py.block_elements import Entry
from factom_py.messages import Message
...
class DirectoryBlockState(Message):
    ...
    def is_sane(self, state: Blockchain):
        ...
        if type(state) is factom_py.blockchains.mainnet.MainnetBlockchain:
            checkpoints = factom_py.blockchains.mainnet.constants.CHECKPOINTS
