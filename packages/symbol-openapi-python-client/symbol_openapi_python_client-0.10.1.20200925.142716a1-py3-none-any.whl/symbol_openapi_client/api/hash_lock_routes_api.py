...
class HashLockRoutesApi(object):
    ...
    def search_hash_lock(self, address, **kwargs):  # noqa: E501
        """Search hash lock entries  # noqa: E501

        Returns an array of hash locks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_hash_lock(address, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.search_hash_lock_with_http_info(address, **kwargs)  # noqa: E501

    def search_hash_lock_with_http_info(self, address, **kwargs):  # noqa: E501
        """Search hash lock entries  # noqa: E501

        Returns an array of hash locks.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_hash_lock_with_http_info(address, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('address' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `address` when calling `search_hash_lock`")  # noqa: E501
