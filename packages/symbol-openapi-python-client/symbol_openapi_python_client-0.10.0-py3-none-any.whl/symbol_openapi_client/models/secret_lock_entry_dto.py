...
class SecretLockEntryDTO(object):
    ...
    def __init__(self, owner_address=None, mosaic_id=None, amount=None, end_height=None, status=None, hash_algorithm=None, secret=None, recipient_address=None, composite_hash=None, local_vars_configuration=None):  # noqa: E501
    ...
    def status(self):
        ...
        A number that indicates the status.  # noqa: E501
