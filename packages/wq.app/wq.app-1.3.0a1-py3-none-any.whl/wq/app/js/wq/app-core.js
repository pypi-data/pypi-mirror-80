            ...
            return _regeneratorRuntime__default['default'].wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 2:
                            app = _this.app;
                            app.router.render(_objectSpread2(_objectSpread2({}, app.router.getContext()), _this.userInfo()), true); // FIXME: Better way to do this?
            ...
            return _regeneratorRuntime__default['default'].wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _this2.app.outbox.setCSRFToken(_this2.userInfo().csrf_token);
...
app.submitForm = /*#__PURE__*/function () {
    var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee3(kwargs) {
        var url, storage, backgroundSync, has_files, outboxId, preserve, vals, conf, options, item;
        return _regeneratorRuntime__default['default'].wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    case 0:
                        url = kwargs.url, storage = kwargs.storage, backgroundSync = kwargs.backgroundSync, has_files = kwargs.has_files, outboxId = kwargs.outboxId, preserve = kwargs.preserve, vals = kwargs.data;
