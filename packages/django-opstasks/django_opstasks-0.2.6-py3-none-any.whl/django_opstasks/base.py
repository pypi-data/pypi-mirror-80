...
def record_start_datetime(func):
    ...
    def _inner(*args, **kwargs):
        ...
        _data = dumps({"date_start": date_start, "task_id": task_id})
...
class CustomTask(Task):
    ...
    def on_failure(self, exc, task_id, args, kwargs, einfo):
        ...
        message = f'run task "{result.task_name}" failure'
        SNOOPY.error(send_to='huaxingliu@yangqianguan.com', message=message)
