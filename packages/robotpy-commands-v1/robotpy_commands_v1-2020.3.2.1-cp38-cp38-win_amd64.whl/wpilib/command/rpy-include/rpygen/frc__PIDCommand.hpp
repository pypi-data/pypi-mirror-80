...
RPYBUILD_OVERLOAD_PURE_NAME(PIDCommand,PYBIND11_TYPE(double), CxxBase, "returnPIDInput", ReturnPIDInput,);    }
#endif

#ifndef RPYGEN_DISABLE_UsePIDOutput_d
    void UsePIDOutput(double output) override {
RPYBUILD_OVERLOAD_PURE_NAME(PIDCommand,PYBIND11_TYPE(void), CxxBase, "usePIDOutput", UsePIDOutput,output);    }
#endif
