...
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(void), CxxBase, "PIDWrite", PIDWrite,output);    }
#endif

#ifndef RPYGEN_DISABLE_PIDGet_v
    double PIDGet() override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(double), CxxBase, "PIDGet", PIDGet,);    }
#endif

#ifndef RPYGEN_DISABLE_SetAbsoluteTolerance_d
    void SetAbsoluteTolerance(double absValue) override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(void), CxxBase, "setAbsoluteTolerance", SetAbsoluteTolerance,absValue);    }
#endif

#ifndef RPYGEN_DISABLE_SetPercentTolerance_d
    void SetPercentTolerance(double percent) override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(void), CxxBase, "setPercentTolerance", SetPercentTolerance,percent);    }
#endif

#ifndef RPYGEN_DISABLE_KOnTarget_v
    bool OnTarget() const override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(bool), CxxBase, "onTarget", OnTarget,);    }
#endif

#ifndef RPYGEN_DISABLE_ReturnPIDInput_v
    double ReturnPIDInput() override {
RPYBUILD_OVERLOAD_PURE_NAME(PIDSubsystem,PYBIND11_TYPE(double), CxxBase, "returnPIDInput", ReturnPIDInput,);    }
#endif

#ifndef RPYGEN_DISABLE_UsePIDOutput_d
    void UsePIDOutput(double output) override {
RPYBUILD_OVERLOAD_PURE_NAME(PIDSubsystem,PYBIND11_TYPE(void), CxxBase, "usePIDOutput", UsePIDOutput,output);    }
#endif
