...
RPYBUILD_OVERLOAD_PURE_NAME(Command,PYBIND11_TYPE(bool), CxxBase, "isFinished", IsFinished,);    }
#endif

#ifndef RPYGEN_DISABLE_End_v
    void End() override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(void), CxxBase, "end", End,);    }
#endif

#ifndef RPYGEN_DISABLE_Interrupted_v
    void Interrupted() override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(void), CxxBase, "interrupted", Interrupted,);    }
#endif

#ifndef RPYGEN_DISABLE__Initialize_v
    void _Initialize() override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(void), CxxBase, "_initialize", _Initialize,);    }
#endif

#ifndef RPYGEN_DISABLE__Interrupted_v
    void _Interrupted() override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(void), CxxBase, "_interrupted", _Interrupted,);    }
#endif

#ifndef RPYGEN_DISABLE__Execute_v
    void _Execute() override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(void), CxxBase, "_execute", _Execute,);    }
#endif

#ifndef RPYGEN_DISABLE__End_v
    void _End() override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(void), CxxBase, "_end", _End,);    }
#endif

#ifndef RPYGEN_DISABLE__Cancel_v
    void _Cancel() override {
PYBIND11_OVERLOAD_NAME(PYBIND11_TYPE(void), CxxBase, "_cancel", _Cancel,);    }
#endif
