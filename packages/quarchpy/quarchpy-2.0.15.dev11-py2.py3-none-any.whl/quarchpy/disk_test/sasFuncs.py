...
class WindowsSAS(abstractSASDet):
    ...
    def sortList(self, err, out):
        ...
        for dev in deviceList:
            ...
            # Matt - 24_09 removing NVMe named devices until an alternative method can be found to differenciate
            if "model" in newDevice:
                if "nvme" in str(newDevice["model"]).lower():
                    continue
