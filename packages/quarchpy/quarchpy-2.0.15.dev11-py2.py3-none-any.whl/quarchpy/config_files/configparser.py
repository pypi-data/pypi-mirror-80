...
class ModuleRangeParam:
    ...
    def __repr__(self):
        ...
        for item in self.ranges:
            string = string + item.min_value + "," + item.max_value + "," + item.step_value + "," + item.unit + "|"
        return string
    ...
    # TODO: shouldn't this be called get_min?
    def get_max_value(self):
...
#
# string = """Module Name:
# PCIe SFF HS Drive Module
#
# Module Identity Information:
# Family:     Torridon System
# Name:       PCIe SFF HS Drive Module
# Part#:      QTL1743-03
# Processor:  QTL1747-01,4.009
# Bootloader: QTL1693-01,1.00
# FPGA 1:     QTL1742,1.5"""
#
# x = get_config_path_for_module(idn_string=string)
# print(return_module_type_list("drive"))