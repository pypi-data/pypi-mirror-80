...
#
# files in "/home/conda/staged-recipes/build_artifacts/cctbx-base_1600649704566/_h_env_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_" and run
#
#   libtbx.refresh
#
...
#
# See also:
#   "/home/conda/staged-recipes/build_artifacts/cctbx-base_1600649704566/_h_env_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_placehold_/dispatcher_include_template.sh"
#
...
if [ -n "$LIBTBX__VALGRIND_FLAG__" ]; then
  exec $LIBTBX_VALGRIND "$LIBTBX_PREFIX/lib/python3.8/site-packages/libtbx/command_line/bash.sh" "$@"
elif [ $# -eq 0 ]; then
  exec "$LIBTBX_PREFIX/lib/python3.8/site-packages/libtbx/command_line/bash.sh"
else
  exec "$LIBTBX_PREFIX/lib/python3.8/site-packages/libtbx/command_line/bash.sh" "$@"
fi
