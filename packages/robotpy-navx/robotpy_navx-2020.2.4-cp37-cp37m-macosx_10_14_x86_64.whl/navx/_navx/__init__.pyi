...
class AHRS(wpilib._wpilib.SendableBase, wpilib._wpilib.Sendable, wpilib._wpilib.ErrorBase, wpilib.interfaces._interfaces.PIDSource, wpilib.interfaces._interfaces.Gyro):
    class BoardAxis():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kBoardAxisX': BoardAxis.kBoardAxisX, 'kBoardAxisY': BoardAxis.kBoardAxisY, 'kBoardAxisZ': BoardAxis.kBoardAxisZ}
        kBoardAxisX: navx._navx.AHRS.BoardAxis # value = BoardAxis.kBoardAxisX
        kBoardAxisY: navx._navx.AHRS.BoardAxis # value = BoardAxis.kBoardAxisY
        kBoardAxisZ: navx._navx.AHRS.BoardAxis # value = BoardAxis.kBoardAxisZ
        pass
    class BoardYawAxis():
    ...
    class SerialDataType():
        ...
        def name(self) -> None:
            ...
            :type: None
            """
        __members__: dict # value = {'kProcessedData': SerialDataType.kProcessedData, 'kRawData': SerialDataType.kRawData}
        kProcessedData: navx._navx.AHRS.SerialDataType # value = SerialDataType.kProcessedData
        kRawData: navx._navx.AHRS.SerialDataType # value = SerialDataType.kRawData
        pass
    @typing.overload
