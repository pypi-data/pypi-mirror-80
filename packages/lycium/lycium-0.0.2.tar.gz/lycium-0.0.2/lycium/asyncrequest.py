...
def main():
    ...
    @tornado_route(r'/t3', methods=['GET'])
    @tornado.gen.coroutine
    def test_t3(handler, request):
        print('111111')
        resp_code, resp_text = yield async_get('http://10.10.61.30:8088/bencao/rules/basic/freqs', proxies={})
        print('333333', resp_code)
        # resp_text = resp.body.decode()
        return resp_text
