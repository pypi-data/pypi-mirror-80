    ...
    """
{
    ...
    "package_data": {
        "aws_cdk_appsync_transformer._jsii": [
            "aws-cdk-appsync-transformer@1.63.0-rc.1.jsii.tgz"
        ],
        "aws_cdk_appsync_transformer": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-appsync>=1.63.0, <2.0.0",
        "aws-cdk.aws-cognito>=1.63.0, <2.0.0",
        "aws-cdk.aws-dynamodb>=1.63.0, <2.0.0",
        "aws-cdk.aws-iam>=1.63.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.63.0, <2.0.0",
