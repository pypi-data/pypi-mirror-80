...
class AppSyncTransformer(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: -
        :param id: -
        :param schema_path: Required. Relative path where schema.graphql exists
        :param api_name: Optional. String value representing the api name Default: ``${id}-api``
        :param authorization_config: Optional. {@link AuthorizationConfig} type defining authorization for AppSync GraphqlApi. Defaults to API_KEY Default: API_KEY authorization config
        :param field_log_level: Optional. {@link FieldLogLevel} type for AppSync GraphqlApi log level Default: FieldLogLevel.NONE
        :param sync_enabled: Optional. Boolean to enable DataStore Sync Tables Default: false
