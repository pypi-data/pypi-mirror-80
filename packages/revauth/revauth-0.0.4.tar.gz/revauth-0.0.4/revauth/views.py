...
from .serializers import RegisterSerializer, SocialSerializer, ValidationSerializer, ProfileJWTSerializer
from revauth import exceptions
...
class UserRegister(views.APIView):
    ...
    def post(self, request):
        ...
        try:
            decoded = JWTCryptor().decode(serializer.validated_data['access_token'])
        except:
