...
from .going_to_future_negative_queries import GET_N_DATA_QUESTIONS
from .going_to_future_negative_queries import GET_N_DATA_QUESTIONS_PER_WORD
from .lemma_queries import GET_LEMMA_LIST_DATA


class GTFNCQuestionGetter(QuestionGetter):
    code = "GTFNC"
