...
from .present_continuous_interrogative_queries import GET_N_DATA_QUESTIONS
from .present_continuous_interrogative_queries import GET_N_DATA_QUESTIONS_PER_WORD


class PCIPTQuestionGetter(QuestionGetter):
    code = "PCIPT"
