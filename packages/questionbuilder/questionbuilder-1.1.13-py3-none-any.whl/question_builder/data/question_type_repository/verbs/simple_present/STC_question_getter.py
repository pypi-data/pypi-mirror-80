...
from .simple_present_affirmative_queries import GET_N_DATA_QUESTIONS
from .simple_present_affirmative_queries import GET_N_DATA_QUESTIONS_PER_WORD


class STCQuestionGetter(QuestionGetter):
    code = "STC"
