...
class SimplePastNegationChoiceQuestionCreator(QuestionCreator):
    ...
    @staticmethod
    def _get_did_with_negation(negation_adverb):
    ...
    @staticmethod
    def _get_correct_answer(target_verb, subject, did_with_negation):
        return f"{subject} {did_with_negation} {target_verb}"

    @staticmethod
    def _get_baits(self, subject, did_with_negation, target_verb_past_tense):
