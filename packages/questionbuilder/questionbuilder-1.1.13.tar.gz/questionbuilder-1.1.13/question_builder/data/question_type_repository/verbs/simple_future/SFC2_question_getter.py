...
from .simple_future_affirmative_queries import GET_N_DATA_QUESTIONS
from .simple_future_affirmative_queries import GET_N_DATA_QUESTIONS_PER_WORD


# Conjugation
class SFC2QuestionGetter(QuestionGetter):
    code = "SFC2"
