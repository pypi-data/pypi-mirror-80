...
from .present_continuous_negative_queries import GET_N_DATA_QUESTIONS
from .present_continuous_negative_queries import GET_N_DATA_QUESTIONS_PER_WORD


class PCNPTQuestionGetter(QuestionGetter):
    code = "PCNPT"
