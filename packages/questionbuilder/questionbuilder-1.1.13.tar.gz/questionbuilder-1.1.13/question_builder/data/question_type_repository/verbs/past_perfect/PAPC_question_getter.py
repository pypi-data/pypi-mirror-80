...
from .past_perfect_affirmative_queries import GET_N_DATA_QUESTIONS
from .past_perfect_affirmative_queries import GET_N_DATA_QUESTIONS_PER_WORD


class PAPCQuestionGetter(QuestionGetter):
    code = "PAPC"
