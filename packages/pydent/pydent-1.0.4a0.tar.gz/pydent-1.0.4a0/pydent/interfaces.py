...
class QueryInterface(SessionInterface, QueryInterfaceABC):
    ...
    def all(
        self, methods: List[str] = None, include=None, opts: dict = None,
    ):
        """Finds all models.
    ...
    def pagination(
        ...
        :param page_callback: optional callback function to apply to (page_num, models)
               for each page.
