...
class SageDarkData(SageBinaryData):
    ...
    def _get_galaxy_struct(self):
        ...
        galdesc_full = [
            ...
            ("SpinStars", (np.float32, 3)),
            ("SpinGas", (np.float32, 3)),
            ("SpinClassicalBulge", (np.float32, 3)),

            ("StarsFromH2", np.float32),
            ("StarsInstability", np.float32),
            ("StarsMergeBurst", np.float32),

            ("DiscHI", (np.float32, 30)),
            ("DiscH2", (np.float32, 30)),
            ("DiscSFR", (np.float32, 30)),
            ...
            ("SfrFromH2", np.float32),
            ("SfrInstab", np.float32),
            ("SfrMerge", np.float32),
            ("SfrDiskZ", np.float32),
            ("SfrBulgeZ", np.float32),

            ("DiskRadius", np.float32),
            ("DiskCoolRadius", np.float32),
