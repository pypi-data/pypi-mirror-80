...
# novelty detector
fname = "noclear_novelty_detector_channel2_difference9_0_index10_1_channel12_index1_8.retrain.pkl"
dlink = "https://drive.google.com/uc?export=download&id=1k0m5fJCBiJbVAoPQPfN0iqn3LnI3UVvu"
urllib.request.urlretrieve(dlink, os.path.join(path_tables_default, fname))
# cloud mask
fname = "cld_mask_S2_classi_20170412_v20170412_11:43:14.h5"
dlink = "https://drive.google.com/uc?export=download&id=1PHmX24B_LkbGRgfntQbYc8NWlSkdIX-M"
urllib.request.urlretrieve(dlink, os.path.join(path_tables_default, fname))
# from sicor.tables.get_tables_pypi import get_tables_pypi
# for sensor in ["s2", "l8"]:
    # get_tables_pypi(sicor_path=path_sicorlib, sicor_table_path=path_tables_default, sensor=sensor)
