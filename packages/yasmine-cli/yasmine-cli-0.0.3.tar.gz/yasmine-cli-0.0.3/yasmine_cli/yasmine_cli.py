...
#from .libs.libs_util import processCmdLine, configure, configure_logger
...
def main():
    ...
    #print("Main: loglevel=%d" % logger.level)
    ...
    if args.plot_resp:
        ...
        try:
            ...
            #print("Call _write_stationxml: schema_version=[%s]" % schema_version)
