...
package_name = "s3-package-publisher"
...
setup(
    ...
    description="A Pipenv-friendly CLI tool that packages and publishes your python package to your own S3 repository",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/amamparo/s3-package-publisher",
    packages=find_packages(),
    entry_points={"console_scripts": ["publish = src.main:main"]},
