...
class OwletPy(object):
    ...
    def get_dsn(self):
        dsnurl = region_config[owlet_region]['url_base'] + '/devices.json'
    ...
    def get_properties(self, measure=None, set_active=True):
        ...
        properties_url = region_config[owlet_region]['url_base'] + '/dsns/' + self.dsn + '/properties'
    ...
    def set_app_active(self):
        ...
        if self.app_active_expire < time.time():
            ...
            data_point_url = region_config[owlet_region]['url_base'] + '/properties/' + self.app_active_prop_id + '/datapoints.json'
