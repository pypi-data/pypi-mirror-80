...
class FormApi(object):
    ...
    def patch_form(self, form_id, form, **kwargs):  # noqa: E501
        """Update a form  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_form(form_id, form, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.patch_form_with_http_info(form_id, form, **kwargs)  # noqa: E501

    def patch_form_with_http_info(self, form_id, form, **kwargs):  # noqa: E501
        """Update a form  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_form_with_http_info(form_id, form, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('form' not in local_var_params or  # noqa: E501
                                                        local_var_params['form'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `form` when calling `patch_form`")  # noqa: E501
