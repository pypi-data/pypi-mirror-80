...
"""
    ...
    The version of the OpenAPI document: 1.0.16.3
...
class SegmentFullResponse(object):
    ...
    def __init__(self, id=None, name=None, query=None, mailings_count=None, last_used=None, created_on=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.name = name
        self.query = query
        self.mailings_count = mailings_count
    ...
    @property
    def mailings_count(self):
        """Gets the mailings_count of this SegmentFullResponse.  # noqa: E501


        :return: The mailings_count of this SegmentFullResponse.  # noqa: E501
        :rtype: int
        """
        return self._mailings_count

    @mailings_count.setter
    def mailings_count(self, mailings_count):
        """Sets the mailings_count of this SegmentFullResponse.


        :param mailings_count: The mailings_count of this SegmentFullResponse.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and mailings_count is None:  # noqa: E501
            raise ValueError("Invalid value for `mailings_count`, must not be `None`")  # noqa: E501

        self._mailings_count = mailings_count
