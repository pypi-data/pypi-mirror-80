...
class UsageLimitsResponse(object):
    ...
    def per_campaign(self, per_campaign):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and per_campaign is None:  # noqa: E501
            raise ValueError("Invalid value for `per_campaign`, must not be `None`")  # noqa: E501
    ...
    def per_month(self, per_month):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and per_month is None:  # noqa: E501
    ...
    def maximum_contacts(self, maximum_contacts):
        ...
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and maximum_contacts is None:  # noqa: E501
            raise ValueError("Invalid value for `maximum_contacts`, must not be `None`")  # noqa: E501
