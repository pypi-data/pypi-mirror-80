...
class ContactApi(object):
    ...
    def list_contacts_of_segment(self, list_id, segment_id, **kwargs):  # noqa: E501
        """Show all contacts in a segment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_contacts_of_segment(list_id, segment_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_contacts_of_segment_with_http_info(list_id, segment_id, **kwargs)  # noqa: E501

    def list_contacts_of_segment_with_http_info(self, list_id, segment_id, **kwargs):  # noqa: E501
        """Show all contacts in a segment  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_contacts_of_segment_with_http_info(list_id, segment_id, async_req=True)
        >>> result = thread.get()
