...
_HOTCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='unfreeze_max_price', full_name='ffs.rpc.HotConfig.unfreeze_max_price', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ipfs', full_name='ffs.rpc.HotConfig.ipfs', index=3,
...
_FILCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='fast_retrieval', full_name='ffs.rpc.FilConfig.fast_retrieval', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='deal_start_offset', full_name='ffs.rpc.FilConfig.deal_start_offset', index=9,
...
_FILSTORAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='piece_cid', full_name='ffs.rpc.FilStorage.piece_cid', index=7,
...
_GETSTORAGEJOBREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='jid', full_name='ffs.rpc.GetStorageJobRequest.jid', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETSTORAGEJOBRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='job', full_name='ffs.rpc.GetStorageJobResponse.job', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
GetStorageJobRequest = _reflection.GeneratedProtocolMessageType('GetStorageJobRequest', (_message.Message,), {
...
GetStorageJobResponse = _reflection.GeneratedProtocolMessageType('GetStorageJobResponse', (_message.Message,), {
