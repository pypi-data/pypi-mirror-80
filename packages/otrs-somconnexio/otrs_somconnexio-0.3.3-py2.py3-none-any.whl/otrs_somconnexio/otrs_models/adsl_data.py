class ADSLData:
    ...
    def __init__(
        self, order_id, phone_number, iban, landline_type, landline_minutes,
        ...
        shipment_subdivision, previous_service, previous_provider, previous_owner_vat,
        previous_owner_name, previous_owner_surname, notes, adsl_coverage, mm_fiber_coverage,
            vdf_fiber_coverage, change_address, product):
        ...
        # ADSL the Tickets
        self.landline_type = landline_type
        self.landline_minutes = landline_minutes
