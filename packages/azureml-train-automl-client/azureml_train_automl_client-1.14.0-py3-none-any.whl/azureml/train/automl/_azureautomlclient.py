...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import (
    InvalidArgumentWithSupportedValues, InvalidArgumentType, SnapshotLimitExceeded, LocalLegacyDependencyMissing)
        ...
        try:
            if self.automl_settings.spark_context:
                ...
                try:
                    ...
                    raise ConfigException._with_error(
                        AzureMLError.create(
                            LocalLegacyDependencyMissing, target="local", module_name="azureml-train-automl-runtime")
                    )
