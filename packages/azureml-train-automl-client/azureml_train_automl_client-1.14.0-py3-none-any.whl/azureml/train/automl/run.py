...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import (
    AutoMLInternal, ConflictingValueForArguments, FeatureUnsupportedForIncompatibleArguments, InvalidArgumentType,
    InvalidOperationOnRunState, OnnxNotEnabled, OnnxSplitsNotEnabled, NoMetricsData, ModelMissing,
    CancelUnsupportedForLocalRuns, ContinueRunUnsupportedForUntrackedRuns, LoadModelDependencyMissing,
    LocalLegacyDependencyMissing, LocalLegacyDependencyMissing, ContinueRunUnsupportedForAdb, DependencyWrongVersion)
...
class AutoMLRun(Run):
        ...
        with logging_utilities.log_activity(
            ...
            try:
                ...
                if e.name == 'xgboost':
                    ...
                    raise ConfigException._with_error(AzureMLError.create(
                        LoadModelDependencyMissing, target="get_output", module="xgboost", ver="<=0.90",
                ...
                if isinstance(e, XGBoostError):
                    import xgboost
                    # XGBoost is installed but at an incorrect version.
                    ...
                    # be of type None).
                    raise ConfigException._with_error(AzureMLError.create(
                        DependencyWrongVersion, target="get_output", module="xgboost", ver="==0.90",
    ...
    def _download_automl_onnx_model(self, curr_run: Run, model_name: str) -> Any:
        ...
        try:
            ...
            raise ConfigException._with_error(
                AzureMLError.create(
                    LocalLegacyDependencyMissing, target="onnx-model", module_name="azureml-train-automl-runtime")
            )
