...
# source: hydro_serving_grpc/onnx/onnx.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='hydro_serving_grpc/onnx/onnx.proto',
  package='hydrosphere.onnx',
  syntax='proto3',
  serialized_pb=_b('\n\"hydro_serving_grpc/onnx/onnx.proto\x12\x10hydrosphere.onnx\"\x9c\x04\n\x0e\x41ttributeProto\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\x15\n\rref_attr_name\x18\x15 \x01(\t\x12\x12\n\ndoc_string\x18\r \x01(\t\x12<\n\x04type\x18\x14 \x01(\x0e\x32..hydrosphere.onnx.AttributeProto.AttributeType\x12\t\n\x01\x66\x18\x02 \x01(\x02\x12\t\n\x01i\x18\x03 \x01(\x03\x12\t\n\x01s\x18\x04 \x01(\x0c\x12(\n\x01t\x18\x05 \x01(\x0b\x32\x1d.hydrosphere.onnx.TensorProto\x12\'\n\x01g\x18\x06 \x01(\x0b\x32\x1c.hydrosphere.onnx.GraphProto\x12\x0e\n\x06\x66loats\x18\x07 \x03(\x02\x12\x0c\n\x04ints\x18\x08 \x03(\x03\x12\x0f\n\x07strings\x18\t \x03(\x0c\x12.\n\x07tensors\x18\n \x03(\x0b\x32\x1d.hydrosphere.onnx.TensorProto\x12,\n\x06graphs\x18\x0b \x03(\x0b\x32\x1c.hydrosphere.onnx.GraphProto\"\x91\x01\n\rAttributeType\x12\r\n\tUNDEFINED\x10\x00\x12\t\n\x05\x46LOAT\x10\x01\x12\x07\n\x03INT\x10\x02\x12\n\n\x06STRING\x10\x03\x12\n\n\x06TENSOR\x10\x04\x12\t\n\x05GRAPH\x10\x05\x12\n\n\x06\x46LOATS\x10\x06\x12\x08\n\x04INTS\x10\x07\x12\x0b\n\x07STRINGS\x10\x08\x12\x0b\n\x07TENSORS\x10\t\x12\n\n\x06GRAPHS\x10\n\"]\n\x0eValueInfoProto\x12\x0c\n\x04name\x18\x01 \x01(\t\x12)\n\x04type\x18\x02 \x01(\x0b\x32\x1b.hydrosphere.onnx.TypeProto\x12\x12\n\ndoc_string\x18\x03 \x01(\t\"\xa2\x01\n\tNodeProto\x12\r\n\x05input\x18\x01 \x03(\t\x12\x0e\n\x06output\x18\x02 \x03(\t\x12\x0c\n\x04name\x18\x03 \x01(\t\x12\x0f\n\x07op_type\x18\x04 \x01(\t\x12\x0e\n\x06\x64omain\x18\x07 \x01(\t\x12\x33\n\tattribute\x18\x05 \x03(\x0b\x32 .hydrosphere.onnx.AttributeProto\x12\x12\n\ndoc_string\x18\x06 \x01(\t\"\xb7\x02\n\nModelProto\x12\x12\n\nir_version\x18\x01 \x01(\x03\x12:\n\x0copset_import\x18\x08 \x03(\x0b\x32$.hydrosphere.onnx.OperatorSetIdProto\x12\x15\n\rproducer_name\x18\x02 \x01(\t\x12\x18\n\x10producer_version\x18\x03 \x01(\t\x12\x0e\n\x06\x64omain\x18\x04 \x01(\t\x12\x15\n\rmodel_version\x18\x05 \x01(\x03\x12\x12\n\ndoc_string\x18\x06 \x01(\t\x12+\n\x05graph\x18\x07 \x01(\x0b\x32\x1c.hydrosphere.onnx.GraphProto\x12@\n\x0emetadata_props\x18\x0e \x03(\x0b\x32(.hydrosphere.onnx.StringStringEntryProto\"4\n\x16StringStringEntryProto\x12\x0b\n\x03key\x18\x01 \x01(\t\x12\r\n\x05value\x18\x02 \x01(\t\"\xa6\x02\n\nGraphProto\x12)\n\x04node\x18\x01 \x03(\x0b\x32\x1b.hydrosphere.onnx.NodeProto\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\x32\n\x0binitializer\x18\x05 \x03(\x0b\x32\x1d.hydrosphere.onnx.TensorProto\x12\x12\n\ndoc_string\x18\n \x01(\t\x12/\n\x05input\x18\x0b \x03(\x0b\x32 .hydrosphere.onnx.ValueInfoProto\x12\x30\n\x06output\x18\x0c \x03(\x0b\x32 .hydrosphere.onnx.ValueInfoProto\x12\x34\n\nvalue_info\x18\r \x03(\x0b\x32 .hydrosphere.onnx.ValueInfoProto\"\xc7\x04\n\x0bTensorProto\x12\x0c\n\x04\x64ims\x18\x01 \x03(\x03\x12\x39\n\tdata_type\x18\x02 \x01(\x0e\x32&.hydrosphere.onnx.TensorProto.DataType\x12\x36\n\x07segment\x18\x03 \x01(\x0b\x32%.hydrosphere.onnx.TensorProto.Segment\x12\x16\n\nfloat_data\x18\x04 \x03(\x02\x42\x02\x10\x01\x12\x16\n\nint32_data\x18\x05 \x03(\x05\x42\x02\x10\x01\x12\x13\n\x0bstring_data\x18\x06 \x03(\x0c\x12\x16\n\nint64_data\x18\x07 \x03(\x03\x42\x02\x10\x01\x12\x0c\n\x04name\x18\x08 \x01(\t\x12\x12\n\ndoc_string\x18\x0c \x01(\t\x12\x10\n\x08raw_data\x18\t \x01(\x0c\x12\x17\n\x0b\x64ouble_data\x18\n \x03(\x01\x42\x02\x10\x01\x12\x17\n\x0buint64_data\x18\x0b \x03(\x04\x42\x02\x10\x01\x1a%\n\x07Segment\x12\r\n\x05\x62\x65gin\x18\x01 \x01(\x03\x12\x0b\n\x03\x65nd\x18\x02 \x01(\x03\"\xcc\x01\n\x08\x44\x61taType\x12\r\n\tUNDEFINED\x10\x00\x12\t\n\x05\x46LOAT\x10\x01\x12\t\n\x05UINT8\x10\x02\x12\x08\n\x04INT8\x10\x03\x12\n\n\x06UINT16\x10\x04\x12\t\n\x05INT16\x10\x05\x12\t\n\x05INT32\x10\x06\x12\t\n\x05INT64\x10\x07\x12\n\n\x06STRING\x10\x08\x12\x08\n\x04\x42OOL\x10\t\x12\x0b\n\x07\x46LOAT16\x10\n\x12\n\n\x06\x44OUBLE\x10\x0b\x12\n\n\x06UINT32\x10\x0c\x12\n\n\x06UINT64\x10\r\x12\r\n\tCOMPLEX64\x10\x0e\x12\x0e\n\nCOMPLEX128\x10\x0f\"\xa1\x01\n\x10TensorShapeProto\x12\x39\n\x03\x64im\x18\x01 \x03(\x0b\x32,.hydrosphere.onnx.TensorShapeProto.Dimension\x1aR\n\tDimension\x12\x13\n\tdim_value\x18\x01 \x01(\x03H\x00\x12\x13\n\tdim_param\x18\x02 \x01(\tH\x00\x12\x12\n\ndenotation\x18\x03 \x01(\tB\x07\n\x05value\"\xb8\x01\n\x14\x44\x65notationConstProto\x12\x12\n\nDATA_BATCH\x18\x01 \x01(\t\x12\x14\n\x0c\x44\x41TA_CHANNEL\x18\x02 \x01(\t\x12\x11\n\tDATA_TIME\x18\x03 \x01(\t\x12\x14\n\x0c\x44\x41TA_FEATURE\x18\x04 \x01(\t\x12\x19\n\x11\x46ILTER_IN_CHANNEL\x18\x05 \x01(\t\x12\x1a\n\x12\x46ILTER_OUT_CHANNEL\x18\x06 \x01(\t\x12\x16\n\x0e\x46ILTER_SPATIAL\x18\x07 \x01(\t\"\xc7\x01\n\tTypeProto\x12\x39\n\x0btensor_type\x18\x01 \x01(\x0b\x32\".hydrosphere.onnx.TypeProto.TensorH\x00\x1av\n\x06Tensor\x12\x39\n\telem_type\x18\x01 \x01(\x0e\x32&.hydrosphere.onnx.TensorProto.DataType\x12\x31\n\x05shape\x18\x02 \x01(\x0b\x32\".hydrosphere.onnx.TensorShapeProtoB\x07\n\x05value\"5\n\x12OperatorSetIdProto\x12\x0e\n\x06\x64omain\x18\x01 \x01(\t\x12\x0f\n\x07version\x18\x02 \x01(\x03*c\n\x07Version\x12\x12\n\x0e_START_VERSION\x10\x00\x12\x19\n\x15IR_VERSION_2017_10_10\x10\x01\x12\x19\n\x15IR_VERSION_2017_10_30\x10\x02\x12\x0e\n\nIR_VERSION\x10\x03\x42\x1d\n\x1bio.hydrosphere.serving.onnxb\x06proto3')
)

_VERSION = _descriptor.EnumDescriptor(
  name='Version',
  full_name='hydrosphere.onnx.Version',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_ATTRIBUTEPROTO_ATTRIBUTETYPE = _descriptor.EnumDescriptor(
  name='AttributeType',
  full_name='hydrosphere.onnx.AttributeProto.AttributeType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_TENSORPROTO_DATATYPE = _descriptor.EnumDescriptor(
  name='DataType',
  full_name='hydrosphere.onnx.TensorProto.DataType',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_ATTRIBUTEPROTO = _descriptor.Descriptor(
  name='AttributeProto',
  full_name='hydrosphere.onnx.AttributeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='hydrosphere.onnx.AttributeProto.name', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ref_attr_name', full_name='hydrosphere.onnx.AttributeProto.ref_attr_name', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='doc_string', full_name='hydrosphere.onnx.AttributeProto.doc_string', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='hydrosphere.onnx.AttributeProto.type', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='f', full_name='hydrosphere.onnx.AttributeProto.f', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='i', full_name='hydrosphere.onnx.AttributeProto.i', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='s', full_name='hydrosphere.onnx.AttributeProto.s', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='t', full_name='hydrosphere.onnx.AttributeProto.t', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='g', full_name='hydrosphere.onnx.AttributeProto.g', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='floats', full_name='hydrosphere.onnx.AttributeProto.floats', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ints', full_name='hydrosphere.onnx.AttributeProto.ints', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='strings', full_name='hydrosphere.onnx.AttributeProto.strings', index=11,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tensors', full_name='hydrosphere.onnx.AttributeProto.tensors', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='graphs', full_name='hydrosphere.onnx.AttributeProto.graphs', index=13,
...
_VALUEINFOPROTO = _descriptor.Descriptor(
  name='ValueInfoProto',
  full_name='hydrosphere.onnx.ValueInfoProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='hydrosphere.onnx.ValueInfoProto.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='type', full_name='hydrosphere.onnx.ValueInfoProto.type', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='doc_string', full_name='hydrosphere.onnx.ValueInfoProto.doc_string', index=2,
...
_NODEPROTO = _descriptor.Descriptor(
  name='NodeProto',
  full_name='hydrosphere.onnx.NodeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='input', full_name='hydrosphere.onnx.NodeProto.input', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='output', full_name='hydrosphere.onnx.NodeProto.output', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='hydrosphere.onnx.NodeProto.name', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='op_type', full_name='hydrosphere.onnx.NodeProto.op_type', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='domain', full_name='hydrosphere.onnx.NodeProto.domain', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='attribute', full_name='hydrosphere.onnx.NodeProto.attribute', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='doc_string', full_name='hydrosphere.onnx.NodeProto.doc_string', index=6,
...
_MODELPROTO = _descriptor.Descriptor(
  name='ModelProto',
  full_name='hydrosphere.onnx.ModelProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ir_version', full_name='hydrosphere.onnx.ModelProto.ir_version', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='opset_import', full_name='hydrosphere.onnx.ModelProto.opset_import', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='producer_name', full_name='hydrosphere.onnx.ModelProto.producer_name', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='producer_version', full_name='hydrosphere.onnx.ModelProto.producer_version', index=3,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='domain', full_name='hydrosphere.onnx.ModelProto.domain', index=4,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='model_version', full_name='hydrosphere.onnx.ModelProto.model_version', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='doc_string', full_name='hydrosphere.onnx.ModelProto.doc_string', index=6,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='graph', full_name='hydrosphere.onnx.ModelProto.graph', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='metadata_props', full_name='hydrosphere.onnx.ModelProto.metadata_props', index=8,
...
_STRINGSTRINGENTRYPROTO = _descriptor.Descriptor(
  ...
  full_name='hydrosphere.onnx.StringStringEntryProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='hydrosphere.onnx.StringStringEntryProto.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='hydrosphere.onnx.StringStringEntryProto.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GRAPHPROTO = _descriptor.Descriptor(
  name='GraphProto',
  full_name='hydrosphere.onnx.GraphProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='node', full_name='hydrosphere.onnx.GraphProto.node', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='hydrosphere.onnx.GraphProto.name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='initializer', full_name='hydrosphere.onnx.GraphProto.initializer', index=2,
      number=5, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='doc_string', full_name='hydrosphere.onnx.GraphProto.doc_string', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='input', full_name='hydrosphere.onnx.GraphProto.input', index=4,
      number=11, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='output', full_name='hydrosphere.onnx.GraphProto.output', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value_info', full_name='hydrosphere.onnx.GraphProto.value_info', index=6,
...
_TENSORPROTO_SEGMENT = _descriptor.Descriptor(
  name='Segment',
  full_name='hydrosphere.onnx.TensorProto.Segment',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='begin', full_name='hydrosphere.onnx.TensorProto.Segment.begin', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='end', full_name='hydrosphere.onnx.TensorProto.Segment.end', index=1,
...
_TENSORPROTO = _descriptor.Descriptor(
  name='TensorProto',
  full_name='hydrosphere.onnx.TensorProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dims', full_name='hydrosphere.onnx.TensorProto.dims', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data_type', full_name='hydrosphere.onnx.TensorProto.data_type', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='segment', full_name='hydrosphere.onnx.TensorProto.segment', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='float_data', full_name='hydrosphere.onnx.TensorProto.float_data', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='int32_data', full_name='hydrosphere.onnx.TensorProto.int32_data', index=4,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='string_data', full_name='hydrosphere.onnx.TensorProto.string_data', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='int64_data', full_name='hydrosphere.onnx.TensorProto.int64_data', index=6,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='name', full_name='hydrosphere.onnx.TensorProto.name', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='doc_string', full_name='hydrosphere.onnx.TensorProto.doc_string', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='raw_data', full_name='hydrosphere.onnx.TensorProto.raw_data', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='double_data', full_name='hydrosphere.onnx.TensorProto.double_data', index=10,
      ...
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))),
    _descriptor.FieldDescriptor(
      name='uint64_data', full_name='hydrosphere.onnx.TensorProto.uint64_data', index=11,
...
_TENSORSHAPEPROTO_DIMENSION = _descriptor.Descriptor(
  name='Dimension',
  full_name='hydrosphere.onnx.TensorShapeProto.Dimension',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dim_value', full_name='hydrosphere.onnx.TensorShapeProto.Dimension.dim_value', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='dim_param', full_name='hydrosphere.onnx.TensorShapeProto.Dimension.dim_param', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='denotation', full_name='hydrosphere.onnx.TensorShapeProto.Dimension.denotation', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='hydrosphere.onnx.TensorShapeProto.Dimension.value',
...
_TENSORSHAPEPROTO = _descriptor.Descriptor(
  ...
  full_name='hydrosphere.onnx.TensorShapeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dim', full_name='hydrosphere.onnx.TensorShapeProto.dim', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DENOTATIONCONSTPROTO = _descriptor.Descriptor(
  name='DenotationConstProto',
  full_name='hydrosphere.onnx.DenotationConstProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='DATA_BATCH', full_name='hydrosphere.onnx.DenotationConstProto.DATA_BATCH', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='DATA_CHANNEL', full_name='hydrosphere.onnx.DenotationConstProto.DATA_CHANNEL', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='DATA_TIME', full_name='hydrosphere.onnx.DenotationConstProto.DATA_TIME', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='DATA_FEATURE', full_name='hydrosphere.onnx.DenotationConstProto.DATA_FEATURE', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='FILTER_IN_CHANNEL', full_name='hydrosphere.onnx.DenotationConstProto.FILTER_IN_CHANNEL', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='FILTER_OUT_CHANNEL', full_name='hydrosphere.onnx.DenotationConstProto.FILTER_OUT_CHANNEL', index=5,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='FILTER_SPATIAL', full_name='hydrosphere.onnx.DenotationConstProto.FILTER_SPATIAL', index=6,
      number=7, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TYPEPROTO_TENSOR = _descriptor.Descriptor(
  name='Tensor',
  full_name='hydrosphere.onnx.TypeProto.Tensor',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='elem_type', full_name='hydrosphere.onnx.TypeProto.Tensor.elem_type', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='shape', full_name='hydrosphere.onnx.TypeProto.Tensor.shape', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TYPEPROTO = _descriptor.Descriptor(
  name='TypeProto',
  full_name='hydrosphere.onnx.TypeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tensor_type', full_name='hydrosphere.onnx.TypeProto.tensor_type', index=0,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='hydrosphere.onnx.TypeProto.value',
      index=0, containing_type=None, fields=[]),
  ],
...
_OPERATORSETIDPROTO = _descriptor.Descriptor(
  ...
  full_name='hydrosphere.onnx.OperatorSetIdProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='domain', full_name='hydrosphere.onnx.OperatorSetIdProto.domain', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='version', full_name='hydrosphere.onnx.OperatorSetIdProto.version', index=1,
      number=2, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['DenotationConstProto'] = _DENOTATIONCONSTPROTO
...
AttributeProto = _reflection.GeneratedProtocolMessageType('AttributeProto', (_message.Message,), dict(
  ...
  __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
  # @@protoc_insertion_point(class_scope:hydrosphere.onnx.AttributeProto)
  ))
...
ValueInfoProto = _reflection.GeneratedProtocolMessageType('ValueInfoProto', (_message.Message,), dict(
  ...
  __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
  # @@protoc_insertion_point(class_scope:hydrosphere.onnx.ValueInfoProto)
  ))
...
NodeProto = _reflection.GeneratedProtocolMessageType('NodeProto', (_message.Message,), dict(
  ...
  __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
  # @@protoc_insertion_point(class_scope:hydrosphere.onnx.NodeProto)
  ))
...
ModelProto = _reflection.GeneratedProtocolMessageType('ModelProto', (_message.Message,), dict(
  ...
  __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
  # @@protoc_insertion_point(class_scope:hydrosphere.onnx.ModelProto)
  ))
...
StringStringEntryProto = _reflection.GeneratedProtocolMessageType('StringStringEntryProto', (_message.Message,), dict(
  ...
  __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
  # @@protoc_insertion_point(class_scope:hydrosphere.onnx.StringStringEntryProto)
  ))
...
GraphProto = _reflection.GeneratedProtocolMessageType('GraphProto', (_message.Message,), dict(
  ...
  __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
  # @@protoc_insertion_point(class_scope:hydrosphere.onnx.GraphProto)
  ))
...
TensorProto = _reflection.GeneratedProtocolMessageType('TensorProto', (_message.Message,), dict(
  ...
  Segment = _reflection.GeneratedProtocolMessageType('Segment', (_message.Message,), dict(
    ...
    __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
    # @@protoc_insertion_point(class_scope:hydrosphere.onnx.TensorProto.Segment)
    ))
  ,
  DESCRIPTOR = _TENSORPROTO,
  __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
  # @@protoc_insertion_point(class_scope:hydrosphere.onnx.TensorProto)
  ))
...
TensorShapeProto = _reflection.GeneratedProtocolMessageType('TensorShapeProto', (_message.Message,), dict(
  ...
  Dimension = _reflection.GeneratedProtocolMessageType('Dimension', (_message.Message,), dict(
    ...
    __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
    # @@protoc_insertion_point(class_scope:hydrosphere.onnx.TensorShapeProto.Dimension)
    ))
  ,
  DESCRIPTOR = _TENSORSHAPEPROTO,
  __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
  # @@protoc_insertion_point(class_scope:hydrosphere.onnx.TensorShapeProto)
  ))
_sym_db.RegisterMessage(TensorShapeProto)
_sym_db.RegisterMessage(TensorShapeProto.Dimension)

DenotationConstProto = _reflection.GeneratedProtocolMessageType('DenotationConstProto', (_message.Message,), dict(
  DESCRIPTOR = _DENOTATIONCONSTPROTO,
  __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
  # @@protoc_insertion_point(class_scope:hydrosphere.onnx.DenotationConstProto)
  ))
_sym_db.RegisterMessage(DenotationConstProto)
...
TypeProto = _reflection.GeneratedProtocolMessageType('TypeProto', (_message.Message,), dict(
  ...
  Tensor = _reflection.GeneratedProtocolMessageType('Tensor', (_message.Message,), dict(
    ...
    __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
    # @@protoc_insertion_point(class_scope:hydrosphere.onnx.TypeProto.Tensor)
    ))
  ,
  DESCRIPTOR = _TYPEPROTO,
  __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
  # @@protoc_insertion_point(class_scope:hydrosphere.onnx.TypeProto)
  ))
...
OperatorSetIdProto = _reflection.GeneratedProtocolMessageType('OperatorSetIdProto', (_message.Message,), dict(
  ...
  __module__ = 'hydro_serving_grpc.onnx.onnx_pb2'
  # @@protoc_insertion_point(class_scope:hydrosphere.onnx.OperatorSetIdProto)
  ))
_sym_db.RegisterMessage(OperatorSetIdProto)


DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n\033io.hydrosphere.serving.onnx'))
