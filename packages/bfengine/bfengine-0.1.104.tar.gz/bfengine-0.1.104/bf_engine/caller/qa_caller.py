...
class QACaller(CallerBase):
    ...
    def get_similar_qa_list(self,user_inputs:str,max_topn,category_ids,online: bool=True):
        ...
        self.get_all_sq_under_input_folders(category_ids_list, sq_list, sq_map, answer_map)
    ...
    def get_all_sq_under_input_folders(self, category_ids_list, sq_list, sq_map,answer_map):
