...
class InterfaceBase(abc.ABC):
    ...
    async def publish(self,
                      stream: 'grpclib.server.Stream[gv_proto.proto.broadcaster_pb2.PubRequest, gv_proto.proto.common_pb2.Ack]') -> None:
        pass

    @abc.abstractmethod
    async def subscribe(self,
                        stream: 'grpclib.server.Stream[gv_proto.proto.broadcaster_pb2.SubRequest, google.protobuf.any_pb2.Any]') -> None:
        pass

    @abc.abstractmethod
    async def get_indicators(self,
                             stream: 'grpclib.server.Stream[gv_proto.proto.archivist_pb2.IndicatorsRequest, gv_proto.proto.archivist_pb2.Indicators]') -> None:
        pass

    @abc.abstractmethod
    async def get_data_quality(self,
                               stream: 'grpclib.server.Stream[gv_proto.proto.archivist_pb2.DataQualityRequest, gv_proto.proto.archivist_pb2.DataQuality]') -> None:
        pass

    @abc.abstractmethod
    async def get_travel_times(self,
                               stream: 'grpclib.server.Stream[gv_proto.proto.archivist_pb2.TravelTimesRequest, gv_proto.proto.archivist_pb2.TravelTimes]') -> None:
        pass

    @abc.abstractmethod
    async def add_mapping_roads_data_points(self,
                                            stream: 'grpclib.server.Stream[gv_proto.proto.geographer_pb2.Mapping, gv_proto.proto.common_pb2.Ack]') -> None:
        pass

    @abc.abstractmethod
    async def add_data_points(self,
                              stream: 'grpclib.server.Stream[gv_proto.proto.geographer_pb2.Locations, gv_proto.proto.common_pb2.Ack]') -> None:
        pass

    @abc.abstractmethod
    async def import_shapefile_to_db(self,
                                     stream: 'grpclib.server.Stream[google.protobuf.empty_pb2.Empty, gv_proto.proto.common_pb2.Ack]') -> None:
        pass

    @abc.abstractmethod
    async def get_data_points(self,
                              stream: 'grpclib.server.Stream[gv_proto.proto.geographer_pb2.LocationsRequest, gv_proto.proto.geographer_pb2.Locations]') -> None:
        pass
    ...
    @abc.abstractmethod
    async def get_zone_points(self,
                              stream: 'grpclib.server.Stream[gv_proto.proto.geographer_pb2.LocationsRequest, gv_proto.proto.geographer_pb2.Locations]') -> None:
        pass

    @abc.abstractmethod
    async def get_mapping_roads_data_points(self,
                                            stream: 'grpclib.server.Stream[gv_proto.proto.geographer_pb2.MappingRequest, gv_proto.proto.geographer_pb2.Mapping]') -> None:
        pass

    @abc.abstractmethod
    async def update_roads_freeflow_speed(self,
                                          stream: 'grpclib.server.Stream[gv_proto.proto.geographer_pb2.FreeflowSpeeds, gv_proto.proto.common_pb2.Ack]') -> None:
        pass
