...
from qgis.core import QgsApplication, QgsMapLayer, QgsMapLayerType, QgsWkbTypes
...
class DialogBase(QDialog):
    ...
    def load_help(self, text_edit: QTextEdit) -> None:
        ...
        try:
            with open(help_file) as help_markdown:
                html_str = markdown2.markdown(help_markdown.read())
    ...
    def run_worker(self, *args: Any, log: QPlainTextEdit = None,
