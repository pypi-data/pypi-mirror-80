...
from PyQt5.QtWidgets import (QCheckBox, QComboBox, QGroupBox, QLineEdit,
                             ...
                             QSpinBox, QTextEdit)
from qgis.core import QgsField, QgsMeshLayer, QgsProject, QgsVectorLayer
from qgis.gui import QgisInterface
from ...core import Lattice
from ...feedback import Feedback
from ...meshing import quality_mesh
from ...stringdefs import write_string_defs_mesh, write_string_defs_sidecar
            ...
            with feedback.busy('Adding geometries to lattice...'):
                ...
                for line in lines:
                    nodes = [lattice.add_node((*p, 0.0), auto_conform=False)
                             for p in line]
                    lattice.add_segment(*nodes, auto_conform=False)
