...
from qgis.core import (QgsFeature, QgsFeatureSink, QgsField, QgsFields,
                       QgsGeometry, QgsMeshLayer, QgsPointXY,
...
class AssignMaterialID(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, _: Dict[str, Any] = None) -> None:
    ...
    def processAlgorithm(self, parameters: Dict[str, Any],
        ...
        for feature in input_polygon_layer.getFeatures():
            ...
            polygons.append((matid, polygon))

        # Modify and save the mesh
        elements: List[MeshElement]
        for matid, polygon in polygons:
            elements = mesh.elements_by_polygon(polygon)
