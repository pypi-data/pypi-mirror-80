...
def read_nodes(filename: str, attr_names: List[str] = None) -> List[PSLGNode]:
...
def write_poly(filename: str, *, nodes: Collection[PSLGNode] = None,
               segments: Collection[PSLGSegment] = None,
               holes: Collection[HoleMarker] = None,
               regions: Collection[RegionMarker] = None,
...
def _create_consecutive_list(
        iterable: Iterable[T], *,
        key: Callable[[T], Optional[int]] = None) -> List[T]:
