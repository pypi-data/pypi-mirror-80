...
class Triangle:
    ...
    def triangulate_poly(self, nodes: Collection[PSLGNode],
                         segments: Collection[PSLGSegment] = None,
                         holes: Iterable[HoleMarker] = None,
                         regions: Iterable[RegionMarker] = None,
                         *, dir_: str = '', node_attr_keys: List[str] = None,
    ...
    def run(self, input_file: str, *, suppress_output: bool = False,
            redirect_stdout: Callable[[str], None] = None,
            flags: Dict[str, Any] = None, **kwargs: Any) -> None:
