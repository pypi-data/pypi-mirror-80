...
class Ao21(And3):
    ...
    def __init__(self, name=__defaultName, in1='A1', in2='A2', in3='B', out='Z', andG=None, orG=None):
        ...
        if (andG is None):
            try:
                andGate = Component.get_component('AN2D0')
            except:
                andGate = And()
        ...
        if (orG is None):
            try:
                orGate = Component.get_component('OR2D0')
            except:
                orGate = Or()
...
class Ao211(And4):
    ...
    def __init__(self, name=__defaultName, in1='A1', in2='A2', in3='B', in4='C', out='Z', andG=None, orG=None):
        ...
        if (orG is None):
            try:    
                orGate = Component.get_component('OR3D0')
            except:
                orGate = Or3()
...
class Aoi21(And3):
    ...
    def __init__(self, name=__defaultName, in1='A1', in2='A2', in3='B', out='ZN',aoG=None, andG=None, orG=None, invG=None):
        ...
        if (aoG is None):
            try:
                ao21 = Component.get_component('AO21D0')
            except:
        ...
        if (invG is None):
            try:    
                inv = Component.get_component('INVD0')
            except:
                inv = Inverter()
...
class Aoi211(Andx):
    ...
    def __init__(self, name=__defaultName, in1='A1', in2='A2', in3='B', in4='C', out='ZN',aoG=None, andG=None, orG=None, invG=None):
        ...
        if (aoG is None):
            try:    
                ao211 = Component.get_component('AO211D0')
            except:
...
class Aoi221(Andx):
    ...
    def __init__(self, name=__defaultName, in1='A1', in2='A2', in3='B1', in4='B2', in5='C', out='ZN',aoG=None, andG=None, orG=None, invG=None):
        ...
        if (aoG is None):
            try:    
                ao221 = Component.get_component('AO221D0')
            except:
