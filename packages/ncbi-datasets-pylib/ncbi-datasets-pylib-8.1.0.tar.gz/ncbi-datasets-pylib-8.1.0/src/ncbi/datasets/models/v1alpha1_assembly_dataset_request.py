...
class V1alpha1AssemblyDatasetRequest(object):
    ...
    def __init__(self, accessions=None, assembly_accessions=None, chromosomes=None, exclude_sequence=None, hydrated=None, include_annotation=None, include_annotation_type=None, local_vars_configuration=None):  # noqa: E501
