...
class V1alpha1GeneDatasetRequest(object):
    ...
    def __init__(self, accessions=None, gene_ids=None, include_annotation_type=None, returned_content=None, sort_schema=None, symbols_for_taxon=None, local_vars_configuration=None):  # noqa: E501
