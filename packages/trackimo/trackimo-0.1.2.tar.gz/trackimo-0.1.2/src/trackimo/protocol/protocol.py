...
class Protocol(object):
    ...
    def __init__(self, clientid, clientsecret, host='app.trackimo.com', version=3, port=443, protocol='https', username = None, password = None):
        super().__init__()
    ...
    async def login(self, username=None, password=None, scopes=None):
        ...
        response = self.__session.post(self.__api_login_url, json=login_payload, allow_redirects=True)
    ...
    async def api(self, method='GET', path='', data=None, headers = {}):
        ...
        response = self.__session.request(method, url=url, params=params, json=json, headers=headers)
