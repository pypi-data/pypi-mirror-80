...
class ClusterProps:
    def __init__(
        ...
        *,
        ...
        :param subnet_group: A cluster subnet group to use with this cluster. Default: - a new subnet group will be created.
...
class ClusterSubnetGroupProps:
    def __init__(
        ...
        *,
        ...
        :param removal_policy: The removal policy to apply when the subnet group are removed from the stack or replaced during an update. Default: RemovalPolicy.RETAIN
