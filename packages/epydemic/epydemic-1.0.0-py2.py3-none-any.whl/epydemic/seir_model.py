...
class SEIR(CompartmentedModel):
    ...
    *versus* exposed individuals, capturing the significance of asymptomatic infection;
    ...
    def infectAsymptomatic( self, t, e ):
        ...
        symptomatic individuals are treated in the same way (although possibly with
        different probabilities). Sub-classes can override this
    ...
    def infect( self, t, e ):
        '''Perform an infection event when an :attr:`INFECTED` (symptomatic) individual
        infects a neighbouring :attr:`SUSCEPTIBLE`, rendering them :attr:`EXPOSED`.  
    ...
    def symptoms( self, t, n ):
        ...
        the :attr:`EXPOSED` node to :attr:`INFECTED`. This may change the probability
        of infection for neighbouring susceptible nodes.
