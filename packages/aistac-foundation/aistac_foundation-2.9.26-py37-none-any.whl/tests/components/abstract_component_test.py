...
class AbstractComponentTest(unittest.TestCase):
    ...
    def test_set_report_persist(self):
        ...
        self.assertEqual('./hadron/data/hadron_control_task_primary_schema_v00.json', result)
        ...
        result = manager.pm.get_connector_contract(manager.REPORT_SCHEMA).uri
        self.assertEqual('./hadron/data/hadron_control_task_primary_schema_v00.csv', result)
