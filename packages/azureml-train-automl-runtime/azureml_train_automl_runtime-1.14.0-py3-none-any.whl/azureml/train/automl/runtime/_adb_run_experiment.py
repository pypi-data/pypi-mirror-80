...
class _AdbAutomlExperiment:
    ...
    def fit_iteration_core(self,
                           ...
                           pipeline_dto, run_id, feature_configs, onnx_cvt):
        # worker node
    ...
    def model_explain_iteration(self, verifier, current_run, feature_configs):
        log_message(parent_run_id=self.parent_run_id, worker_id=self.worker_id,
        ...
        with _AMLLogUploader(current_run, self.worker_id):
            try:
                ...
                if run_id.endswith("setup"):
                    ...
                    self.model_explain_iteration(verifier, current_run, feature_configs)
                else:
