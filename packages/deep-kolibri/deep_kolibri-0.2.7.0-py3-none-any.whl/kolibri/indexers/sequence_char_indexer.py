...
class SequenceCharIndexer(SequenceIndexer):
    ...
    def __init__(self,  build_in_vocab= 'text', min_count = 0, build_vocab_from_labels = False, index=None, char_seq_length=None, **kwargs: Any):
        """
        Args:
...
#            self.seq_length += 2
    ...
    def transform(self,
        ...
        chars_vectors= [pad_sequences(seq, maxlen=self.char_seq_length, padding='post', truncating='post') for seq in numerized_samples]
