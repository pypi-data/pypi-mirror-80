...
"""
    ...
    def process(self, x, **kwargs):
            ...
            return vectorize(wav_output, vectorizer=self.component_config['vectorizer'], max_samples=wav_len, n_features=self.component_config['n_features'],sr=self.component_config['sample_rate'],window_samples=self.component_config['window_samples'], hop_samples=self.component_config['hop_samples'], num_filt=self.component_config['num_filt'], fft_size=self.component_config['fft_size'], num_coeffs=self.component_config['feature_size'])
