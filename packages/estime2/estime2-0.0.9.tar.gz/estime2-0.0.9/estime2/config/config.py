...
is_containing_comp_end = lambda x: is_list_containing(x, 'comp.end')
...
_registered_options = {
    'age.down_to': RegisteredOption(
        ...
        doc =\
            "\n (int)\n    " +\
            "A bottom level of the neighbouring ages for the " +\
            "problematic age. Counter-adjustments are applied " +\
            "from the maximum neighbouring age and " +\
            "all the way down to the maximum of -1 and " +\
            "age of modification - age.down_to.",
    ...
    'age.prop_size': RegisteredOption(
        ...
        doc =\
            "\n (int)\n    " +\
            'A size of period to use when applying the ' +\
            'proportional method. It must be a positive integer.' +\
            'Default is 5.',
    ...
    'method': RegisteredOption(
        ...
        doc =\
            ...
            "table. Must be either one of '1dist', 'filler', " +\
            "or 'prop'.",
        validator = is_method
    ),
