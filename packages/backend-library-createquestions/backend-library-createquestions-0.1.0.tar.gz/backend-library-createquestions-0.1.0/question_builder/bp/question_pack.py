...
class CreatorNode:
    def __init__(self, question_creator: QuestionCreator):
        self.question_creator = question_creator
        self.next: QuestionCreator = None


class QuestionPack:
    def __init__(self, code: str, level_to_question_types: Dict[int, List[str]], level_to_master: int = None):
        self.code: str = code
        self.level_to_question_types: Dict[int, List[str]] = level_to_question_types
        self.level_to_master: int = len(level_to_question_types.keys())
        self._question_types: List[str] = None
        self._question_type_to_level: Dict[str, int] = None
        self._responsibility_chain: Dict[str, CreatorNode] = None
    ...
    @property
    def question_type_to_level(self) -> Dict[str, int]:
    ...
    @property
    def responsibility_chain(self) -> Dict[str, CreatorNode]:
        """
