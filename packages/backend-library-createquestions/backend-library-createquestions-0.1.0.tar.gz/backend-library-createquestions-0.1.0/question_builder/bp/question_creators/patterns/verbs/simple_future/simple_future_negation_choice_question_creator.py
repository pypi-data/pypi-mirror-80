...
class SimpleFutureNegationChoiceQuestionCreator(QuestionCreator):
    ...
    @staticmethod
    def _get_combined_verbtowill_and_negation_adverb(negation_adverb: str) -> str:
    ...
    @staticmethod
    def _get_correct_answer(target_verb: str, subject: str, verbtowill_and_negation_adverb: str) -> str:
        return f"{subject} {verbtowill_and_negation_adverb} {target_verb}"

    @staticmethod
    def _get_baits(target_verb: str, subject: str, verbtowill_and_negation_adverb: str) -> List[str]:
