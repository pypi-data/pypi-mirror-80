...
class SimpleFutureChoiceTwoQuestionCreator(QuestionCreator):
    ...
    def _get_baits(self, pattern: str, verb_past: str, verb_present_continuous: str) -> List[str]:
    ...
    def _get_phrase(self, original_phrase: str, subject: str, target_lemma: str, pattern: str) -> str:
