...
from question_builder.data import ContentRepository, Content
...
class QuestionCreator:
    ...
    def _get_links_and_media_types(self, content: Content) -> Tuple[List[str], List[str]]:
        """
    ...
    def _get_translation(self, content: Content) -> str:
    ...
    def _remove_word(self, phrase: str, word: str) -> str:
    ...
    def _underline_word(self, phrase: str, word: str) -> str:
    ...
    def _get_options(self, correct_answer: str, baits: List[str]) -> List[Dict]:
        """
