...
from .present_perfect_continuous_affirmative_queries import GET_N_DATA_QUESTIONS
from .present_perfect_continuous_affirmative_queries import (
    GET_N_DATA_QUESTIONS_PER_WORD,
)


class PRPCCQuestionGetter(QuestionGetter):
    code = "PRPCC"
