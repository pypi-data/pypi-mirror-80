...
from .future_perfect_continuous_affirmative_queries import GET_N_DATA_QUESTIONS
from .future_perfect_continuous_affirmative_queries import GET_N_DATA_QUESTIONS_PER_WORD
from .lemma_queries import GET_LEMMA_LIST_DATA


class FPCCQuestionGetter(QuestionGetter):
    code = "FPCC"
