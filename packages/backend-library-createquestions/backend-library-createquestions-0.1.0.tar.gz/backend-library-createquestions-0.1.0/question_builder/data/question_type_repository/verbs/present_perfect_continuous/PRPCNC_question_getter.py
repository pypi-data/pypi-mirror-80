...
from .present_perfect_continuous_negative_queries import GET_N_DATA_QUESTIONS
from .present_perfect_continuous_negative_queries import GET_N_DATA_QUESTIONS_PER_WORD


class PRPCNCQuestionGetter(QuestionGetter):
    code = "PRPCNC"
