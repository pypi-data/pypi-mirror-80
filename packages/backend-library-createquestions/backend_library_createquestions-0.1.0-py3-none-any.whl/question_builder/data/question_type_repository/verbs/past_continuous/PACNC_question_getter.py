...
from .past_continuous_negative_queries import GET_N_DATA_QUESTIONS
from .past_continuous_negative_queries import GET_N_DATA_QUESTIONS_PER_WORD


class PACNCQuestionGetter(QuestionGetter):
    code = "PACNC"
