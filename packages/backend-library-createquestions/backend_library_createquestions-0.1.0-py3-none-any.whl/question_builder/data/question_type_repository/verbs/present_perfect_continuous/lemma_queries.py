...
OPTIONAL MATCH (lemma) -[:HAS_LEMMA{tag:"VBD"}]-(verb_vbd:WORD)
WITH user, lemma, {VBG: coalesce(collect(verb_vbg.text)[0], 'N/A'), VBD: coalesce(collect(verb_vbd.text)[0], 'N/A')} as lemma_conjugations
