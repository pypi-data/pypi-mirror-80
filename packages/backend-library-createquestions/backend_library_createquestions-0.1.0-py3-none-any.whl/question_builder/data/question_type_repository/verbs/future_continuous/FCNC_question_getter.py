...
from .future_continuous_negative_queries import GET_N_DATA_QUESTIONS
from .future_continuous_negative_queries import GET_N_DATA_QUESTIONS_PER_WORD
from .lemma_queries import GET_LEMMA_LIST_DATA


class FCNCQuestionGetter(QuestionGetter):
    code = "FCNC"
