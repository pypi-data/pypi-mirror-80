...
class SubwordQuestionCreator(QuestionCreator):
    ...
    def _get_options(self, correct_answer: str, baits: List[str], target_word: str) -> List[str]:
        """
    ...
    def _add_line_to_option(self, option: str, is_prefix: bool) -> str:
        if is_prefix:
            return option + "-"
        else:
            return "-" + option
    ...
    def _add_space_to_dash(self, is_prefix: bool) -> str:
        if is_prefix:
            return "    -"
        else:
            return "-    "
