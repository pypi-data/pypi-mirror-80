...
class PastContinuousChoiceQuestionCreator(QuestionCreator):
    ...
    @staticmethod
    def _get_correct_answer(target_verb: str, subject: str, conjugated_verbtobe: str) -> str:
        return f"{subject} {conjugated_verbtobe} {target_verb}"

    @staticmethod
    def _get_baits(
        target_verb: str, target_lemma: str, subject: str, conjugated_verbtobe: str, target_verb_past_tense: str
    ) -> List[str]:
