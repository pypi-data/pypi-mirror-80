...
class PastPerfectNegationChoiceQuestionCreator(QuestionCreator):
    ...
    @staticmethod
    def _get_combined_verbtohave_and_negation_adverb(negation_adverb: str) -> str:
    ...
    @staticmethod
    def _get_correct_answer(target_verb: str, subject: str, verbtohave_and_negation_adverb: str) -> str:
        return f"{subject} {verbtohave_and_negation_adverb} {target_verb}"

    @staticmethod
    def _get_baits(target_verb: str, subject: str, verbtohave_and_negation_adverb: str) -> List[str]:
        return random.sample(
            [
                f"{subject} {DIDNT} {HAD} {target_verb}",
                f"{subject} {HAD} {NO} {target_verb}",
                f"{subject} {NOT} {HAVE} {target_verb}",
            ],
            SAMPLE_N_BAITS,
        )
