...
class PresentPerfectChoiceQuestionCreator(QuestionCreator):
    ...
    @staticmethod
    def _get_combined_subject_and_verbtohave(subject: str, conjugated_verbtohave: str) -> str:
    ...
    @staticmethod
    def _get_correct_answer(target_verb: str, subject_and_verbtohave: str) -> str:
        return f"{subject_and_verbtohave} {target_verb}"

    @staticmethod
    def _get_baits(
        target_lemma: str, subject: str, subject_and_verbtohave: str, target_verb_present_continuous: str
    ) -> List[str]:
    ...
    def _get_phrase(self, original_phrase: str, target_verb: str, subject_and_verbtohave: str) -> str:
