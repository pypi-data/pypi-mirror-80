...
efficientnet_b0 = ("https://tfhub.dev/google/efficientnet/b0/feature-vector/1", 224)

def fit(epochs=0, input_model=efficientnet_b0, optimizer=optimizers.RMSprop(), classes=[], data_folder="./images", batch_size=32, validation_split=0.2, predict_retrain_loops=0, verbose=True):
