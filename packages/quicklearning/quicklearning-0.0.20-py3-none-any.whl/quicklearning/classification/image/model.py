...
class Model(object):
    ...
    def __init__(self, model, image_size, data_folder="./images", batch_size=32, validation_split=0.2, callbacks=[], verbose=False):
        self.model = model
        ...
        self.classes = [x for x in model.train.class_indices.keys()]
    ...
    def predictions(self, file="", url="", image=None):
        ...
        prediction = self.model.predict(x)
        return list(zip(self.classes, prediction[0]))
