...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'hcloud', '0.2.1-alpha.1600708713+df79d2a2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource hcloud 0.2.1-alpha.1600708713+df79d2a2`
                """)
            else:
                raise
