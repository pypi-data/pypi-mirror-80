...
def select_atoms(parmed_structure, keyword_selection=None, ligand_resname=None, resid_selection=None):
    """
    Select atoms is the main selection mechanism for rs_simtools functionality. It requires as input a parmed structure
...
def align_structure(pmd, sel1, sel2, axis):
    ...
    :param sel1: string
        rs_simtools selection mask. If starts with resid resid selection is assumed else keyword selection is assumed
    :param sel2: string
        rs_simtools selection mask. If starts with resid resid selection is assumed else keyword selection is assumed
