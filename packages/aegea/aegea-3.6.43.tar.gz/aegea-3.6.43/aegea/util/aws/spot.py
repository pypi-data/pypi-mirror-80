...
class SpotFleetBuilder(VerboseRepr):
    ...
    def __init__(self, launch_spec, cores=1, min_cores_per_instance=1, min_mem_per_core_gb=1.5, gpus_per_instance=0,
                 min_ephemeral_storage_gb=0, spot_price=None, duration_hours=None, sfr_type="request",
                 instance_interruption_behavior="terminate", instance_type_prefixes=None,
                 client_token=None, dry_run=False):
        ...
        self.spot_fleet_request_config = dict(Type=sfr_type,
