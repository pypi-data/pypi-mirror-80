...
def launch(args):
    ...
    try:
        if args.spot:
            ...
            if args.duration_hours or args.cores or args.min_mem_per_core_gb or args.spot_instance_interruption_behavior != "terminate":
                spot_fleet_args = dict(launch_spec=dict(launch_spec, TagSpecifications=[tag_spec]),
                                       instance_interruption_behavior=args.spot_instance_interruption_behavior,
...
parser.add_argument("--spot-instance-interruption-behavior", choices={"hibernate", "stop", "terminate"})
