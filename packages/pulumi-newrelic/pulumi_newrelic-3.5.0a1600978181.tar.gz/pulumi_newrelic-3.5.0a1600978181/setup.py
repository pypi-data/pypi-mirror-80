...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '3.5.0-alpha.1600978181+bc0e43de'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 3.5.0-alpha.1600978181+bc0e43de`
                """)
            else:
                raise
