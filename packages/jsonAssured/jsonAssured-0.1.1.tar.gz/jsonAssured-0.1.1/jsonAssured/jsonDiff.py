...
def main():
    ...
    parser.add_argument('-c', dest="configPath", help="mapping file path")
    parser.add_argument('-s', dest="sourcePath", help="source file path")
    parser.add_argument('-t', dest="targetPath", help="target file path")
