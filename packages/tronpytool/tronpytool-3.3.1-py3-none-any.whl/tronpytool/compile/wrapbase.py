...
from tronpytool.common.key import to_hex_address, keccak256, is_address, to_base58check_address
...
class ContractMethod:
    ...
    def __call__(self, *args, **kwargs) -> "TransactionBuilder":
        ...
        print("debug params: {}".format(parameter))

        if self._abi.get("stateMutability", None).lower() in ["view", "pure"]:
            # const call, contract ret

            ret = self.transaction_builder.trigger_smart_contract(
