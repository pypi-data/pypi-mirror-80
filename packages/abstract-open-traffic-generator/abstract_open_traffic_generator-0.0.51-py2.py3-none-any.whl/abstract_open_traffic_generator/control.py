...
class PortLink(object):
    """Generated from OpenAPI schema object #/components/schemas/Control.PortLink
...
class FlowTransmit(object):
    """Generated from OpenAPI schema object #/components/schemas/Control.FlowTransmit
...
class PortCapture(object):
    """Generated from OpenAPI schema object #/components/schemas/Control.PortCapture

    Control port capture state  

    Args
    ----
    - port_names (list[str]): The name of a port to start capturing packets on
