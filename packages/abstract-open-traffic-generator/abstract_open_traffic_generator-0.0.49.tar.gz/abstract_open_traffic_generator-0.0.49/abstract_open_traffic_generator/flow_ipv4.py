...
class Priority(object):
    ...
    def __init__(self, choice=None):
        ...
        if isinstance(choice, (type(None), Pattern, Tos, Dscp)) is False:
            raise TypeError('choice must be of type: type(None), Pattern, Tos, Dscp')
...
class Tos(object):
    """Generated from OpenAPI #/components/schemas/Flow.Ipv4.Tos model
