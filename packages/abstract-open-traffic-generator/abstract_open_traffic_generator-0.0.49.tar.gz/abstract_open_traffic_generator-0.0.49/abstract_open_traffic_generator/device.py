...
class Device(object):
    ...
    - ethernets (list[Ethernet]): An unordered list of 0
     n emulated ethernet protocols
    - devices (list[Device]): An unordered list of 0
     n emulated device containers
    - networks (list[Network]): An unordered list of 0
     n emulated device containers
    """
...
class Network(object):
    ...
    - flow_link_name (str): Identifies which object in another container is the next hop from this container
     The name cannot be one of the names in this networks container
     An empty value indicates there is no flow link other than the default specified by the implementation
