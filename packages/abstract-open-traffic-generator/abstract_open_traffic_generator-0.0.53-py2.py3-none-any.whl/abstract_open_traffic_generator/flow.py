...
class Header(object):
    ...
    Args
    ----
    - choice (Union[Custom, Ethernet, Vlan, Vxlan, Ipv4, Ipv6, PfcPause, EthernetPause, Tcp, Udp, Gre]): TBD
    """
    _CHOICE_MAP = {
        'Custom': 'custom',
        'Ethernet': 'ethernet',
    ...
    def __init__(self, choice=None):
        ...
        if isinstance(choice, (Custom, Ethernet, Vlan, Vxlan, Ipv4, Ipv6, PfcPause, EthernetPause, Tcp, Udp, Gre)) is False:
            raise TypeError('choice must be of type: Custom, Ethernet, Vlan, Vxlan, Ipv4, Ipv6, PfcPause, EthernetPause, Tcp, Udp, Gre')
...
class FixedSeconds(object):
    ...
    - delay_unit (Union[bytes, nanoseconds]): The delay expressed as a number of this value
    """
    def __init__(self, seconds=0, gap=None, delay=None, delay_unit=None):
