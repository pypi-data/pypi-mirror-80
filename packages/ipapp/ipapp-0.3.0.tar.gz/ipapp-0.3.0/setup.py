...
['aiohttp>=3.6.2,<4.0.0',
 ...
 'pyyaml>=5.3.1,<6.0.0',
 'sentry-sdk>=0.16.3,<1.0',
 'tinyrpc>=1.0.4,<2.0.0']

extras_require = \
{'dbtm': ['asyncpg>=0.20.1,<0.21.0', 'crontab>=0.22.6,<0.23.0'],
 'fastapi': ['uvicorn>=0.11.8,<0.12.0', 'fastapi>=0.61.0,<0.62.0'],
 'iprpc': ['iprpc>=0.2.2,<0.3.0'],
 'oracle': ['cx-Oracle>=8.0.0,<9.0.0'],
 'postgres': ['asyncpg>=0.20.1,<0.21.0'],
 'rabbitmq': ['pika>=1.1.0,<2.0.0'],
 's3': ['aiobotocore>=1.0.7,<2.0.0', 'python-magic>=0.4.18,<0.5.0'],
 'sftp': ['asyncssh[pyOpenSSL]>=2.3.0,<3.0.0'],
 'testing': ['idna>=2.10,<3.0',
             'black==20.8b1',
             'flake8==3.8.3',
             'mock>=4.0.2,<5.0.0',
             'mypy==0.782',
