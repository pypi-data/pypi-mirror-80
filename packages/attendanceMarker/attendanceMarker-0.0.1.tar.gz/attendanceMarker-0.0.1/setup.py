...
setup(
    ...
    description="Compares excel files from webex and compares with roll call to mark attendance",
    ...
    entry_points="""
    [console_scripts]
    attendancemarker=attendancemarker.cli:cli
    """,
    ...
    url= 'https://github.com/dipayan90/attendancemarker',
    download_url=(
        f'https://github.com/dipayan90/'
        f'attendancemarker/archive/{version}.tar.gz'
    ),
    keywords=[
