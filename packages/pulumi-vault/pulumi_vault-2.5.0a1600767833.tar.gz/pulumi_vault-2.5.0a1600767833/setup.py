...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '2.5.0-alpha.1600767833+50d28eb1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 2.5.0-alpha.1600767833+50d28eb1`
                """)
            else:
                raise
