...
class MetricDescriptor(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"created_at",b"created_at",u"description",b"description",u"metric_descriptor_id",b"metric_descriptor_id",u"metric_type",b"metric_type",u"name",b"name",u"organization_id",b"organization_id",u"properties",b"properties",u"status",b"status",u"updated_at",b"updated_at",u"value_type",b"value_type"]) -> None: ...
...
class MetricSummaryRequest(google___protobuf___message___Message):
    ...
    external_entity_id: google___protobuf___internal___containers___RepeatedScalarFieldContainer[typing___Text] = ...
    ...
    def __init__(self,
        *,
        ...
        external_entity_id : typing___Optional[typing___Iterable[typing___Text]] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"starting_at",b"starting_at"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"external_entity_id",b"external_entity_id",u"external_entity_type",b"external_entity_type",u"organization_id",b"organization_id",u"starting_at",b"starting_at",u"time_zone",b"time_zone"]) -> None: ...
...
class GetMetricDescriptorRequest(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"metric_descriptor_id",b"metric_descriptor_id",u"organization_id",b"organization_id"]) -> None: ...
