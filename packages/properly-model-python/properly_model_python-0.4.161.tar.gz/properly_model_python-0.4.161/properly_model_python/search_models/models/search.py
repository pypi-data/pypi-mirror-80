...
class Search(Model):
    ...
    def __init__(self, id: str = None, search_hash: str = None, last_run_millis: int = None, properly_city_code: str = None, neighbourhoods: List[str] = None, addresses: List[str] = None, building_types: List[str] = None, min_price: int = None, max_price: int = None, min_beds: int = None, min_baths: int = None, min_parking: int = None, min_square_foot: int = None, max_square_foot: int = None, geohash6_areas: List[str] = None):  # noqa: E501
