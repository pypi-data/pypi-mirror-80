...
class ConicalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self) -> '_946.GearLTCAContactCharts':
        ...
        if _946.GearLTCAContactCharts.TYPE not in self.wrapped.ContactCharts.__class__.__mro__:
    ...
    @property
    def contact_charts_as_text_file(self) -> '_945.GearLTCAContactChartDataAsTextFile':
        ...
        if _945.GearLTCAContactChartDataAsTextFile.TYPE not in self.wrapped.ContactChartsAsTextFile.__class__.__mro__:
