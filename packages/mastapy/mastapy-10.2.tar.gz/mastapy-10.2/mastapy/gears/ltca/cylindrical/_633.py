...
class CylindricalMeshLoadDistributionAtRotation(_616.GearMeshLoadDistributionAtRotation):
    '''CylindricalMeshLoadDistributionAtRotation
    ...
    @property
    def mesh_alignment(self) -> '_860.MeshAlignment':
        ...
        return constructor.new(_860.MeshAlignment)(self.wrapped.MeshAlignment) if self.wrapped.MeshAlignment else None

    @property
    def loaded_contact_lines(self) -> 'List[_630.CylindricalGearMeshLoadedContactLine]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadedContactLines, constructor.new(_630.CylindricalGearMeshLoadedContactLine))
        return value
