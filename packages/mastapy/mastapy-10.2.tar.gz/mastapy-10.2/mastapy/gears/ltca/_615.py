...
from mastapy.gears.ltca import _616, _614
...
class GearMeshLoadDistributionAnalysis(_955.GearMeshImplementationAnalysis):
    '''GearMeshLoadDistributionAnalysis
    ...
    @property
    def transmission_error_fourier_series(self) -> '_1078.FourierSeries':
        ...
        return constructor.new(_1078.FourierSeries)(self.wrapped.TransmissionErrorFourierSeries) if self.wrapped.TransmissionErrorFourierSeries else None

    @property
    def load_distribution_analyses_at_single_rotation(self) -> 'List[_616.GearMeshLoadDistributionAtRotation]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadDistributionAnalysesAtSingleRotation, constructor.new(_616.GearMeshLoadDistributionAtRotation))
        return value

    def maximum_root_stress_with_flanks(self, gear: '_614.GearLoadDistributionAnalysis', flank: '_126.GearFlanks', stress_type: '_1394.StressResultsType') -> 'float':
    ...
    def maximum_root_stress(self, gear: '_614.GearLoadDistributionAnalysis', stress_type: '_1394.StressResultsType') -> 'float':
        ''' 'MaximumRootStress' is the original name of this method.
