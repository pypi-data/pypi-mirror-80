...
from mastapy.gears.fe_model import _933, _932
...
class GearSetFEModel(_963.GearSetImplementationDetail):
    '''GearSetFEModel
    ...
    @property
    def mesh_fe_models(self) -> 'List[_933.GearMeshFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshFEModels, constructor.new(_933.GearMeshFEModel))
        return value

    @property
    def gear_fe_models(self) -> 'List[_932.GearFEModel]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearFEModels, constructor.new(_932.GearFEModel))
        return value
