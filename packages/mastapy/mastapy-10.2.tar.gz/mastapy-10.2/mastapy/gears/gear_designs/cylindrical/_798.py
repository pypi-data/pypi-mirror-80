...
from mastapy.gears.gear_designs.cylindrical.thickness_stock_and_backlash import _838
...
class FinishStockSpecification(_820.RelativeValuesSpecification['FinishStockSpecification']):
    '''FinishStockSpecification
    ...
    @property
    def finish_stock_rough_thickness_specification_method(self) -> '_838.FinishStockType':
        ...
        return constructor.new(_838.FinishStockType)(value) if value else None

    @finish_stock_rough_thickness_specification_method.setter
    def finish_stock_rough_thickness_specification_method(self, value: '_838.FinishStockType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.FinishStockRoughThicknessSpecificationMethod = value

    @property
    def normal(self) -> '_833.TolerancedValueSpecification[FinishStockSpecification]':
        ...
        if _833.TolerancedValueSpecification[FinishStockSpecification].TYPE not in self.wrapped.Normal.__class__.__mro__:
    ...
    @property
    def tangent_to_reference_circle(self) -> '_833.TolerancedValueSpecification[FinishStockSpecification]':
        ...
        if _833.TolerancedValueSpecification[FinishStockSpecification].TYPE not in self.wrapped.TangentToReferenceCircle.__class__.__mro__:
