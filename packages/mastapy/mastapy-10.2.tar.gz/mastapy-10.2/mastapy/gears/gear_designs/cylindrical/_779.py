...
from mastapy.gears.gear_designs.cylindrical import _783, _814, _815
from mastapy.gears import _144, _134, _115
...
class CylindricalGearDesignSettings(_1143.PerMachineSettings):
    '''CylindricalGearDesignSettings
    ...
    @property
    def cylindrical_gear_profile_measurement(self) -> '_783.CylindricalGearProfileMeasurementType':
    ...
    def cylindrical_gear_profile_measurement(self, value: '_783.CylindricalGearProfileMeasurementType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CylindricalGearProfileMeasurement = value

    @property
    def agma_quality_grade_type(self) -> '_144.QualityGradeTypes':
        ...
        return constructor.new(_144.QualityGradeTypes)(value) if value else None

    @agma_quality_grade_type.setter
    def agma_quality_grade_type(self, value: '_144.QualityGradeTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.AGMAQualityGradeType = value

    @property
    def tolerance_rounding_system(self) -> '_1156.MeasurementSystem':
        ...
        return constructor.new(_1156.MeasurementSystem)(value) if value else None

    @tolerance_rounding_system.setter
    def tolerance_rounding_system(self, value: '_1156.MeasurementSystem'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def agma_tolerances_standard(self) -> '_115.AGMAToleranceStandard':
        ...
        return constructor.new(_115.AGMAToleranceStandard)(value) if value else None

    @agma_tolerances_standard.setter
    def agma_tolerances_standard(self, value: '_115.AGMAToleranceStandard'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def micro_geometry_lead_relief_definition(self) -> '_814.MicroGeometryConvention':
        ...
        return constructor.new(_814.MicroGeometryConvention)(value) if value else None

    @micro_geometry_lead_relief_definition.setter
    def micro_geometry_lead_relief_definition(self, value: '_814.MicroGeometryConvention'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.MicroGeometryLeadReliefDefinition = value

    @property
    def micro_geometry_profile_relief_definition(self) -> '_815.MicroGeometryProfileConvention':
        ...
        return constructor.new(_815.MicroGeometryProfileConvention)(value) if value else None

    @micro_geometry_profile_relief_definition.setter
    def micro_geometry_profile_relief_definition(self, value: '_815.MicroGeometryProfileConvention'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
