...
from mastapy.gears.gear_designs.cylindrical import _774, _795, _782
from mastapy._internal.cast_exception import CastException
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _842, _862
...
class CylindricalGearMicroGeometry(_953.GearImplementationDetail):
    '''CylindricalGearMicroGeometry
    ...
    @property
    def cylindrical_gear(self) -> '_774.CylindricalGearDesign':
        ...
        if _774.CylindricalGearDesign.TYPE not in self.wrapped.CylindricalGear.__class__.__mro__:
    ...
    @property
    def left_flank(self) -> '_842.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_842.CylindricalGearFlankMicroGeometry)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None

    @property
    def right_flank(self) -> '_842.CylindricalGearFlankMicroGeometry':
        ...
        return constructor.new(_842.CylindricalGearFlankMicroGeometry)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def profile_control_point(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.ProfileControlPoint) if self.wrapped.ProfileControlPoint else None

    @property
    def flanks(self) -> 'List[_842.CylindricalGearFlankMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Flanks, constructor.new(_842.CylindricalGearFlankMicroGeometry))
        return value

    @property
    def meshed_gears(self) -> 'List[_862.MeshedCylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_862.MeshedCylindricalGearMicroGeometry))
        return value
