...
from mastapy.gears import _133, _114
...
class CylindricalGearDesign(_711.GearDesign):
    '''CylindricalGearDesign
    ...
    def iso6336_geometry(self) -> '_809.ISO6336GeometryBase':
        ...
        if _809.ISO6336GeometryBase.TYPE not in self.wrapped.ISO6336Geometry.__class__.__mro__:
    ...
    @property
    def surface_roughness(self) -> '_828.SurfaceRoughness':
        ...
        return constructor.new(_828.SurfaceRoughness)(self.wrapped.SurfaceRoughness) if self.wrapped.SurfaceRoughness else None

    @property
    def tip_diameter_reporting(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.TipDiameterReporting) if self.wrapped.TipDiameterReporting else None

    @property
    def root_diameter_reporting(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.RootDiameterReporting) if self.wrapped.RootDiameterReporting else None

    @property
    def cylindrical_gear_set(self) -> '_785.CylindricalGearSetDesign':
        ...
        if _785.CylindricalGearSetDesign.TYPE not in self.wrapped.CylindricalGearSet.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_micro_geometry(self) -> '_847.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_847.CylindricalGearMicroGeometry)(self.wrapped.CylindricalGearMicroGeometry) if self.wrapped.CylindricalGearMicroGeometry else None

    @property
    def cylindrical_gear_manufacturing_configuration(self) -> '_395.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_395.CylindricalGearManufacturingConfig)(self.wrapped.CylindricalGearManufacturingConfiguration) if self.wrapped.CylindricalGearManufacturingConfiguration else None

    @property
    def lowest_start_of_active_profile(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.LowestStartOfActiveProfile) if self.wrapped.LowestStartOfActiveProfile else None

    @property
    def material(self) -> '_377.GearMaterial':
        ...
        if _377.GearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_bevel_gear_iso_material(self) -> '_368.BevelGearISOMaterial':
        ...
        if _368.BevelGearISOMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_bevel_gear_material(self) -> '_370.BevelGearMaterial':
        ...
        if _370.BevelGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_cylindrical_gear_material(self) -> '_374.CylindricalGearMaterial':
        ...
        if _374.CylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_iso_cylindrical_gear_material(self) -> '_380.ISOCylindricalGearMaterial':
        ...
        if _380.ISOCylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_klingelnberg_cyclo_palloid_conical_gear_material(self) -> '_384.KlingelnbergCycloPalloidConicalGearMaterial':
        ...
        if _384.KlingelnbergCycloPalloidConicalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def material_of_type_plastic_cylindrical_gear_material(self) -> '_386.PlasticCylindricalGearMaterial':
        ...
        if _386.PlasticCylindricalGearMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
    ...
    @property
    def system_of_gear_fits(self) -> '_877.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_877.DIN3967SystemOfGearFits)(self.wrapped.SystemOfGearFits) if self.wrapped.SystemOfGearFits else None

    @property
    def iso_accuracy_grade(self) -> '_880.ISO1328AccuracyGrades':
        ...
        return constructor.new(_880.ISO1328AccuracyGrades)(self.wrapped.ISOAccuracyGrade) if self.wrapped.ISOAccuracyGrade else None

    @property
    def agma_accuracy_grade(self) -> '_872.AGMA20151AccuracyGrades':
        ...
        return constructor.new(_872.AGMA20151AccuracyGrades)(self.wrapped.AGMAAccuracyGrade) if self.wrapped.AGMAAccuracyGrade else None

    @property
    def accuracy_grade_allowances_and_tolerances(self) -> '_874.CylindricalAccuracyGrader':
        ...
        if _874.CylindricalAccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma2000_accuracy_grader(self) -> '_870.AGMA2000AccuracyGrader':
        ...
        if _870.AGMA2000AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agma20151_accuracy_grader(self) -> '_871.AGMA20151AccuracyGrader':
        ...
        if _871.AGMA20151AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_agmaiso13282013_accuracy_grader(self) -> '_873.AGMAISO13282013AccuracyGrader':
        ...
        if _873.AGMAISO13282013AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_cylindrical_accuracy_grader_with_profile_form_and_slope(self) -> '_875.CylindricalAccuracyGraderWithProfileFormAndSlope':
        ...
        if _875.CylindricalAccuracyGraderWithProfileFormAndSlope.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso13282013_accuracy_grader(self) -> '_878.ISO13282013AccuracyGrader':
        ...
        if _878.ISO13282013AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grade_allowances_and_tolerances_of_type_iso1328_accuracy_grader(self) -> '_879.ISO1328AccuracyGrader':
        ...
        if _879.ISO1328AccuracyGrader.TYPE not in self.wrapped.AccuracyGradeAllowancesAndTolerances.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy(self) -> '_114.AccuracyGrades':
        ...
        if _114.AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_agma20151_accuracy_grades(self) -> '_872.AGMA20151AccuracyGrades':
        ...
        if _872.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_cylindrical_accuracy_grades(self) -> '_876.CylindricalAccuracyGrades':
        ...
        if _876.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_iso1328_accuracy_grades(self) -> '_880.ISO1328AccuracyGrades':
        ...
        if _880.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    @property
    def accuracy_grades_specified_accuracy_of_type_agma_gleason_conical_accuracy_grades(self) -> '_927.AGMAGleasonConicalAccuracyGrades':
        ...
        if _927.AGMAGleasonConicalAccuracyGrades.TYPE not in self.wrapped.AccuracyGradesSpecifiedAccuracy.__class__.__mro__:
    ...
    @property
    def tip_form(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.TipForm) if self.wrapped.TipForm else None

    @property
    def root_form(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.RootForm) if self.wrapped.RootForm else None

    @property
    def case_hardening_properties(self) -> '_765.CaseHardeningProperties':
        ...
        return constructor.new(_765.CaseHardeningProperties)(self.wrapped.CaseHardeningProperties) if self.wrapped.CaseHardeningProperties else None

    @property
    def tiff_analysis_settings(self) -> '_830.TiffAnalysisSettings':
        ...
        return constructor.new(_830.TiffAnalysisSettings)(self.wrapped.TIFFAnalysisSettings) if self.wrapped.TIFFAnalysisSettings else None

    @property
    def finished_tooth_thickness_specification(self) -> '_799.FinishToothThicknessDesignSpecification':
        ...
        return constructor.new(_799.FinishToothThicknessDesignSpecification)(self.wrapped.FinishedToothThicknessSpecification) if self.wrapped.FinishedToothThicknessSpecification else None

    @property
    def rough_tooth_thickness_specification(self) -> '_834.ToothThicknessSpecification':
        ...
        return constructor.new(_834.ToothThicknessSpecification)(self.wrapped.RoughToothThicknessSpecification) if self.wrapped.RoughToothThicknessSpecification else None

    @property
    def finish_stock_specification(self) -> '_798.FinishStockSpecification':
        ...
        return constructor.new(_798.FinishStockSpecification)(self.wrapped.FinishStockSpecification) if self.wrapped.FinishStockSpecification else None

    @property
    def cylindrical_gear_cutting_options(self) -> '_772.CylindricalGearCuttingOptions':
        ...
        return constructor.new(_772.CylindricalGearCuttingOptions)(self.wrapped.CylindricalGearCuttingOptions) if self.wrapped.CylindricalGearCuttingOptions else None

    @property
    def lowest_point_of_fewest_tooth_contacts(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.LowestPointOfFewestToothContacts) if self.wrapped.LowestPointOfFewestToothContacts else None

    @property
    def highest_point_of_fewest_tooth_contacts(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.HighestPointOfFewestToothContacts) if self.wrapped.HighestPointOfFewestToothContacts else None

    @property
    def cylindrical_meshes(self) -> 'List[_780.CylindricalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshes, constructor.new(_780.CylindricalGearMeshDesign))
        return value

    @property
    def micro_geometries(self) -> 'List[_847.CylindricalGearMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometries, constructor.new(_847.CylindricalGearMicroGeometry))
        return value

    @property
    def manufacturing_configurations(self) -> 'List[_395.CylindricalGearManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturingConfigurations, constructor.new(_395.CylindricalGearManufacturingConfig))
        return value
