...
class CylindricalGearDesignConstraintSettings(_1143.PerMachineSettings):
    '''CylindricalGearDesignConstraintSettings
    ...
    @property
    def cylindrical_gear_design_constraints(self) -> '_776.CylindricalGearDesignConstraints':
        ...
        return constructor.new(_776.CylindricalGearDesignConstraints)(self.wrapped.CylindricalGearDesignConstraints) if self.wrapped.CylindricalGearDesignConstraints else None
