...
from mastapy.gears.gear_designs.cylindrical import _806, _807
...
class CaseHardeningProperties(_0.APIBase):
    ...
    @property
    def hardness_profile_calculation_method(self) -> '_806.HardnessProfileCalculationMethod':
        ...
        return constructor.new(_806.HardnessProfileCalculationMethod)(value) if value else None

    @hardness_profile_calculation_method.setter
    def hardness_profile_calculation_method(self, value: '_806.HardnessProfileCalculationMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HardnessProfileCalculationMethod = value

    @property
    def heat_treatment_type(self) -> '_807.HeatTreatmentType':
        ...
        return constructor.new(_807.HeatTreatmentType)(value) if value else None
