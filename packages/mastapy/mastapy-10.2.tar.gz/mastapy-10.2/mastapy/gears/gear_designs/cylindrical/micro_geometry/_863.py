...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    @property
    def gear_option(self) -> '_854.DrawDefiningGearOrBoth':
        ...
        return constructor.new(_854.DrawDefiningGearOrBoth)(value) if value else None

    @gear_option.setter
    def gear_option(self, value: '_854.DrawDefiningGearOrBoth'):
