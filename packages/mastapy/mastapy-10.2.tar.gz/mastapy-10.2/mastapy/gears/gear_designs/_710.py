...
from mastapy.utility.property import _1351
from mastapy.gears.gear_designs import _708
...
class DesignConstraintsCollection(_1346.NamedDatabaseItem):
    '''DesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> 'List[_1351.DeletableCollectionMember[_708.DesignConstraint]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.DesignConstraints, constructor.new(_1351.DeletableCollectionMember)[_708.DesignConstraint])
        return value
