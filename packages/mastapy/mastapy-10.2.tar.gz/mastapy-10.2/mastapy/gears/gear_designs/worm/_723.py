...
from mastapy.gears.gear_designs.worm import _721, _722
...
class WormGearSetDesign(_714.GearSetDesign):
    '''WormGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_721.WormGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_721.WormGearDesign))
        return value
    ...
    @property
    def worm_meshes(self) -> 'List[_722.WormGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshes, constructor.new(_722.WormGearMeshDesign))
        return value
