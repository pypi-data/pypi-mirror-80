...
class FaceGearMicroGeometry(_953.GearImplementationDetail):
    '''FaceGearMicroGeometry
    ...
    @property
    def face_gear(self) -> '_753.FaceGearDesign':
        ...
        if _753.FaceGearDesign.TYPE not in self.wrapped.FaceGear.__class__.__mro__:
    ...
    @property
    def micro_geometry(self) -> '_847.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_847.CylindricalGearMicroGeometry)(self.wrapped.MicroGeometry) if self.wrapped.MicroGeometry else None
