...
class MicroGeometryDesignSpaceSearchChartInformation(_671.ChartInfoBase['_632.CylindricalGearSetLoadDistributionAnalysis', '_684.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchChartInformation
    ...
    @property
    def optimiser(self) -> '_683.MicroGeometryDesignSpaceSearch':
