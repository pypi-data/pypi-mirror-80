...
class OptimisationTarget(_0.APIBase, Generic[T]):
    ...
    @property
    def input_setters(self) -> 'List[_1098.InputSetter[T]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSetters, constructor.new(_1098.InputSetter)[T])
        return value
