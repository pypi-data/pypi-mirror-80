...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    @property
    def select_chart_type(self) -> '_1109.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart':
        ...
        return constructor.new(_1109.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart)(value) if value else None

    @select_chart_type.setter
    def select_chart_type(self, value: '_1109.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.SelectChartType = value

    @property
    def chart_type(self) -> '_1272.CustomChartType':
        ...
        return constructor.new(_1272.CustomChartType)(value) if value else None
    ...
    @property
    def result_chart_scatter(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.ResultChartScatter) if self.wrapped.ResultChartScatter else None

    @property
    def result_chart_bar_and_line(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.ResultChartBarAndLine) if self.wrapped.ResultChartBarAndLine else None
    ...
    @property
    def optimiser(self) -> '_673.DesignSpaceSearchBase[TAnalysis, TCandidate]':
        ...
        if _673.DesignSpaceSearchBase[TAnalysis, TCandidate].TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_cylindrical_gear_set_pareto_optimiser(self) -> '_672.CylindricalGearSetParetoOptimiser':
        ...
        if _672.CylindricalGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_face_gear_set_pareto_optimiser(self) -> '_675.FaceGearSetParetoOptimiser':
        ...
        if _675.FaceGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_gear_set_pareto_optimiser(self) -> '_679.GearSetParetoOptimiser':
        ...
        if _679.GearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_hypoid_gear_set_pareto_optimiser(self) -> '_680.HypoidGearSetParetoOptimiser':
        ...
        if _680.HypoidGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_micro_geometry_design_space_search(self) -> '_683.MicroGeometryDesignSpaceSearch':
        ...
        if _683.MicroGeometryDesignSpaceSearch.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_micro_geometry_gear_set_design_space_search(self) -> '_686.MicroGeometryGearSetDesignSpaceSearch':
        ...
        if _686.MicroGeometryGearSetDesignSpaceSearch.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_spiral_bevel_gear_set_pareto_optimiser(self) -> '_705.SpiralBevelGearSetParetoOptimiser':
        ...
        if _705.SpiralBevelGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def optimiser_of_type_straight_bevel_gear_set_pareto_optimiser(self) -> '_706.StraightBevelGearSetParetoOptimiser':
        ...
        if _706.StraightBevelGearSetParetoOptimiser.TYPE not in self.wrapped.Optimiser.__class__.__mro__:
    ...
    @property
    def bars(self) -> 'List[_669.BarForPareto[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Bars, constructor.new(_669.BarForPareto)[TAnalysis, TCandidate])
        return value

    @property
    def input_sliders(self) -> 'List[_681.InputSliderForPareto[TAnalysis, TCandidate]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InputSliders, constructor.new(_681.InputSliderForPareto)[TAnalysis, TCandidate])
        return value
