...
class ZerolBevelGearRating(_339.BevelGearRating):
    ...
    @property
    def zerol_bevel_gear(self) -> '_716.ZerolBevelGearDesign':
        ...
        return constructor.new(_716.ZerolBevelGearDesign)(self.wrapped.ZerolBevelGear) if self.wrapped.ZerolBevelGear else None
