...
class HypoidGearMeshRating(_349.AGMAGleasonConicalGearMeshRating):
    ...
    @property
    def hypoid_gear_mesh(self) -> '_750.HypoidGearMeshDesign':
        ...
        return constructor.new(_750.HypoidGearMeshDesign)(self.wrapped.HypoidGearMesh) if self.wrapped.HypoidGearMesh else None
