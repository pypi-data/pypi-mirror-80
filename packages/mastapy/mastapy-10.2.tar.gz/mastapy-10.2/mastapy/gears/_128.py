...
from mastapy.gears.rating.cylindrical import _273, _259
from mastapy.gears.gear_designs.cylindrical import _832, _778
from mastapy.materials import _72, _61
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @property
    def misalignment_contact_pattern_enhancement(self) -> '_273.MisalignmentContactPatternEnhancements':
        ...
        return constructor.new(_273.MisalignmentContactPatternEnhancements)(value) if value else None

    @misalignment_contact_pattern_enhancement.setter
    def misalignment_contact_pattern_enhancement(self, value: '_273.MisalignmentContactPatternEnhancements'):
    ...
    @property
    def default_rough_toleranced_metal_measurement(self) -> '_832.TolerancedMetalMeasurements':
        ...
        return constructor.new(_832.TolerancedMetalMeasurements)(value) if value else None

    @default_rough_toleranced_metal_measurement.setter
    def default_rough_toleranced_metal_measurement(self, value: '_832.TolerancedMetalMeasurements'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def general_transmission_properties(self) -> '_61.GeneralTransmissionProperties':
        ...
        return constructor.new(_61.GeneralTransmissionProperties)(self.wrapped.GeneralTransmissionProperties) if self.wrapped.GeneralTransmissionProperties else None

    @property
    def settings(self) -> '_259.CylindricalGearRatingSettings':
        ...
        return constructor.new(_259.CylindricalGearRatingSettings)(self.wrapped.Settings) if self.wrapped.Settings else None
