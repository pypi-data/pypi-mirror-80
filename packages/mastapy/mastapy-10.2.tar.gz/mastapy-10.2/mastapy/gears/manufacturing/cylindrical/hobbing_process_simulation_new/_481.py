...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _445, _477
...
class WormGrindingProcessProfileCalculation(_477.WormGrindingProcessCalculation):
    '''WormGrindingProcessProfileCalculation
    ...
    @property
    def right_flank(self) -> '_445.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_445.CalculateProfileDeviationAccuracy)(self.wrapped.RightFlank) if self.wrapped.RightFlank else None

    @property
    def left_flank(self) -> '_445.CalculateProfileDeviationAccuracy':
        ...
        return constructor.new(_445.CalculateProfileDeviationAccuracy)(self.wrapped.LeftFlank) if self.wrapped.LeftFlank else None
