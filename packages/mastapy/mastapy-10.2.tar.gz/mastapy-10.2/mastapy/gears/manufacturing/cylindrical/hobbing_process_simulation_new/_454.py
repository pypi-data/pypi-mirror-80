...
from mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new import _445, _449
...
class HobbingProcessProfileCalculation(_449.HobbingProcessCalculation):
    '''HobbingProcessProfileCalculation
