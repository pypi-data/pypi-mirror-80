...
class ConicalSetMicroGeometryConfigBase(_963.GearSetImplementationDetail):
    '''ConicalSetMicroGeometryConfigBase
    ...
    @property
    def deflection_from_bending_option(self) -> '_125.DeflectionFromBendingOption':
        ...
        return constructor.new(_125.DeflectionFromBendingOption)(value) if value else None

    @deflection_from_bending_option.setter
    def deflection_from_bending_option(self, value: '_125.DeflectionFromBendingOption'):
