...
from mastapy.system_model.imported_fes import (
    _1934, _1968, _1992, _1928,
    _1930, _1993, _1988, _1967,
    _1926, _1951, _1954, _1974,
    _1973, _1970, _1971, _1972
)
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.part_model import _2013, _2009, _2021
from mastapy.nodal_analysis import _1380, _1373, _1376
from mastapy.nodal_analysis.component_mode_synthesis import _1502
from mastapy.system_model import _1827
from mastapy.math_utility import _1066
from mastapy.materials import _44, _86
...
class ImportedFE(_1376.FEStiffness):
    '''ImportedFE
    ...
    @property
    def bearing_node_alignment(self) -> '_1934.BearingNodeAlignmentOption':
        ...
        return constructor.new(_1934.BearingNodeAlignmentOption)(value) if value else None

    @bearing_node_alignment.setter
    def bearing_node_alignment(self, value: '_1934.BearingNodeAlignmentOption'):
    ...
    @property
    def alignment_method(self) -> '_1928.AlignmentMethod':
        ...
        return constructor.new(_1928.AlignmentMethod)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1928.AlignmentMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def gravity_force_source(self) -> '_1380.GravityForceSource':
        ...
        return constructor.new(_1380.GravityForceSource)(value) if value else None
    ...
    @property
    def fe_meshing_options(self) -> '_1373.FEMeshingOptions':
        ...
        return constructor.new(_1373.FEMeshingOptions)(self.wrapped.FEMeshingOptions) if self.wrapped.FEMeshingOptions else None

    @property
    def cms_model(self) -> '_1502.FullFEModel':
        ...
        return constructor.new(_1502.FullFEModel)(self.wrapped.CMSModel) if self.wrapped.CMSModel else None

    @property
    def alignment_to_component(self) -> '_1827.RelativeComponentAlignment[_2009.Component]':
        ...
        return constructor.new(_1827.RelativeComponentAlignment)[_2009.Component](self.wrapped.AlignmentToComponent) if self.wrapped.AlignmentToComponent else None

    @property
    def alignment_using_axial_node_positions(self) -> '_1930.AlignmentUsingAxialNodePositions':
        ...
        return constructor.new(_1930.AlignmentUsingAxialNodePositions)(self.wrapped.AlignmentUsingAxialNodePositions) if self.wrapped.AlignmentUsingAxialNodePositions else None

    @property
    def coordinate_system(self) -> '_1066.CoordinateSystem3D':
        ...
        return constructor.new(_1066.CoordinateSystem3D)(self.wrapped.CoordinateSystem) if self.wrapped.CoordinateSystem else None

    @property
    def export(self) -> '_1993.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile':
        ...
        return constructor.new(_1993.UsedForExportingAnImportedFEsSetupOrSubstructuringStepToAnFEFile)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def sound_pressure_enclosure(self) -> '_86.SoundPressureEnclosure':
        ...
        return constructor.new(_86.SoundPressureEnclosure)(self.wrapped.SoundPressureEnclosure) if self.wrapped.SoundPressureEnclosure else None

    @property
    def shafts_that_can_be_replaced(self) -> 'List[_1988.ReplacedShaftSelectionHelper]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShaftsThatCanBeReplaced, constructor.new(_1988.ReplacedShaftSelectionHelper))
        return value
    ...
    @property
    def replaced_shafts(self) -> 'List[_2044.Shaft]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ReplacedShafts, constructor.new(_2044.Shaft))
        return value

    @property
    def links(self) -> 'List[_1926.ImportedFELink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1926.ImportedFELink))
        return value

    @property
    def thermal_expansion_forces(self) -> 'List[_1123.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionForces, constructor.new(_1123.VectorWithLinearAndAngularComponents))
        return value

    @property
    def thermal_expansion_displacements(self) -> 'List[_1123.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ThermalExpansionDisplacements, constructor.new(_1123.VectorWithLinearAndAngularComponents))
        return value

    @property
    def geometries(self) -> 'List[_1951.FEStiffnessGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Geometries, constructor.new(_1951.FEStiffnessGeometry))
        return value

    @property
    def gear_meshing_options(self) -> 'List[_1954.GearMeshingOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshingOptions, constructor.new(_1954.GearMeshingOptions))
        return value

    @property
    def independent_masta_created_condensation_nodes(self) -> 'List[_1974.IndependentMastaCreatedCondensationNode]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.IndependentMastaCreatedCondensationNodes, constructor.new(_1974.IndependentMastaCreatedCondensationNode))
        return value

    @property
    def imported_fe_component(self) -> '_2021.ImportedFEComponent':
        ...
        return constructor.new(_2021.ImportedFEComponent)(self.wrapped.ImportedFEComponent) if self.wrapped.ImportedFEComponent else None
    ...
    def load_existing_masta_fe_file_with_progress(self, file_name: 'str', progress: '_6531.TaskProgress'):
        ''' 'LoadExistingMastaFEFile' is the original name of this method.
    ...
    def create_imported_fe_with_selection_static_analysis(self) -> '_1973.ImportedFEWithSelectionStaticAnalysis':
    ...
    def create_imported_fe_with_selection_components(self) -> '_1970.ImportedFEWithSelectionComponents':
    ...
    def create_imported_fe_with_selection_for_harmonic_analysis(self) -> '_1971.ImportedFEWithSelectionForHarmonicAnalysis':
    ...
    def create_imported_fe_with_selection_modal_analysis(self) -> '_1972.ImportedFEWithSelectionModalAnalysis':
    ...
    def links_for(self, node: '_1967.ImportedFEStiffnessNode') -> 'List[_1926.ImportedFELink]':
        ...
        return conversion.pn_to_mp_objects_in_list(self.wrapped.LinksFor(node.wrapped if node else None), constructor.new(_1926.ImportedFELink))
