...
class CylindricalGearSetCompoundPowerFlow(_3419.GearSetCompoundPowerFlow):
    ...
    @property
    def gear_set_duty_cycle_rating(self) -> '_261.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_261.CylindricalGearSetDutyCycleRating)(self.wrapped.GearSetDutyCycleRating) if self.wrapped.GearSetDutyCycleRating else None

    @property
    def cylindrical_gear_set_duty_cycle_rating(self) -> '_261.CylindricalGearSetDutyCycleRating':
        ...
        return constructor.new(_261.CylindricalGearSetDutyCycleRating)(self.wrapped.CylindricalGearSetDutyCycleRating) if self.wrapped.CylindricalGearSetDutyCycleRating else None
    ...
    @property
    def ratings_for_all_designs(self) -> 'List[_261.CylindricalGearSetDutyCycleRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RatingsForAllDesigns, constructor.new(_261.CylindricalGearSetDutyCycleRating))
        return value
