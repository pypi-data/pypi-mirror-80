...
class CylindricalGearSetPowerFlow(_3295.GearSetPowerFlow):
    ...
    @property
    def ratings_for_all_designs(self) -> 'List[_262.CylindricalGearSetRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RatingsForAllDesigns, constructor.new(_262.CylindricalGearSetRating))
        return value
