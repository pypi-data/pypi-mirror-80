...
class StraightBevelGearMeshCompoundModalAnalysesAtStiffnesses(_3885.BevelGearMeshCompoundModalAnalysesAtStiffnesses):
    '''StraightBevelGearMeshCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def component_design(self) -> '_1907.StraightBevelGearMesh':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3849.StraightBevelGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3849.StraightBevelGearMeshModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3849.StraightBevelGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_3849.StraightBevelGearMeshModalAnalysesAtStiffnesses))
        return value
