...
class FaceGearMeshCompoundModalAnalysesAtStiffnesses(_3922.GearMeshCompoundModalAnalysesAtStiffnesses):
    '''FaceGearMeshCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def component_design(self) -> '_1891.FaceGearMesh':
    ...
    @property
    def connection_design(self) -> '_1891.FaceGearMesh':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3794.FaceGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3794.FaceGearMeshModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3794.FaceGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_3794.FaceGearMeshModalAnalysesAtStiffnesses))
        return value
