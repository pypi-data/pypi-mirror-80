...
class ConceptCouplingConnectionGearWhineAnalysis(_5314.CouplingConnectionGearWhineAnalysis):
    '''ConceptCouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2255.ConceptCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2255.ConceptCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
