...
class MeasurementComponentGearWhineAnalysis(_5418.VirtualComponentGearWhineAnalysis):
    '''MeasurementComponentGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2311.MeasurementComponentSystemDeflection':
        ...
        return constructor.new(_2311.MeasurementComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
