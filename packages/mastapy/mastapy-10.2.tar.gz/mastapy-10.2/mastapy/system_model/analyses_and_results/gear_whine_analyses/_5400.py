...
from mastapy.system_model.analyses_and_results.system_deflections import _2343, _2347, _2348
...
class StraightBevelDiffGearGearWhineAnalysis(_5292.BevelGearGearWhineAnalysis):
    '''StraightBevelDiffGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2343.StraightBevelDiffGearSystemDeflection':
