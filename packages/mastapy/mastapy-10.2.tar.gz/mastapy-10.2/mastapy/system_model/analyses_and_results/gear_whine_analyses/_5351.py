...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5393, _5342
...
class GearWhineAnalysisOptions(_0.APIBase):
    ...
    @property
    def excitation_selection(self) -> '_5429.ExcitationSourceSelectionGroup':
        ...
        return constructor.new(_5429.ExcitationSourceSelectionGroup)(self.wrapped.ExcitationSelection) if self.wrapped.ExcitationSelection else None

    @property
    def modal_analysis_options(self) -> '_4800.ModalAnalysisOptions':
        ...
        return constructor.new(_4800.ModalAnalysisOptions)(self.wrapped.ModalAnalysisOptions) if self.wrapped.ModalAnalysisOptions else None
