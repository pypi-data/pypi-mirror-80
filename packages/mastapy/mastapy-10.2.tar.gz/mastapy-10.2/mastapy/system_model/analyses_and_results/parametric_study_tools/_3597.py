...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3596, _3595, _3503
...
class SpiralBevelGearSetParametricStudyTool(_3503.BevelGearSetParametricStudyTool):
    ...
    @property
    def spiral_bevel_gears_parametric_study_tool(self) -> 'List[_3596.SpiralBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsParametricStudyTool, constructor.new(_3596.SpiralBevelGearParametricStudyTool))
        return value

    @property
    def spiral_bevel_meshes_parametric_study_tool(self) -> 'List[_3595.SpiralBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesParametricStudyTool, constructor.new(_3595.SpiralBevelGearMeshParametricStudyTool))
        return value
