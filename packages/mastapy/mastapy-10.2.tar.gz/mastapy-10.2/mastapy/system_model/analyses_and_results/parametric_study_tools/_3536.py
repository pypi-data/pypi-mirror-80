...
class DutyCycleResultsForAllGearSets(_0.APIBase):
    ...
    @property
    def duty_cycle_results(self) -> '_959.GearSetGroupDutyCycle':
        ...
        return constructor.new(_959.GearSetGroupDutyCycle)(self.wrapped.DutyCycleResults) if self.wrapped.DutyCycleResults else None
