...
class CylindricalGearMeshCompoundSystemDeflection(_2432.GearMeshCompoundSystemDeflection):
    ...
    @property
    def component_design(self) -> '_1889.CylindricalGearMesh':
    ...
    @property
    def cylindrical_mesh_rating(self) -> '_264.CylindricalMeshDutyCycleRating':
        ...
        return constructor.new(_264.CylindricalMeshDutyCycleRating)(self.wrapped.CylindricalMeshRating) if self.wrapped.CylindricalMeshRating else None

    @property
    def load_case_analyses_ready(self) -> 'List[_2273.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2273.CylindricalGearMeshSystemDeflection))
        return value

    @property
    def connection_system_deflection_load_cases(self) -> 'List[_2273.CylindricalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionLoadCases, constructor.new(_2273.CylindricalGearMeshSystemDeflection))
        return value
