...
class StraightBevelDiffGearMeshSystemDeflection(_2244.BevelGearMeshSystemDeflection):
    '''StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def rating(self) -> '_195.StraightBevelDiffGearMeshRating':
        ...
        return constructor.new(_195.StraightBevelDiffGearMeshRating)(self.wrapped.Rating) if self.wrapped.Rating else None
