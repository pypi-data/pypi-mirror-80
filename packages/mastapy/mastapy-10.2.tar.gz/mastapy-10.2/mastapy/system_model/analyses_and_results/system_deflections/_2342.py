...
from mastapy.system_model.analyses_and_results.system_deflections import _2343, _2341, _2245
...
class StraightBevelDiffGearSetSystemDeflection(_2245.BevelGearSetSystemDeflection):
    '''StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def straight_bevel_diff_gears_system_deflection(self) -> 'List[_2343.StraightBevelDiffGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsSystemDeflection, constructor.new(_2343.StraightBevelDiffGearSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_system_deflection(self) -> 'List[_2341.StraightBevelDiffGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesSystemDeflection, constructor.new(_2341.StraightBevelDiffGearMeshSystemDeflection))
        return value
