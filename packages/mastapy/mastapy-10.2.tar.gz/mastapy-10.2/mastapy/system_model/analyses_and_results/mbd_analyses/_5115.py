...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5119, _5029
...
class TorqueConverterConnectionMultiBodyDynamicsAnalysis(_5029.CouplingConnectionMultiBodyDynamicsAnalysis):
    '''TorqueConverterConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def locking_status(self) -> '_5119.TorqueConverterStatus':
        ...
        return constructor.new(_5119.TorqueConverterStatus)(value) if value else None
