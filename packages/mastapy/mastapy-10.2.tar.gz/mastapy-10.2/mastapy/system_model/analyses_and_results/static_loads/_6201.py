...
from mastapy.nodal_analysis.varying_input_components import _1402, _1401, _1406
from mastapy.math_utility.control import _1129
from mastapy.system_model.analyses_and_results.static_loads import _6213, _6124, _6082
...
class RootAssemblyLoadCase(_6082.AssemblyLoadCase):
    '''RootAssemblyLoadCase
    ...
    @property
    def brake_force_input_values(self) -> '_1402.ForceInputComponent':
        ...
        return constructor.new(_1402.ForceInputComponent)(self.wrapped.BrakeForceInputValues) if self.wrapped.BrakeForceInputValues else None

    @property
    def road_incline_input_values(self) -> '_1401.AngleInputComponent':
        ...
        return constructor.new(_1401.AngleInputComponent)(self.wrapped.RoadInclineInputValues) if self.wrapped.RoadInclineInputValues else None

    @property
    def drive_cycle_pid_control_settings(self) -> '_1129.PIDControlSettings':
        ...
        return constructor.new(_1129.PIDControlSettings)(self.wrapped.DriveCyclePIDControlSettings) if self.wrapped.DriveCyclePIDControlSettings else None

    @property
    def target_vehicle_speed(self) -> '_1406.VelocityInputComponent':
        ...
        return constructor.new(_1406.VelocityInputComponent)(self.wrapped.TargetVehicleSpeed) if self.wrapped.TargetVehicleSpeed else None
    ...
    @property
    def supercharger_rotor_sets(self) -> 'List[_6124.CylindricalGearSetLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SuperchargerRotorSets, constructor.new(_6124.CylindricalGearSetLoadCase))
        return value
