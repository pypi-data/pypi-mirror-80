...
from mastapy.system_model.imported_fes import _1931, _1955
...
class ImportedFEComponentLoadCase(_6076.AbstractShaftOrHousingLoadCase):
    '''ImportedFEComponentLoadCase
    ...
    @property
    def angle_source(self) -> '_1931.AngleSource':
        ...
        return constructor.new(_1931.AngleSource)(value) if value else None
