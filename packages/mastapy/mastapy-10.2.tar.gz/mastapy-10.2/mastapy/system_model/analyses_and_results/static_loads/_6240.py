...
from mastapy.system_model.analyses_and_results.static_loads import _6238, _6239, _6152
...
class WormGearSetLoadCase(_6152.GearSetLoadCase):
    '''WormGearSetLoadCase
    ...
    @property
    def worm_gears_load_case(self) -> 'List[_6238.WormGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsLoadCase, constructor.new(_6238.WormGearLoadCase))
        return value

    @property
    def worm_meshes_load_case(self) -> 'List[_6239.WormGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesLoadCase, constructor.new(_6239.WormGearMeshLoadCase))
        return value
