...
class PlanetaryGearSetLoadCase(_6124.CylindricalGearSetLoadCase):
    '''PlanetaryGearSetLoadCase
    ...
    @property
    def include_gear_blank_elastic_distortion(self) -> '_1141.LoadCaseOverrideOption':
    ...
    def include_gear_blank_elastic_distortion(self, value: '_1141.LoadCaseOverrideOption'):
    ...
    @property
    def assembly_design(self) -> '_2103.PlanetaryGearSet':
        ...
        return constructor.new(_2103.PlanetaryGearSet)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None
