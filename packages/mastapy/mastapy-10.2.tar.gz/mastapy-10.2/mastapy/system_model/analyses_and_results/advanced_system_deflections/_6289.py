...
class ConceptCouplingConnectionAdvancedSystemDeflection(_6301.CouplingConnectionAdvancedSystemDeflection):
    '''ConceptCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6101.ConceptCouplingConnectionLoadCase':
        ...
        return constructor.new(_6101.ConceptCouplingConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2255.ConceptCouplingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2255.ConceptCouplingConnectionSystemDeflection))
        return value
