...
class ConceptGearMeshAdvancedSystemDeflection(_6318.GearMeshAdvancedSystemDeflection):
    '''ConceptGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6105.ConceptGearMeshLoadCase':
        ...
        return constructor.new(_6105.ConceptGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2258.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2258.ConceptGearMeshSystemDeflection))
        return value
