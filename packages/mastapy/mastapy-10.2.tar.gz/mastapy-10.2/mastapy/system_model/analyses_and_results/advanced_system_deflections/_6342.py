...
class PartToPartShearCouplingConnectionAdvancedSystemDeflection(_6301.CouplingConnectionAdvancedSystemDeflection):
    '''PartToPartShearCouplingConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2317.PartToPartShearCouplingConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2317.PartToPartShearCouplingConnectionSystemDeflection))
        return value
