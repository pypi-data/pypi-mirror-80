...
class ConicalGearMeshAdvancedSystemDeflection(_6318.GearMeshAdvancedSystemDeflection):
    '''ConicalGearMeshAdvancedSystemDeflection
    ...
    @property
    def active_flank(self) -> '_885.ActiveConicalFlank':
        ...
        return constructor.new(_885.ActiveConicalFlank)(value) if value else None

    @property
    def inactive_flank(self) -> '_885.ActiveConicalFlank':
