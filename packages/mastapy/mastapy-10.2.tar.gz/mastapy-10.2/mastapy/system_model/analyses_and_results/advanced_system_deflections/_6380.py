...
class TransmissionErrorToOtherPowerLoad(_0.APIBase):
    ...
    @property
    def fourier_series_of_te(self) -> '_1078.FourierSeries':
        ...
        return constructor.new(_1078.FourierSeries)(self.wrapped.FourierSeriesOfTE) if self.wrapped.FourierSeriesOfTE else None
