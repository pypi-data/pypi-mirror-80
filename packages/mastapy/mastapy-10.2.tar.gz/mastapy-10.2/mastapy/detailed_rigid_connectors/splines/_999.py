...
from mastapy.detailed_rigid_connectors.splines import (
    _983, _1000, _975, _978,
    _982, _985, _986, _993,
    _1005
)
from mastapy._internal.cast_exception import CastException
from mastapy.detailed_rigid_connectors.splines.tolerances_and_deviations import _1006
...
class SplineHalfDesign(_973.DetailedRigidConnectorHalfDesign):
    '''SplineHalfDesign
    ...
    @property
    def heat_treatment(self) -> '_983.HeatTreatmentTypes':
        ...
        return constructor.new(_983.HeatTreatmentTypes)(value) if value else None

    @heat_treatment.setter
    def heat_treatment(self, value: '_983.HeatTreatmentTypes'):
    ...
    @property
    def spline_joint_design(self) -> '_1000.SplineJointDesign':
        ...
        if _1000.SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_custom_spline_joint_design(self) -> '_975.CustomSplineJointDesign':
        ...
        if _975.CustomSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_din5480_spline_joint_design(self) -> '_978.DIN5480SplineJointDesign':
        ...
        if _978.DIN5480SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_gbt3478_spline_joint_design(self) -> '_982.GBT3478SplineJointDesign':
        ...
        if _982.GBT3478SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_iso4156_spline_joint_design(self) -> '_985.ISO4156SplineJointDesign':
        ...
        if _985.ISO4156SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_jisb1603_spline_joint_design(self) -> '_986.JISB1603SplineJointDesign':
        ...
        if _986.JISB1603SplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_sae_spline_joint_design(self) -> '_993.SAESplineJointDesign':
        ...
        if _993.SAESplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def spline_joint_design_of_type_standard_spline_joint_design(self) -> '_1005.StandardSplineJointDesign':
        ...
        if _1005.StandardSplineJointDesign.TYPE not in self.wrapped.SplineJointDesign.__class__.__mro__:
    ...
    @property
    def fit_and_tolerance(self) -> '_1006.FitAndTolerance':
        ...
        return constructor.new(_1006.FitAndTolerance)(self.wrapped.FitAndTolerance) if self.wrapped.FitAndTolerance else None
