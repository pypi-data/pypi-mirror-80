...
from mastapy.bearings.bearing_designs.rolling import _1776, _1773
...
class TaperRollerBearing(_1773.NonBarrelRollerBearing):
    '''TaperRollerBearing
    ...
    @property
    def bearing_measurement_type(self) -> '_1520.BearingMeasurementType':
        ...
        return constructor.new(_1520.BearingMeasurementType)(value) if value else None

    @bearing_measurement_type.setter
    def bearing_measurement_type(self, value: '_1520.BearingMeasurementType'):
    ...
    @property
    def major_rib_detail(self) -> '_1776.RollerRibDetail':
        ...
        return constructor.new(_1776.RollerRibDetail)(self.wrapped.MajorRibDetail) if self.wrapped.MajorRibDetail else None
