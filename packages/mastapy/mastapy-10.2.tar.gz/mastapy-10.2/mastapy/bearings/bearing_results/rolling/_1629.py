...
from mastapy.bearings.bearing_results.rolling import _1701, _1660
...
class LoadedBallBearingResults(_1660.LoadedRollingBearingResults):
    '''LoadedBallBearingResults
    ...
    @property
    def track_truncation(self) -> '_1701.TrackTruncationSafetyFactorResults':
        ...
        return constructor.new(_1701.TrackTruncationSafetyFactorResults)(self.wrapped.TrackTruncation) if self.wrapped.TrackTruncation else None
