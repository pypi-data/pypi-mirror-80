...
class LoadedNonBarrelRollerBearingRow(_1657.LoadedRollerBearingRow):
    '''LoadedNonBarrelRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1651.LoadedNonBarrelRollerBearingResults':
