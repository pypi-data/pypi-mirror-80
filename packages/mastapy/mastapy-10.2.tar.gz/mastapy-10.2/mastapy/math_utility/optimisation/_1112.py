...
from mastapy.math_utility.optimisation import _1113, _1111
...
class ParetoOptimistaionVariable(_1111.ParetoOptimisationVariableBase):
    '''ParetoOptimistaionVariable
    ...
    @property
    def property_target_for_dominant_candidate_search(self) -> '_1113.PropertyTargetForDominantCandidateSearch':
        ...
        return constructor.new(_1113.PropertyTargetForDominantCandidateSearch)(value) if value else None

    @property_target_for_dominant_candidate_search.setter
    def property_target_for_dominant_candidate_search(self, value: '_1113.PropertyTargetForDominantCandidateSearch'):
