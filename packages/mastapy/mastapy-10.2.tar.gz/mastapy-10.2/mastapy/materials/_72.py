...
class LubricationDetail(_1346.NamedDatabaseItem):
    '''LubricationDetail
    ...
    @property
    def density_specification_method(self) -> '_57.DensitySpecificationMethod':
        ...
        return constructor.new(_57.DensitySpecificationMethod)(value) if value else None

    @density_specification_method.setter
    def density_specification_method(self, value: '_57.DensitySpecificationMethod'):
    ...
    @property
    def pressure_viscosity_coefficient_method(self) -> '_80.PressureViscosityCoefficientMethod':
        ...
        return constructor.new(_80.PressureViscosityCoefficientMethod)(value) if value else None

    @pressure_viscosity_coefficient_method.setter
    def pressure_viscosity_coefficient_method(self, value: '_80.PressureViscosityCoefficientMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def oil_filtration_and_contamination(self) -> '_79.OilFiltrationOptions':
        ...
        return constructor.new(_79.OilFiltrationOptions)(value) if value else None

    @oil_filtration_and_contamination.setter
    def oil_filtration_and_contamination(self, value: '_79.OilFiltrationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OilFiltrationAndContamination = value

    @property
    def grease_contamination_level(self) -> '_62.GreaseContaminationOptions':
        ...
        return constructor.new(_62.GreaseContaminationOptions)(value) if value else None

    @grease_contamination_level.setter
    def grease_contamination_level(self, value: '_62.GreaseContaminationOptions'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_viscosity_classification(self) -> '_69.LubricantViscosityClassification':
        ...
        return constructor.new(_69.LubricantViscosityClassification)(value) if value else None

    @lubricant_viscosity_classification.setter
    def lubricant_viscosity_classification(self, value: '_69.LubricantViscosityClassification'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def lubricant_grade_agma(self) -> '_68.LubricantViscosityClassAGMA':
        ...
        return constructor.new(_68.LubricantViscosityClassAGMA)(value) if value else None

    @lubricant_grade_agma.setter
    def lubricant_grade_agma(self, value: '_68.LubricantViscosityClassAGMA'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.LubricantGradeAGMA = value

    @property
    def lubricant_grade_sae(self) -> '_71.LubricantViscosityClassSAE':
        ...
        return constructor.new(_71.LubricantViscosityClassSAE)(value) if value else None

    @lubricant_grade_sae.setter
    def lubricant_grade_sae(self, value: '_71.LubricantViscosityClassSAE'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def delivery(self) -> '_67.LubricantDelivery':
        ...
        return constructor.new(_67.LubricantDelivery)(value) if value else None
    ...
    @property
    def isotr139892000isotr1514412014_lubricant_type(self) -> '_65.ISOLubricantType':
        ...
        return constructor.new(_65.ISOLubricantType)(value) if value else None

    @isotr139892000isotr1514412014_lubricant_type.setter
    def isotr139892000isotr1514412014_lubricant_type(self, value: '_65.ISOLubricantType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
