...
from mastapy.gears.gear_designs.zerol_bevel import _716, _717
...
class ZerolBevelGearSetDesign(_917.BevelGearSetDesign):
    '''ZerolBevelGearSetDesign
    ...
    @property
    def tooth_taper_zerol(self) -> '_152.ZerolBevelGleasonToothTaperOption':
        ...
        return constructor.new(_152.ZerolBevelGleasonToothTaperOption)(value) if value else None

    @tooth_taper_zerol.setter
    def tooth_taper_zerol(self, value: '_152.ZerolBevelGleasonToothTaperOption'):
    ...
    @property
    def gears(self) -> 'List[_716.ZerolBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_716.ZerolBevelGearDesign))
        return value
    ...
    @property
    def zerol_bevel_meshes(self) -> 'List[_717.ZerolBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshes, constructor.new(_717.ZerolBevelGearMeshDesign))
        return value
