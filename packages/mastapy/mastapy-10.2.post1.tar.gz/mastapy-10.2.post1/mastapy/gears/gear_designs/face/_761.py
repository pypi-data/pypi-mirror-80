...
from mastapy.gears.gear_designs.face import _754, _753
...
class FaceGearWheelDesign(_753.FaceGearDesign):
    '''FaceGearWheelDesign
    ...
    @property
    def face_width_and_diameters_specification_method(self) -> '_754.FaceGearDiameterFaceWidthSpecificationMethod':
        ...
        return constructor.new(_754.FaceGearDiameterFaceWidthSpecificationMethod)(value) if value else None

    @face_width_and_diameters_specification_method.setter
    def face_width_and_diameters_specification_method(self, value: '_754.FaceGearDiameterFaceWidthSpecificationMethod'):
