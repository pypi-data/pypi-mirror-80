...
from mastapy.gears.gear_designs.concept import _911, _912
...
class ConceptGearSetDesign(_714.GearSetDesign):
    '''ConceptGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_911.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_911.ConceptGearDesign))
        return value

    @property
    def concept_gears(self) -> 'List[_911.ConceptGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGears, constructor.new(_911.ConceptGearDesign))
        return value

    @property
    def concept_meshes(self) -> 'List[_912.ConceptGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshes, constructor.new(_912.ConceptGearMeshDesign))
        return value
