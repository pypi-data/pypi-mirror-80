...
from mastapy.gears import _135, _118
...
class CylindricalGearMeshDesign(_713.GearMeshDesign):
    '''CylindricalGearMeshDesign
    ...
    def profile_modification(self, value: '_784.CylindricalGearProfileModifications'):
    ...
    @property
    def type_of_mechanism_housing(self) -> '_836.TypeOfMechanismHousing':
        ...
        return constructor.new(_836.TypeOfMechanismHousing)(value) if value else None

    @type_of_mechanism_housing.setter
    def type_of_mechanism_housing(self, value: '_836.TypeOfMechanismHousing'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def centre_distance_change_method(self) -> '_118.CentreDistanceChangeMethod':
        ...
        return constructor.new(_118.CentreDistanceChangeMethod)(value) if value else None

    @centre_distance_change_method.setter
    def centre_distance_change_method(self, value: '_118.CentreDistanceChangeMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def backlash_specification(self) -> '_763.BacklashSpecification':
        ...
        return constructor.new(_763.BacklashSpecification)(self.wrapped.BacklashSpecification) if self.wrapped.BacklashSpecification else None

    @property
    def valid_normal_module_range(self) -> '_1124.ShortLengthRange':
        ...
        return constructor.new(_1124.ShortLengthRange)(self.wrapped.ValidNormalModuleRange) if self.wrapped.ValidNormalModuleRange else None
    ...
    @property
    def cylindrical_meshed_gear(self) -> 'List[_792.CylindricalMeshedGear]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshedGear, constructor.new(_792.CylindricalMeshedGear))
        return value

    @property
    def gear_a(self) -> '_774.CylindricalGearDesign':
    ...
    @property
    def gear_b(self) -> '_774.CylindricalGearDesign':
