...
from mastapy.gears.gear_designs.cylindrical import _833, _763
...
class CylindricalMeshLinearBacklashSpecification(_833.TolerancedValueSpecification['_763.BacklashSpecification']):
    '''CylindricalMeshLinearBacklashSpecification
