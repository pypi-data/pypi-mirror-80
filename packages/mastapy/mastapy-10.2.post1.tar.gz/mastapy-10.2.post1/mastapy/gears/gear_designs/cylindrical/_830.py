...
from mastapy.gears.gear_designs.cylindrical import _805
...
class TiffAnalysisSettings(_1138.IndependentReportablePropertiesBase['TiffAnalysisSettings']):
    '''TiffAnalysisSettings
    ...
    @property
    def surface_material_properties(self) -> '_805.HardenedMaterialProperties':
        ...
        return constructor.new(_805.HardenedMaterialProperties)(self.wrapped.SurfaceMaterialProperties) if self.wrapped.SurfaceMaterialProperties else None

    @property
    def core_material_properties(self) -> '_805.HardenedMaterialProperties':
        ...
        return constructor.new(_805.HardenedMaterialProperties)(self.wrapped.CoreMaterialProperties) if self.wrapped.CoreMaterialProperties else None
