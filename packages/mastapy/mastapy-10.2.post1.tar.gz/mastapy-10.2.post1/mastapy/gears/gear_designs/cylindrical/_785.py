...
class CylindricalGearSetDesign(_714.GearSetDesign):
    '''CylindricalGearSetDesign
    ...
    @property
    def profile_shift_distribution_rule(self) -> '_762.AddendumModificationDistributionRule':
        ...
        return constructor.new(_762.AddendumModificationDistributionRule)(value) if value else None

    @profile_shift_distribution_rule.setter
    def profile_shift_distribution_rule(self, value: '_762.AddendumModificationDistributionRule'):
    ...
    @property
    def efficiency_rating_method(self) -> '_97.EfficiencyRatingMethod':
        ...
        return constructor.new(_97.EfficiencyRatingMethod)(value) if value else None

    @efficiency_rating_method.setter
    def efficiency_rating_method(self, value: '_97.EfficiencyRatingMethod'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.EfficiencyRatingMethod = value

    @property
    def helical_gear_micro_geometry_option(self) -> '_301.HelicalGearMicroGeometryOption':
        ...
        return constructor.new(_301.HelicalGearMicroGeometryOption)(value) if value else None

    @helical_gear_micro_geometry_option.setter
    def helical_gear_micro_geometry_option(self, value: '_301.HelicalGearMicroGeometryOption'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.HelicalGearMicroGeometryOption = value

    @property
    def gear_fit_system(self) -> '_800.GearFitSystems':
        ...
        return constructor.new(_800.GearFitSystems)(value) if value else None

    @gear_fit_system.setter
    def gear_fit_system(self, value: '_800.GearFitSystems'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def cylindrical_gear_set_micro_geometry(self) -> '_852.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_852.CylindricalGearSetMicroGeometry)(self.wrapped.CylindricalGearSetMicroGeometry) if self.wrapped.CylindricalGearSetMicroGeometry else None

    @property
    def scuffing(self) -> '_821.Scuffing':
        ...
        return constructor.new(_821.Scuffing)(self.wrapped.Scuffing) if self.wrapped.Scuffing else None

    @property
    def micropitting(self) -> '_816.Micropitting':
        ...
        return constructor.new(_816.Micropitting)(self.wrapped.Micropitting) if self.wrapped.Micropitting else None

    @property
    def usage(self) -> '_837.Usage':
        ...
        return constructor.new(_837.Usage)(self.wrapped.Usage) if self.wrapped.Usage else None
    ...
    @property
    def cylindrical_gear_set_manufacturing_configuration(self) -> '_408.CylindricalSetManufacturingConfig':
        ...
        return constructor.new(_408.CylindricalSetManufacturingConfig)(self.wrapped.CylindricalGearSetManufacturingConfiguration) if self.wrapped.CylindricalGearSetManufacturingConfiguration else None

    @property
    def gears(self) -> 'List[_774.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_774.CylindricalGearDesign))
        return value

    @property
    def cylindrical_gears(self) -> 'List[_774.CylindricalGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGears, constructor.new(_774.CylindricalGearDesign))
        return value
    ...
    @property
    def micro_geometries(self) -> 'List[_852.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MicroGeometries, constructor.new(_852.CylindricalGearSetMicroGeometry))
        return value

    @property
    def manufacturing_configurations(self) -> 'List[_408.CylindricalSetManufacturingConfig]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ManufacturingConfigurations, constructor.new(_408.CylindricalSetManufacturingConfig))
        return value

    def create_optimiser(self, duty_cycle: '_261.CylindricalGearSetDutyCycleRating') -> '_786.CylindricalGearSetMacroGeometryOptimiser':
    ...
    def set_active_manufacturing_configuration(self, value: '_408.CylindricalSetManufacturingConfig'):
    ...
    def add_new_manufacturing_configuration(self, new_config_name: Optional['str'] = 'None') -> '_408.CylindricalSetManufacturingConfig':
    ...
    def delete_manufacturing_configuration(self, config: '_408.CylindricalSetManufacturingConfig'):
    ...
    def add_new_micro_geometry(self) -> '_852.CylindricalGearSetMicroGeometry':
    ...
    def delete_micro_geometry(self, micro_geometry: '_852.CylindricalGearSetMicroGeometry'):
    ...
    def set_active_micro_geometry(self, value: '_852.CylindricalGearSetMicroGeometry'):
    ...
    def micro_geometry_named(self, micro_geometry_name: 'str') -> '_852.CylindricalGearSetMicroGeometry':
