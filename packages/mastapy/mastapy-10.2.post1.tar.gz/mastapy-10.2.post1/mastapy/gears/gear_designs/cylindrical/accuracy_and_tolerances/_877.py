...
from mastapy.gears.gear_designs.cylindrical import _796, _797
...
class DIN3967SystemOfGearFits(_0.APIBase):
    ...
    @property
    def tooth_thickness_reduction_allowance(self) -> '_796.DIN3967AllowanceSeries':
        ...
        return constructor.new(_796.DIN3967AllowanceSeries)(value) if value else None

    @tooth_thickness_reduction_allowance.setter
    def tooth_thickness_reduction_allowance(self, value: '_796.DIN3967AllowanceSeries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ToothThicknessReductionAllowance = value

    @property
    def tooth_thickness_tolerance(self) -> '_797.DIN3967ToleranceSeries':
        ...
        return constructor.new(_797.DIN3967ToleranceSeries)(value) if value else None

    @tooth_thickness_tolerance.setter
    def tooth_thickness_tolerance(self, value: '_797.DIN3967ToleranceSeries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
