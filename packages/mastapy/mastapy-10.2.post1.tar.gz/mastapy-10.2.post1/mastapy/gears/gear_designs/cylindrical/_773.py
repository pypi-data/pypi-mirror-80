...
class CylindricalGearDefaults(_1143.PerMachineSettings):
    '''CylindricalGearDefaults
    ...
    @property
    def system_of_fits_defaults(self) -> '_877.DIN3967SystemOfGearFits':
        ...
        return constructor.new(_877.DIN3967SystemOfGearFits)(self.wrapped.SystemOfFitsDefaults) if self.wrapped.SystemOfFitsDefaults else None
