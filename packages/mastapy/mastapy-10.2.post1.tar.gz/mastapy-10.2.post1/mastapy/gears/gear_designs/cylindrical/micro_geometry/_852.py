...
from mastapy.gears.gear_designs.cylindrical.micro_geometry import _847, _845
...
class CylindricalGearSetMicroGeometry(_963.GearSetImplementationDetail):
    '''CylindricalGearSetMicroGeometry
    ...
    @property
    def cylindrical_mesh_micro_geometries(self) -> 'List[_845.CylindricalGearMeshMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshMicroGeometries, constructor.new(_845.CylindricalGearMeshMicroGeometry))
        return value
