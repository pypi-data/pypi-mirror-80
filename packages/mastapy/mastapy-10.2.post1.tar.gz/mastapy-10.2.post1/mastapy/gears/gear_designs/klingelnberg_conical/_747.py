...
from mastapy.gears.gear_designs.conical import _903, _891
...
class KlingelnbergConicalGearSetDesign(_891.ConicalGearSetDesign):
    '''KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self) -> '_903.KlingelnbergFinishingMethods':
        ...
        return constructor.new(_903.KlingelnbergFinishingMethods)(value) if value else None

    @gear_finish.setter
    def gear_finish(self, value: '_903.KlingelnbergFinishingMethods'):
    ...
    @property
    def conical_meshes(self) -> 'List[_746.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConicalMeshes, constructor.new(_746.KlingelnbergConicalGearMeshDesign))
        return value

    @property
    def klingelnberg_conical_meshes(self) -> 'List[_746.KlingelnbergConicalGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_746.KlingelnbergConicalGearMeshDesign))
        return value
