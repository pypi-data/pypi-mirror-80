...
from mastapy.gears.gear_designs.straight_bevel import _729, _730
...
class StraightBevelGearSetDesign(_917.BevelGearSetDesign):
    '''StraightBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_729.StraightBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_729.StraightBevelGearDesign))
        return value
    ...
    @property
    def straight_bevel_meshes(self) -> 'List[_730.StraightBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshes, constructor.new(_730.StraightBevelGearMeshDesign))
        return value
