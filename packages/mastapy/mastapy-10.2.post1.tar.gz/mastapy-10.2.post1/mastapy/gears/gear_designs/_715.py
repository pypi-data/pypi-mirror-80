...
class SelectedDesignConstraintsCollection(_1143.PerMachineSettings):
    '''SelectedDesignConstraintsCollection
    ...
    @property
    def design_constraints(self) -> '_710.DesignConstraintsCollection':
        ...
        return constructor.new(_710.DesignConstraintsCollection)(self.wrapped.DesignConstraints) if self.wrapped.DesignConstraints else None
