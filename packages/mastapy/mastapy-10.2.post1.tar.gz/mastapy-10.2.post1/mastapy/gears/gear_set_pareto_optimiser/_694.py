...
from mastapy.gears.gear_set_pareto_optimiser import _696
...
class ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase(_696.ParetoFaceRatingOptimisationStrategyDatabase):
    '''ParetoFaceGearSetDutyCycleOptimisationStrategyDatabase
