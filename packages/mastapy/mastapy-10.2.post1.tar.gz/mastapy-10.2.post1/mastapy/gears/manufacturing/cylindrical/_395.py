...
from mastapy.gears.manufacturing.cylindrical import _407, _406, _394
...
from mastapy.gears.gear_designs.cylindrical import _798, _774, _795
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import (
    _494, _491, _499, _488,
    _497
)
from mastapy.gears.manufacturing.cylindrical.process_simulation import _422, _423, _424
...
class CylindricalGearManufacturingConfig(_953.GearImplementationDetail):
    '''CylindricalGearManufacturingConfig
    ...
    @property
    def rough_cutter(self) -> '_514.CylindricalGearRealCutterDesign':
        ...
        if _514.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_508.CylindricalGearFormGrindingWheel':
        ...
        if _508.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_509.CylindricalGearGrindingWorm':
        ...
        if _509.CylindricalGearGrindingWorm.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_hob_design(self) -> '_510.CylindricalGearHobDesign':
        ...
        if _510.CylindricalGearHobDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_511.CylindricalGearPlungeShaver':
        ...
        if _511.CylindricalGearPlungeShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_rack_design(self) -> '_513.CylindricalGearRackDesign':
        ...
        if _513.CylindricalGearRackDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_shaper(self) -> '_515.CylindricalGearShaper':
        ...
        if _515.CylindricalGearShaper.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_cylindrical_gear_shaver(self) -> '_516.CylindricalGearShaver':
        ...
        if _516.CylindricalGearShaver.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_of_type_involute_cutter_design(self) -> '_519.InvoluteCutterDesign':
        ...
        if _519.InvoluteCutterDesign.TYPE not in self.wrapped.RoughCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter(self) -> '_514.CylindricalGearRealCutterDesign':
        ...
        if _514.CylindricalGearRealCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_form_grinding_wheel(self) -> '_508.CylindricalGearFormGrindingWheel':
        ...
        if _508.CylindricalGearFormGrindingWheel.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_grinding_worm(self) -> '_509.CylindricalGearGrindingWorm':
        ...
        if _509.CylindricalGearGrindingWorm.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_hob_design(self) -> '_510.CylindricalGearHobDesign':
        ...
        if _510.CylindricalGearHobDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_plunge_shaver(self) -> '_511.CylindricalGearPlungeShaver':
        ...
        if _511.CylindricalGearPlungeShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_rack_design(self) -> '_513.CylindricalGearRackDesign':
        ...
        if _513.CylindricalGearRackDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_shaper(self) -> '_515.CylindricalGearShaper':
        ...
        if _515.CylindricalGearShaper.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_cylindrical_gear_shaver(self) -> '_516.CylindricalGearShaver':
        ...
        if _516.CylindricalGearShaver.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def finish_cutter_of_type_involute_cutter_design(self) -> '_519.InvoluteCutterDesign':
        ...
        if _519.InvoluteCutterDesign.TYPE not in self.wrapped.FinishCutter.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation(self) -> '_494.GearCutterSimulation':
        ...
        if _494.GearCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_491.FinishCutterSimulation':
        ...
        if _491.FinishCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_499.RoughCutterSimulation':
        ...
        if _499.RoughCutterSimulation.TYPE not in self.wrapped.RoughCutterSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation(self) -> '_422.CutterProcessSimulation':
        ...
        if _422.CutterProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_423.FormWheelGrindingProcessSimulation':
        ...
        if _423.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def rough_process_simulation_of_type_shaping_process_simulation(self) -> '_424.ShapingProcessSimulation':
        ...
        if _424.ShapingProcessSimulation.TYPE not in self.wrapped.RoughProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation(self) -> '_494.GearCutterSimulation':
        ...
        if _494.GearCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation_of_type_finish_cutter_simulation(self) -> '_491.FinishCutterSimulation':
        ...
        if _491.FinishCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_cutter_simulation_of_type_rough_cutter_simulation(self) -> '_499.RoughCutterSimulation':
        ...
        if _499.RoughCutterSimulation.TYPE not in self.wrapped.FinishCutterSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation(self) -> '_422.CutterProcessSimulation':
        ...
        if _422.CutterProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation_of_type_form_wheel_grinding_process_simulation(self) -> '_423.FormWheelGrindingProcessSimulation':
        ...
        if _423.FormWheelGrindingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def finish_process_simulation_of_type_shaping_process_simulation(self) -> '_424.ShapingProcessSimulation':
        ...
        if _424.ShapingProcessSimulation.TYPE not in self.wrapped.FinishProcessSimulation.__class__.__mro__:
    ...
    @property
    def design(self) -> '_774.CylindricalGearDesign':
        ...
        if _774.CylindricalGearDesign.TYPE not in self.wrapped.Design.__class__.__mro__:
    ...
    @property
    def rough_gear_specification(self) -> '_488.CylindricalGearSpecification':
        ...
        return constructor.new(_488.CylindricalGearSpecification)(self.wrapped.RoughGearSpecification) if self.wrapped.RoughGearSpecification else None

    @property
    def finished_gear_specification(self) -> '_488.CylindricalGearSpecification':
        ...
        return constructor.new(_488.CylindricalGearSpecification)(self.wrapped.FinishedGearSpecification) if self.wrapped.FinishedGearSpecification else None

    @property
    def gear_blank(self) -> '_394.CylindricalGearBlank':
        ...
        return constructor.new(_394.CylindricalGearBlank)(self.wrapped.GearBlank) if self.wrapped.GearBlank else None

    @property
    def rough_manufacturing_process_controls(self) -> '_497.ManufacturingProcessControls':
        ...
        return constructor.new(_497.ManufacturingProcessControls)(self.wrapped.RoughManufacturingProcessControls) if self.wrapped.RoughManufacturingProcessControls else None

    @property
    def finish_manufacturing_process_controls(self) -> '_497.ManufacturingProcessControls':
        ...
        return constructor.new(_497.ManufacturingProcessControls)(self.wrapped.FinishManufacturingProcessControls) if self.wrapped.FinishManufacturingProcessControls else None
