...
class CylindricalGearMeshLoadedContactPoint(_618.GearMeshLoadedContactPoint):
    '''CylindricalGearMeshLoadedContactPoint
    ...
    @property
    def gear_a_profile_measurement(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.GearAProfileMeasurement) if self.wrapped.GearAProfileMeasurement else None

    @property
    def gear_b_profile_measurement(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.GearBProfileMeasurement) if self.wrapped.GearBProfileMeasurement else None
