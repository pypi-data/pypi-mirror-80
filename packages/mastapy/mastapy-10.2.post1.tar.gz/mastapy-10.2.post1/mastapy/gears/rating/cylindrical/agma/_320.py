...
from mastapy.gears.gear_designs.cylindrical import _784, _823
...
class AGMA2101MeshSingleFlankRating(_265.CylindricalMeshSingleFlankRating):
    '''AGMA2101MeshSingleFlankRating
    ...
    @property
    def gearing_type(self) -> '_60.GearingTypes':
        ...
        return constructor.new(_60.GearingTypes)(value) if value else None

    @property
    def scuffing_temperature_method(self) -> '_823.ScuffingTemperatureMethodsAGMA':
