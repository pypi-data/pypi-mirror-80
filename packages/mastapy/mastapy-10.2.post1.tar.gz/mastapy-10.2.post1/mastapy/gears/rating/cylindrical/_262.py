...
from mastapy.gears.rating.cylindrical import _259, _255, _257
...
class CylindricalGearSetRating(_163.GearSetRating):
    '''CylindricalGearSetRating
    ...
    @property
    def vdi_cylindrical_gear_single_flank_ratings(self) -> 'List[_281.VDI2737InternalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.VDICylindricalGearSingleFlankRatings, constructor.new(_281.VDI2737InternalGearSingleFlankRating))
        return value

    @property
    def cylindrical_mesh_ratings(self) -> 'List[_255.CylindricalGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshRatings, constructor.new(_255.CylindricalGearMeshRating))
        return value

    @property
    def gear_ratings(self) -> 'List[_257.CylindricalGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_257.CylindricalGearRating))
        return value
