...
class ISO6336AbstractMetalMeshSingleFlankRating(_309.ISO6336AbstractMeshSingleFlankRating):
    '''ISO6336AbstractMetalMeshSingleFlankRating
    ...
    @property
    def scuffing_temperature_method(self) -> '_824.ScuffingTemperatureMethodsISO':
        ...
        return constructor.new(_824.ScuffingTemperatureMethodsISO)(value) if value else None
    ...
    @property
    def sorted_micro_pitting_results(self) -> '_256.CylindricalGearMicroPittingResults':
        ...
        return constructor.new(_256.CylindricalGearMicroPittingResults)(self.wrapped.SortedMicroPittingResults) if self.wrapped.SortedMicroPittingResults else None

    @property
    def single_flank_rating_of_test_gears_for_micropitting(self) -> '_305.ISO63362006MeshSingleFlankRating':
        ...
        if _305.ISO63362006MeshSingleFlankRating.TYPE not in self.wrapped.SingleFlankRatingOfTestGearsForMicropitting.__class__.__mro__:
    ...
    @property
    def isodin_cylindrical_gear_single_flank_ratings(self) -> 'List[_310.ISO6336AbstractMetalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ISODINCylindricalGearSingleFlankRatings, constructor.new(_310.ISO6336AbstractMetalGearSingleFlankRating))
        return value
