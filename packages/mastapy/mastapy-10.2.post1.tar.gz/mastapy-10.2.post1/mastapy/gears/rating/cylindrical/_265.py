...
from mastapy.gears.gear_designs.cylindrical import _822, _821
from mastapy.materials import _72
from mastapy.gears.rating.cylindrical import _260, _259, _263
...
class CylindricalMeshSingleFlankRating(_166.MeshSingleFlankRating):
    '''CylindricalMeshSingleFlankRating
    ...
    @property
    def contact_ratio_source(self) -> '_121.ContactRatioDataSource':
        ...
        return constructor.new(_121.ContactRatioDataSource)(value) if value else None
    ...
    @property
    def coefficient_of_friction_method_flash_temperature_method(self) -> '_822.ScuffingCoefficientOfFrictionMethods':
        ...
        return constructor.new(_822.ScuffingCoefficientOfFrictionMethods)(value) if value else None
    ...
    @property
    def lubrication_detail(self) -> '_72.LubricationDetail':
        ...
        return constructor.new(_72.LubricationDetail)(self.wrapped.LubricationDetail) if self.wrapped.LubricationDetail else None

    @property
    def sorted_scuffing_results(self) -> '_260.CylindricalGearScuffingResults':
        ...
        return constructor.new(_260.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResults) if self.wrapped.SortedScuffingResults else None

    @property
    def sorted_scuffing_results_without_special_values(self) -> '_260.CylindricalGearScuffingResults':
        ...
        return constructor.new(_260.CylindricalGearScuffingResults)(self.wrapped.SortedScuffingResultsWithoutSpecialValues) if self.wrapped.SortedScuffingResultsWithoutSpecialValues else None

    @property
    def rating_settings(self) -> '_259.CylindricalGearRatingSettings':
        ...
        return constructor.new(_259.CylindricalGearRatingSettings)(self.wrapped.RatingSettings) if self.wrapped.RatingSettings else None
    ...
    @property
    def gear_single_flank_ratings(self) -> 'List[_263.CylindricalGearSingleFlankRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearSingleFlankRatings, constructor.new(_263.CylindricalGearSingleFlankRating))
        return value
