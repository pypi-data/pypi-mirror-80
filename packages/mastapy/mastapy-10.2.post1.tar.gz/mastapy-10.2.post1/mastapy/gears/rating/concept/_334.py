...
class ConceptGearMeshRating(_160.GearMeshRating):
    ...
    @property
    def concept_gear_mesh(self) -> '_912.ConceptGearMeshDesign':
        ...
        return constructor.new(_912.ConceptGearMeshDesign)(self.wrapped.ConceptGearMesh) if self.wrapped.ConceptGearMesh else None
