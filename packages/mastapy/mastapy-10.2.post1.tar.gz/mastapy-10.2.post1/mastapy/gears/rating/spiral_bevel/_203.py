...
class SpiralBevelGearRating(_339.BevelGearRating):
    ...
    @property
    def spiral_bevel_gear(self) -> '_733.SpiralBevelGearDesign':
        ...
        return constructor.new(_733.SpiralBevelGearDesign)(self.wrapped.SpiralBevelGear) if self.wrapped.SpiralBevelGear else None
