...
class SpiralBevelGearMeshRating(_338.BevelGearMeshRating):
    ...
    @property
    def spiral_bevel_gear_mesh(self) -> '_734.SpiralBevelGearMeshDesign':
        ...
        return constructor.new(_734.SpiralBevelGearMeshDesign)(self.wrapped.SpiralBevelGearMesh) if self.wrapped.SpiralBevelGearMesh else None
