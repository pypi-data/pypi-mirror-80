...
from mastapy.gears.rating.worm import _173, _174
...
class WormGearSetRating(_163.GearSetRating):
    '''WormGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_174.WormGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_174.WormGearRating))
        return value

    @property
    def worm_gear_ratings(self) -> 'List[_174.WormGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearRatings, constructor.new(_174.WormGearRating))
        return value
