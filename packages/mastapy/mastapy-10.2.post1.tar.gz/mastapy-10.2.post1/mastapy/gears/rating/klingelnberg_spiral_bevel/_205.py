...
from mastapy.gears.rating.klingelnberg_conical.kn3030 import _219
...
class KlingelnbergCycloPalloidSpiralBevelGearMeshRating(_211.KlingelnbergCycloPalloidConicalGearMeshRating):
    '''KlingelnbergCycloPalloidSpiralBevelGearMeshRating
    ...
    @property
    def kn3030_klingelnberg_mesh_single_flank_rating(self) -> '_219.KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating':
        ...
        return constructor.new(_219.KlingelnbergCycloPalloidSpiralBevelMeshSingleFlankRating)(self.wrapped.KN3030KlingelnbergMeshSingleFlankRating) if self.wrapped.KN3030KlingelnbergMeshSingleFlankRating else None

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_mesh(self) -> '_738.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign':
        ...
        return constructor.new(_738.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign)(self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearMesh) if self.wrapped.KlingelnbergCycloPalloidSpiralBevelGearMesh else None
