...
class GearSetOptimiser(_0.APIBase):
    ...
    def perform_strength_optimisation(self, number_of_results: 'int', use_current_design_as_starting_point: Optional['bool'] = False) -> '_131.GearSetOptimisationResults':
    ...
    def perform_strength_optimisation_with_progress(self, number_of_results: 'int', progress: '_6531.TaskProgress', use_current_design_as_starting_point: Optional['bool'] = False) -> '_131.GearSetOptimisationResults':
        ''' 'PerformStrengthOptimisation' is the original name of this method.
