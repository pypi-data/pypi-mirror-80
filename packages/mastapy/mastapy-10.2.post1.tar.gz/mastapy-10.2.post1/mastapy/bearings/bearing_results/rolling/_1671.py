...
from mastapy.bearings.bearing_results.rolling import _1670, _1657
...
class LoadedSphericalRollerThrustBearingRow(_1657.LoadedRollerBearingRow):
    '''LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1670.LoadedSphericalRollerThrustBearingResults':
        ...
        return constructor.new(_1670.LoadedSphericalRollerThrustBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
