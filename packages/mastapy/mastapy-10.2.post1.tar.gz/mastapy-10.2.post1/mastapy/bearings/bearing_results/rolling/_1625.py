...
from mastapy.bearings.bearing_results.rolling import _1624, _1622
...
class LoadedAxialThrustNeedleRollerBearingRow(_1622.LoadedAxialThrustCylindricalRollerBearingRow):
    '''LoadedAxialThrustNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1624.LoadedAxialThrustNeedleRollerBearingResults':
        ...
        return constructor.new(_1624.LoadedAxialThrustNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
