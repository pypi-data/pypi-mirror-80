...
from mastapy.bearings.bearing_results.rolling import _1667, _1657
...
class LoadedSphericalRollerRadialBearingRow(_1657.LoadedRollerBearingRow):
    '''LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1667.LoadedSphericalRollerRadialBearingResults':
        ...
        return constructor.new(_1667.LoadedSphericalRollerRadialBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
