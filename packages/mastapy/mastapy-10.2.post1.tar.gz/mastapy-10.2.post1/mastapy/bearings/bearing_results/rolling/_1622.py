...
from mastapy.bearings.bearing_results.rolling import _1621, _1624, _1652
...
class LoadedAxialThrustCylindricalRollerBearingRow(_1652.LoadedNonBarrelRollerBearingRow):
    '''LoadedAxialThrustCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1621.LoadedAxialThrustCylindricalRollerBearingResults':
