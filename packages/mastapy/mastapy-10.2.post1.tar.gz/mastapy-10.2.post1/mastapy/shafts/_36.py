...
class ShaftSectionEndDamageResults(_0.APIBase):
    ...
    @property
    def section_end(self) -> '_1392.SectionEnd':
        ...
        return constructor.new(_1392.SectionEnd)(value) if value else None
    ...
    def sn_curve(self) -> '_84.SNCurve':
        ...
        return constructor.new(_84.SNCurve)(self.wrapped.SNCurve) if self.wrapped.SNCurve else None
    ...
    @property
    def sn_curve_axial(self) -> '_84.SNCurve':
        ...
        return constructor.new(_84.SNCurve)(self.wrapped.SNCurveAxial) if self.wrapped.SNCurveAxial else None

    @property
    def sn_curve_bending_x(self) -> '_84.SNCurve':
        ...
        return constructor.new(_84.SNCurve)(self.wrapped.SNCurveBendingX) if self.wrapped.SNCurveBendingX else None

    @property
    def sn_curve_bending_y(self) -> '_84.SNCurve':
        ...
        return constructor.new(_84.SNCurve)(self.wrapped.SNCurveBendingY) if self.wrapped.SNCurveBendingY else None

    @property
    def sn_curve_torsional(self) -> '_84.SNCurve':
        ...
        return constructor.new(_84.SNCurve)(self.wrapped.SNCurveTorsional) if self.wrapped.SNCurveTorsional else None
