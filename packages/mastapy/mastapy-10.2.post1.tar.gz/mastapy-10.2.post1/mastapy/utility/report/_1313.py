...
from mastapy.utility.report import _1312, _1305
...
class UserTextRow(_1305.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1312.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1312.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1312.HeadingSize'):
