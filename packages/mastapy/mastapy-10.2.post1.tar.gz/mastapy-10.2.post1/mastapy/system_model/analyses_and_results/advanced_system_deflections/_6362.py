...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6301
...
class SpringDamperConnectionAdvancedSystemDeflection(_6301.CouplingConnectionAdvancedSystemDeflection):
    '''SpringDamperConnectionAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6210.SpringDamperConnectionLoadCase':
        ...
        return constructor.new(_6210.SpringDamperConnectionLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None

    @property
    def connection_system_deflection_results(self) -> 'List[_2338.SpringDamperConnectionSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2338.SpringDamperConnectionSystemDeflection))
        return value
