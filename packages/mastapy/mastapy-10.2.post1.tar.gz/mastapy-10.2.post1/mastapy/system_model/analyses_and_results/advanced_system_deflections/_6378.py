...
class TorqueConverterPumpAdvancedSystemDeflection(_6302.CouplingHalfAdvancedSystemDeflection):
    '''TorqueConverterPumpAdvancedSystemDeflection
    ...
    @property
    def component_load_case(self) -> '_6230.TorqueConverterPumpLoadCase':
        ...
        return constructor.new(_6230.TorqueConverterPumpLoadCase)(self.wrapped.ComponentLoadCase) if self.wrapped.ComponentLoadCase else None

    @property
    def component_system_deflection_results(self) -> 'List[_2357.TorqueConverterPumpSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentSystemDeflectionResults, constructor.new(_2357.TorqueConverterPumpSystemDeflection))
        return value
