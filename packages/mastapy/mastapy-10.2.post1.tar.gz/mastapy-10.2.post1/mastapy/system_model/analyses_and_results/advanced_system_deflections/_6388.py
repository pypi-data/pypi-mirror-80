...
class ZerolBevelGearMeshAdvancedSystemDeflection(_6279.BevelGearMeshAdvancedSystemDeflection):
    '''ZerolBevelGearMeshAdvancedSystemDeflection
    ...
    @property
    def connection_load_case(self) -> '_6242.ZerolBevelGearMeshLoadCase':
        ...
        return constructor.new(_6242.ZerolBevelGearMeshLoadCase)(self.wrapped.ConnectionLoadCase) if self.wrapped.ConnectionLoadCase else None
    ...
    @property
    def connection_system_deflection_results(self) -> 'List[_2367.ZerolBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionSystemDeflectionResults, constructor.new(_2367.ZerolBevelGearMeshSystemDeflection))
        return value
