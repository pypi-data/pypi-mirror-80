...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4111, _4110, _4045
...
class WormGearSetModalAnalysesAtSpeeds(_4045.GearSetModalAnalysesAtSpeeds):
    '''WormGearSetModalAnalysesAtSpeeds
    ...
    @property
    def worm_gears_modal_analyses_at_speeds(self) -> 'List[_4111.WormGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsModalAnalysesAtSpeeds, constructor.new(_4111.WormGearModalAnalysesAtSpeeds))
        return value

    @property
    def worm_meshes_modal_analyses_at_speeds(self) -> 'List[_4110.WormGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesModalAnalysesAtSpeeds, constructor.new(_4110.WormGearMeshModalAnalysesAtSpeeds))
        return value
