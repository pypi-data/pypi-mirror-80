...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4114, _4113, _4007
...
class ZerolBevelGearSetModalAnalysesAtSpeeds(_4007.BevelGearSetModalAnalysesAtSpeeds):
    '''ZerolBevelGearSetModalAnalysesAtSpeeds
    ...
    @property
    def zerol_bevel_gears_modal_analyses_at_speeds(self) -> 'List[_4114.ZerolBevelGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysesAtSpeeds, constructor.new(_4114.ZerolBevelGearModalAnalysesAtSpeeds))
        return value

    @property
    def zerol_bevel_meshes_modal_analyses_at_speeds(self) -> 'List[_4113.ZerolBevelGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysesAtSpeeds, constructor.new(_4113.ZerolBevelGearMeshModalAnalysesAtSpeeds))
        return value
