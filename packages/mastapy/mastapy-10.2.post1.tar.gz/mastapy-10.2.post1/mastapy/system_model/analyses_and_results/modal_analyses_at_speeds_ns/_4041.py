...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4040, _4039, _4045
...
class FaceGearSetModalAnalysesAtSpeeds(_4045.GearSetModalAnalysesAtSpeeds):
    '''FaceGearSetModalAnalysesAtSpeeds
    ...
    @property
    def face_gears_modal_analyses_at_speeds(self) -> 'List[_4040.FaceGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysesAtSpeeds, constructor.new(_4040.FaceGearModalAnalysesAtSpeeds))
        return value

    @property
    def face_meshes_modal_analyses_at_speeds(self) -> 'List[_4039.FaceGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysesAtSpeeds, constructor.new(_4039.FaceGearMeshModalAnalysesAtSpeeds))
        return value
