...
class FlexiblePinAssemblyCompoundModalAnalysesAtStiffnesses(_3960.SpecialisedAssemblyCompoundModalAnalysesAtStiffnesses):
    '''FlexiblePinAssemblyCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def component_design(self) -> '_2017.FlexiblePinAssembly':
        ...
        return constructor.new(_2017.FlexiblePinAssembly)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3797.FlexiblePinAssemblyModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3797.FlexiblePinAssemblyModalAnalysesAtStiffnesses))
        return value

    @property
    def assembly_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3797.FlexiblePinAssemblyModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblyModalAnalysesAtStiffnessesLoadCases, constructor.new(_3797.FlexiblePinAssemblyModalAnalysesAtStiffnesses))
        return value
