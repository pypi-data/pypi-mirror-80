...
class ZerolBevelGearMeshCompoundModalAnalysesAtStiffnesses(_3885.BevelGearMeshCompoundModalAnalysesAtStiffnesses):
    '''ZerolBevelGearMeshCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def component_design(self) -> '_1911.ZerolBevelGearMesh':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3867.ZerolBevelGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3867.ZerolBevelGearMeshModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3867.ZerolBevelGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_3867.ZerolBevelGearMeshModalAnalysesAtStiffnesses))
        return value
