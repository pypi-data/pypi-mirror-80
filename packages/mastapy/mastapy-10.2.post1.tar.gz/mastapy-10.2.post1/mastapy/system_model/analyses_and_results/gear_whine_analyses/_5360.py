...
class KlingelnbergCycloPalloidConicalGearGearWhineAnalysis(_5309.ConicalGearGearWhineAnalysis):
    '''KlingelnbergCycloPalloidConicalGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2097.KlingelnbergCycloPalloidConicalGear':
    ...
    @property
    def system_deflection_results(self) -> '_2301.KlingelnbergCycloPalloidConicalGearSystemDeflection':
