...
class CVTPulleyGearWhineAnalysis(_5383.PulleyGearWhineAnalysis):
    '''CVTPulleyGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2271.CVTPulleySystemDeflection':
        ...
        return constructor.new(_2271.CVTPulleySystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
