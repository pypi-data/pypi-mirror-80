...
class CouplingConnectionGearWhineAnalysis(_5359.InterMountableComponentConnectionGearWhineAnalysis):
    '''CouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2267.CouplingConnectionSystemDeflection':
