...
class WormGearGearWhineAnalysis(_5343.GearGearWhineAnalysis):
    '''WormGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2366.WormGearSystemDeflection':
        ...
        return constructor.new(_2366.WormGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
