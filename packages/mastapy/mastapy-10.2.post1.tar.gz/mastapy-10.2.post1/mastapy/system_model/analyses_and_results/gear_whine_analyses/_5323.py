...
class CylindricalPlanetGearGearWhineAnalysis(_5320.CylindricalGearGearWhineAnalysis):
    '''CylindricalPlanetGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2282.CylindricalPlanetGearSystemDeflection':
        ...
        return constructor.new(_2282.CylindricalPlanetGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
