...
class ConnectionSingleMeshWhineAnalysis(_6517.ConnectionStaticLoadAnalysisCase):
    '''ConnectionSingleMeshWhineAnalysis
    ...
    @property
    def single_mesh_whine_analysis(self) -> '_5528.SingleMeshWhineAnalysis':
        ...
        return constructor.new(_5528.SingleMeshWhineAnalysis)(self.wrapped.SingleMeshWhineAnalysis) if self.wrapped.SingleMeshWhineAnalysis else None
