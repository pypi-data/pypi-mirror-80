...
class KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis(_5360.KlingelnbergCycloPalloidConicalGearGearWhineAnalysis):
    '''KlingelnbergCycloPalloidSpiralBevelGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2307.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2307.KlingelnbergCycloPalloidSpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
