...
class ConceptGearMeshGearWhineAnalysis(_5345.GearMeshGearWhineAnalysis):
    '''ConceptGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2258.ConceptGearMeshSystemDeflection':
        ...
        return constructor.new(_2258.ConceptGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
