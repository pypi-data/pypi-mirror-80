...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5350, _5279
...
class ImportedFEComponentGearWhineAnalysis(_5279.AbstractShaftOrHousingGearWhineAnalysis):
    '''ImportedFEComponentGearWhineAnalysis
    ...
    @property
    def coupled_modal_analysis(self) -> '_4784.ImportedFEComponentModalAnalysis':
        ...
        return constructor.new(_4784.ImportedFEComponentModalAnalysis)(self.wrapped.CoupledModalAnalysis) if self.wrapped.CoupledModalAnalysis else None

    @property
    def export(self) -> '_5350.GearWhineAnalysisFEExportOptions':
        ...
        return constructor.new(_5350.GearWhineAnalysisFEExportOptions)(self.wrapped.Export) if self.wrapped.Export else None
    ...
    @property
    def system_deflection_results(self) -> '_2297.ImportedFEComponentSystemDeflection':
        ...
        return constructor.new(_2297.ImportedFEComponentSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
