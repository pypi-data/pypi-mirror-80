...
class CylindricalGearSystemDeflectionWithLTCAResults(_2279.CylindricalGearSystemDeflection):
    '''CylindricalGearSystemDeflectionWithLTCAResults
    ...
    @property
    def cylindrical_gear_ltca_results(self) -> '_628.CylindricalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_628.CylindricalGearLoadDistributionAnalysis)(self.wrapped.CylindricalGearLTCAResults) if self.wrapped.CylindricalGearLTCAResults else None
