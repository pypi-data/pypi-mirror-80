...
class CylindricalGearSetSystemDeflectionWithLTCAResults(_2276.CylindricalGearSetSystemDeflection):
    '''CylindricalGearSetSystemDeflectionWithLTCAResults
    ...
    @property
    def basic_ltca_results(self) -> '_632.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _632.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.BasicLTCAResults.__class__.__mro__:
    ...
    @property
    def basic_ltca_results_only_first_planetary_mesh(self) -> '_632.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _632.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.BasicLTCAResultsOnlyFirstPlanetaryMesh.__class__.__mro__:
    ...
    @property
    def advanced_ltca_results(self) -> '_632.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _632.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.AdvancedLTCAResults.__class__.__mro__:
    ...
    @property
    def advanced_ltca_results_only_first_planetary_mesh(self) -> '_632.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _632.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.AdvancedLTCAResultsOnlyFirstPlanetaryMesh.__class__.__mro__:
