...
from mastapy.math_utility.measured_vectors import _1123, _1118
...
class ImportedFEComponentSystemDeflection(_2231.AbstractShaftOrHousingSystemDeflection):
    '''ImportedFEComponentSystemDeflection
    ...
    @property
    def stiffness_in_world_coordinate_system_mn_rad(self) -> '_1388.NodalMatrix':
        ...
        return constructor.new(_1388.NodalMatrix)(self.wrapped.StiffnessInWorldCoordinateSystemMNRad) if self.wrapped.StiffnessInWorldCoordinateSystemMNRad else None

    @property
    def mass_in_world_coordinate_system_mn_rad_s_kg(self) -> '_1388.NodalMatrix':
        ...
        return constructor.new(_1388.NodalMatrix)(self.wrapped.MassInWorldCoordinateSystemMNRadSKg) if self.wrapped.MassInWorldCoordinateSystemMNRadSKg else None
    ...
    @property
    def applied_internal_forces_in_world_coordinate_system(self) -> 'List[_1123.VectorWithLinearAndAngularComponents]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AppliedInternalForcesInWorldCoordinateSystem, constructor.new(_1123.VectorWithLinearAndAngularComponents))
        return value

    @property
    def node_results_in_shaft_coordinate_system(self) -> 'List[_1118.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeResultsInShaftCoordinateSystem, constructor.new(_1118.ForceAndDisplacementResults))
        return value
