...
from mastapy.system_model.analyses_and_results.system_deflections import _2288, _2286, _2291
...
class FaceGearSetSystemDeflection(_2291.GearSetSystemDeflection):
    '''FaceGearSetSystemDeflection
    ...
    @property
    def face_gears_system_deflection(self) -> 'List[_2288.FaceGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsSystemDeflection, constructor.new(_2288.FaceGearSystemDeflection))
        return value

    @property
    def face_meshes_system_deflection(self) -> 'List[_2286.FaceGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesSystemDeflection, constructor.new(_2286.FaceGearMeshSystemDeflection))
        return value
