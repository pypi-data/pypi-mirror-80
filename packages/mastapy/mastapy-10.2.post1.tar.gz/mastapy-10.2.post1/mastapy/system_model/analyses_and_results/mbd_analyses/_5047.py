...
class GearMultiBodyDynamicsAnalysis(_5073.MountableComponentMultiBodyDynamicsAnalysis):
    '''GearMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_gear_torque(self) -> 'List[_5133.DynamicTorqueResultAtTime]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PeakGearTorque, constructor.new(_5133.DynamicTorqueResultAtTime))
        return value
