...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5074, _4997
...
class RootAssemblyMultiBodyDynamicsAnalysis(_4997.AssemblyMultiBodyDynamicsAnalysis):
    '''RootAssemblyMultiBodyDynamicsAnalysis
    ...
    @property
    def multi_body_dynamics_analysis_inputs(self) -> '_5074.MultiBodyDynamicsAnalysis':
        ...
        return constructor.new(_5074.MultiBodyDynamicsAnalysis)(self.wrapped.MultiBodyDynamicsAnalysisInputs) if self.wrapped.MultiBodyDynamicsAnalysisInputs else None
