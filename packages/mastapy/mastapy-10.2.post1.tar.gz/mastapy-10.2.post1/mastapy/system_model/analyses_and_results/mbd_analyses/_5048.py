...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5047, _5045, _5096
...
class GearSetMultiBodyDynamicsAnalysis(_5096.SpecialisedAssemblyMultiBodyDynamicsAnalysis):
    '''GearSetMultiBodyDynamicsAnalysis
    ...
    @property
    def gears(self) -> 'List[_5047.GearMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_5047.GearMultiBodyDynamicsAnalysis))
        return value

    @property
    def meshes(self) -> 'List[_5045.GearMeshMultiBodyDynamicsAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_5045.GearMeshMultiBodyDynamicsAnalysis))
        return value
