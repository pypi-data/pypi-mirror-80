...
from mastapy.system_model.analyses_and_results.parametric_study_tools.compound import _3666, _3667, _3678
...
class CylindricalGearSetCompoundParametricStudyTool(_3678.GearSetCompoundParametricStudyTool):
    '''CylindricalGearSetCompoundParametricStudyTool
    ...
    @property
    def cylindrical_gears_compound_parametric_study_tool(self) -> 'List[_3666.CylindricalGearCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalGearsCompoundParametricStudyTool, constructor.new(_3666.CylindricalGearCompoundParametricStudyTool))
        return value

    @property
    def cylindrical_meshes_compound_parametric_study_tool(self) -> 'List[_3667.CylindricalGearMeshCompoundParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CylindricalMeshesCompoundParametricStudyTool, constructor.new(_3667.CylindricalGearMeshCompoundParametricStudyTool))
        return value
