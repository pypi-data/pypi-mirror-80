...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3568, _3565
...
class ParametricStudyVariable(_2200.AnalysisCaseVariable):
    '''ParametricStudyVariable
    ...
    @property
    def dimension(self) -> '_3568.ParametricStudyDimension':
        ...
        return constructor.new(_3568.ParametricStudyDimension)(value) if value else None

    @dimension.setter
    def dimension(self, value: '_3568.ParametricStudyDimension'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.Dimension = value

    @property
    def distribution(self) -> '_3565.MonteCarloDistribution':
        ...
        return constructor.new(_3565.MonteCarloDistribution)(value) if value else None

    @distribution.setter
    def distribution(self, value: '_3565.MonteCarloDistribution'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
