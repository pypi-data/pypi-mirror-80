...
from mastapy.system_model.analyses_and_results.static_loads import _6132, _6138
...
T = TypeVar('T', bound='_6138.ElectricMachineHarmonicLoadImportOptionsBase')


class ElectricMachineHarmonicLoadDataFromMotorPackages(_6132.ElectricMachineHarmonicLoadData, Generic[T]):
    '''ElectricMachineHarmonicLoadDataFromMotorPackages
