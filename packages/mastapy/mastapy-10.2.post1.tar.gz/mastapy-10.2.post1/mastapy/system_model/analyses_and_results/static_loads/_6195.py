...
from mastapy.system_model import _1823, _1824, _1825
from mastapy.system_model.analyses_and_results.mbd_analyses import _5123
from mastapy.system_model.analyses_and_results.static_loads import _6233, _6132, _6237
from mastapy.system_model.imported_fes import _1944
from mastapy.system_model.part_model import _2035
from mastapy.math_utility.control import _1129
from mastapy.nodal_analysis.varying_input_components import _1404
...
class PowerLoadLoadCase(_6237.VirtualComponentLoadCase):
    '''PowerLoadLoadCase
    ...
    @property
    def drag_torque_specification_method(self) -> '_1823.PowerLoadDragTorqueSpecificationMethod':
        ...
        return constructor.new(_1823.PowerLoadDragTorqueSpecificationMethod)(value) if value else None

    @drag_torque_specification_method.setter
    def drag_torque_specification_method(self, value: '_1823.PowerLoadDragTorqueSpecificationMethod'):
    ...
    @property
    def wheel_slip_model(self) -> '_5123.WheelSlipType':
        ...
        return constructor.new(_5123.WheelSlipType)(value) if value else None

    @wheel_slip_model.setter
    def wheel_slip_model(self, value: '_5123.WheelSlipType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def target_speed_input_type(self) -> '_1825.PowerLoadPIDControlSpeedInputType':
        ...
        return constructor.new(_1825.PowerLoadPIDControlSpeedInputType)(value) if value else None

    @target_speed_input_type.setter
    def target_speed_input_type(self, value: '_1825.PowerLoadPIDControlSpeedInputType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def engine_idle_speed_control_pid_settings(self) -> '_1129.PIDControlSettings':
        ...
        return constructor.new(_1129.PIDControlSettings)(self.wrapped.EngineIdleSpeedControlPIDSettings) if self.wrapped.EngineIdleSpeedControlPIDSettings else None

    @property
    def coefficient_of_friction_with_ground(self) -> '_1404.NonDimensionalInputComponent':
        ...
        return constructor.new(_1404.NonDimensionalInputComponent)(self.wrapped.CoefficientOfFrictionWithGround) if self.wrapped.CoefficientOfFrictionWithGround else None

    @property
    def pid_control_settings(self) -> '_1129.PIDControlSettings':
        ...
        return constructor.new(_1129.PIDControlSettings)(self.wrapped.PIDControlSettings) if self.wrapped.PIDControlSettings else None

    def get_harmonic_load_data_for_import(self) -> '_6132.ElectricMachineHarmonicLoadData':
