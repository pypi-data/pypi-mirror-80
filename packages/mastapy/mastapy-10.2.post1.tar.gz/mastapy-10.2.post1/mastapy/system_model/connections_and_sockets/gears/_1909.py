...
class WormGearMesh(_1893.GearMesh):
    '''WormGearMesh
    ...
    @property
    def worm_gear_mesh_design(self) -> '_722.WormGearMeshDesign':
        ...
        return constructor.new(_722.WormGearMeshDesign)(self.wrapped.WormGearMeshDesign) if self.wrapped.WormGearMeshDesign else None
