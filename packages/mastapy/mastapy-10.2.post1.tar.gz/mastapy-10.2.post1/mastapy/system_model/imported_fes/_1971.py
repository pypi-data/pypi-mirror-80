...
class ImportedFEWithSelectionForHarmonicAnalysis(_1969.ImportedFEWithSelection):
    '''ImportedFEWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self) -> '_1463.FEModelHarmonicAnalysisDrawStyle':
        ...
        return constructor.new(_1463.FEModelHarmonicAnalysisDrawStyle)(self.wrapped.HarmonicDrawStyle) if self.wrapped.HarmonicDrawStyle else None
