...
from mastapy.system_model.imported_fes import _1929, _1935
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self) -> '_1929.AlignmentMethodForRaceBearing':
        ...
        return constructor.new(_1929.AlignmentMethodForRaceBearing)(value) if value else None

    @alignment_method.setter
    def alignment_method(self, value: '_1929.AlignmentMethodForRaceBearing'):
    ...
    @property
    def links(self) -> 'List[_1935.BearingRaceNodeLink]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1935.BearingRaceNodeLink))
        return value
