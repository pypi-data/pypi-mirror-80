...
from mastapy.system_model.part_model.couplings import _2161, _2159
...
class Synchroniser(_2039.SpecialisedAssembly):
    '''Synchroniser
    ...
    @property
    def hub_and_sleeve(self) -> '_2161.SynchroniserSleeve':
        ...
        return constructor.new(_2161.SynchroniserSleeve)(self.wrapped.HubAndSleeve) if self.wrapped.HubAndSleeve else None

    @property
    def left_cone(self) -> '_2159.SynchroniserHalf':
        ...
        return constructor.new(_2159.SynchroniserHalf)(self.wrapped.LeftCone) if self.wrapped.LeftCone else None

    @property
    def right_cone(self) -> '_2159.SynchroniserHalf':
        ...
        return constructor.new(_2159.SynchroniserHalf)(self.wrapped.RightCone) if self.wrapped.RightCone else None

    @property
    def clutch_connection_left(self) -> '_1913.ClutchConnection':
        ...
        return constructor.new(_1913.ClutchConnection)(self.wrapped.ClutchConnectionLeft) if self.wrapped.ClutchConnectionLeft else None

    @property
    def clutch_connection_right(self) -> '_1913.ClutchConnection':
        ...
        return constructor.new(_1913.ClutchConnection)(self.wrapped.ClutchConnectionRight) if self.wrapped.ClutchConnectionRight else None
