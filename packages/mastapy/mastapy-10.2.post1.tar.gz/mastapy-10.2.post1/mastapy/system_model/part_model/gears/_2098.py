...
class KlingelnbergCycloPalloidConicalGearSet(_2085.ConicalGearSet):
    '''KlingelnbergCycloPalloidConicalGearSet
    ...
    @property
    def conical_gear_set_design(self) -> '_747.KlingelnbergConicalGearSetDesign':
    ...
    @property
    def klingelnberg_conical_gear_set_design(self) -> '_747.KlingelnbergConicalGearSetDesign':
        ...
        if _747.KlingelnbergConicalGearSetDesign.TYPE not in self.wrapped.KlingelnbergConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def klingelnberg_conical_gear_set_design_of_type_klingelnberg_cyclo_palloid_spiral_bevel_gear_set_design(self) -> '_739.KlingelnbergCycloPalloidSpiralBevelGearSetDesign':
        ...
        if _739.KlingelnbergCycloPalloidSpiralBevelGearSetDesign.TYPE not in self.wrapped.KlingelnbergConicalGearSetDesign.__class__.__mro__:
    ...
    @property
    def klingelnberg_conical_gear_set_design_of_type_klingelnberg_cyclo_palloid_hypoid_gear_set_design(self) -> '_743.KlingelnbergCycloPalloidHypoidGearSetDesign':
        ...
        if _743.KlingelnbergCycloPalloidHypoidGearSetDesign.TYPE not in self.wrapped.KlingelnbergConicalGearSetDesign.__class__.__mro__:
