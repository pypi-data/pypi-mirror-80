...
class WormGear(_2091.Gear):
    ...
    @property
    def active_gear_design(self) -> '_721.WormGearDesign':
    ...
    @property
    def worm_gear_design(self) -> '_721.WormGearDesign':
        ...
        if _721.WormGearDesign.TYPE not in self.wrapped.WormGearDesign.__class__.__mro__:
