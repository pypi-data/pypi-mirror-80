...
from mastapy.nodal_analysis import _1399
...
class TransientSolver(_1413.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_1399.TransientSolverStatus':
        ...
        return constructor.new(_1399.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_1399.TransientSolverStatus'):
