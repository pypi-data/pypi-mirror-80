...
class WormGearMeshRating(_160.GearMeshRating):
    '''WormGearMeshRating
    ...
    @property
    def worm_gear_mesh(self) -> '_722.WormGearMeshDesign':
        ...
        return constructor.new(_722.WormGearMeshDesign)(self.wrapped.WormGearMesh) if self.wrapped.WormGearMesh else None
