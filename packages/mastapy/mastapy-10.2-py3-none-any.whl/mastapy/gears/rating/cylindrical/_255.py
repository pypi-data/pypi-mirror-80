...
class CylindricalGearMeshRating(_160.GearMeshRating):
    ...
    @property
    def cylindrical_gear_mesh(self) -> '_780.CylindricalGearMeshDesign':
        ...
        return constructor.new(_780.CylindricalGearMeshDesign)(self.wrapped.CylindricalGearMesh) if self.wrapped.CylindricalGearMesh else None
