...
from mastapy.gears.rating import _159, _161
from mastapy.gears.rating.cylindrical import _253, _254, _280
...
class CylindricalGearRating(_161.GearRating):
    '''CylindricalGearRating
    ...
    @property
    def left_flank_rating(self) -> '_159.GearFlankRating':
        ...
        if _159.GearFlankRating.TYPE not in self.wrapped.LeftFlankRating.__class__.__mro__:
    ...
    @property
    def right_flank_rating(self) -> '_159.GearFlankRating':
        ...
        if _159.GearFlankRating.TYPE not in self.wrapped.RightFlankRating.__class__.__mro__:
    ...
    @property
    def vdi2737_safety_factor(self) -> '_280.VDI2737SafetyFactorReportingObject':
        ...
        return constructor.new(_280.VDI2737SafetyFactorReportingObject)(self.wrapped.VDI2737SafetyFactor) if self.wrapped.VDI2737SafetyFactor else None
