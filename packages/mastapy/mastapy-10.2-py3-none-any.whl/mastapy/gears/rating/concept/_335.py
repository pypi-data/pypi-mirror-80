...
class ConceptGearRating(_161.GearRating):
    '''ConceptGearRating
    ...
    @property
    def concave_flank_rating(self) -> '_159.GearFlankRating':
        ...
        if _159.GearFlankRating.TYPE not in self.wrapped.ConcaveFlankRating.__class__.__mro__:
    ...
    @property
    def convex_flank_rating(self) -> '_159.GearFlankRating':
        ...
        if _159.GearFlankRating.TYPE not in self.wrapped.ConvexFlankRating.__class__.__mro__:
    ...
    @property
    def concept_gear(self) -> '_911.ConceptGearDesign':
        ...
        return constructor.new(_911.ConceptGearDesign)(self.wrapped.ConceptGear) if self.wrapped.ConceptGear else None
