...
from mastapy.gears.rating import _154, _153
...
class AbstractGearSetRating(_949.AbstractGearSetAnalysis):
    '''AbstractGearSetRating
    ...
    @property
    def gear_ratings(self) -> 'List[_154.AbstractGearRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearRatings, constructor.new(_154.AbstractGearRating))
        return value

    @property
    def gear_mesh_ratings(self) -> 'List[_153.AbstractGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.GearMeshRatings, constructor.new(_153.AbstractGearMeshRating))
        return value
