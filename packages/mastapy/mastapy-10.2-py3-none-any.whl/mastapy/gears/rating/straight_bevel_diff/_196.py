...
class StraightBevelDiffGearRating(_324.ConicalGearRating):
    ...
    @property
    def straight_bevel_diff_gear(self) -> '_725.StraightBevelDiffGearDesign':
        ...
        return constructor.new(_725.StraightBevelDiffGearDesign)(self.wrapped.StraightBevelDiffGear) if self.wrapped.StraightBevelDiffGear else None
