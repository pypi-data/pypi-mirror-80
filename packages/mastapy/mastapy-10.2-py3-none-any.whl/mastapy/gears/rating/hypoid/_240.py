...
from mastapy.gears.rating.hypoid import _238, _239
...
class HypoidGearSetRating(_351.AGMAGleasonConicalGearSetRating):
    ...
    @property
    def hypoid_gear_set(self) -> '_751.HypoidGearSetDesign':
        ...
        return constructor.new(_751.HypoidGearSetDesign)(self.wrapped.HypoidGearSet) if self.wrapped.HypoidGearSet else None

    @property
    def hypoid_mesh_ratings(self) -> 'List[_238.HypoidGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshRatings, constructor.new(_238.HypoidGearMeshRating))
        return value
