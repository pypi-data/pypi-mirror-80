...
from mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics import _545, _544, _548
from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _487
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    @property
    def accuracy_level_iso6(self) -> '_545.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_545.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO6) if self.wrapped.AccuracyLevelISO6 else None

    @property
    def accuracy_level_iso7(self) -> '_545.RollAngleRangeRelativeToAccuracy':
        ...
        return constructor.new(_545.RollAngleRangeRelativeToAccuracy)(self.wrapped.AccuracyLevelISO7) if self.wrapped.AccuracyLevelISO7 else None

    @property
    def designed_gear(self) -> '_487.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_487.CylindricalCutterSimulatableGear)(self.wrapped.DesignedGear) if self.wrapped.DesignedGear else None
    ...
    @property
    def life_shaver(self) -> '_516.CylindricalGearShaver':
        ...
        if _516.CylindricalGearShaver.TYPE not in self.wrapped.LifeShaver.__class__.__mro__:
    ...
    @property
    def new_cutter_start_of_shaving(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.NewCutterStartOfShaving) if self.wrapped.NewCutterStartOfShaving else None

    @property
    def life_cutter_start_of_shaving(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.LifeCutterStartOfShaving) if self.wrapped.LifeCutterStartOfShaving else None
