...
from mastapy.gears.manufacturing.cylindrical.cutters import _505, _507
...
class CylindricalGearRealCutterDesign(_507.CylindricalGearAbstractCutterDesign):
    '''CylindricalGearRealCutterDesign
    ...
    @property
    def nominal_cutter_drawing(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.NominalCutterDrawing) if self.wrapped.NominalCutterDrawing else None
    ...
    @property
    def nominal_cutter_shape(self) -> '_524.CutterShapeDefinition':
        ...
        if _524.CutterShapeDefinition.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_formed_wheel_grinder_tangible(self) -> '_525.CylindricalGearFormedWheelGrinderTangible':
        ...
        if _525.CylindricalGearFormedWheelGrinderTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_hob_shape(self) -> '_526.CylindricalGearHobShape':
        ...
        if _526.CylindricalGearHobShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaper_tangible(self) -> '_527.CylindricalGearShaperTangible':
        ...
        if _527.CylindricalGearShaperTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_shaver_tangible(self) -> '_528.CylindricalGearShaverTangible':
        ...
        if _528.CylindricalGearShaverTangible.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_cylindrical_gear_worm_grinder_shape(self) -> '_529.CylindricalGearWormGrinderShape':
        ...
        if _529.CylindricalGearWormGrinderShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def nominal_cutter_shape_of_type_rack_shape(self) -> '_531.RackShape':
        ...
        if _531.RackShape.TYPE not in self.wrapped.NominalCutterShape.__class__.__mro__:
    ...
    @property
    def customised_cutting_edge_profile(self) -> '_505.CustomisableEdgeProfile':
        ...
        return constructor.new(_505.CustomisableEdgeProfile)(self.wrapped.CustomisedCuttingEdgeProfile) if self.wrapped.CustomisedCuttingEdgeProfile else None
