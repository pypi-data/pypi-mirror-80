...
from mastapy.gears.gear_designs.cylindrical import _835, _799, _834
...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    def shaver_hand(self) -> '_133.Hand':
    ...
    @shaver_hand.setter
    def shaver_hand(self, value: '_133.Hand'):
    ...
    @property
    def input_gear_geometry(self) -> '_487.CylindricalCutterSimulatableGear':
        ...
        return constructor.new(_487.CylindricalCutterSimulatableGear)(self.wrapped.InputGearGeometry) if self.wrapped.InputGearGeometry else None

    @property
    def tooth_thickness(self) -> '_835.ToothThicknessSpecificationBase':
        ...
        if _835.ToothThicknessSpecificationBase.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_finish_tooth_thickness_design_specification(self) -> '_799.FinishToothThicknessDesignSpecification':
        ...
        if _799.FinishToothThicknessDesignSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
    ...
    @property
    def tooth_thickness_of_type_tooth_thickness_specification(self) -> '_834.ToothThicknessSpecification':
        ...
        if _834.ToothThicknessSpecification.TYPE not in self.wrapped.ToothThickness.__class__.__mro__:
