...
from mastapy.gears.gear_set_pareto_optimiser import _673, _684
...
class MicroGeometryDesignSpaceSearch(_673.DesignSpaceSearchBase['_632.CylindricalGearSetLoadDistributionAnalysis', '_684.MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearch
    ...
    @property
    def load_case_duty_cycle(self) -> '_632.CylindricalGearSetLoadDistributionAnalysis':
        ...
        if _632.CylindricalGearSetLoadDistributionAnalysis.TYPE not in self.wrapped.LoadCaseDutyCycle.__class__.__mro__:
    ...
    @property
    def selected_candidate_micro_geometry(self) -> '_852.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_852.CylindricalGearSetMicroGeometry)(self.wrapped.SelectedCandidateMicroGeometry) if self.wrapped.SelectedCandidateMicroGeometry else None

    @property
    def candidate_gear_sets(self) -> 'List[_852.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CandidateGearSets, constructor.new(_852.CylindricalGearSetMicroGeometry))
        return value

    @property
    def all_candidate_gear_sets(self) -> 'List[_852.CylindricalGearSetMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllCandidateGearSets, constructor.new(_852.CylindricalGearSetMicroGeometry))
        return value
