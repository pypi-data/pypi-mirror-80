...
from mastapy.gears.gear_designs.face import _759, _753
...
class FaceGearMeshDesign(_713.GearMeshDesign):
    '''FaceGearMeshDesign
    ...
    @property
    def face_gear_set(self) -> '_759.FaceGearSetDesign':
        ...
        return constructor.new(_759.FaceGearSetDesign)(self.wrapped.FaceGearSet) if self.wrapped.FaceGearSet else None
