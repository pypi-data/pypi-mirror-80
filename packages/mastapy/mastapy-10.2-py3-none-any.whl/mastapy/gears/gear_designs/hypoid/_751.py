...
from mastapy.gears.gear_designs.hypoid import _749, _750
...
class HypoidGearSetDesign(_930.AGMAGleasonConicalGearSetDesign):
    '''HypoidGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_749.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_749.HypoidGearDesign))
        return value

    @property
    def hypoid_gears(self) -> 'List[_749.HypoidGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGears, constructor.new(_749.HypoidGearDesign))
        return value

    @property
    def meshes(self) -> 'List[_750.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_750.HypoidGearMeshDesign))
        return value

    @property
    def hypoid_meshes(self) -> 'List[_750.HypoidGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshes, constructor.new(_750.HypoidGearMeshDesign))
        return value
