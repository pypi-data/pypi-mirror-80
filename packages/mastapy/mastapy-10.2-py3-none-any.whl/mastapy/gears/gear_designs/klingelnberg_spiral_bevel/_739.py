...
from mastapy.gears.gear_designs.klingelnberg_spiral_bevel import _737, _738
...
class KlingelnbergCycloPalloidSpiralBevelGearSetDesign(_747.KlingelnbergConicalGearSetDesign):
    '''KlingelnbergCycloPalloidSpiralBevelGearSetDesign
    ...
    @property
    def gears(self) -> 'List[_737.KlingelnbergCycloPalloidSpiralBevelGearDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Gears, constructor.new(_737.KlingelnbergCycloPalloidSpiralBevelGearDesign))
        return value
    ...
    @property
    def klingelnberg_conical_meshes(self) -> 'List[_738.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergConicalMeshes, constructor.new(_738.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign))
        return value

    @property
    def klingelnberg_cyclo_palloid_spiral_bevel_meshes(self) -> 'List[_738.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.KlingelnbergCycloPalloidSpiralBevelMeshes, constructor.new(_738.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign))
        return value
