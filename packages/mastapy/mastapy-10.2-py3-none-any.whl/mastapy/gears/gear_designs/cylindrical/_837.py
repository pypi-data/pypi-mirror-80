...
class Usage(_1138.IndependentReportablePropertiesBase['Usage']):
    '''Usage
    ...
    @property
    def spur_gear_load_sharing_code(self) -> '_826.SpurGearLoadSharingCodes':
        ...
        return constructor.new(_826.SpurGearLoadSharingCodes)(value) if value else None

    @spur_gear_load_sharing_code.setter
    def spur_gear_load_sharing_code(self, value: '_826.SpurGearLoadSharingCodes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
