...
class CylindricalGearSetMicroGeometryDutyCycle(_962.GearSetImplementationAnalysisDutyCycle):
    '''CylindricalGearSetMicroGeometryDutyCycle
    ...
    @property
    def meshes(self) -> 'List[_846.CylindricalGearMeshMicroGeometryDutyCycle]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Meshes, constructor.new(_846.CylindricalGearMeshMicroGeometryDutyCycle))
        return value
