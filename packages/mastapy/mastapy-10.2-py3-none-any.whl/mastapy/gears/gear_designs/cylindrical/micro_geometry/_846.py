...
class CylindricalGearMeshMicroGeometryDutyCycle(_954.GearMeshDesignAnalysis):
    '''CylindricalGearMeshMicroGeometryDutyCycle
    ...
    @property
    def meshes_analysis(self) -> 'List[_629.CylindricalGearMeshLoadDistributionAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshesAnalysis, constructor.new(_629.CylindricalGearMeshLoadDistributionAnalysis))
        return value
