...
from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _876, _872, _880
...
class CylindricalAccuracyGrader(_0.APIBase):
    ...
    @property
    def accuracy_grades(self) -> '_876.CylindricalAccuracyGrades':
        ...
        if _876.CylindricalAccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_agma20151_accuracy_grades(self) -> '_872.AGMA20151AccuracyGrades':
        ...
        if _872.AGMA20151AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
    ...
    @property
    def accuracy_grades_of_type_iso1328_accuracy_grades(self) -> '_880.ISO1328AccuracyGrades':
        ...
        if _880.ISO1328AccuracyGrades.TYPE not in self.wrapped.AccuracyGrades.__class__.__mro__:
