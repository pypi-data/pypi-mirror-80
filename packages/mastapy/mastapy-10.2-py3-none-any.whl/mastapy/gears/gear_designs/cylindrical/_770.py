...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    @property
    def gear(self) -> '_774.CylindricalGearDesign':
        ...
        if _774.CylindricalGearDesign.TYPE not in self.wrapped.Gear.__class__.__mro__:
    ...
    @property
    def shaper_for_agma_rating(self) -> '_515.CylindricalGearShaper':
        ...
        return constructor.new(_515.CylindricalGearShaper)(self.wrapped.ShaperForAGMARating) if self.wrapped.ShaperForAGMARating else None
