...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    @property
    def cylindrical_gear_cutter(self) -> '_770.CylindricalGearAbstractRack':
        ...
        if _770.CylindricalGearAbstractRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_basic_rack(self) -> '_771.CylindricalGearBasicRack':
        ...
        if _771.CylindricalGearBasicRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_cylindrical_gear_pinion_type_cutter(self) -> '_781.CylindricalGearPinionTypeCutter':
        ...
        if _781.CylindricalGearPinionTypeCutter.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def cylindrical_gear_cutter_of_type_standard_rack(self) -> '_827.StandardRack':
        ...
        if _827.StandardRack.TYPE not in self.wrapped.CylindricalGearCutter.__class__.__mro__:
    ...
    @property
    def manufacturing_configuration_selection(self) -> '_787.CylindricalGearSetManufacturingConfigurationSelection':
        ...
        return constructor.new(_787.CylindricalGearSetManufacturingConfigurationSelection)(self.wrapped.ManufacturingConfigurationSelection) if self.wrapped.ManufacturingConfigurationSelection else None

    @property
    def manufacturing_configuration(self) -> '_395.CylindricalGearManufacturingConfig':
        ...
        return constructor.new(_395.CylindricalGearManufacturingConfig)(self.wrapped.ManufacturingConfiguration) if self.wrapped.ManufacturingConfiguration else None
