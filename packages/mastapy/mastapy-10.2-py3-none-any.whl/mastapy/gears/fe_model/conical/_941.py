...
class ConicalSetFEModel(_935.GearSetFEModel):
    '''ConicalSetFEModel
    ...
    @property
    def flank_data_source(self) -> '_942.FlankDataSource':
        ...
        return constructor.new(_942.FlankDataSource)(value) if value else None

    @flank_data_source.setter
    def flank_data_source(self, value: '_942.FlankDataSource'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
