...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def rolled_before_or_after_heat_treatment(self) -> '_1054.RolledBeforeOrAfterHeatTreament':
        ...
        return constructor.new(_1054.RolledBeforeOrAfterHeatTreament)(value) if value else None

    @rolled_before_or_after_heat_treatment.setter
    def rolled_before_or_after_heat_treatment(self, value: '_1054.RolledBeforeOrAfterHeatTreament'):
    ...
    @property
    def joint_geometry(self) -> '_1051.JointGeometries':
        ...
        return constructor.new(_1051.JointGeometries)(value) if value else None

    @joint_geometry.setter
    def joint_geometry(self, value: '_1051.JointGeometries'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def clamped_parts(self) -> 'List[_1046.ClampedSection]':
        '''List[ClampedSection]: 'ClampedParts' is the original name of this property.'''

        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClampedParts, constructor.new(_1046.ClampedSection))
        return value

    @clamped_parts.setter
    def clamped_parts(self, value: 'List[_1046.ClampedSection]'):
        value = value if value else None
    ...
    @property
    def bolt_geometry(self) -> '_1039.BoltGeometry':
        ...
        return constructor.new(_1039.BoltGeometry)(self.wrapped.BoltGeometry) if self.wrapped.BoltGeometry else None
    ...
    @property
    def material_of_nut(self) -> '_1037.BoltedJointMaterial':
        ...
        if _1037.BoltedJointMaterial.TYPE not in self.wrapped.MaterialOfNut.__class__.__mro__:
    ...
    @property
    def material_of_bolt(self) -> '_1041.BoltMaterial':
        ...
        return constructor.new(_1041.BoltMaterial)(self.wrapped.MaterialOfBolt) if self.wrapped.MaterialOfBolt else None

    @property
    def material_of_tapped_thread(self) -> '_1037.BoltedJointMaterial':
        ...
        if _1037.BoltedJointMaterial.TYPE not in self.wrapped.MaterialOfTappedThread.__class__.__mro__:
    ...
    @property
    def clamped_sections(self) -> 'List[_1046.ClampedSection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClampedSections, constructor.new(_1046.ClampedSection))
        return value
