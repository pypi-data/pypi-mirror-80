...
class OilPumpDetail(_1138.IndependentReportablePropertiesBase['OilPumpDetail']):
    '''OilPumpDetail
    ...
    @property
    def oil_pump_drive_type(self) -> '_102.OilPumpDriveType':
        ...
        return constructor.new(_102.OilPumpDriveType)(value) if value else None

    @oil_pump_drive_type.setter
    def oil_pump_drive_type(self, value: '_102.OilPumpDriveType'):
