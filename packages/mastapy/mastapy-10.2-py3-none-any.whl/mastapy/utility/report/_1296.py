...
from mastapy.utility.report import _1297, _1300
...
TItem = TypeVar('TItem', bound='_1300.CustomReportPropertyItem')


class CustomReportMultiPropertyItem(_1297.CustomReportMultiPropertyItemBase, Generic[TItem]):
    '''CustomReportMultiPropertyItem
