...
class ThrustBallBearing(_1758.BallBearing):
    '''ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self) -> '_1531.OuterRingMounting':
        ...
        return constructor.new(_1531.OuterRingMounting)(value) if value else None

    @outer_ring_mounting.setter
    def outer_ring_mounting(self, value: '_1531.OuterRingMounting'):
