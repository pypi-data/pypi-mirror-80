...
from mastapy.bearings.bearing_results.rolling.skf_module import _1719, _1721
...
class Viscosities(_1721.SKFCalculationResult):
    '''Viscosities
    ...
    @property
    def operating_viscosity(self) -> '_1719.OperatingViscosity':
        ...
        return constructor.new(_1719.OperatingViscosity)(self.wrapped.OperatingViscosity) if self.wrapped.OperatingViscosity else None
