...
from mastapy.bearings.bearing_results.rolling import _1694, _1641
...
class LoadedRollerBearingElement(_1641.LoadedElement):
    '''LoadedRollerBearingElement
    ...
    @property
    def results_at_roller_offsets(self) -> 'List[_1694.ResultsAtRollerOffset]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ResultsAtRollerOffsets, constructor.new(_1694.ResultsAtRollerOffset))
        return value
