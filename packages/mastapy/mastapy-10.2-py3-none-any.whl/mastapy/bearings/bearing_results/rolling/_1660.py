...
from mastapy.bearings.bearing_results.rolling.fitting import _1735, _1733, _1736
from mastapy.bearings.bearing_results.rolling import (
    _1604, _1601, _1688, _1661
)
from mastapy.bearings.bearing_results.rolling.iso_rating_results import (
    _1726, _1724, _1730, _1729,
    _1725, _1731, _1727
)
...
class LoadedRollingBearingResults(_1588.LoadedDetailedBearingResults):
    '''LoadedRollingBearingResults
    ...
    @property
    def fluid_film_temperature_source(self) -> '_1526.FluidFilmTemperatureOptions':
        ...
        return constructor.new(_1526.FluidFilmTemperatureOptions)(value) if value else None
    ...
    @property
    def outer_ring_fitting_at_assembly(self) -> '_1735.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1735.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtAssembly) if self.wrapped.OuterRingFittingAtAssembly else None

    @property
    def outer_ring_fitting_at_operating_conditions(self) -> '_1735.OuterRingFittingThermalResults':
        ...
        return constructor.new(_1735.OuterRingFittingThermalResults)(self.wrapped.OuterRingFittingAtOperatingConditions) if self.wrapped.OuterRingFittingAtOperatingConditions else None

    @property
    def inner_ring_fitting_at_assembly(self) -> '_1733.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1733.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtAssembly) if self.wrapped.InnerRingFittingAtAssembly else None

    @property
    def inner_ring_fitting_at_operating_conditions(self) -> '_1733.InnerRingFittingThermalResults':
        ...
        return constructor.new(_1733.InnerRingFittingThermalResults)(self.wrapped.InnerRingFittingAtOperatingConditions) if self.wrapped.InnerRingFittingAtOperatingConditions else None
    ...
    @property
    def din732(self) -> '_1601.DIN732Results':
        ...
        return constructor.new(_1601.DIN732Results)(self.wrapped.DIN732) if self.wrapped.DIN732 else None

    @property
    def iso2812007(self) -> '_1726.ISO2812007Results':
        ...
        if _1726.ISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_ball_iso2812007_results(self) -> '_1724.BallISO2812007Results':
        ...
        if _1724.BallISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def iso2812007_of_type_roller_iso2812007_results(self) -> '_1730.RollerISO2812007Results':
        ...
        if _1730.RollerISO2812007Results.TYPE not in self.wrapped.ISO2812007.__class__.__mro__:
    ...
    @property
    def isots162812008(self) -> '_1729.ISOTS162812008Results':
        ...
        if _1729.ISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_ball_isots162812008_results(self) -> '_1725.BallISOTS162812008Results':
        ...
        if _1725.BallISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def isots162812008_of_type_roller_isots162812008_results(self) -> '_1731.RollerISOTS162812008Results':
        ...
        if _1731.RollerISOTS162812008Results.TYPE not in self.wrapped.ISOTS162812008.__class__.__mro__:
    ...
    @property
    def iso762006(self) -> '_1727.ISO762006Results':
        ...
        return constructor.new(_1727.ISO762006Results)(self.wrapped.ISO762006) if self.wrapped.ISO762006 else None

    @property
    def maximum_static_contact_stress(self) -> '_1688.MaximumStaticContactStress':
        ...
        return constructor.new(_1688.MaximumStaticContactStress)(self.wrapped.MaximumStaticContactStress) if self.wrapped.MaximumStaticContactStress else None

    @property
    def skf_module_results(self) -> '_1721.SKFModuleResults':
        ...
        return constructor.new(_1721.SKFModuleResults)(self.wrapped.SKFModuleResults) if self.wrapped.SKFModuleResults else None

    @property
    def rows(self) -> 'List[_1661.LoadedRollingBearingRow]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Rows, constructor.new(_1661.LoadedRollingBearingRow))
        return value

    @property
    def all_mounting_results(self) -> 'List[_1736.RingFittingThermalResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AllMountingResults, constructor.new(_1736.RingFittingThermalResults))
        return value
