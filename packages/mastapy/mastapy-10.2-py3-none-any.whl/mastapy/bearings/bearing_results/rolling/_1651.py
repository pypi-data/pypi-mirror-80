...
from mastapy.bearings.bearing_results.rolling import _1699, _1656
...
class LoadedNonBarrelRollerBearingResults(_1656.LoadedRollerBearingResults):
    '''LoadedNonBarrelRollerBearingResults
    ...
    @property
    def smt_rib_stress(self) -> '_1699.SMTRibStressResults':
        ...
        return constructor.new(_1699.SMTRibStressResults)(self.wrapped.SMTRibStress) if self.wrapped.SMTRibStress else None
