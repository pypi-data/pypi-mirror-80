...
from mastapy.bearings.bearing_results.rolling import _1679, _1630
...
class LoadedThreePointContactBallBearingRow(_1630.LoadedBallBearingRow):
    '''LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1679.LoadedThreePointContactBallBearingResults':
        ...
        return constructor.new(_1679.LoadedThreePointContactBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
