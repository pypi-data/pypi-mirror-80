...
from mastapy.bearings.bearing_results.rolling import (
    _1629, _1610, _1613, _1639,
    _1644, _1663, _1679, _1682,
    _1628, _1661
)
...
class LoadedBallBearingRow(_1661.LoadedRollingBearingRow):
    '''LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1629.LoadedBallBearingResults':
    ...
    @property
    def race_results(self) -> 'List[_1628.LoadedBallBearingRaceResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RaceResults, constructor.new(_1628.LoadedBallBearingRaceResults))
        return value
