...
from mastapy.bearings.bearing_results.rolling import (
    _1656, _1616, _1621, _1624,
    _1632, _1636, _1648, _1651,
    _1667, _1670, _1676, _1685,
    _1602, _1661
)
...
class LoadedRollerBearingRow(_1661.LoadedRollingBearingRow):
    '''LoadedRollerBearingRow
    ...
    @property
    def shear_stress_chart_inner(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.ShearStressChartInner) if self.wrapped.ShearStressChartInner else None

    @property
    def shear_stress_chart_outer(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.ShearStressChartOuter) if self.wrapped.ShearStressChartOuter else None

    @property
    def depth_of_maximum_shear_stress_chart_inner(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.DepthOfMaximumShearStressChartInner) if self.wrapped.DepthOfMaximumShearStressChartInner else None

    @property
    def depth_of_maximum_shear_stress_chart_outer(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.DepthOfMaximumShearStressChartOuter) if self.wrapped.DepthOfMaximumShearStressChartOuter else None

    @property
    def loaded_bearing(self) -> '_1656.LoadedRollerBearingResults':
    ...
    @property
    def lamina_dynamic_equivalent_loads(self) -> 'List[_1602.ForceAtLaminaGroupReportable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LaminaDynamicEquivalentLoads, constructor.new(_1602.ForceAtLaminaGroupReportable))
        return value
