...
from mastapy.bearings.bearing_results.rolling import _1639, _1630
...
class LoadedDeepGrooveBallBearingRow(_1630.LoadedBallBearingRow):
    '''LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1639.LoadedDeepGrooveBallBearingResults':
        ...
        return constructor.new(_1639.LoadedDeepGrooveBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
