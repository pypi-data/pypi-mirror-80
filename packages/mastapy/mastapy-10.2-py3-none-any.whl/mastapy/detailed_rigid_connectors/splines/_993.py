...
from mastapy.detailed_rigid_connectors.splines import _980, _1005
...
class SAESplineJointDesign(_1005.StandardSplineJointDesign):
    '''SAESplineJointDesign
    ...
    @property
    def fit_type(self) -> '_980.FitTypes':
        '''FitTypes: 'FitType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.FitType)
        return constructor.new(_980.FitTypes)(value) if value else None

    @fit_type.setter
    def fit_type(self, value: '_980.FitTypes'):
