...
class SocketConnectionOptions(_0.APIBase):
    ...
    @property
    def sockets(self) -> 'List[_1880.SocketConnectionSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Sockets, constructor.new(_1880.SocketConnectionSelection))
        return value
