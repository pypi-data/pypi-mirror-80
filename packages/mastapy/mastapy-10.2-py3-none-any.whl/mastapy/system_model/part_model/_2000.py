...
class Assembly(_2001.AbstractAssembly):
    ...
    def add_belt_drive(self, centre_distance: Optional['float'] = 0.1, pulley_a_diameter: Optional['float'] = 0.1, pulley_b_diameter: Optional['float'] = 0.1, name: Optional['str'] = 'Belt Drive') -> '_2133.BeltDrive':
        ''' 'AddBeltDrive' is the original name of this method.
    ...
    def add_planet_carrier(self, number_of_planets: Optional['int'] = 3, diameter: Optional['float'] = 0.1) -> '_2032.PlanetCarrier':
        ''' 'AddPlanetCarrier' is the original name of this method.
    ...
    def add_shaft(self, length: Optional['float'] = 0.1, outer_diameter: Optional['float'] = 0.0, bore: Optional['float'] = 0.0, name: Optional['str'] = 'Shaft') -> '_2044.Shaft':
        ''' 'AddShaft' is the original name of this method.
    ...
    def add_hypoid_gear_set_detailed(self, name: Optional['str'] = 'Hypoid Gear Set', pinion_number_of_teeth: Optional['int'] = 7, wheel_number_of_teeth: Optional['int'] = 41, outer_transverse_module: Optional['float'] = 0.0, wheel_face_width: Optional['float'] = 0.1, offset: Optional['float'] = 0.0, average_pressure_angle: Optional['float'] = 0.4, design_method: Optional['_914.AGMAGleasonConicalGearGeometryMethods'] = _914.AGMAGleasonConicalGearGeometryMethods.GLEASON) -> '_2096.HypoidGearSet':
        ''' 'AddHypoidGearSet' is the original name of this method.
