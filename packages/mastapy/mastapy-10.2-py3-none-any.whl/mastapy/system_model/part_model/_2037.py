...
from mastapy.system_model.part_model.projections import _2047
...
class RootAssembly(_2000.Assembly):
    '''RootAssembly
    ...
    @property
    def parallel_part_groups_drawing_order(self) -> 'List[_2047.SpecifiedParallelPartGroupDrawingOrder]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroupsDrawingOrder, constructor.new(_2047.SpecifiedParallelPartGroupDrawingOrder))
        return value

    @property
    def parallel_part_groups(self) -> 'List[_2052.ParallelPartGroup]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ParallelPartGroups, constructor.new(_2052.ParallelPartGroup))
        return value
