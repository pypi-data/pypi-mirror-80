...
from mastapy.system_model.part_model.couplings import _2163, _2165, _2140
...
class TorqueConverter(_2140.Coupling):
    '''TorqueConverter
    ...
    @property
    def pump(self) -> '_2163.TorqueConverterPump':
        ...
        return constructor.new(_2163.TorqueConverterPump)(self.wrapped.Pump) if self.wrapped.Pump else None

    @property
    def turbine(self) -> '_2165.TorqueConverterTurbine':
        ...
        return constructor.new(_2165.TorqueConverterTurbine)(self.wrapped.Turbine) if self.wrapped.Turbine else None
