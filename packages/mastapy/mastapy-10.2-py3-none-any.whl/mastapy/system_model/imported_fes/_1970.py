...
class ImportedFEWithSelectionComponents(_1969.ImportedFEWithSelection):
    '''ImportedFEWithSelectionComponents
    ...
    @property
    def component_links(self) -> 'List[_1959.ImportedFeLinkWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ComponentLinks, constructor.new(_1959.ImportedFeLinkWithSelection))
        return value

    @property
    def links_for_selected_component(self) -> 'List[_1959.ImportedFeLinkWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinksForSelectedComponent, constructor.new(_1959.ImportedFeLinkWithSelection))
        return value

    @property
    def links_for_electric_machine(self) -> 'List[_1959.ImportedFeLinkWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LinksForElectricMachine, constructor.new(_1959.ImportedFeLinkWithSelection))
        return value

    @property
    def rigid_element_properties(self) -> 'List[_1947.ElementPropertiesWithSelection[_1486.ElementPropertiesRigid]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RigidElementProperties, constructor.new(_1947.ElementPropertiesWithSelection)[_1486.ElementPropertiesRigid])
        return value

    @property
    def solid_element_properties(self) -> 'List[_1947.ElementPropertiesWithSelection[_1488.ElementPropertiesSolid]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SolidElementProperties, constructor.new(_1947.ElementPropertiesWithSelection)[_1488.ElementPropertiesSolid])
        return value

    @property
    def shell_element_properties(self) -> 'List[_1947.ElementPropertiesWithSelection[_1487.ElementPropertiesShell]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ShellElementProperties, constructor.new(_1947.ElementPropertiesWithSelection)[_1487.ElementPropertiesShell])
        return value

    @property
    def beam_element_properties(self) -> 'List[_1947.ElementPropertiesWithSelection[_1483.ElementPropertiesBeam]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BeamElementProperties, constructor.new(_1947.ElementPropertiesWithSelection)[_1483.ElementPropertiesBeam])
        return value

    @property
    def spring_dashpot_element_properties(self) -> 'List[_1947.ElementPropertiesWithSelection[_1489.ElementPropertiesSpringDashpot]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpringDashpotElementProperties, constructor.new(_1947.ElementPropertiesWithSelection)[_1489.ElementPropertiesSpringDashpot])
        return value

    @property
    def mass_element_properties(self) -> 'List[_1947.ElementPropertiesWithSelection[_1485.ElementPropertiesMass]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MassElementProperties, constructor.new(_1947.ElementPropertiesWithSelection)[_1485.ElementPropertiesMass])
        return value

    @property
    def interface_element_properties(self) -> 'List[_1947.ElementPropertiesWithSelection[_1484.ElementPropertiesInterface]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.InterfaceElementProperties, constructor.new(_1947.ElementPropertiesWithSelection)[_1484.ElementPropertiesInterface])
        return value

    @property
    def other_element_properties(self) -> 'List[_1947.ElementPropertiesWithSelection[_1482.ElementPropertiesBase]]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.OtherElementProperties, constructor.new(_1947.ElementPropertiesWithSelection)[_1482.ElementPropertiesBase])
        return value

    @property
    def materials(self) -> 'List[_1977.MaterialPropertiesWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Materials, constructor.new(_1977.MaterialPropertiesWithSelection))
        return value

    @property
    def coordinate_systems(self) -> 'List[_1939.CoordinateSystemWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CoordinateSystems, constructor.new(_1939.CoordinateSystemWithSelection))
        return value
