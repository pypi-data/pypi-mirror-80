...
class GearSetLoadCase(_6205.SpecialisedAssemblyLoadCase):
    '''GearSetLoadCase
    ...
    @property
    def gear_mesh_stiffness_model(self) -> '_5046.GearMeshStiffnessModel':
        ...
        return constructor.new(_5046.GearMeshStiffnessModel)(value) if value else None

    @gear_mesh_stiffness_model.setter
    def gear_mesh_stiffness_model(self, value: '_5046.GearMeshStiffnessModel'):
