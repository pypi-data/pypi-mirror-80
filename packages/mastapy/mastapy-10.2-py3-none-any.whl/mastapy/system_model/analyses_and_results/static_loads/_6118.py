...
from mastapy.system_model.analyses_and_results.static_loads import _6119, _6085
...
class CVTLoadCase(_6085.BeltDriveLoadCase):
    '''CVTLoadCase
    ...
    @property
    def assembly_design(self) -> '_2142.CVT':
        ...
        return constructor.new(_2142.CVT)(self.wrapped.AssemblyDesign) if self.wrapped.AssemblyDesign else None

    @property
    def pulleys(self) -> 'List[_6119.CVTPulleyLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Pulleys, constructor.new(_6119.CVTPulleyLoadCase))
        return value
