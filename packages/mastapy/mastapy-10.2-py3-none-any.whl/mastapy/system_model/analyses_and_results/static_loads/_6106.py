...
from mastapy.system_model.analyses_and_results.static_loads import _6104, _6105, _6152
...
class ConceptGearSetLoadCase(_6152.GearSetLoadCase):
    '''ConceptGearSetLoadCase
    ...
    @property
    def concept_gears_load_case(self) -> 'List[_6104.ConceptGearLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsLoadCase, constructor.new(_6104.ConceptGearLoadCase))
        return value

    @property
    def concept_meshes_load_case(self) -> 'List[_6105.ConceptGearMeshLoadCase]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesLoadCase, constructor.new(_6105.ConceptGearMeshLoadCase))
        return value
