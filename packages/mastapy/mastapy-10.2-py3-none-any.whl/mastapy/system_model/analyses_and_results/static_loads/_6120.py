...
from mastapy.system_model.analyses_and_results.static_loads import _6121, _6147
...
class CylindricalGearLoadCase(_6147.GearLoadCase):
    '''CylindricalGearLoadCase
    ...
    @property
    def gear_manufacture_errors(self) -> '_6121.CylindricalGearManufactureError':
        ...
        return constructor.new(_6121.CylindricalGearManufactureError)(self.wrapped.GearManufactureErrors) if self.wrapped.GearManufactureErrors else None

    @property
    def overridden_micro_geometry(self) -> '_847.CylindricalGearMicroGeometry':
        ...
        return constructor.new(_847.CylindricalGearMicroGeometry)(self.wrapped.OverriddenMicroGeometry) if self.wrapped.OverriddenMicroGeometry else None
