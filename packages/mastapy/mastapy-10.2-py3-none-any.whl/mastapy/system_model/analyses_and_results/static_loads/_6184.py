...
class PartLoadCase(_2206.PartAnalysis):
    '''PartLoadCase
    ...
    @property
    def static_load_case(self) -> '_6213.StaticLoadCase':
        ...
        if _6213.StaticLoadCase.TYPE not in self.wrapped.StaticLoadCase.__class__.__mro__:
    ...
    @property
    def time_series_load_case(self) -> '_6227.TimeSeriesLoadCase':
        ...
        return constructor.new(_6227.TimeSeriesLoadCase)(self.wrapped.TimeSeriesLoadCase) if self.wrapped.TimeSeriesLoadCase else None

    def get_harmonic_load_data_for_import(self) -> '_6155.HarmonicLoadDataBase':
