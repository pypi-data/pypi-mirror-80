...
from mastapy.math_utility import _1071, _1078
...
class PointLoadHarmonicLoadData(_6206.SpeedDependentHarmonicLoadData):
    '''PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self) -> '_1071.DegreesOfFreedom':
        ...
        return constructor.new(_1071.DegreesOfFreedom)(value) if value else None

    @degree_of_freedom.setter
    def degree_of_freedom(self, value: '_1071.DegreesOfFreedom'):
