...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4091, _3996
...
class RootAssemblyModalAnalysesAtSpeeds(_3996.AssemblyModalAnalysesAtSpeeds):
    '''RootAssemblyModalAnalysesAtSpeeds
    ...
    @property
    def modal_analyses_at_speeds_inputs(self) -> '_4091.StabilityAnalysis':
        ...
        return constructor.new(_4091.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeedsInputs) if self.wrapped.ModalAnalysesAtSpeedsInputs else None
