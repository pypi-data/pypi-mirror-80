...
class ConnectionModalAnalysesAtSpeeds(_6517.ConnectionStaticLoadAnalysisCase):
    '''ConnectionModalAnalysesAtSpeeds
    ...
    @property
    def modal_analyses_at_speeds(self) -> '_4091.StabilityAnalysis':
        ...
        return constructor.new(_4091.StabilityAnalysis)(self.wrapped.ModalAnalysesAtSpeeds) if self.wrapped.ModalAnalysesAtSpeeds else None
