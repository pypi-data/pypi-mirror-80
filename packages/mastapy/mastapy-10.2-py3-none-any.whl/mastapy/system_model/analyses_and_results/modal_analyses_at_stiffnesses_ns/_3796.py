...
from mastapy.system_model.analyses_and_results.modal_analyses_at_stiffnesses_ns import _3795, _3794, _3800
...
class FaceGearSetModalAnalysesAtStiffnesses(_3800.GearSetModalAnalysesAtStiffnesses):
    '''FaceGearSetModalAnalysesAtStiffnesses
    ...
    @property
    def face_gears_modal_analyses_at_stiffnesses(self) -> 'List[_3795.FaceGearModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysesAtStiffnesses, constructor.new(_3795.FaceGearModalAnalysesAtStiffnesses))
        return value

    @property
    def face_meshes_modal_analyses_at_stiffnesses(self) -> 'List[_3794.FaceGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysesAtStiffnesses, constructor.new(_3794.FaceGearMeshModalAnalysesAtStiffnesses))
        return value
