...
from mastapy.system_model.analyses_and_results.system_deflections import _2353, _2360
...
class PartSystemDeflection(_6523.PartFEAnalysis):
    '''PartSystemDeflection
    ...
    @property
    def twod_drawing_showing_axial_forces(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.TwoDDrawingShowingAxialForces) if self.wrapped.TwoDDrawingShowingAxialForces else None
    ...
    @property
    def system_deflection(self) -> '_2353.SystemDeflection':
        ...
        if _2353.SystemDeflection.TYPE not in self.wrapped.SystemDeflection.__class__.__mro__:
    ...
    @property
    def mass_properties_from_node_model(self) -> '_1082.MassProperties':
        ...
        return constructor.new(_1082.MassProperties)(self.wrapped.MassPropertiesFromNodeModel) if self.wrapped.MassPropertiesFromNodeModel else None
