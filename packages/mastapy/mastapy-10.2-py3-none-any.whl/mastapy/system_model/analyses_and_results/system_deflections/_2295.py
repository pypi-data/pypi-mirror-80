...
from mastapy.system_model.analyses_and_results.system_deflections import _2296, _2294, _2233
...
class HypoidGearSetSystemDeflection(_2233.AGMAGleasonConicalGearSetSystemDeflection):
    '''HypoidGearSetSystemDeflection
    ...
    @property
    def hypoid_gears_system_deflection(self) -> 'List[_2296.HypoidGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsSystemDeflection, constructor.new(_2296.HypoidGearSystemDeflection))
        return value

    @property
    def hypoid_meshes_system_deflection(self) -> 'List[_2294.HypoidGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesSystemDeflection, constructor.new(_2294.HypoidGearMeshSystemDeflection))
        return value
