...
class ConicalGearSystemDeflection(_2292.GearSystemDeflection):
    '''ConicalGearSystemDeflection
    ...
    @property
    def conical_gear_ltca_results(self) -> '_639.ConicalGearLoadDistributionAnalysis':
        ...
        return constructor.new(_639.ConicalGearLoadDistributionAnalysis)(self.wrapped.ConicalGearLTCAResults) if self.wrapped.ConicalGearLTCAResults else None
