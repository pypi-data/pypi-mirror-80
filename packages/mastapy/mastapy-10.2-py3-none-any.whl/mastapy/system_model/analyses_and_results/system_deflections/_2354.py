...
from mastapy.system_model.drawing import _1847, _1845
...
class SystemDeflectionDrawStyle(_1845.ContourDrawStyle):
    '''SystemDeflectionDrawStyle
    ...
    @property
    def force_arrow_scaling(self) -> '_1847.ScalingDrawStyle':
        ...
        return constructor.new(_1847.ScalingDrawStyle)(self.wrapped.ForceArrowScaling) if self.wrapped.ForceArrowScaling else None
