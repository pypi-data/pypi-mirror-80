...
from mastapy.system_model.analyses_and_results.system_deflections import _2260, _2258, _2291
...
class ConceptGearSetSystemDeflection(_2291.GearSetSystemDeflection):
    '''ConceptGearSetSystemDeflection
    ...
    @property
    def concept_gears_system_deflection(self) -> 'List[_2260.ConceptGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptGearsSystemDeflection, constructor.new(_2260.ConceptGearSystemDeflection))
        return value

    @property
    def concept_meshes_system_deflection(self) -> 'List[_2258.ConceptGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptMeshesSystemDeflection, constructor.new(_2258.ConceptGearMeshSystemDeflection))
        return value
