...
class ShaftSectionSystemDeflection(_1428.Bar):
    '''ShaftSectionSystemDeflection
    ...
    @property
    def left_end(self) -> '_2330.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2330.ShaftSectionEndResultsSystemDeflection)(self.wrapped.LeftEnd) if self.wrapped.LeftEnd else None

    @property
    def right_end(self) -> '_2330.ShaftSectionEndResultsSystemDeflection':
        ...
        return constructor.new(_2330.ShaftSectionEndResultsSystemDeflection)(self.wrapped.RightEnd) if self.wrapped.RightEnd else None
