...
from mastapy.system_model.analyses_and_results.system_deflections import _2337, _2335, _2245
...
class SpiralBevelGearSetSystemDeflection(_2245.BevelGearSetSystemDeflection):
    '''SpiralBevelGearSetSystemDeflection
    ...
    @property
    def spiral_bevel_gears_system_deflection(self) -> 'List[_2337.SpiralBevelGearSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelGearsSystemDeflection, constructor.new(_2337.SpiralBevelGearSystemDeflection))
        return value

    @property
    def spiral_bevel_meshes_system_deflection(self) -> 'List[_2335.SpiralBevelGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpiralBevelMeshesSystemDeflection, constructor.new(_2335.SpiralBevelGearMeshSystemDeflection))
        return value
