...
class GearSystemDeflection(_2313.MountableComponentSystemDeflection):
    '''GearSystemDeflection
    ...
    @property
    def mesh_point_results_in_wcs(self) -> 'List[_1118.ForceAndDisplacementResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshPointResultsInWCS, constructor.new(_1118.ForceAndDisplacementResults))
        return value
