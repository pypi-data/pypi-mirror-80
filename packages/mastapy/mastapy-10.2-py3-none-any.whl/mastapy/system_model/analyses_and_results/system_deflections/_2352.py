...
from mastapy.system_model.analyses_and_results.system_deflections import _2349, _2334
...
class SynchroniserSystemDeflection(_2334.SpecialisedAssemblySystemDeflection):
    '''SynchroniserSystemDeflection
    ...
    @property
    def cones(self) -> 'List[_2349.SynchroniserHalfSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Cones, constructor.new(_2349.SynchroniserHalfSystemDeflection))
        return value
