...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3463
...
class StraightBevelPlanetGearCompoundPowerFlow(_3463.StraightBevelDiffGearCompoundPowerFlow):
    '''StraightBevelPlanetGearCompoundPowerFlow
