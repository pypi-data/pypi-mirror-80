...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3550, _3549, _3491
...
class HypoidGearSetParametricStudyTool(_3491.AGMAGleasonConicalGearSetParametricStudyTool):
    ...
    @property
    def hypoid_gears_parametric_study_tool(self) -> 'List[_3550.HypoidGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsParametricStudyTool, constructor.new(_3550.HypoidGearParametricStudyTool))
        return value

    @property
    def hypoid_meshes_parametric_study_tool(self) -> 'List[_3549.HypoidGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesParametricStudyTool, constructor.new(_3549.HypoidGearMeshParametricStudyTool))
        return value
