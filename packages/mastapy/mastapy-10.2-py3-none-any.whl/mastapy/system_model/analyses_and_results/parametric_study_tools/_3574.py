...
from mastapy.system_model.analyses_and_results.static_loads import _6081, _6183
from mastapy.system_model import _1818
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3575, _3576
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    @property
    def parametric_study_type(self) -> '_6183.ParametricStudyType':
        ...
        return constructor.new(_6183.ParametricStudyType)(value) if value else None

    @parametric_study_type.setter
    def parametric_study_type(self, value: '_6183.ParametricStudyType'):
    ...
    @property
    def external_full_fe_loader(self) -> '_1818.ExternalFullFELoader':
        ...
        return constructor.new(_1818.ExternalFullFELoader)(self.wrapped.ExternalFullFELoader) if self.wrapped.ExternalFullFELoader else None

    @property
    def step_results(self) -> 'List[_3575.ParametricStudyToolStepResult]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StepResults, constructor.new(_3575.ParametricStudyToolStepResult))
        return value

    @property
    def study_variables(self) -> 'List[_3576.ParametricStudyVariable]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StudyVariables, constructor.new(_3576.ParametricStudyVariable))
        return value
