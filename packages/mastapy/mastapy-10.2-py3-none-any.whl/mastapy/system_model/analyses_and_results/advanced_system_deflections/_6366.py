...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6364, _6365, _6280
...
class StraightBevelDiffGearSetAdvancedSystemDeflection(_6280.BevelGearSetAdvancedSystemDeflection):
    '''StraightBevelDiffGearSetAdvancedSystemDeflection
    ...
    @property
    def rating(self) -> '_197.StraightBevelDiffGearSetRating':
        ...
        return constructor.new(_197.StraightBevelDiffGearSetRating)(self.wrapped.Rating) if self.wrapped.Rating else None

    @property
    def component_detailed_analysis(self) -> '_197.StraightBevelDiffGearSetRating':
        ...
        return constructor.new(_197.StraightBevelDiffGearSetRating)(self.wrapped.ComponentDetailedAnalysis) if self.wrapped.ComponentDetailedAnalysis else None

    @property
    def straight_bevel_diff_gears_advanced_system_deflection(self) -> 'List[_6364.StraightBevelDiffGearAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffGearsAdvancedSystemDeflection, constructor.new(_6364.StraightBevelDiffGearAdvancedSystemDeflection))
        return value

    @property
    def straight_bevel_diff_meshes_advanced_system_deflection(self) -> 'List[_6365.StraightBevelDiffGearMeshAdvancedSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshesAdvancedSystemDeflection, constructor.new(_6365.StraightBevelDiffGearMeshAdvancedSystemDeflection))
        return value
