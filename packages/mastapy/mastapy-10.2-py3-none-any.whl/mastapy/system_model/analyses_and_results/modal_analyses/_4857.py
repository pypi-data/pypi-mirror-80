...
from mastapy.system_model.analyses_and_results.modal_analyses import _4856, _4855, _4740
...
class ZerolBevelGearSetModalAnalysis(_4740.BevelGearSetModalAnalysis):
    '''ZerolBevelGearSetModalAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2368.ZerolBevelGearSetSystemDeflection':
        ...
        return constructor.new(_2368.ZerolBevelGearSetSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None

    @property
    def zerol_bevel_gears_modal_analysis(self) -> 'List[_4856.ZerolBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelGearsModalAnalysis, constructor.new(_4856.ZerolBevelGearModalAnalysis))
        return value

    @property
    def zerol_bevel_meshes_modal_analysis(self) -> 'List[_4855.ZerolBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ZerolBevelMeshesModalAnalysis, constructor.new(_4855.ZerolBevelGearMeshModalAnalysis))
        return value
