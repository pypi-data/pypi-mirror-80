...
from mastapy.system_model.analyses_and_results.modal_analyses import _4773, _4772, _4779
...
class FaceGearSetModalAnalysis(_4779.GearSetModalAnalysis):
    '''FaceGearSetModalAnalysis
    ...
    @property
    def face_gears_modal_analysis(self) -> 'List[_4773.FaceGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceGearsModalAnalysis, constructor.new(_4773.FaceGearModalAnalysis))
        return value

    @property
    def face_meshes_modal_analysis(self) -> 'List[_4772.FaceGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshesModalAnalysis, constructor.new(_4772.FaceGearMeshModalAnalysis))
        return value
