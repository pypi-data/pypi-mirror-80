...
from mastapy.system_model.analyses_and_results.modal_analyses import _4797, _4729
...
class RootAssemblyModalAnalysis(_4729.AssemblyModalAnalysis):
    '''RootAssemblyModalAnalysis
    ...
    @property
    def modal_analysis_inputs(self) -> '_4797.ModalAnalysis':
        ...
        if _4797.ModalAnalysis.TYPE not in self.wrapped.ModalAnalysisInputs.__class__.__mro__:
