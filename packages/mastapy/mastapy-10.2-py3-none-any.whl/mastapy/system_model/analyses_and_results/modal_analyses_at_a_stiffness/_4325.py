...
from mastapy.system_model.analyses_and_results.modal_analyses_at_a_stiffness import _4309, _4242
...
class RootAssemblyModalAnalysisAtAStiffness(_4242.AssemblyModalAnalysisAtAStiffness):
    '''RootAssemblyModalAnalysisAtAStiffness
    ...
    @property
    def modal_analysis_at_a_stiffness_inputs(self) -> '_4309.ModalAnalysisAtAStiffness':
        ...
        return constructor.new(_4309.ModalAnalysisAtAStiffness)(self.wrapped.ModalAnalysisAtAStiffnessInputs) if self.wrapped.ModalAnalysisAtAStiffnessInputs else None
