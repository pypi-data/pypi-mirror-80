...
class StraightBevelGearGearWhineAnalysis(_5292.BevelGearGearWhineAnalysis):
    '''StraightBevelGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2346.StraightBevelGearSystemDeflection':
        ...
        return constructor.new(_2346.StraightBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
