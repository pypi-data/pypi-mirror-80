...
class SpiralBevelGearGearWhineAnalysis(_5292.BevelGearGearWhineAnalysis):
    '''SpiralBevelGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2337.SpiralBevelGearSystemDeflection':
        ...
        return constructor.new(_2337.SpiralBevelGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
