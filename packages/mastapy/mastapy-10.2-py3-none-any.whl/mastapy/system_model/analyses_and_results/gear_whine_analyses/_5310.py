...
class ConicalGearMeshGearWhineAnalysis(_5345.GearMeshGearWhineAnalysis):
    '''ConicalGearMeshGearWhineAnalysis
    ...
    @property
    def connection_design(self) -> '_1887.ConicalGearMesh':
    ...
    @property
    def system_deflection_results(self) -> '_2262.ConicalGearMeshSystemDeflection':
