...
class StraightBevelSunGearGearWhineAnalysis(_5400.StraightBevelDiffGearGearWhineAnalysis):
    '''StraightBevelSunGearGearWhineAnalysis
    ...
    @property
    def component_design(self) -> '_2111.StraightBevelSunGear':
        ...
        return constructor.new(_2111.StraightBevelSunGear)(self.wrapped.ComponentDesign) if self.wrapped.ComponentDesign else None

    @property
    def system_deflection_results(self) -> '_2348.StraightBevelSunGearSystemDeflection':
        ...
        return constructor.new(_2348.StraightBevelSunGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
