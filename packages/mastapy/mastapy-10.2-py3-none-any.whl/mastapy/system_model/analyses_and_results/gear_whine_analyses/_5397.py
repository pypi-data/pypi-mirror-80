...
class SpringDamperConnectionGearWhineAnalysis(_5314.CouplingConnectionGearWhineAnalysis):
    '''SpringDamperConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2338.SpringDamperConnectionSystemDeflection':
        ...
        return constructor.new(_2338.SpringDamperConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
