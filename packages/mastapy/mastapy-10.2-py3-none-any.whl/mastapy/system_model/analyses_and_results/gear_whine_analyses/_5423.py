...
class ZerolBevelGearMeshGearWhineAnalysis(_5293.BevelGearMeshGearWhineAnalysis):
    '''ZerolBevelGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2367.ZerolBevelGearMeshSystemDeflection':
        ...
        return constructor.new(_2367.ZerolBevelGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
