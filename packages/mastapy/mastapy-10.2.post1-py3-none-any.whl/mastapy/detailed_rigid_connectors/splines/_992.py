...
from mastapy.detailed_rigid_connectors.splines import _1004
...
class SAESplineHalfDesign(_1004.StandardSplineHalfDesign):
    '''SAESplineHalfDesign
    ...
    @property
    def sae_accuracy_and_tolerance(self) -> '_1007.SAESplineTolerances':
        ...
        return constructor.new(_1007.SAESplineTolerances)(self.wrapped.SAEAccuracyAndTolerance) if self.wrapped.SAEAccuracyAndTolerance else None
