...
from mastapy.detailed_rigid_connectors.splines import _983
...
class SplineMaterial(_74.Material):
    '''SplineMaterial
    ...
    @property
    def heat_treatment_type(self) -> '_983.HeatTreatmentTypes':
    ...
    def heat_treatment_type(self, value: '_983.HeatTreatmentTypes'):
