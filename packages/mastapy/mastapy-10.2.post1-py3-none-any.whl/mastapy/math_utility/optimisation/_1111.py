...
from mastapy.math_utility.optimisation import _1116, _1115
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    @property
    def specification_type(self) -> '_1116.TargetingPropertyTo':
        ...
        return constructor.new(_1116.TargetingPropertyTo)(value) if value else None

    @specification_type.setter
    def specification_type(self, value: '_1116.TargetingPropertyTo'):
