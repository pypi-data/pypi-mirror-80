...
from mastapy.bolts import _1037, _1041
...
class ClampedSection(_0.APIBase):
    ...
    @property
    def material(self) -> '_1037.BoltedJointMaterial':
        ...
        if _1037.BoltedJointMaterial.TYPE not in self.wrapped.Material.__class__.__mro__:
