...
from mastapy.bolts import _1056, _1037
...
class BoltMaterial(_1037.BoltedJointMaterial):
    '''BoltMaterial
    ...
    @property
    def strength_grade(self) -> '_1056.StrengthGrades':
        ...
        return constructor.new(_1056.StrengthGrades)(value) if value else None

    @strength_grade.setter
    def strength_grade(self, value: '_1056.StrengthGrades'):
