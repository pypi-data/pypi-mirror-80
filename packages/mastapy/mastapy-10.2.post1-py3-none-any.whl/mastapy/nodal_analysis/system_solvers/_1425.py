...
from mastapy.nodal_analysis.system_solvers import _1410
...
class TransientSolver(_1410.DynamicSolver):
    '''TransientSolver
    ...
    @property
    def solver_status(self) -> '_1396.TransientSolverStatus':
        ...
        return constructor.new(_1396.TransientSolverStatus)(value) if value else None

    @solver_status.setter
    def solver_status(self, value: '_1396.TransientSolverStatus'):
