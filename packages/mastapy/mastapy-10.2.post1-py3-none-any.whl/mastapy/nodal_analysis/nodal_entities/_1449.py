...
from mastapy.math_utility.stiffness_calculators import _1095
...
class SurfaceToSurfaceContactStiffnessEntity(_1427.ArbitraryNodalComponent):
    '''SurfaceToSurfaceContactStiffnessEntity
    ...
    @property
    def contact(self) -> '_1095.SurfaceToSurfaceContact':
        ...
        return constructor.new(_1095.SurfaceToSurfaceContact)(self.wrapped.Contact) if self.wrapped.Contact else None
