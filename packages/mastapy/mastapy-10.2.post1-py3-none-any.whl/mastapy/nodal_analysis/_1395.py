...
class TransientSolverOptions(_0.APIBase):
    ...
    @property
    def solver_tolerance_input_method(self) -> '_1397.TransientSolverToleranceInputMethod':
        ...
        return constructor.new(_1397.TransientSolverToleranceInputMethod)(value) if value else None

    @solver_tolerance_input_method.setter
    def solver_tolerance_input_method(self, value: '_1397.TransientSolverToleranceInputMethod'):
    ...
    @property
    def damping_scaling_for_initial_transients(self) -> '_1369.DampingScalingTypeForInitialTransients':
        ...
        return constructor.new(_1369.DampingScalingTypeForInitialTransients)(value) if value else None

    @damping_scaling_for_initial_transients.setter
    def damping_scaling_for_initial_transients(self, value: '_1369.DampingScalingTypeForInitialTransients'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
    ...
    @property
    def result_logging_frequency(self) -> '_1391.ResultLoggingFrequency':
        ...
        return constructor.new(_1391.ResultLoggingFrequency)(value) if value else None

    @result_logging_frequency.setter
    def result_logging_frequency(self, value: '_1391.ResultLoggingFrequency'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
