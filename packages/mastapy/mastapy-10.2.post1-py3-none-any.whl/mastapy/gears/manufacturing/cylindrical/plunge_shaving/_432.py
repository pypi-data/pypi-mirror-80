...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _439, _425
...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def crossed_axis_calculation_details(self) -> '_768.CrossedAxisCylindricalGearPairLineContact':
        ...
        return constructor.new(_768.CrossedAxisCylindricalGearPairLineContact)(self.wrapped.CrossedAxisCalculationDetails) if self.wrapped.CrossedAxisCalculationDetails else None

    @property
    def points_of_interest_on_the_shaver(self) -> 'List[_439.ShaverPointOfInterest]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PointsOfInterestOnTheShaver, constructor.new(_439.ShaverPointOfInterest))
        return value

    @property
    def calculation_errors(self) -> 'List[_425.CalculationError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.CalculationErrors, constructor.new(_425.CalculationError))
        return value
