...
class CylindricalGearShaper(_519.InvoluteCutterDesign):
    '''CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self) -> '_825.ShaperEdgeTypes':
        ...
        return constructor.new(_825.ShaperEdgeTypes)(value) if value else None

    @shaper_edge_type.setter
    def shaper_edge_type(self, value: '_825.ShaperEdgeTypes'):
