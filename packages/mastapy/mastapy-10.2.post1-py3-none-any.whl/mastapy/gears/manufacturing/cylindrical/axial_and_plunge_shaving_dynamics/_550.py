...
class ShavingDynamicsCalculationForDesignedGears(_549.ShavingDynamicsCalculation['T'], Generic[T]):
    '''ShavingDynamicsCalculationForDesignedGears
    ...
    @property
    def start_of_shaving_profile(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.StartOfShavingProfile.Value) if self.wrapped.StartOfShavingProfile.Value else None

    @property
    def end_of_shaving_profile(self) -> '_782.CylindricalGearProfileMeasurement':
        ...
        return constructor.new(_782.CylindricalGearProfileMeasurement)(self.wrapped.EndOfShavingProfile.Value) if self.wrapped.EndOfShavingProfile.Value else None

    @property
    def redressing(self) -> '_547.ShaverRedressing[T]':
        ...
        if _547.ShaverRedressing[T].TYPE not in self.wrapped.Redressing.__class__.__mro__:
    ...
    @property
    def redressing_of_type_axial_shaver_redressing(self) -> '_533.AxialShaverRedressing':
        ...
        if _533.AxialShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
    ...
    @property
    def redressing_of_type_plunge_shaver_redressing(self) -> '_540.PlungeShaverRedressing':
        ...
        if _540.PlungeShaverRedressing.TYPE not in self.wrapped.Redressing.__class__.__mro__:
