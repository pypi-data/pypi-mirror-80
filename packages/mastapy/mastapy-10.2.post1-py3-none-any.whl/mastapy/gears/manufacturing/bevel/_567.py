...
from mastapy.gears.manufacturing.bevel import _578, _562
...
class ConicalMeshManufacturingAnalysis(_955.GearMeshImplementationAnalysis):
    '''ConicalMeshManufacturingAnalysis
    ...
    @property
    def conical_mesh_load_case(self) -> '_659.ConicalMeshLoadCase':
        ...
        if _659.ConicalMeshLoadCase.TYPE not in self.wrapped.ConicalMeshLoadCase.__class__.__mro__:
    ...
    @property
    def tca(self) -> '_578.EaseOffBasedTCA':
        ...
        return constructor.new(_578.EaseOffBasedTCA)(self.wrapped.TCA) if self.wrapped.TCA else None

    @property
    def meshed_gears(self) -> 'List[_562.ConicalMeshedGearManufacturingAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.MeshedGears, constructor.new(_562.ConicalMeshedGearManufacturingAnalysis))
        return value
