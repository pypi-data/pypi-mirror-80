...
from mastapy.gears.manufacturing.bevel import _581, _595
...
class ManufacturingMachine(_1346.NamedDatabaseItem):
    '''ManufacturingMachine
    ...
    @property
    def machine_type(self) -> '_581.MachineTypes':
        '''MachineTypes: 'MachineType' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.MachineType)
        return constructor.new(_581.MachineTypes)(value) if value else None

    @machine_type.setter
    def machine_type(self, value: '_581.MachineTypes'):
    ...
    @property
    def wheel_formate_machine_type(self) -> '_595.WheelFormatMachineTypes':
        ...
        return constructor.new(_595.WheelFormatMachineTypes)(value) if value else None

    @wheel_formate_machine_type.setter
    def wheel_formate_machine_type(self, value: '_595.WheelFormatMachineTypes'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
