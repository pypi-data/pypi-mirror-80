...
from mastapy.gears.gear_designs.conical.micro_geometry import _908
...
class ConicalMeshFlankMicroGeometryConfig(_0.APIBase):
    ...
    @property
    def specified_ease_off_surface(self) -> '_908.ConicalGearFlankMicroGeometry':
        ...
        return constructor.new(_908.ConicalGearFlankMicroGeometry)(self.wrapped.SpecifiedEaseOffSurface) if self.wrapped.SpecifiedEaseOffSurface else None
