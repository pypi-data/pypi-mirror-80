...
class PocketingPowerLossCoefficients(_1346.NamedDatabaseItem):
    '''PocketingPowerLossCoefficients
    ...
    @property
    def specifications_for_the_effect_of_oil_kinematic_viscosity(self) -> 'List[_146.SpecificationForTheEffectOfOilKinematicViscosity]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.SpecificationsForTheEffectOfOilKinematicViscosity, constructor.new(_146.SpecificationForTheEffectOfOilKinematicViscosity))
        return value
