...
class MicroGeometryDesignSpaceSearchCandidate(_674.DesignSpaceSearchCandidateBase['_632.CylindricalGearSetLoadDistributionAnalysis', 'MicroGeometryDesignSpaceSearchCandidate']):
    '''MicroGeometryDesignSpaceSearchCandidate
    ...
    @property
    def candidate_for_slider(self) -> '_852.CylindricalGearSetMicroGeometry':
        ...
        return constructor.new(_852.CylindricalGearSetMicroGeometry)(self.wrapped.CandidateForSlider) if self.wrapped.CandidateForSlider else None
