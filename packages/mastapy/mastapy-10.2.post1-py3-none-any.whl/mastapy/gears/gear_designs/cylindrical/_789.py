...
class CylindricalGearTableWithMGCharts(_1307.CustomTable):
    '''CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self) -> '_788.CylindricalGearTableMGItemDetail':
        ...
        return constructor.new(_788.CylindricalGearTableMGItemDetail)(value) if value else None

    @item_detail.setter
    def item_detail(self, value: '_788.CylindricalGearTableMGItemDetail'):
