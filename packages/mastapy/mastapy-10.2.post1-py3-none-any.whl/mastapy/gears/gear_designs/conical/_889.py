...
from mastapy.gears.manufacturing.bevel import _579
...
class ConicalGearDesign(_711.GearDesign):
    '''ConicalGearDesign
    ...
    @property
    def flank_measurement_border(self) -> '_579.FlankMeasurementBorder':
        ...
        return constructor.new(_579.FlankMeasurementBorder)(self.wrapped.FlankMeasurementBorder) if self.wrapped.FlankMeasurementBorder else None
