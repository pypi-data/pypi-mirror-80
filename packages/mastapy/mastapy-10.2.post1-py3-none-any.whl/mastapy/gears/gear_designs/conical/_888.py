...
class ConicalGearCutter(_0.APIBase):
    ...
    @property
    def cutter_gauge_length(self) -> '_897.CutterGaugeLengths':
        ...
        return constructor.new(_897.CutterGaugeLengths)(value) if value else None

    @cutter_gauge_length.setter
    def cutter_gauge_length(self, value: '_897.CutterGaugeLengths'):
    ...
    @property
    def cutter_blade_type(self) -> '_896.CutterBladeType':
        ...
        return constructor.new(_896.CutterBladeType)(value) if value else None

    @cutter_blade_type.setter
    def cutter_blade_type(self, value: '_896.CutterBladeType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CutterBladeType = value

    @property
    def input_toprem_as(self) -> '_905.TopremEntryType':
        ...
        return constructor.new(_905.TopremEntryType)(value) if value else None

    @input_toprem_as.setter
    def input_toprem_as(self, value: '_905.TopremEntryType'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.InputTopremAs = value

    @property
    def outer_toprem_letter_concave(self) -> '_906.TopremLetter':
        ...
        return constructor.new(_906.TopremLetter)(value) if value else None

    @outer_toprem_letter_concave.setter
    def outer_toprem_letter_concave(self, value: '_906.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.OuterTopremLetterConcave = value

    @property
    def inner_toprem_letter_convex(self) -> '_906.TopremLetter':
    ...
    def inner_toprem_letter_convex(self, value: '_906.TopremLetter'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
