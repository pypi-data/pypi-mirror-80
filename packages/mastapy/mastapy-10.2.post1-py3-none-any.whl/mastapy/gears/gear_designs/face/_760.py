...
from mastapy.gears.gear_designs.face import _759, _757, _756
...
class FaceGearSetMicroGeometry(_963.GearSetImplementationDetail):
    '''FaceGearSetMicroGeometry
    ...
    @property
    def face_mesh_micro_geometries(self) -> 'List[_756.FaceGearMeshMicroGeometry]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.FaceMeshMicroGeometries, constructor.new(_756.FaceGearMeshMicroGeometry))
        return value
