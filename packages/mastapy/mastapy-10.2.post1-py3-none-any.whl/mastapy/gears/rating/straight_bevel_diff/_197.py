...
from mastapy.gears.rating.straight_bevel_diff import _195, _196
...
class StraightBevelDiffGearSetRating(_326.ConicalGearSetRating):
    ...
    @property
    def straight_bevel_diff_gear_set(self) -> '_727.StraightBevelDiffGearSetDesign':
        ...
        return constructor.new(_727.StraightBevelDiffGearSetDesign)(self.wrapped.StraightBevelDiffGearSet) if self.wrapped.StraightBevelDiffGearSet else None

    @property
    def straight_bevel_diff_mesh_ratings(self) -> 'List[_195.StraightBevelDiffGearMeshRating]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelDiffMeshRatings, constructor.new(_195.StraightBevelDiffGearMeshRating))
        return value
