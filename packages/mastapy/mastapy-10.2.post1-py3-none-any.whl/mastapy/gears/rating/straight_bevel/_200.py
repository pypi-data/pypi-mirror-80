...
class StraightBevelGearRating(_339.BevelGearRating):
    ...
    @property
    def straight_bevel_gear(self) -> '_729.StraightBevelGearDesign':
        ...
        return constructor.new(_729.StraightBevelGearDesign)(self.wrapped.StraightBevelGear) if self.wrapped.StraightBevelGear else None
