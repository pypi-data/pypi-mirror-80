...
class AGMAGleasonConicalGearMeshRating(_323.ConicalGearMeshRating):
    ...
    @property
    def load_distribution_factor_method(self) -> '_904.LoadDistributionFactorMethods':
        ...
        return constructor.new(_904.LoadDistributionFactorMethods)(value) if value else None
