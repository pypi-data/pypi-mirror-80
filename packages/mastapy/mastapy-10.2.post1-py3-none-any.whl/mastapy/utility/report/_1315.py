...
from mastapy.utility.report import _1314, _1307
...
class UserTextRow(_1307.CustomRow):
    '''UserTextRow
    ...
    @property
    def heading_size(self) -> '_1314.HeadingSize':
        '''HeadingSize: 'HeadingSize' is the original name of this property.'''

        value = conversion.pn_to_mp_enum(self.wrapped.HeadingSize)
        return constructor.new(_1314.HeadingSize)(value) if value else None

    @heading_size.setter
    def heading_size(self, value: '_1314.HeadingSize'):
