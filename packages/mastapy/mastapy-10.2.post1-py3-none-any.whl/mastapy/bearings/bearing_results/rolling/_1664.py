...
from mastapy.bearings.bearing_results.rolling import _1663, _1630
...
class LoadedSelfAligningBallBearingRow(_1630.LoadedBallBearingRow):
    '''LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1663.LoadedSelfAligningBallBearingResults':
        ...
        return constructor.new(_1663.LoadedSelfAligningBallBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
