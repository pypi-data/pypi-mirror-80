...
from mastapy.bearings.bearing_results.rolling import _1648, _1637
...
class LoadedNeedleRollerBearingRow(_1637.LoadedCylindricalRollerBearingRow):
    '''LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1648.LoadedNeedleRollerBearingResults':
        ...
        return constructor.new(_1648.LoadedNeedleRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
