...
from mastapy.bearings.bearing_results import _1580
...
class RollingBearingFrictionCoefficients(_1138.IndependentReportablePropertiesBase['RollingBearingFrictionCoefficients']):
    '''RollingBearingFrictionCoefficients
    ...
    @property
    def iso14179_static_equivalent_load_factors(self) -> '_1580.EquivalentLoadFactors':
        ...
        return constructor.new(_1580.EquivalentLoadFactors)(self.wrapped.ISO14179StaticEquivalentLoadFactors) if self.wrapped.ISO14179StaticEquivalentLoadFactors else None

    @property
    def iso14179_dynamic_equivalent_load_factors(self) -> '_1580.EquivalentLoadFactors':
        ...
        return constructor.new(_1580.EquivalentLoadFactors)(self.wrapped.ISO14179DynamicEquivalentLoadFactors) if self.wrapped.ISO14179DynamicEquivalentLoadFactors else None
