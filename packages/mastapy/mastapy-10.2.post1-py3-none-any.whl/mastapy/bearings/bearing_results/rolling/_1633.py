...
from mastapy.bearings.bearing_results.rolling import _1632, _1657
...
class LoadedCrossedRollerBearingRow(_1657.LoadedRollerBearingRow):
    '''LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1632.LoadedCrossedRollerBearingResults':
        ...
        return constructor.new(_1632.LoadedCrossedRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
