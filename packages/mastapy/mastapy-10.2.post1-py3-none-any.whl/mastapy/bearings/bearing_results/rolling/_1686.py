...
from mastapy.bearings.bearing_results.rolling import _1685, _1657
...
class LoadedToroidalRollerBearingRow(_1657.LoadedRollerBearingRow):
    '''LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self) -> '_1685.LoadedToroidalRollerBearingResults':
        ...
        return constructor.new(_1685.LoadedToroidalRollerBearingResults)(self.wrapped.LoadedBearing) if self.wrapped.LoadedBearing else None
