...
from mastapy.bearings.bearing_results.rolling import _1698, _1651
...
class LoadedCylindricalRollerBearingResults(_1651.LoadedNonBarrelRollerBearingResults):
    '''LoadedCylindricalRollerBearingResults
    ...
    @property
    def skf_maximal_constantly_acting_axial_load(self) -> '_1698.SKFMaximalConstantlyActingAxialLoadResults':
        ...
        return constructor.new(_1698.SKFMaximalConstantlyActingAxialLoadResults)(self.wrapped.SKFMaximalConstantlyActingAxialLoad) if self.wrapped.SKFMaximalConstantlyActingAxialLoad else None
