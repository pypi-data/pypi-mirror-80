...
from mastapy.bearings import (
    _1534, _1537, _1513, _1514,
    _1515, _1516
)
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.bearings.bearing_designs.rolling import (
    _1786, _1770, _1768, _1764,
    _1779, _1761
)
...
class RollingBearing(_1749.DetailedBearing):
    '''RollingBearing
    ...
    @property
    def catalogue(self) -> '_1513.BearingCatalog':
        ...
        return constructor.new(_1513.BearingCatalog)(value) if value else None
    ...
    @property
    def type_information(self) -> '_1764.BearingTypeExtraInformation':
        ...
        return constructor.new(_1764.BearingTypeExtraInformation)(value) if value else None
    ...
    @property
    def cage_material(self) -> '_1516.BearingCageMaterial':
        ...
        return constructor.new(_1516.BearingCageMaterial)(value) if value else None

    @cage_material.setter
    def cage_material(self, value: '_1516.BearingCageMaterial'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.CageMaterial = value

    @property
    def sleeve_type(self) -> '_1779.SleeveType':
        ...
        return constructor.new(_1779.SleeveType)(value) if value else None
    ...
    @property
    def protection(self) -> '_1761.BearingProtection':
        ...
        return constructor.new(_1761.BearingProtection)(self.wrapped.Protection) if self.wrapped.Protection else None
