...
class TorqueConverterGearWhineAnalysis(_5315.CouplingGearWhineAnalysis):
    '''TorqueConverterGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2358.TorqueConverterSystemDeflection':
        ...
        return constructor.new(_2358.TorqueConverterSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
