...
class ConceptGearGearWhineAnalysis(_5343.GearGearWhineAnalysis):
    '''ConceptGearGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2260.ConceptGearSystemDeflection':
        ...
        return constructor.new(_2260.ConceptGearSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
