...
class CVTGearWhineAnalysis(_5286.BeltDriveGearWhineAnalysis):
    '''CVTGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2272.CVTSystemDeflection':
        ...
        return constructor.new(_2272.CVTSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
