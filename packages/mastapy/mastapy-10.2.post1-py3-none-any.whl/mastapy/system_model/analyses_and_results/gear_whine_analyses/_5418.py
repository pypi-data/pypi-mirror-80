...
class VirtualComponentGearWhineAnalysis(_5371.MountableComponentGearWhineAnalysis):
    '''VirtualComponentGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2363.VirtualComponentSystemDeflection':
