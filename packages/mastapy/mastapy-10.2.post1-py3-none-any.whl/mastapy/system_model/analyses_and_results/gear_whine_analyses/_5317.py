...
class CVTBeltConnectionGearWhineAnalysis(_5285.BeltConnectionGearWhineAnalysis):
    '''CVTBeltConnectionGearWhineAnalysis
    ...
    @property
    def connection_design(self) -> '_1856.CVTBeltConnection':
    ...
    @property
    def system_deflection_results(self) -> '_2270.CVTBeltConnectionSystemDeflection':
        ...
        return constructor.new(_2270.CVTBeltConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
