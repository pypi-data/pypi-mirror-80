...
class MassDiscGearWhineAnalysis(_5418.VirtualComponentGearWhineAnalysis):
    '''MassDiscGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2310.MassDiscSystemDeflection':
        ...
        return constructor.new(_2310.MassDiscSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
