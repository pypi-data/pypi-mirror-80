...
class RollingRingGearWhineAnalysis(_5316.CouplingHalfGearWhineAnalysis):
    '''RollingRingGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2327.RollingRingSystemDeflection':
        ...
        return constructor.new(_2327.RollingRingSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
