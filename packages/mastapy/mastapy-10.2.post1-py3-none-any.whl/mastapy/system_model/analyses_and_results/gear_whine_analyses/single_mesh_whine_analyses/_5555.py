...
from mastapy.system_model.analyses_and_results.gear_whine_analyses.single_mesh_whine_analyses import _5556, _5554, _5489
...
class WormGearSetSingleMeshWhineAnalysis(_5489.GearSetSingleMeshWhineAnalysis):
    '''WormGearSetSingleMeshWhineAnalysis
    ...
    @property
    def worm_gears_single_mesh_whine_analysis(self) -> 'List[_5556.WormGearSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormGearsSingleMeshWhineAnalysis, constructor.new(_5556.WormGearSingleMeshWhineAnalysis))
        return value

    @property
    def worm_meshes_single_mesh_whine_analysis(self) -> 'List[_5554.WormGearMeshSingleMeshWhineAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.WormMeshesSingleMeshWhineAnalysis, constructor.new(_5554.WormGearMeshSingleMeshWhineAnalysis))
        return value
