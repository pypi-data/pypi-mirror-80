...
from mastapy.system_model.analyses_and_results.gear_whine_analyses import (
    _5278, _5326, _5327, _5328,
    _5329, _5330, _5331, _5332,
    _5333, _5334, _5335, _5336,
    _5344, _5346, _5347, _5352,
    _5377, _5391, _5416
)
...
class SingleMeshWhineAnalysis(_6526.StaticLoadAnalysisCase):
    '''SingleMeshWhineAnalysis
    ...
    @property
    def excitation_detail(self) -> '_5278.AbstractPeriodicExcitationDetail':
        ...
        if _5278.AbstractPeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_periodic_excitation_detail(self) -> '_5326.ElectricMachinePeriodicExcitationDetail':
        ...
        if _5326.ElectricMachinePeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_rotor_x_force_periodic_excitation_detail(self) -> '_5327.ElectricMachineRotorXForcePeriodicExcitationDetail':
        ...
        if _5327.ElectricMachineRotorXForcePeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_rotor_x_moment_periodic_excitation_detail(self) -> '_5328.ElectricMachineRotorXMomentPeriodicExcitationDetail':
        ...
        if _5328.ElectricMachineRotorXMomentPeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_rotor_y_force_periodic_excitation_detail(self) -> '_5329.ElectricMachineRotorYForcePeriodicExcitationDetail':
        ...
        if _5329.ElectricMachineRotorYForcePeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_rotor_y_moment_periodic_excitation_detail(self) -> '_5330.ElectricMachineRotorYMomentPeriodicExcitationDetail':
        ...
        if _5330.ElectricMachineRotorYMomentPeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_rotor_z_force_periodic_excitation_detail(self) -> '_5331.ElectricMachineRotorZForcePeriodicExcitationDetail':
        ...
        if _5331.ElectricMachineRotorZForcePeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_stator_tooth_axial_loads_excitation_detail(self) -> '_5332.ElectricMachineStatorToothAxialLoadsExcitationDetail':
        ...
        if _5332.ElectricMachineStatorToothAxialLoadsExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_stator_tooth_loads_excitation_detail(self) -> '_5333.ElectricMachineStatorToothLoadsExcitationDetail':
        ...
        if _5333.ElectricMachineStatorToothLoadsExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_stator_tooth_radial_loads_excitation_detail(self) -> '_5334.ElectricMachineStatorToothRadialLoadsExcitationDetail':
        ...
        if _5334.ElectricMachineStatorToothRadialLoadsExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_stator_tooth_tangential_loads_excitation_detail(self) -> '_5335.ElectricMachineStatorToothTangentialLoadsExcitationDetail':
        ...
        if _5335.ElectricMachineStatorToothTangentialLoadsExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_electric_machine_torque_ripple_periodic_excitation_detail(self) -> '_5336.ElectricMachineTorqueRipplePeriodicExcitationDetail':
        ...
        if _5336.ElectricMachineTorqueRipplePeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_gear_mesh_excitation_detail(self) -> '_5344.GearMeshExcitationDetail':
        ...
        if _5344.GearMeshExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_gear_mesh_misalignment_excitation_detail(self) -> '_5346.GearMeshMisalignmentExcitationDetail':
        ...
        if _5346.GearMeshMisalignmentExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_gear_mesh_te_excitation_detail(self) -> '_5347.GearMeshTEExcitationDetail':
        ...
        if _5347.GearMeshTEExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_general_periodic_excitation_detail(self) -> '_5352.GeneralPeriodicExcitationDetail':
        ...
        if _5352.GeneralPeriodicExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_periodic_excitation_with_reference_shaft(self) -> '_5377.PeriodicExcitationWithReferenceShaft':
        ...
        if _5377.PeriodicExcitationWithReferenceShaft.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_single_node_periodic_excitation_with_reference_shaft(self) -> '_5391.SingleNodePeriodicExcitationWithReferenceShaft':
        ...
        if _5391.SingleNodePeriodicExcitationWithReferenceShaft.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
    ...
    @property
    def excitation_detail_of_type_unbalanced_mass_excitation_detail(self) -> '_5416.UnbalancedMassExcitationDetail':
        ...
        if _5416.UnbalancedMassExcitationDetail.TYPE not in self.wrapped.ExcitationDetail.__class__.__mro__:
