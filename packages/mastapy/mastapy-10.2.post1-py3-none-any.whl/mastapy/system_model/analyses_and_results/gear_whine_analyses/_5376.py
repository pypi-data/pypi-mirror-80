...
class PartToPartShearCouplingHalfGearWhineAnalysis(_5316.CouplingHalfGearWhineAnalysis):
    '''PartToPartShearCouplingHalfGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2318.PartToPartShearCouplingHalfSystemDeflection':
        ...
        return constructor.new(_2318.PartToPartShearCouplingHalfSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
