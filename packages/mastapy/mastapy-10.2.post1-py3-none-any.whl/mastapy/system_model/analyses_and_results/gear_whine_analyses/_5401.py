...
class StraightBevelDiffGearMeshGearWhineAnalysis(_5293.BevelGearMeshGearWhineAnalysis):
    '''StraightBevelDiffGearMeshGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2341.StraightBevelDiffGearMeshSystemDeflection':
        ...
        return constructor.new(_2341.StraightBevelDiffGearMeshSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
