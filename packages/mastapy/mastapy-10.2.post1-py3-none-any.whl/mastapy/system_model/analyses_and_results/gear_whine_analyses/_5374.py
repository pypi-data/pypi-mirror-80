...
class PartToPartShearCouplingConnectionGearWhineAnalysis(_5314.CouplingConnectionGearWhineAnalysis):
    '''PartToPartShearCouplingConnectionGearWhineAnalysis
    ...
    @property
    def system_deflection_results(self) -> '_2317.PartToPartShearCouplingConnectionSystemDeflection':
        ...
        return constructor.new(_2317.PartToPartShearCouplingConnectionSystemDeflection)(self.wrapped.SystemDeflectionResults) if self.wrapped.SystemDeflectionResults else None
