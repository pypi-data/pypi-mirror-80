...
from mastapy.system_model.analyses_and_results.modal_analyses import _4833, _4832, _4740
...
class StraightBevelGearSetModalAnalysis(_4740.BevelGearSetModalAnalysis):
    '''StraightBevelGearSetModalAnalysis
    ...
    @property
    def straight_bevel_gears_modal_analysis(self) -> 'List[_4833.StraightBevelGearModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsModalAnalysis, constructor.new(_4833.StraightBevelGearModalAnalysis))
        return value

    @property
    def straight_bevel_meshes_modal_analysis(self) -> 'List[_4832.StraightBevelGearMeshModalAnalysis]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesModalAnalysis, constructor.new(_4832.StraightBevelGearMeshModalAnalysis))
        return value
