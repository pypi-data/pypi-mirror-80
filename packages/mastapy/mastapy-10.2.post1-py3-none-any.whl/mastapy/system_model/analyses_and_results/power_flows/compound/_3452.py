...
class RootAssemblyCompoundPowerFlow(_3371.AssemblyCompoundPowerFlow):
    ...
    @property
    def compound_static_load(self) -> '_5259.AbstractStaticLoadCaseGroup':
        ...
        if _5259.AbstractStaticLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_abstract_design_state_load_case_group(self) -> '_5257.AbstractDesignStateLoadCaseGroup':
        ...
        if _5257.AbstractDesignStateLoadCaseGroup.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_design_state(self) -> '_5262.DesignState':
        ...
        if _5262.DesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_duty_cycle(self) -> '_5263.DutyCycle':
        ...
        if _5263.DutyCycle.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
    ...
    @property
    def compound_static_load_of_type_sub_group_in_single_design_state(self) -> '_5267.SubGroupInSingleDesignState':
        ...
        if _5267.SubGroupInSingleDesignState.TYPE not in self.wrapped.CompoundStaticLoad.__class__.__mro__:
