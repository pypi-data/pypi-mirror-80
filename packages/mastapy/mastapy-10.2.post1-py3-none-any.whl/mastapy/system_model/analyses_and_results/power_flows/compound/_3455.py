...
from mastapy.system_model.analyses_and_results.power_flows.compound import _3399
...
class ShaftToMountableComponentConnectionCompoundPowerFlow(_3399.ConnectionCompoundPowerFlow):
    '''ShaftToMountableComponentConnectionCompoundPowerFlow
