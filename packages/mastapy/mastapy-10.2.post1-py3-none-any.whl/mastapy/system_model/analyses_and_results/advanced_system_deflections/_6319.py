...
from mastapy.system_model.analyses_and_results.advanced_system_deflections import _6335, _6357
...
class GearSetAdvancedSystemDeflection(_6357.SpecialisedAssemblyAdvancedSystemDeflection):
    '''GearSetAdvancedSystemDeflection
    ...
    @property
    def use_ltca_in_advanced_system_deflection(self) -> '_6335.UseLtcaInAsdOption':
        ...
        return constructor.new(_6335.UseLtcaInAsdOption)(value) if value else None

    @use_ltca_in_advanced_system_deflection.setter
    def use_ltca_in_advanced_system_deflection(self, value: '_6335.UseLtcaInAsdOption'):
