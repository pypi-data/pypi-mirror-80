...
class TorqueConverterAdvancedSystemDeflection(_6300.CouplingAdvancedSystemDeflection):
    '''TorqueConverterAdvancedSystemDeflection
    ...
    @property
    def assembly_load_case(self) -> '_6229.TorqueConverterLoadCase':
        ...
        return constructor.new(_6229.TorqueConverterLoadCase)(self.wrapped.AssemblyLoadCase) if self.wrapped.AssemblyLoadCase else None

    @property
    def assembly_system_deflection_results(self) -> 'List[_2358.TorqueConverterSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2358.TorqueConverterSystemDeflection))
        return value
