...
from mastapy.system_model.analyses_and_results.system_deflections import _2308, _2355
...
class SystemDeflection(_6520.FEAnalysis):
    '''SystemDeflection
    ...
    @property
    def overall_efficiency_results(self) -> '_2308.LoadCaseOverallEfficiencyResult':
        ...
        return constructor.new(_2308.LoadCaseOverallEfficiencyResult)(self.wrapped.OverallEfficiencyResults) if self.wrapped.OverallEfficiencyResults else None

    @property
    def analysis_options(self) -> '_2355.SystemDeflectionOptions':
        ...
        return constructor.new(_2355.SystemDeflectionOptions)(self.wrapped.AnalysisOptions) if self.wrapped.AnalysisOptions else None

    @property
    def bearing_race_fes(self) -> 'List[_1986.RaceBearingFESystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.BearingRaceFEs, constructor.new(_1986.RaceBearingFESystemDeflection))
        return value
