...
class ConicalGearMeshCompoundSystemDeflection(_2432.GearMeshCompoundSystemDeflection):
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_2262.ConicalGearMeshSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_2262.ConicalGearMeshSystemDeflection))
        return value
