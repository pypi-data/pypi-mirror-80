...
from mastapy.system_model.analyses_and_results.static_loads import _6232, _6161, _6206
...
class ElectricMachineHarmonicLoadData(_6206.SpeedDependentHarmonicLoadData):
    '''ElectricMachineHarmonicLoadData
    ...
    @property
    def force_distribution(self) -> '_6534.SMTBitmap':
        ...
        return constructor.new(_6534.SMTBitmap)(self.wrapped.ForceDistribution) if self.wrapped.ForceDistribution else None
