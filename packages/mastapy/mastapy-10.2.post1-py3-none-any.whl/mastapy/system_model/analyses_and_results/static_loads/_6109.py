...
from mastapy.gears.gear_designs.conical import _901, _895
...
class ConicalGearMeshLoadCase(_6149.GearMeshLoadCase):
    '''ConicalGearMeshLoadCase
    ...
    @property
    def results_from_imported_xml(self) -> '_901.KimosBevelHypoidSingleLoadCaseResultsData':
        ...
        return constructor.new(_901.KimosBevelHypoidSingleLoadCaseResultsData)(self.wrapped.ResultsFromImportedXML) if self.wrapped.ResultsFromImportedXML else None
