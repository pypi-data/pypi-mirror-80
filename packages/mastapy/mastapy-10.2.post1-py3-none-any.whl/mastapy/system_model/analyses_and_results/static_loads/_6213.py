...
from mastapy.system_model.analyses_and_results import _2229
from mastapy.system_model.analyses_and_results.gear_whine_analyses import _5351
from mastapy.system_model.analyses_and_results.load_case_groups import _5260, _5261, _5262
...
class StaticLoadCase(_6074.LoadCase):
    '''StaticLoadCase
    ...
    @property
    def planetary_rating_load_sharing_method(self) -> '_141.PlanetaryRatingLoadSharingOption':
    ...
    def planetary_rating_load_sharing_method(self, value: '_141.PlanetaryRatingLoadSharingOption'):
    ...
    @property
    def te_set_up_for_dynamic_analyses_options(self) -> '_2229.TESetUpForDynamicAnalysisOptions':
        ...
        return constructor.new(_2229.TESetUpForDynamicAnalysisOptions)(self.wrapped.TESetUpForDynamicAnalysesOptions) if self.wrapped.TESetUpForDynamicAnalysesOptions else None

    @property
    def gear_whine_harmonic_excitation_analysis_options(self) -> '_5351.GearWhineAnalysisOptions':
        ...
        return constructor.new(_5351.GearWhineAnalysisOptions)(self.wrapped.GearWhineHarmonicExcitationAnalysisOptions) if self.wrapped.GearWhineHarmonicExcitationAnalysisOptions else None

    @property
    def clutch_engagements(self) -> 'List[_5260.ClutchEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ClutchEngagements, constructor.new(_5260.ClutchEngagementStatus))
        return value

    @property
    def concept_clutch_engagements(self) -> 'List[_5261.ConceptSynchroGearEngagementStatus]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConceptClutchEngagements, constructor.new(_5261.ConceptSynchroGearEngagementStatus))
        return value

    def duplicate(self, new_design_state_group: '_5262.DesignState', name: Optional['str'] = 'None') -> 'StaticLoadCase':
