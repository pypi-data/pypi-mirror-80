...
from mastapy.system_model.analyses_and_results.static_loads import _6150, _6155
...
class GearSetHarmonicLoadData(_6155.HarmonicLoadDataBase):
    '''GearSetHarmonicLoadData
    ...
    @property
    def gear_mesh_te_order_type(self) -> '_6150.GearMeshTEOrderType':
        ...
        return constructor.new(_6150.GearMeshTEOrderType)(value) if value else None

    @gear_mesh_te_order_type.setter
    def gear_mesh_te_order_type(self, value: '_6150.GearMeshTEOrderType'):
