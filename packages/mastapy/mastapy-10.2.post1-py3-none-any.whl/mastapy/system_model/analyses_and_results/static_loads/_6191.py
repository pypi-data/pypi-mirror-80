...
from mastapy.system_model.analyses_and_results.static_loads import _6190, _6180
...
class PlanetCarrierLoadCase(_6180.MountableComponentLoadCase):
    '''PlanetCarrierLoadCase
    ...
    @property
    def planet_manufacture_errors(self) -> 'List[_6190.PlanetarySocketManufactureError]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.PlanetManufactureErrors, constructor.new(_6190.PlanetarySocketManufactureError))
        return value
