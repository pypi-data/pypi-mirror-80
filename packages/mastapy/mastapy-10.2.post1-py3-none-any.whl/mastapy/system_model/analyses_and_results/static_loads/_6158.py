...
from mastapy.system_model.analyses_and_results.static_loads import _6161, _6157, _6138
...
class HarmonicLoadDataImportFromMotorPackages(_6157.HarmonicLoadDataImportBase['T'], Generic[T]):
    '''HarmonicLoadDataImportFromMotorPackages
