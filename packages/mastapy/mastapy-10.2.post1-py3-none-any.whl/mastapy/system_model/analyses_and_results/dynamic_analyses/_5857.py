...
class ConnectionDynamicAnalysis(_6516.ConnectionFEAnalysis):
    '''ConnectionDynamicAnalysis
    ...
    @property
    def dynamic_analysis(self) -> '_5870.DynamicAnalysis':
        ...
        if _5870.DynamicAnalysis.TYPE not in self.wrapped.DynamicAnalysis.__class__.__mro__:
