...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5057, _5095, _5090
...
class MBDRunUpAnalysisOptions(_6512.AbstractAnalysisOptions['_6227.TimeSeriesLoadCase']):
    '''MBDRunUpAnalysisOptions
    ...
    @property
    def input_velocity_processing_type(self) -> '_5057.InputVelocityForRunUpProcessingType':
        ...
        return constructor.new(_5057.InputVelocityForRunUpProcessingType)(value) if value else None

    @input_velocity_processing_type.setter
    def input_velocity_processing_type(self, value: '_5057.InputVelocityForRunUpProcessingType'):
    ...
    @property
    def shape_of_initial_acceleration_period(self) -> '_5095.ShapeOfInitialAccelerationPeriodForRunUp':
        ...
        return constructor.new(_5095.ShapeOfInitialAccelerationPeriodForRunUp)(value) if value else None

    @shape_of_initial_acceleration_period.setter
    def shape_of_initial_acceleration_period(self, value: '_5095.ShapeOfInitialAccelerationPeriodForRunUp'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
        self.wrapped.ShapeOfInitialAccelerationPeriod = value

    @property
    def run_up_driving_mode(self) -> '_5090.RunUpDrivingMode':
        ...
        return constructor.new(_5090.RunUpDrivingMode)(value) if value else None

    @run_up_driving_mode.setter
    def run_up_driving_mode(self, value: '_5090.RunUpDrivingMode'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
