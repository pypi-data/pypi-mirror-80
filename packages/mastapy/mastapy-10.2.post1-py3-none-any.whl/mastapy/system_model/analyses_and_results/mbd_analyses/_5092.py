...
from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5132, _5134
...
class ShaftHubConnectionMultiBodyDynamicsAnalysis(_5028.ConnectorMultiBodyDynamicsAnalysis):
    '''ShaftHubConnectionMultiBodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force_angular(self) -> '_5134.DynamicTorqueVector3DResult':
        ...
        return constructor.new(_5134.DynamicTorqueVector3DResult)(self.wrapped.PeakDynamicForceAngular) if self.wrapped.PeakDynamicForceAngular else None
