...
class StabilityAnalysis(_6526.StaticLoadAnalysisCase):
    '''StabilityAnalysis
    ...
    @property
    def modal_analyses_at_speeds_options(self) -> '_4063.ModalAnalysesAtSpeedsOptions':
        ...
        return constructor.new(_4063.ModalAnalysesAtSpeedsOptions)(self.wrapped.ModalAnalysesAtSpeedsOptions) if self.wrapped.ModalAnalysesAtSpeedsOptions else None
