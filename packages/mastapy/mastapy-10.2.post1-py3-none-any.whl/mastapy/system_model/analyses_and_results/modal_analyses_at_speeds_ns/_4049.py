...
from mastapy.system_model.analyses_and_results.modal_analyses_at_speeds_ns import _4048, _4047, _3995
...
class HypoidGearSetModalAnalysesAtSpeeds(_3995.AGMAGleasonConicalGearSetModalAnalysesAtSpeeds):
    '''HypoidGearSetModalAnalysesAtSpeeds
    ...
    @property
    def hypoid_gears_modal_analyses_at_speeds(self) -> 'List[_4048.HypoidGearModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidGearsModalAnalysesAtSpeeds, constructor.new(_4048.HypoidGearModalAnalysesAtSpeeds))
        return value

    @property
    def hypoid_meshes_modal_analyses_at_speeds(self) -> 'List[_4047.HypoidGearMeshModalAnalysesAtSpeeds]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.HypoidMeshesModalAnalysesAtSpeeds, constructor.new(_4047.HypoidGearMeshModalAnalysesAtSpeeds))
        return value
