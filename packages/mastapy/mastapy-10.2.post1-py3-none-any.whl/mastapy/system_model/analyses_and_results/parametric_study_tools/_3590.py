...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3573, _3492
...
class RootAssemblyParametricStudyTool(_3492.AssemblyParametricStudyTool):
    ...
    @property
    def parametric_study_tool_inputs(self) -> '_3573.ParametricStudyTool':
        ...
        return constructor.new(_3573.ParametricStudyTool)(self.wrapped.ParametricStudyToolInputs) if self.wrapped.ParametricStudyToolInputs else None

    @property
    def root_assembly_duty_cycle_results(self) -> 'List[_2425.DutyCycleEfficiencyResults]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.RootAssemblyDutyCycleResults, constructor.new(_2425.DutyCycleEfficiencyResults))
        return value
