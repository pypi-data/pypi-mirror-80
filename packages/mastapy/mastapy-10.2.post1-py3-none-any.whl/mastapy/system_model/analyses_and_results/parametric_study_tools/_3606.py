...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3605, _3604, _3503
...
class StraightBevelGearSetParametricStudyTool(_3503.BevelGearSetParametricStudyTool):
    ...
    @property
    def straight_bevel_gears_parametric_study_tool(self) -> 'List[_3605.StraightBevelGearParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelGearsParametricStudyTool, constructor.new(_3605.StraightBevelGearParametricStudyTool))
        return value

    @property
    def straight_bevel_meshes_parametric_study_tool(self) -> 'List[_3604.StraightBevelGearMeshParametricStudyTool]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.StraightBevelMeshesParametricStudyTool, constructor.new(_3604.StraightBevelGearMeshParametricStudyTool))
        return value
