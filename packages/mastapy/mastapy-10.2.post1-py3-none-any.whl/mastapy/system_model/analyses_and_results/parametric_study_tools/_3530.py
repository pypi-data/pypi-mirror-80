...
from mastapy.system_model.analyses_and_results.parametric_study_tools import _3529, _3528, _3547
...
class CylindricalGearSetParametricStudyTool(_3547.GearSetParametricStudyTool):
    '''CylindricalGearSetParametricStudyTool
    ...
    @property
    def assembly_system_deflection_results(self) -> 'List[_2276.CylindricalGearSetSystemDeflection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.AssemblySystemDeflectionResults, constructor.new(_2276.CylindricalGearSetSystemDeflection))
        return value
