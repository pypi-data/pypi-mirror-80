...
class ParametricStudyDOEResultVariable(_1111.ParetoOptimisationVariableBase):
    '''ParametricStudyDOEResultVariable
    ...
    @property
    def target(self) -> '_1113.PropertyTargetForDominantCandidateSearch':
    ...
    @target.setter
    def target(self, value: '_1113.PropertyTargetForDominantCandidateSearch'):
