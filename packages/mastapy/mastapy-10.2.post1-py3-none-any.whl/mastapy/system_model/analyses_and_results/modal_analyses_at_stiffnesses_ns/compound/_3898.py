...
class ConceptGearMeshCompoundModalAnalysesAtStiffnesses(_3922.GearMeshCompoundModalAnalysesAtStiffnesses):
    '''ConceptGearMeshCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def component_design(self) -> '_1885.ConceptGearMesh':
    ...
    @property
    def connection_design(self) -> '_1885.ConceptGearMesh':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3773.ConceptGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3773.ConceptGearMeshModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3773.ConceptGearMeshModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_3773.ConceptGearMeshModalAnalysesAtStiffnesses))
        return value
