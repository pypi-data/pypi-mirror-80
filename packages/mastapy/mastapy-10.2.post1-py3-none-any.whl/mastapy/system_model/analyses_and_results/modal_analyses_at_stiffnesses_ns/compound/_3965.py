...
class SpringDamperConnectionCompoundModalAnalysesAtStiffnesses(_3906.CouplingConnectionCompoundModalAnalysesAtStiffnesses):
    '''SpringDamperConnectionCompoundModalAnalysesAtStiffnesses
    ...
    @property
    def component_design(self) -> '_1921.SpringDamperConnection':
    ...
    @property
    def connection_design(self) -> '_1921.SpringDamperConnection':
    ...
    @property
    def load_case_analyses_ready(self) -> 'List[_3843.SpringDamperConnectionModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.LoadCaseAnalysesReady, constructor.new(_3843.SpringDamperConnectionModalAnalysesAtStiffnesses))
        return value

    @property
    def connection_modal_analyses_at_stiffnesses_load_cases(self) -> 'List[_3843.SpringDamperConnectionModalAnalysesAtStiffnesses]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ConnectionModalAnalysesAtStiffnessesLoadCases, constructor.new(_3843.SpringDamperConnectionModalAnalysesAtStiffnesses))
        return value
