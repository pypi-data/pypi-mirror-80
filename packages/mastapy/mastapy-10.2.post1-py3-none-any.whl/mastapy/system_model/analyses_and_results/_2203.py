...
class DesignEntityAnalysis(_0.APIBase):
    ...
    @property
    def safety_factors(self) -> '_82.SafetyFactorGroup':
        ...
        return constructor.new(_82.SafetyFactorGroup)(self.wrapped.SafetyFactors) if self.wrapped.SafetyFactors else None

    @property
    def component_design(self) -> '_1814.DesignEntity':
        ...
        if _1814.DesignEntity.TYPE not in self.wrapped.ComponentDesign.__class__.__mro__:
    ...
    @property
    def component_design_of_type_connection(self) -> '_1855.Connection':
    ...
    @property
    def component_design_of_type_part(self) -> '_2031.Part':
