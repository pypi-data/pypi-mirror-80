...
class OilSeal(_2012.Connector):
    ...
    @property
    def oil_seal_material(self) -> '_103.OilSealMaterialType':
        ...
        return constructor.new(_103.OilSealMaterialType)(value) if value else None

    @oil_seal_material.setter
    def oil_seal_material(self, value: '_103.OilSealMaterialType'):
    ...
    @property
    def oil_seal_orientation(self) -> '_1594.Orientations':
    ...
    def oil_seal_orientation(self, value: '_1594.Orientations'):
        value = value if value else None
        value = conversion.mp_to_pn_enum(value)
