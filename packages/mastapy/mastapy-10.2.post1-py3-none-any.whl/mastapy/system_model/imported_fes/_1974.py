...
class IndependentMastaCreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self) -> '_1477.RigidCouplingType':
        ...
        return constructor.new(_1477.RigidCouplingType)(value) if value else None

    @rigid_coupling_type.setter
    def rigid_coupling_type(self, value: '_1477.RigidCouplingType'):
    ...
    @property
    def imported_fe_node(self) -> '_1967.ImportedFEStiffnessNode':
        ...
        return constructor.new(_1967.ImportedFEStiffnessNode)(self.wrapped.ImportedFENode) if self.wrapped.ImportedFENode else None
