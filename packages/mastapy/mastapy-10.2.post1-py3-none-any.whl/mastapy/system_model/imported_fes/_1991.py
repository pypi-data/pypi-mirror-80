...
from mastapy.system_model.imported_fes import _1984, _1983
...
class SystemDeflectionFEExportOptions(_0.APIBase):
    ...
    @property
    def nodes(self) -> 'List[_1984.PerNodeExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Nodes, constructor.new(_1984.PerNodeExportOptions))
        return value

    @property
    def links(self) -> 'List[_1983.PerLinkExportOptions]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.Links, constructor.new(_1983.PerLinkExportOptions))
        return value
