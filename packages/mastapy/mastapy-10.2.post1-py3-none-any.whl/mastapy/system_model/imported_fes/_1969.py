...
class ImportedFEWithSelection(_1932.BaseFEWithSelection):
    '''ImportedFEWithSelection
    ...
    @property
    def imported_fe(self) -> '_1955.ImportedFE':
        ...
        return constructor.new(_1955.ImportedFE)(self.wrapped.ImportedFE) if self.wrapped.ImportedFE else None

    @property
    def element_face_groups(self) -> 'List[_1946.ElementFaceGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.ElementFaceGroups, constructor.new(_1946.ElementFaceGroupWithSelection))
        return value

    @property
    def node_groups(self) -> 'List[_1980.NodeGroupWithSelection]':
        ...
        value = conversion.pn_to_mp_objects_in_list(self.wrapped.NodeGroups, constructor.new(_1980.NodeGroupWithSelection))
        return value
