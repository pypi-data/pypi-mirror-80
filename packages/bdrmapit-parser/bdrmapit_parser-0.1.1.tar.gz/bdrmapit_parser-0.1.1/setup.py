...
extensions_names = {
    'bdrmapit.bdrmapit_parser.graph.node': ['bdrmapit/bdrmapit_parser/graph/node' + ext_pyx],
    'bdrmapit.bdrmapit_parser.graph.construct': ['bdrmapit/bdrmapit_parser/graph/construct' + ext_pyx],
    'bdrmapit.bdrmapit_parser.algorithm.updates_dict': ['bdrmapit/bdrmapit_parser/algorithm/updates_dict' + ext_pyx],
}
