...
from toolkit_w.internal.vars_global import ProblemType, FeatureType, Estimator, TargetMetric, SplittingStrategy, Pipeline, \
...
class Dataset(APIResource):
    ...
    def list(cls, search_term: str = None, page: int = None, page_size: int = None, sort: Dict = None,
        ...
        Returns:
            WhatifyResponse: Datasets are represented as nested dictionaries under `hits`.
        """
    ...
    def get(cls, id: int, api_key: str = None) -> WhatifyResponse:
        ...
        Returns:
            WhatifyResponse: Information about the Dataset.
        """
    ...
    def train(cls, task_name: str, dataset_id: int, estimators: List[Estimator] = None,
        ...
        Returns:
            ...
            raises FireflyError otherwise.
        """
        return toolkit_w.Task.create(name=task_name, dataset_id=dataset_id, estimators=estimators,
    ...
    def get_available_estimators(cls, id: int, inter_level: InterpretabilityLevel = None,
        ...
        Returns:
            WhatifyResponse: List of possible values for estimators.
        """
    ...
    def get_available_pipeline(cls, id: int, inter_level: InterpretabilityLevel = None,
        ...
        Returns:
            WhatifyResponse: List of possible values for pipeline.
        """
    ...
    def get_available_splitting_strategy(cls, id: int, inter_level: InterpretabilityLevel = None,
        ...
        Returns:
            WhatifyResponse: List of possible values for splitting strategies.
        """
    ...
    def get_available_target_metric(cls, id: int, inter_level: InterpretabilityLevel = None,
        ...
        Returns:
            WhatifyResponse: List of possible values for target metrics.
        """
        return cls._get_available_configuration_options(id=id, inter_level=inter_level, api_key=api_key)[
            'target_metric']
    ...
    def _get_available_configuration_options(cls, id: int, inter_level: InterpretabilityLevel = None,
        ...
        return WhatifyResponse(data=new_data)

    @classmethod
    def get_metadata(cls, id: int, api_key: str = None) -> WhatifyResponse:
        """
        ...
        Returns:
            WhatifyResponse: Contains mapping of metadata.
        """
        requestor = APIRequestor()
