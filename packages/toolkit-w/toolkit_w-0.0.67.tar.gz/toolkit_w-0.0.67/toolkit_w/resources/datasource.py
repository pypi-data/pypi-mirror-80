...
from toolkit_w.internal.vars_global import FeatureType, ProblemType
...
class Datasource(APIResource):
    ...
    def get(cls, id: int, api_key: str = None) -> WhatifyResponse:
        ...
        Returns:
            WhatifyResponse: Information about the Datasource.
        """
    ...
    def create(cls, filename: str, na_values: List[str] = None, wait: bool = False, skip_if_exists: bool = False,
        ...
        Returns:
            WhatifyResponse: Datasource ID, if successful and wait=False or Datasource if successful and wait=True;
    ...
    @classmethod
    def get_base_types(cls, id: int, api_key: str = None) -> WhatifyResponse:
        """
        ...
        Returns:
            WhatifyResponse: Contains mapping of feature names to base types.
        """
        requestor = APIRequestor()
    ...
    @classmethod
    def get_feature_types(cls, id: int, api_key: str = None) -> WhatifyResponse:
        """
        ...
        Returns:
            WhatifyResponse: Contains mapping of feature names to feature types.
        """
        requestor = APIRequestor()
    ...
    @classmethod
    def get_type_warnings(cls, id: int, api_key: str = None) -> WhatifyResponse:
        """
        ...
        Returns:
            WhatifyResponse: Contains mapping of feature names to a list of type warnings (can be empty).
        """
        requestor = APIRequestor()
    ...
    def prepare_data(cls, datasource_id: int, dataset_name: str, target: str, problem_type: ProblemType,
                     ...
                     wait: bool = False, skip_if_exists: bool = False, api_key: str = None) -> WhatifyResponse:
        """
        ...
        Returns:
            WhatifyResponse: Dataset ID, if successful and wait=False or Dataset if successful and wait=True;
            raises FireflyError otherwise.
        """
        return toolkit_w.Dataset.create(datasource_id=datasource_id, dataset_name=dataset_name, target=target,
