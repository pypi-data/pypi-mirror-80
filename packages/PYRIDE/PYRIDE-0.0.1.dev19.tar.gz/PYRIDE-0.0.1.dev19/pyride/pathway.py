...
(i.e. extension), and hold the information in containers better designed
for it
"""
...
def normalize(path_name, override=None):
    ...
    ONLY PROVIDE OVERRIDE IF:
        1) YOU ARE WORKING WITH A FOLDER THAT HAS AN EXTENSION IN THE NAME
...
def get_name(path_name, *, ext=True, override=None, identity=None):
    """
    Gets the name part of the path name given. By 'name' I mean the basename of
...
def get_system_drives():
    ...
    if os.name == 'nt':
        ...
        # TODO What if you have multiple drives ?????
...
# TODO Make a symbol meaning current python installation directory
...
class File:
    ...
    def __repr__(self):
        # TODO If you eval() the repr, does it return the same object?
