...
int FLWT_Var_getRc(FLWT_Var *var, double *rc);
int FLWT_Var_getIdx(FLWT_Var *var, int *idx);
int FLWT_Constr_getName(FLWT_Constr *constr, char **name);
int FLWT_Constr_getSense(FLWT_Constr *constr, char *sense);
int FLWT_Constr_getRhs(FLWT_Constr *constr, double *rhs);
int FLWT_Constr_getExpr(FLWT_Constr *constr, FLWT_LinExpr *expr);
int FLWT_Constr_getPi(FLWT_Constr *constr, double *pi);
...
int FLWT_Model_addGraph(FLWT_Model *model, int directed, double *obj, int *from,
                        int *to, int m, int source, int sink, double L,
                        double U, char type, char **names, FLWT_Graph **graph);
...
int FLWT_Model_getConstrs(FLWT_Model *model, FLWT_Constr **constr);
