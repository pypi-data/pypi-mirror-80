...
class EfsStorage(
    ...
    def efs_apps_dns(self) -> builtins.str:
        ...
        :stability: experimental
        """
        return jsii.get(self, "efsAppsDns")
    ...
    def efs_data_dns(self) -> builtins.str:
        ...
        :stability: experimental
        """
        return jsii.get(self, "efsDataDns")
...
class IamRoles(
    ...
    def compute_node_iam_role(self) -> aws_cdk.aws_iam.IRole:
        ...
        :stability: experimental
        """
        return jsii.get(self, "computeNodeIamRole")
    ...
    def compute_node_instance_profile_name(self) -> builtins.str:
        ...
        :stability: experimental
        """
        return jsii.get(self, "computeNodeInstanceProfileName")
    ...
    def scheduler_iam_instance_profile_name(self) -> builtins.str:
        ...
        :stability: experimental
        """
        return jsii.get(self, "schedulerIamInstanceProfileName")
    ...
    def scheduler_iam_role(self) -> aws_cdk.aws_iam.IRole:
        ...
        :stability: experimental
        """
        return jsii.get(self, "schedulerIAMRole")
...
class Workload(
    ...
    def __init__(
        ...
        *,
        ...
        :param scope: -
        :param id: -
        :param client_ip_cidr: Default IP(s) allowed to directly SSH into the scheduler and access ElasticSearch. 0.0.0.0/0 means ALL INTERNET access. You probably want to change it with your own IP/subnet (x.x.x.x/32 for your own ip or x.x.x.x/24 for range. Replace x.x.x.x with your own PUBLIC IP. You can get your public IP using tools such as https://ifconfig.co/). Make sure to keep it restrictive! Default: - not to add any client IP Cidr address
        :param custom_ami: Custom AMI if available. Default: - no custom AMI
        :param instance_type: Instance type for your master host(scheduler). Default: - m5.xlarge
        :param ldap_user_name: Username for your default LDAP user. Default: - 'ldapUserName'
        :param ldap_user_password: Password for your default LDAP user. Default: - 'ldapUserPassword!123'
        :param linux_distribution: Linux distribution. Default: - amazonlinux2
        :param s3_install_bucket: S3 bucket with your SOCA installer. Name of your S3 Bucket where you uploaded your install files. Default: - solutions-reference
        :param s3_install_folder: Name of the S3 folder where you uploaded SOCA. Default: - scale-out-computing-on-aws/v2.5.0
        :param ssh_key_name: Default SSH pem keys used to SSH into the scheduler.
        :param vpc_cidr: VPC Cidr for the new VPC. Default: - 10.0.0.0/16
