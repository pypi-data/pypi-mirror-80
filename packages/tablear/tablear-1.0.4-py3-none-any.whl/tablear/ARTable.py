...
class UserSettings(object):
    def __init__(self, 
        ...
        self.skintone_thresh = skintone_thresh
    def save(self, fpath: str):
        with open(fpath, 'w') as f:
            json.dump({
                ...
                "skintone_thresh": self.skintone_thresh
    ...
    @staticmethod
    def get_default():
        return UserSettings(0, False, False, (44, 50, 85), 11)
...
class ARTable(object):
    def __init__(self, ui_name, on_key, user_settings: UserSettings):
        ...
        self.finger = ColorPointer(self.manager, user_settings.skintone, user_settings.skintone_thresh)
        self.on_key = on_key
