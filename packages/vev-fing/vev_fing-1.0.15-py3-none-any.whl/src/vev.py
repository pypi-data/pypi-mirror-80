...
path_grafics=pathPip+'src/plot_images'  #esto es algo a cambiar en todas las funciones que plotean
loaded_dfs = []
...
def logger(new,experiment,log):
    ...
    if new:
        logFile = open(pathPip+path_pkl+experiment,'w')
    else:
        logFile = open(pathPip+path_pkl+experiment,'a')
