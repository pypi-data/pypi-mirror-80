...
path_pkl = 'src/data_experiments/' #también a cambiar
path_grafics='src/plot_images'  #esto es algo a cambiar en todas las funciones que plotean
loaded_dfs = []
...
class Interfaz(QtWidgets.QMainWindow):
    def __init__(self):
        print(os.path.dirname(src.ReadData.__file__))
        super(Interfaz, self).__init__()
        uic.loadUi('src/ui_files/mainwindow.ui', self)
        self._flag = False
