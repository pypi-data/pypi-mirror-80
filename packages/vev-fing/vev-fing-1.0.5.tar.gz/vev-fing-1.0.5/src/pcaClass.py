...
from PlotEntropyPosition import plotEntropyPosition, plotEntropiesPosition
...
class FigurePCA(FigureCanvas):
    ...
    def onclick(self, event):
        ...
        self.name = 'src/plot_images/Entropy_' + position + '.png'
        img = Image.open(self.name)
        titleAux = "plot_images/Entropy for position " + position
