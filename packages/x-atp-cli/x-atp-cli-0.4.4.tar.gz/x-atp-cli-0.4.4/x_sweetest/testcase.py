...
from x_sweetest.globals import g, now, timestamp
from x_sweetest.elements import e
from x_sweetest.windows import w
from x_sweetest.snapshot import Snapshot
from x_sweetest.locator import locating_elements, locating_data, locating_element
from x_sweetest.keywords import web, common, mobile, http, files
from x_sweetest.config import web_keywords, common_keywords, mobile_keywords, http_keywords, windows_keywords, files_keywords
from x_sweetest.utility import replace_dict, replace
        ...
        for index, step in enumerate(self.testcase['steps']):
            ...
            try:
                ...
                if g.platform.lower() in ('desktop',) and step['keyword'].upper() in web_keywords:
                    ...
                    from x_sweetest.keywords import windows
                    _page = ''
