...
project = 'DearTrioGui'
copyright = 'The DearTrioGui authors'
author = 'The DearTrioGui authors'
...
import deartriogui
version = deartriogui.__version__
...
htmlhelp_basename = 'deartrioguidoc'
...
latex_documents = [
    (master_doc, 'deartriogui.tex', 'Trio Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'deartriogui', 'DearTrioGui Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'deartriogui', 'DearTrioGui Documentation',
     author, 'DearTrioGui', 'Async DearPyGui support using trio guest mode eventloop',
     'Miscellaneous'),
]
