...
class RunInfo():
    def __init__(self, run_name, workspace, cmd_parts, run_script, repeat, context, status, show_output=True, parent_name=None, 
        parent_prep_needed=False, mirror_close_func=None, aml_run=None, node_id=None, run_index=None, 
        mri=None, mri_entry=None, store=None):
    ...
    def run_wrapup(self):
        ...
        if not self.killed_for_restart:
            ...
            print("is_parent={}, self.repeat={}".format(self.is_parent, self.repeat))
            ...
            #if self.mri_entry and store.mongo:
            #   store.mongo.mark_child_run_completed(self.mri_entry)
