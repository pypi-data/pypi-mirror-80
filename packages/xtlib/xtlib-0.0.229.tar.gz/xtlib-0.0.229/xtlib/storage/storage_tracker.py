        ...
        if self.new_text:
            ...
            if not self.current_text:
                ...
                if self.store.helper.provider.does_blob_exist(self.ws_name, self.fn_info):
                    ...
                    self.mongo.create_mongo_job(ji)
    ...
    def import_run(self, ws, run_name):
        ...
        for rd in records:
            ...
            if event == "created":
                ...
                self.mongo.create_mongo_run(ws, run_name, dd)
...
if __name__ == "__main__":
    ...
    mongo_cs = config.get("external-services", "localmongo", "mongo-connection-string")   
    #mongo_cs = store.mongo_conn_str
