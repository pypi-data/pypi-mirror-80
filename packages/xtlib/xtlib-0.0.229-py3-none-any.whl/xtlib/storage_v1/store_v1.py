...
class StoreV1():
    ...
    def __init__(self, storage_creds=None, config=None, max_retries=25, run_cache_dir=None, feedback_enabled=True,  mongo_conn_str=None, 
        ...
        self.mongo = mongo_v1.MongoDB(mongo_conn_str, run_cache_dir) if mongo_conn_str else None
    ...
    def delete_workspace(self, ws_name):
        ...
        if result:
            ...
            self.mongo.delete_workspace_if_needed(ws_name)
    ...
    def log_run_event(self, ws_name, run_name, event_name, data_dict=None, event_time=None, is_aml=False):
        ...
        self.mongo.process_run_event(ws_name, run_name, record_dict)
    ...
    def get_ws_runs(self, ws_name, filter_dict=None, include_log_records=False):
        return self.mongo.get_ws_runs(ws_name, filter_dict, include_log_records)
    ...
    def update_run_at_end(self, ws_name, run_name, status, exit_code, end_time, log_records, hparams, metrics):
        return self.mongo.update_run_at_end(ws_name, run_name, status, exit_code, end_time, log_records, hparams, metrics)
    ...
    def write_job_info_file(self, ws_name, job_id, text):
        ...
        dd = json.loads(text)
        self.mongo.update_job_info(ws_name, job_id, dd)
