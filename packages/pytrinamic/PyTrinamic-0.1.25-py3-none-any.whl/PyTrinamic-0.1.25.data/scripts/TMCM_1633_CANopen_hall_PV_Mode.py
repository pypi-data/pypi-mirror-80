...
objMotorPoles.raw         = 8
objCommutation_Mode.raw   = 6
objHall_Inversion.raw     = 0
objHall_Interpolation.raw = 0

print("MotorPoles:            %d" % objMotorPoles.raw)

print("CommutationMode:       %d" % objCommutation_Mode.raw)
print("Hall_ActualAngle:      %d" % objHall_ActualAngle.raw)
print("Hall_Inversion:        %d" % objHall_Inversion.raw)
print("Hall_Interpolation:    %d" % objHall_Interpolation.raw)
