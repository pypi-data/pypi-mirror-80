'''
Move a motor back and forth in PP_Mode for with CANopen using the TMCM1670 module
...
objMotorType.raw               = 8
objCommutationMode.raw         = 7
objOpenLoopCurrent.raw         = 500
objStepsPerRotation.raw        = 4096
objDirection.raw               = 0

print("Digital Inputs:           %s" % hex(objDigitalInputs.raw))
print("Digital Outputs:          %s" % hex(objDigitalOutputs.raw))
print("Digital Output mask:      %s" % hex(objDigitalOutputMask.raw))
