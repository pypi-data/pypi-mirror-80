...
class ADSLDataFromCRMLeadLine:
    ...
    def build(self):
        ...
        return ADSLData(
            ...
            adsl_coverage='',  # TODO: De donde sacamos los datos del producto?
            mm_fiber_coverage='',  # TODO: De donde sacamos los datos del producto?
            vdf_fiber_coverage='',  # TODO: De donde sacamos los datos del producto?
            change_address='no',  # TODO: De donde sacamos los datos del producto?

            landline_type='',  # To be removed when we will unsupport Tryton
            landline_minutes='',  # To be removed when we will unsupport Tryton
        )
