...
class Configuration():
    ...
    def _setDefaultConfiguration(self):
        ...
        self.set('imagesizeonthumbnail', False)
    ...
    def _readConfiguration(self):
        ...
        if config.read(self.IniPath):
            ...
            imagesizeonthumbnail = default.getstrbool('imagesizeonthumbnail', 'no')
            ...
            self.set('imagesizeonthumbnail', imagesizeonthumbnail)
    ...
    def writeConfiguration(self):
        ...
        config['simimg'] = {
            ...
            'imagesizeonthumbnail': self.get('imagesizeonthumbnail'),
