...
class Predicate(Base):
    ...
    def finalize(self):
        ...
        self.adnominal_evids = head_bpl.adnominal_event_ids
        self.sentential_complement_evids = head_bpl.sentential_complement_event_ids
        ...
        for bp in child_bpl:
            self.children.append(collections.OrderedDict([
                ...
                ('adnominal_event_ids', bp.adnominal_event_ids),
                ('sentential_complement_event_ids', bp.sentential_complement_event_ids),
