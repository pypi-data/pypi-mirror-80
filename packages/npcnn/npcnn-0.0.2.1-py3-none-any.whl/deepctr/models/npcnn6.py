...
def NPCNN6(linear_feature_columns, dnn_feature_columns, conv_kernel_width=(7, 7, 7, 7), conv_filters=(14, 16, 18, 20),
    ...
    dnn_input = tf.keras.layers.Flatten()(inner_product)
