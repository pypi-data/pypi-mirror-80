...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', '3.2.0-alpha.1600529068+dd76df44'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform 3.2.0-alpha.1600529068+dd76df44`
                """)
