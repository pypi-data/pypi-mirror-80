...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.25.0-alpha.1600731936+b6a9cd4a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.25.0-alpha.1600731936+b6a9cd4a`
                """)
            else:
                raise
