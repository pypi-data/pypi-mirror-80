...
class DataPreviewJob(_utils.ServerJob):
    ...
    def _update(self) -> None:
        self._info: Any = self._client._backend.get_data_preview_job(self.key)
...
class DatasetJob(_utils.ServerJob):
    ...
    def _update(self) -> None:
        self._info: Any = self._client._backend.get_dataset_job(self.key)
...
class DatasetSplitJob(_utils.ServerJob):
    ...
    def _update(self) -> None:
        self._info: Any = self._client._backend.get_dataset_split_job(self.key)
