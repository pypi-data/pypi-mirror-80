...
class SocketIo:
	...
	def interface_type(self) -> int:
		...
		return visa.constants.VI_INTF_TCPIP
...
class VisaLib:
	...
	def read(self, session, chunk_size: int):
		...
		return_code = visa.constants.StatusCode.success_max_count_read if more_data_available else visa.constants.StatusCode.success
