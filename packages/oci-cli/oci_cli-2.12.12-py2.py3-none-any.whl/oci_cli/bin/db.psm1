...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        'db' = 'autonomous-container-database autonomous-data-warehouse autonomous-data-warehouse-backup autonomous-database autonomous-database-backup autonomous-database-wallet autonomous-db-preview-version autonomous-db-version autonomous-exadata-infrastructure autonomous-exadata-infrastructure-shape autonomous-patch autonomous-vm-cluster backup backup-destination console-connection data-guard-association database database-software-image db-home exadata-infrastructure external-backup-job gi-version maintenance-run node patch patch-history system system-shape version vm-cluster vm-cluster-network'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-database update' = 'admin-password autonomous-database-id cpu-core-count data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name force freeform-tags from-json help if-match is-auto-scaling-enabled is-data-guard-enabled is-free-tier is-refreshable-clone license-model max-wait-seconds nsg-ids open-mode permission-level private-endpoint-label refreshable-mode subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        ...
        'db database create' = 'admin-password auto-backup-enabled auto-backup-window backup-destination character-set database-software-image-id db-home-id db-name db-system-id db-unique-name db-version db-workload defined-tags freeform-tags from-json help max-wait-seconds ncharacter-set pdb-name recovery-window-in-days source vm-cluster-id wait-for-state wait-interval-seconds'
        ...
        'db database create-from-backup' = 'admin-password backup-id backup-tde-password database-software-image-id db-name db-system-id db-unique-name defined-tags freeform-tags from-json help max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'db database-software-image list' = 'all compartment-id display-name from-json help image-shape-family image-type lifecycle-state limit page page-size sort-by sort-order'
        ...
        'db db-home create' = 'database-software-image-id db-system-id db-version defined-tags display-name freeform-tags from-json help max-wait-seconds source wait-for-state wait-interval-seconds'
