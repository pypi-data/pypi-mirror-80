...
class CfnStream(
    ...
    def __init__(
        ...
        *,
        ...
        stream_encryption: typing.Optional[typing.Union["StreamEncryptionProperty", aws_cdk.core.IResolvable]] = None,
    ...
    def stream_encryption(
        self,
    ) -> typing.Optional[typing.Union["StreamEncryptionProperty", aws_cdk.core.IResolvable]]:
    ...
    def stream_encryption(
        self,
        value: typing.Optional[typing.Union["StreamEncryptionProperty", aws_cdk.core.IResolvable]],
    ) -> None:
