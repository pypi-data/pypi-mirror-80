...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.5.0-alpha.1600708578+d98504dc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.5.0-alpha.1600708578+d98504dc`
                """)
            else:
                raise
