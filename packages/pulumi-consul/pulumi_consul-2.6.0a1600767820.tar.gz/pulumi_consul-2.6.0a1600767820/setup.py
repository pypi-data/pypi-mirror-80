...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.6.0-alpha.1600767820+c2f167e7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.6.0-alpha.1600767820+c2f167e7`
                """)
            else:
                raise
