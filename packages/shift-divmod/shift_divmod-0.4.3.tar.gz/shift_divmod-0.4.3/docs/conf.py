# -*- coding: utf-8 -*-
#
# ShiftDivMod documentation build configuration file, created by
...
htmlhelp_basename = 'ShiftDivModdoc'
...
latex_documents = [
  ('index', 'shift_divmod.tex', u'ShiftDivMod Documentation',
...
man_pages = [
    ('index', 'shift_divmod', u'ShiftDivMod Documentation',
     [u'Shlomi Fish'], 1)
]
