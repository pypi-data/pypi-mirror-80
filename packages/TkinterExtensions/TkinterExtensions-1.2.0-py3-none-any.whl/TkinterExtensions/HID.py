...
class HID_BUFFER(object):
    ...
    def Clear(self, cleared: str = '') -> str:
        self._text = cleared
        self.__update()
        return self._text
    ...
    str
    def format(self, *args, **kwargs): self._text.format(*args, **kwargs)
    def __format__(self, format_spec): return self._text.__format__(format_spec)
    def __contains__(self, item: str): return item in self._text
    def __repr__(self): return f'<{self.__class__.__name__} Object: "{self._text}">'
