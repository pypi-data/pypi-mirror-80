...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', '2.5.0-alpha.1600731130+7a44f75e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp 2.5.0-alpha.1600731130+7a44f75e`
                """)
            else:
                raise
