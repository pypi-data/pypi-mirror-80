...
class Statistics(object):
    ...
    def __init__(self, cost=None, reward=None, measurements=None, orders_count=None, performers_count=None, capacity_utilization=None, capacity_max=None, quality=None, local_vars_configuration=None):  # noqa: E501
