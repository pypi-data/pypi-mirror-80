...
def init(api_key: str, workspace_name: str, project_name: str):
    ...
    parser.add_argument('-adname_fadg',default='none',dest="adname", type=str)
    args = parser.parse_args()

    core = DigoCore.Core(
        api=api_key, workspace_name=workspace_name, project_name=project_name, auto_digo=args.adname)
