...
#         model.prune_clusters(y,pad=2.0,limit=1)
        ...
        self.model.optimize(X=X,y=X,  number_of_random_simulations=self.number_of_random_simulations,
                   number_of_realizations = realizations,
                   agg_func='count',
                   verbose=self.verbose,
                   dim_tuples=self.dim_tuples
                     )
...
#             self.KDE = self.model.kde_target.copy()
        ...
        self.centroids.append(np.vstack(centers))
