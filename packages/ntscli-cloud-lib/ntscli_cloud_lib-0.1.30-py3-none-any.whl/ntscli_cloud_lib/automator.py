...
class TestCase(betterproto.Message):
    ...
    duration: Optional[float] = betterproto.message_field(6, wraps=betterproto.TYPE_FLOAT)
    # The estimated duration of the test based on recent executions, in seconds
    duration_sec: Optional[int] = betterproto.message_field(7, wraps=betterproto.TYPE_UINT32)
