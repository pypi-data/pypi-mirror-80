...
print(color.WHITE + f'Made By Pirxcy')
print(color.YELLOW + f'══════════════════════════════════════════════════════════════')
print(f'  ') 
...
with open('config.json') as f:
    ...
    print(f' [puffi bot] [{getTime()}] Loading config.')

    data = json.load(f)

    print(f' [puffi bot] [{getTime()}] Config loaded.')
...
if debug == 'True':
    ...
    print(f' [puffi bot] [{getTime()}] Debug logging is on.')
...
async def event_ready():
    ...
    print(Fore.GREEN + ' [puffi bot] [' + getTime() + '] Client ready as {0.user.display_name}.'.format(client))
    print(color.YELLOW + f'══════════════════════════════════════════════════════════════')
...
async def event_party_invite(invite):
    ...
    if data['joinoninvite'].lower() == 'true':
        ...
        if invite.sender.display_name not in data['BlockList']:
            ...
            try:
                ...
                print(Fore.CYAN + f' [puffi bot] [{getTime()}] Accepted party invite from {invite.sender.display_name}')
            ...
            print(Fore.RED + f' [puffi bot] [{getTime()}] Never accepted party invite from' + Fore.RED + f' {invite.sender.display_name}')
    ...
    if data['joinoninvite'].lower() == 'false':
        ...
        if invite.sender.display_name in data['FullAccess']:
            ...
            print(Fore.BLUE + f' [puffi bot] [{getTime()}] Accepted party invite from {invite.sender.display_name}')

        else:

            print(Fore.RED + f' [puffi bot] [{getTime()}] Never accepted party invite from {invite.sender.display_name}')
...
async def event_friend_request(request):
    ...
    if data['friendaccept'].lower() == 'true':
        ...
        if request.display_name not in data['BlockList']:
            ...
            try:
                ...
                print(color.CYAN + f" [puffi bot] [{getTime()}] Accepted friend request from: {request.display_name}")
             ...
             print(color.RED + f" [puffi bot] [{getTime()}] Never Accepted friend reqest from: " + Fore.RED + f"{request.display_name}")
    ...
    if data['friendaccept'].lower() == 'false':
        ...
        if request.display_name in data['FullAccess']:
            ...
            print(color.RED + f" [puffi bot] [{getTime()}] Never accepted friend request from: {request.display_name}")
...
async def event_party_member_join(member):
    ...
    if client.user.display_name != member.display_name:
         ...
         print(color.PURPLE + f" [puffi bot] [{getTime()}] {member.display_name} has joined the lobby.")
...
async def event_friend_message(message):
    ...
    print(' [puffi bot] [' + getTime() + '] {0.author.display_name}: {0.content}'.format(message))
    ...
    if "!cid" in args[0].lower():
        ...
        if message.author.display_name in data['BlockList']:
            ...
            try:
                ...
                print(f" [puffi bot] [{getTime()}] CID for {cosmetic.name}: {cosmetic.id}")
    ...
    if "!bid" in args[0].lower():
        ...
        if message.author.display_name in data['BlockList']:
            ...
            try:
                ...
                print(f" [puffi bot] [{getTime()}] BID for {cosmetic.name}: {cosmetic.id}")
    ...
    if "!eid" in args[0].lower():
        ...
        if message.author.display_name in data['BlockList']:
            ...
            try:
                ...
                print(f" [puffi bot] [{getTime()}] EID for {cosmetic.name}: {cosmetic.id}")
    ...
    if "!pid" in args[0].lower():
        ...
        if message.author.display_name in data['BlockList']:
            ...
            try:
                ...
                print(f" [puffi bot] [{getTime()}] PID for {cosmetic.name}: {cosmetic.id}")
    ...
    if "!purpleskull" in args[0].lower():
        ...
        if message.author.display_name in data['BlockList']:
            ...
            try:
                ...
                print(f" [puffi bot] [{getTime()}] Client's Skin set to Purple Skull Trooper")
    ...
    if "!pinkghoul" in args[0].lower():
        ...
        if message.author.display_name in data['BlockList']:
            ...
            try:
                ...
                print(f" [puffi bot] [{getTime()}] Client's Skin set to Pink Ghoul Trooper")
    ...
    if "!brainiacghoul" in args[0].lower():
        ...
        if message.author.display_name in data['BlockList']:
            ...
            try:
                ...
                print(f" [puffi bot] [{getTime()}] Client's Skin set to Brainiac Ghoul Trooper")
    ...
    if "!purpleportal" in args[0].lower():
        ...
        if message.author.display_name in data['BlockList']:
            ...
            print(f" [puffi bot] [{getTime()}] Client's Backpack set to Purple Ghost Portal")
    ...
    if "CID_" in args[0]:
        ...
        if message.author.display_name in data['BlockList']:
            ...
            print(f' [puffi bot] [{getTime()}] Skin set to ' + args[0])
    ...
    if "!variants" in args[0]:
        ...
        if message.author.display_name in data['BlockList']:
            ...
            print(f' [puffi bot] [{getTime()}] Set variants of {args[1]} to {args[2]} {args[3]}.')
    ...
    if "!checkeredrenegade" in args[0].lower():
        ...
        if message.author.display_name in data['BlockList']:
            ...
            print(f" [puffi bot] [{getTime()}] Client's Skin set to Checkered Renegade")
    ...
    if "!mintyelf" in args[0].lower():
        ...
        if message.author.display_name in data['BlockList']:
            ...
            print(f" [puffi bot] [{getTime()}] Client's Skin set to Minty Elf")
    ...
    if "!echo" in args[0].lower():
        ...
        if message.author.display_name in data['FullAccess']:
            ...
            print(f' [puffi bot] [{getTime()}] ' + color.GREEN + 'Sent Message:' + color.END + f' {joinedArguments}')
    ...
    if "!admin" in args[0].lower():
        ...
        if message.author.display_name in data['FullAccess']:
            ...
            if len(args) == 1:
                ...
                print(f' [puffi bot] [{getTime()}] Please specify if you want to add or remove a user from the admin list, using ' + color.GREEN + '!admin add ' + color.END + 'or ' + color.GREEN + '!admin remove' + color.END)
                ...
                if args[1].lower() == 'add':
                    ...
                    if content == "yes":
                        ...
                        with open('config.json', 'w') as f:
                            ...
                            print(f" [puffi bot] [{getTime()}] Removed " + color.GREEN + f"{user.display_name}" + color.END + " as an admin")
            ...
            if len(args) >= 3:
                ...
                try:
                    ...
                    if args[1].lower() == 'add':
                        ...
                        if user.display_name not in data['FullAccess']:
                            ...
                            with open('config.json', 'w') as f:
                                ...
                                print(f" [puffi bot] [{getTime()}] Added " + color.GREEN + f"{user.display_name}" + color.END + " as an admin")
                        ...
                        if user.display_name in data['FullAccess']:
                            ...
                            print(f" [puffi bot] [{getTime()}]" + color.GREEN + f" {user.display_name}" + color.END + " is not an admin")
                    ...
                    print(f" [puffi bot] [{getTime()}] Can't find user: " + color.GREEN + f"{joinedArgumentsAdmin}" + color.END)
            ...
            if len(args) >= 3 and args[1].lower() == 'add':
                ...
                if content in data['AdminPassword']:
                    ...
                    if user.display_name not in data['FullAccess']:
                        ...
                        print(f" [puffi bot] [{getTime()}]" + color.GREEN + f" {user.display_name}" + color.END + " is already an admin")
        ...
        if message.author.display_name in data['FullAccess']:
            ...
            if len(args) == 2:
                ...
                if args[1].lower() == 'add' or args[1].lower() == 'remove':
                    ...
                    print(f' [puffi bot] [{getTime()}] Please specify the name of the user you want to add/remove from the block list')

                else:

                    await message.reply('Invalid usage, try !blocklist add <username> or !blocklist remove <username>')

                    print(f' [puffi bot] [{getTime()}] Invalid usage, try ' + color.GREEN + '!BlockList add <username> ' + color.END + 'or ' + color.GREEN + '!BlockList remove <username>' + color.END)
                ...
                if args[1].lower() == 'add':
                    ...
                    if user.display_name not in data['FullAccess'] and user.display_name not in data['BlockList']:
                        ...
                        with open('config.json', 'w') as f:
                            ...
                            print(f" [puffi bot] [{getTime()}] Added " + color.GREEN + f"{user.display_name}" + color.END + " to the blocked list.")

                    elif user.display_name in data['FullAccess']:

                        await message.reply(f"{user.display_name} can not be added to the blocked list.")

                        print(f" [puffi bot] [{getTime()}]" + color.GREEN + f" {user.display_name}" + color.END + " cannot be added to the blocked list.")

                    elif user.display_name in data['BlockList']:               

                        await message.reply(f"{user.display_name} is already on the blocked list.")

                        print(f" [puffi bot] [{getTime()}]" + color.GREEN + f" {user.display_name}" + color.END + " is already on the blocked list.")
                    ...
                    if user.display_name in data['BlockList']:
                        ...
                        with open('config.json', 'w') as f:
                            ...
                            print(f" [puffi bot] [{getTime()}] Removed " + color.GREEN + f"{user.display_name}" + color.END + " from the blocked list.")

                    elif user.display_name not in data['BlockList']:

                        print(f" [puffi bot] [{getTime()}]" + color.GREEN + f" {user.display_name}" + color.END + " is not on the blocked list.")
    ...
    if "!status" in args[0].lower():
        ...
        if message.author.display_name in data['FullAccess']:
            ...
            print(f' [puffi bot] [{getTime()}] Status set to {joinedArguments}.')
    ...
    if "!leave" in args[0].lower():
        ...
        if message.author.display_name in data['FullAccess']:
            ...
            print(Fore.GREEN + f' [puffi bot] [{getTime()}] Left the party as I was requested.')
    ...
    if "!kick" in args[0].lower() and message.author.display_name in data['FullAccess']:
        ...
        if member is None:
            ...
            try:
                ...
                print(Fore.GREEN + f" [puffi bot] [{getTime()}] Kicked user: {member.display_name}")
                ...
                print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] Failed to kick member as I don't have the required permissions." + Fore.WHITE)
    ...
    if "!join" in args[0] and message.author.display_name in data['FullAccess']:
        ...
        if friend is None:
            ...
            print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] Unable to join user: {joinedArguments}, are you sure the bot has them added?" + Fore.WHITE)
    ...
    if "!invite" in args[0].lower():
        ...
        if friend is None:
            ...
            print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] Unable to invite user: {joinedArguments}, are you sure the bot has them added?" + Fore.WHITE)
            ...
            try:
                ...
                print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] Something went wrong while trying to invite {friend.display_name}" + Fore.WHITE)           
    ...
    if "!add" in args[0].lower() and message.author.display_name in data['FullAccess']:
        ...
        if user is None:
            ...
            print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] Unable to find a player with the name {joinedArguments}")
            ...
            try:
                ...
                if (user.id in friends):
                    ...
                    print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] You already have {user.display_name} added as a friend.")
                    ...
                    print(Fore.GREEN + f" [puffi bot] [{getTime()}] {client.user.display_name} sent a friend request to {user.display_name}" + Fore.WHITE)

            except Exception as e:

                pass

                print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] Something went wrong adding {joinedArguments}" + Fore.WHITE)
        ...
        if user is None:
            ...
            try:
                ...
                if (user.id in friends):
                    ...
                    print(Fore.GREEN + f" [puffi bot] [{getTime()}] {client.user.display_name} removed {user.display_name} as a friend.")

                else: 

                    await message.reply(f"I don't have {user.display_name} as a friend.")

                    print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] {client.user.display_name} tried removing {user.display_name} as a friend, but the client doesn't have the friend added." + Fore.WHITE)

            except Exception as e:

                pass

                print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] Something went wrong removing {joinedArguments} as a friend." + Fore.WHITE)
    ...
    if "!showfriends" in args[0].lower() and message.author.display_name in data['FullAccess']:
        ...
        try:
            ...
            print(f" [puffi bot] [{getTime()}] " + Fore.WHITE + "Friends List: " + Fore.GREEN + f"{len(onlineFriends)} Online " + Fore.WHITE + "/" + Fore.LIGHTBLACK_EX + f" {len(offlineFriends)} Offline " + Fore.WHITE + "/" + Fore.LIGHTWHITE_EX + f" {len(onlineFriends) + len(offlineFriends)} Total")
    ...
    if "!members" in args[0].lower() and message.author.display_name in data['FullAccess']:
            ...
            print(f" [puffi bot] [{getTime()}] " + Fore.WHITE + "There are " + Fore.LIGHTWHITE_EX + f"{len(partyMembers)} members in client's party:")
    ...
    if "!promote" in args[0].lower() and message.author.display_name in data['FullAccess']:
        ...
        if member is None:
            ...
            try:
                ...
                print(Fore.GREEN + f" [puffi bot] [{getTime()}] Promoted user: {member.display_name}")
                ...
                print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] Failed to promote member as I don't have the required permissions." + Fore.WHITE)
    ...
    if "Playlist_" in args[0]:
        ...
        try:
            ...
            print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] Failed to set gamemode as I don't have the required permissions." + Fore.WHITE)
    ...
    if args[0] == "!id":
        ...
        if message.author.display_name in data['BlockList']:
            ...
            try:
                ...
                print(Fore.GREEN + f" [puffi bot] [{getTime()}] {joinedArguments}'s Epic ID is: {user.id}")

            except AttributeError:

                await message.reply(f"I couldn't find an Epic account with the name: {joinedArguments}.")

                print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] I couldn't find an Epic account with the name: {joinedArguments}.")
...
try:
    ...
    print(Fore.RED + f" [puffi bot] [{getTime()}] [ERROR] {e}")
