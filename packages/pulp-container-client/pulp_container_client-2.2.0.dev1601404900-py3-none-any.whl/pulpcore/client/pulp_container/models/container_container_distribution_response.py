...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, pulp_href=None, pulp_created=None, name=None, repository=None, repository_version=None, content_guard=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
