...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, base_path=None, content_guard=None, repository_version=None, repository=None, name=None, pulp_created=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
