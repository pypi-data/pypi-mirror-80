...
class Container(
    ...
    def attach(self, value: typing.Optional[builtins.bool]) -> None:
    ...
    def capabilities(
        self,
        value: typing.Optional[typing.List["ContainerCapabilities"]],
    ) -> None:
    ...
    def healthcheck(
        self,
        value: typing.Optional[typing.List["ContainerHealthcheck"]],
    ) -> None:
    ...
    def logs(self, value: typing.Optional[builtins.bool]) -> None:
    ...
    def must_run(self, value: typing.Optional[builtins.bool]) -> None:
    ...
    def privileged(self, value: typing.Optional[builtins.bool]) -> None:
    ...
    def publish_all_ports(self, value: typing.Optional[builtins.bool]) -> None:
    ...
    def rm(self, value: typing.Optional[builtins.bool]) -> None:
    ...
    def start(self, value: typing.Optional[builtins.bool]) -> None:
...
class Image(
    ...
    def keep_locally(self, value: typing.Optional[builtins.bool]) -> None:
...
class Network(
    ...
    def attachable(self, value: typing.Optional[builtins.bool]) -> None:
    ...
    def check_duplicate(self, value: typing.Optional[builtins.bool]) -> None:
    ...
    def ingress(self, value: typing.Optional[builtins.bool]) -> None:
    ...
    def internal(self, value: typing.Optional[builtins.bool]) -> None:
    ...
    def ipv6(self, value: typing.Optional[builtins.bool]) -> None:
...
class Service(
    ...
    def converge_config(
        self,
        value: typing.Optional[typing.List["ServiceConvergeConfig"]],
    ) -> None:
    ...
    def endpoint_spec(
        self,
        value: typing.Optional[typing.List["ServiceEndpointSpec"]],
    ) -> None:
    ...
    def rollback_config(
        self,
        value: typing.Optional[typing.List["ServiceRollbackConfig"]],
    ) -> None:
    ...
    def update_config(
        self,
        value: typing.Optional[typing.List["ServiceUpdateConfig"]],
    ) -> None:
