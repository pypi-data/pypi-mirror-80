...
class Event:
    ...
    Args:
        ...
        tag (EventCategory): tag mark of this event
    """
    def __init__(self, id: int, tick: int, event_type: int, payload, tag: int):
        self.id = id
        self.tick = tick
        self.payload = None
        self.source = None
