...
class InvalidStartRequest(object):
    ...
    @property
    def error(self):
        """Gets the error of this InvalidStartRequest.  # noqa: E501


        :return: The error of this InvalidStartRequest.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this InvalidStartRequest.


        :param error: The error of this InvalidStartRequest.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InvalidStartRequest):
            return False
