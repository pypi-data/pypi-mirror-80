...
class ModelWithPipeline(BaseEstimator, TransformerMixin):
    ...
    def __init__(self,  model_name='lgb', epochs=200, **kwargs):
        ...
        if 'regression' in self.model_name.lower():
    ...
    def fit(self, X, y=None, **kwargs):
        ...
        if self.model_name.lower()=='dl' or 'deep' in self.model_name.lower():
            ...
            plt.show()
            #plot_train_test(recall_train, recall_test, name='recall')
...
class ModelWithPipelineAndKfold(BaseEstimator, TransformerMixin):
    ...
    def score(self, X, y=None):
        KfoldWithoutCv(self.models,  X, y)
        return self
