...
from ..data_processing import Fillna, LabelEncoder, FillnaAndDropCatFeat, MinMaxScale, FeatureSelection, AssertGoodHeader
...
class MyPipeline:
    ...
    def predict(self, X, y=None):
        if self.model_name is not None:
            return self.pipeline_.predict(X.copy())
        else:
            return None
