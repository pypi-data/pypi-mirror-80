...
STDPCosExpCommonProperties::STDPCosExpCommonProperties()
...
void
STDPCosExpCommonProperties::get_status( DictionaryDatum& d ) const
{
...
void
STDPCosExpCommonProperties::set_status( const DictionaryDatum& d,
