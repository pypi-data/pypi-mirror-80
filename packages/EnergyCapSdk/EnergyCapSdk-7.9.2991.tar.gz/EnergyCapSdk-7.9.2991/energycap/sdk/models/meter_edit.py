...
class MeterEdit(Model):
    ...
    :param use_unit_id: The use unit ID is the reporting unit for use for this
     meter.
     If this property exists, its value CANNOT be null. If it is set to -1 or
     the current use unit ID, then no change will be made.
    ...
    :param demand_unit_id: The demand unit ID is the reporting unit for demand
     ...
     If this property exists and its value is -1 or the current demand unit ID,
     then no change will be made.
     If this property is sent in as null, then the meter's demand unit ID will
     be set to null.
    ...
    def __init__(self, meter_code, meter_info, place_id, commodity_id, meter_time_zone_id, active, address=None, bill_entry_note=None, include_in_energy_star=None, primary_use_id=None, properties=None, use_unit_id=None, demand_unit_id=None):
