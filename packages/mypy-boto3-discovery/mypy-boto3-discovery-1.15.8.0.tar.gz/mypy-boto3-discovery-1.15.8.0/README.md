...
[boto3.ApplicationDiscoveryService 1.15.8](https://boto3.amazonaws.com/v1/documentation/api/1.15.8/reference/services/discovery.html#ApplicationDiscoveryService) service
compatible with
