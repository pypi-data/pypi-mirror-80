...
from kadi_apy.cli.utils import item_add_collection
...
from kadi_apy.cli.utils import item_remove_collection
...
@groups.command()
@id_identifier_options(item="group", helptext="to edit")
@click.option(
    "-v",
    "--visibility",
...
@apy_command
def edit(group_id, identifier, visibility, title, description):
    """Edit visibility, title or description of a group."""

    g = Group(identifier=identifier, id=group_id)

    item_edit(g, visibility=visibility, title=title, description=description)


@groups.command()
@id_identifier_options(item="group")
@click.option(
    "-d",
    "--description",
...
@apy_command
def show_info(group_id, identifier, **kwargs):
...
@groups.command()
@id_identifier_options(item="group", helptext="to add the record")
@click.option(
    "-r",
    "--record-id",
    required=True,
    help="ID of the record to add to the group",
    type=int,
)
@apy_command
def add_record(group_id, identifier, record_id):
    """Link record to a group."""

    g = Group(identifier=identifier, id=group_id)

    item_add_record(g, record_id)


@groups.command()
@id_identifier_options(item="group", helptext="to remove the record")
@click.option(
    "-r",
    "--record-id",
    required=True,
...
@apy_command
def remove_record(group_id, identifier, record_id):
    """Remove a record from a group."""

    g = Group(identifier=identifier, id=group_id)

    item_remove_record(g, record_id)


@groups.command()
@id_identifier_options(item="group", helptext="to add the user")
@click.option(
    "-u",
    "--user-id",
    required=True,
...
@apy_command
def add_user(group_id, identifier, user_id, permission_new):
...
@groups.command()
@id_identifier_options(item="group", helptext="to remove the user")
@click.option(
    "-u",
    "--user-id",
    required=True,
...
@apy_command
def remove_user(group_id, identifier, user_id):
...
@groups.command()
@id_identifier_options(item="group", helptext="to delete")
@click.option(
    "--i-am-sure", help="Enable this option to delete the group", is_flag=True
)
@apy_command
def delete(group_id, identifier, i_am_sure):
    """Delete a group."""
...
@groups.command()
@id_identifier_options(item="group", helptext="to add the collection")
@click.option(
    "-c",
    "--collection-id",
    required=True,
    help="ID of the collection to add to the group",
    type=int,
)
@apy_command
def add_collection(group_id, identifier, collection_id):
    """Add a collection to a group."""

    g = Group(identifier=identifier, id=group_id)

    item_add_collection(g, collection_id=collection_id)


@groups.command()
@id_identifier_options(item="group", helptext="to remove the collection")
@click.option(
    "-c",
    "--collection-id",
    required=True,
    help="ID of the collection to remove from the group",
    type=int,
)
@apy_command
def remove_collection(group_id, identifier, collection_id):
    """Remove a collection from a group."""

    g = Group(identifier=identifier, id=group_id)

    item_remove_collection(g, collection_id=collection_id)
