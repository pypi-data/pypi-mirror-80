...
class client:
    ...
    def getallsecurities(self,exchange="",security_type="",master_id="",lookup=""):
        ...
        response = requests.get(security_url, params=params, verify=False)
        try:
    ...
    def getallindicator(self,indicator="",indicator_category="",lookup=""):
        ...
        if lookup:
            params["lookup"] = lookup
        response = requests.get(getallindicator_url, params=params, verify=False)
        try:
            if "[ERROR]" in response.text:
                raise ValueError(response.text)
            else:
    ...
    def getuserportfolio(self,user=""):
        ...
        response = requests.get(portfolio_url, params=params, verify=False)
        try:
    ...
    def getdata(self,exchange="",security_type="",indicator_category="",date_start="",date_end="",master_id="",indicator_id=""):
        ...
        main_request = requests.get(self.base_url + "/get_data",params=params, verify=False)
        try:
