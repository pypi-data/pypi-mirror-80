    ...
    if hasattr(definition, "__origin__"):
        if hasattr(actual, "__origin__"):
            try:
                ...
                class_similarity = issubclass(actual.__origin__, definition.__origin__)
            except TypeError:
                class_similarity = actual.__origin__ == definition.__origin__

            return class_similarity and all(
