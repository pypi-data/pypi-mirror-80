...
# @Last Modified time: 2020-09-21 20:33:42
...
class LocalServer(object):
	...
	def jacocoIncrementReport(self):
		...
		with open(reportDir+"/incrementReport.html","w+") as temp:
			incrementRes = temp.read()

		self.JavaCoverageIncrementRes.objects.create(coverageRecord=self.alreadyRecord,incrementRes=incrementRes)
	...
	def deleteImportantRes(self):
		...
		'''
		# 删除代码仓库
		with os.popen("rm -rf {serviceRepoDir}".format(
			serviceRepoDir=self.serviceRepoDir)) as temp:
			temp.read()
