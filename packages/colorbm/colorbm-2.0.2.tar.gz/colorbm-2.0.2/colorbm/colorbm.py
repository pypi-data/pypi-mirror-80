...
class available_palattes(object):
    ...
    pal_dic = {**pal_dic_ggsci, **pal_dic_paintings, **pal_dic_carto, **pal_dic_misc, **pal_dic_nintendo}
    pal_key = [*pal_dic]
    ...
    def get(self):
        if self.cpal is None:
            return available_palattes.pal_key
        elif self.cpal in available_palattes.pal_scheme:
            return available_palattes.pal_scheme_dic[self.cpal]
        else:
...
class pal(object):
    ...
    @property
    def as_cmap(self):
        if self.cpal not in available_palattes.pal_key:
            print('No such color palette')
            sys.exit(0)
        else:
            return ListedColormap(available_palattes.pal_dic[self.cpal])
    ...
    def as_cmap_r(self):
        if self.cpal not in available_palattes.pal_key:
            ...
            return ListedColormap(available_palattes.pal_dic[self.cpal][::-1])
    ...
    def as_hex(self):
        if self.cpal not in available_palattes.pal_key:
            ...
            return available_palattes.pal_dic[self.cpal]
    ...
    def as_rgb(self):
        if self.cpal not in available_palattes.pal_key:
            ...
            return pal.hexlist_to_rgb(available_palattes.pal_dic[self.cpal])
...
class pcolor(object):
    ...
    def __init__(self, cmap, n=256):
        ...
        elif self.cmap in available_palattes.pal_key:
            self.type = 'palettes'
        else:
