    ...
    def put_value_in_hash_set(self, redis_key: str, _hash_key: str, _hash_value: str):
        ...
        if redis_connection:
            try:
                ...
                raise RGRedisException("RedisCache->put_value_in_hash_set()->>" + rg_logger.get_exception_msg())
        else:
    ...
    def get_value_from_hash_set(self, redis_key: str, _key):
        ...
        if redis_connection:
            try:
                ...
                raise RGRedisException("RedisCache->get_value_from_hash_set()->>" + rg_logger.get_exception_msg())
        else:
    ...
    def get_all_values_from_hash_set(self, _redis_key: str):
        ...
        if redis_connection:
            try:
                ...
                raise RGRedisException("RedisCache->get_all_values_from_hash_set()->>" + rg_logger.get_exception_msg())
        else:
    ...
    def remove_value_from_hash_set(self, _redis_key: str, _hash_key: str):
        ...
        if redis_connection:
            try:
                ...
                raise RGRedisException("RedisCache->remove_value_from_hash_set()->>" + rg_logger.get_exception_msg())
        else:
    ...
    def delete_key_from_cache(self, _redis_key: str):
        ...
        if redis_connection:
            try:
                ...
                raise RGRedisException("RedisCache->delete_key_from_cache()->>" + rg_logger.get_exception_msg())
        else:
    ...
    def put_string_value(self, _redis_key: str, _value: str):
        ...
        if redis_connection:
            try:
                ...
                raise RGRedisException("RedisCache->put_string_value()->>" + rg_logger.get_exception_msg())
        else:
    ...
    def get_string_value(self, _redis_key):
        ...
        if redis_connection:
            try:
                ...
                raise RGRedisException("RedisCache->get_string_value()->>" + rg_logger.get_exception_msg())
        else:
    ...
    def incr_value(self, _redis_key):
        ...
        if redis_connection:
            try:
                ...
                rg_logger.exception(e, "RedisCache->get_string_value()->>")
                raise RGRedisException("RedisCache->incr_value()->>" + rg_logger.get_exception_msg())
        else:
