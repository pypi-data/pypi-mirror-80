...
import gitlab
import typer
from gitlab.v4.objects import DeployKey, Project, ProjectPipelineSchedule, VISIBILITY_PUBLIC
...
def configure_command(
    ...
    schedule_cron: str = typer.Option(
        constants.SCHEDULE_CRON, help="Cron expression of the pipeline schedule of fetcher",
    ),
