...
class RemoteConfigBase(object):
    def __init__(self, debuglevel=0, debugname='Remote Config Base'):
        ...
        self._fsm = Fysom(
            {
                ...
                'events': [
                    ...
                    {'name': 'halrcmd_up', 'src': 'trying', 'dst': 'syncing'},
    ...
    def send_halrcmd_message(self, msg_type, tx):
        ...
        if msg_type == pb.MT_HALRCOMP_SET:
            if self._fsm.isstate('synced'):
