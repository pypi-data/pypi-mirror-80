...
class arduino_test_1(unittest.TestCase):


    @classmethod
    def setUpClass(cls):
        cls.s = csv.Arduino_csv_saver(port="COM3", channels_to_use=["C0", "C1", "C2", "C3", "C4", "C5"],
    ...
    def test_parameters(self):
        ...
        self.assertEqual(self.s.channels_to_use, ["C0","C1","C2","C3","C4","C5"])
    ...
    def test_start_csv(self):
        ...
        with patch('PyDSlog.csv.ArduinoLogger.stream.Arduino_stream') as mock_stream:
...
class arduino_test_2(unittest.TestCase):
...
class arduino_test_3(unittest.TestCase):
    ...
    def test_format_csv(self):
        ...
        with patch('PyDSlog.csv.ArduinoLogger.time') as mock_ms:
...
class arduino_test_4(unittest.TestCase):
    ...
    def test_format_csv(self):
        ...
        with patch('PyDSlog.csv.ArduinoLogger.datetime') as mock_ms:
            n = datetime.now()
    ...
    def test_header(self):
        ...
        h = "date,time,C0,C1,C2,C3,C4,C5,label\n"
...
class arduino_test_5(unittest.TestCase):
