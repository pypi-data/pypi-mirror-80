...
class CloudvectorDAST(object):
    ...
    def generate_fuzz_report(output_report):
        ...
        for test in report["report"]["tests"]:
            ...
            try:
                ...
                test_response = None
            try:
                if "CURL command to retry:" in curl_command_to_try:
            ...
            #print(curl_command_to_try,"\n\n\n", stdout)
            print("Fuzz type is ", fuzz_type)
    ...
    def generate_auto_input_params_file():
        ...
        try:
            ...
            print("Error: You need to have used a valid SPEC to generate the tests to know the parameter details")
        input_params = {}
