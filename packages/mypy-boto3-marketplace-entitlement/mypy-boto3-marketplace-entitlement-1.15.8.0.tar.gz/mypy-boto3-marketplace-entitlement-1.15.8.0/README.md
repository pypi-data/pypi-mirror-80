...
[boto3.MarketplaceEntitlementService 1.15.8](https://boto3.amazonaws.com/v1/documentation/api/1.15.8/reference/services/marketplace-entitlement.html#MarketplaceEntitlementService) service
compatible with
