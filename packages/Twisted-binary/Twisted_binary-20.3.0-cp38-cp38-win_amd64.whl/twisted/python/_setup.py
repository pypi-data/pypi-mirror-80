...
STATIC_PACKAGE_METADATA = dict(
    name="Twisted-binary",
    description="(Non Official) Binary Build for Twisted-An asynchronous networking framework written in Python",
    author="Lin Xiao Hui",
    author_email="llinxiaohui@126.com",
    maintainer="Lin Xiao Hui",
    maintainer_email="llinxiaohui@126.com",
