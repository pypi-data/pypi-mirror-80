...
from collections import Iterable, Mapping, OrderedDict, deque
...
class AppInstallation(object):
    ...
    def create_deployment_package(self):
        ...
        input_groups = self._input_groups.keys() if len(self._input_groups) > 0 else None
    ...
    def to_dict(self):
        return OrderedDict((
            ...
            ('optional_dependencies', self.optional_dependencies.keys()),
            ('dependents', self.dependents.keys()),
...
class AppInstallationAction(ObjectView):
    ...
    def __init__(self, value):
        ...
        if self.action == SlimInstallationGraphActions.remove:
            ...
            if app_source is root:
                ...
                try:
                    ...
                    if version.match(installed.version):
                        ...
                        app_dependencies = OrderedSet((d.installation.source for d in installed.dependencies.values()))
