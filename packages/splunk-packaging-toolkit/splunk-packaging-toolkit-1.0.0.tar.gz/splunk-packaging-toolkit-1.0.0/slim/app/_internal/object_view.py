...
from collections import Iterable, Mapping, MutableMapping, OrderedDict, ItemsView, KeysView, ValuesView, Set
    ...
    def _to_dict(cls, items):
        ...
        def convert(item):
            ...
            if isinstance(item, Mapping):
                return dict(((n, convert(v)) for n, v in item.iteritems()))
