...
notebooks_url = 'https://github.com/theislab/scarchesp/raw/master/notebooks/'
notebooks = [
]
...
project = 'scArchest'
copyright = f'{datetime.now():%Y}, Marco Wagenstetter, Mohammad Lotfollahi, Mohsen Naghipourfar'
...
def linkcode_resolve(domain, info):
    ...
    fn = os.path.relpath(fn, start=os.path.dirname(scarchest.__file__))
