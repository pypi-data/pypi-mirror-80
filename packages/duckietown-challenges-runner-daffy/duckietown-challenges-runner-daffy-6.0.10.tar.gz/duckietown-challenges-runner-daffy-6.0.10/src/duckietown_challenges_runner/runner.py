...
def go_(
    ...
    evaluator_version = "d-c:%s;d-c-r:%s" % (version_dc, version_dcr,)
...
def run_single(
    *,
    ...
    try:
        ...
        elogger.info(config=config_validated)
        valid_config = True
    ...
    if valid_config:
        ...
        cr = run_one(
            wd, project, do_pull, services=services_names, monitor=tomonitor[0], timeout_sec=timeout_sec,
        )
