...
class Dictabase:
    ...
    def db(self):
        ...
        raise RuntimeError('No AppContext found. You probably tried to access this database from outside a request context (aka outside a View function). Try using "with app.app_context(): DoThing()" instead.')
