...
class RelatedRecordsOperations(object):
	def __init__(self, module_api_name, record_id, related_list_api_name):
		...
		if module_api_name is not None and not isinstance(module_api_name, str):
		...
		if related_list_api_name is not None and not isinstance(related_list_api_name, str):
	...
	def get_related_record(self, header_instance, related_record_id):
		...
		if related_record_id is not None and not isinstance(related_record_id, int):
