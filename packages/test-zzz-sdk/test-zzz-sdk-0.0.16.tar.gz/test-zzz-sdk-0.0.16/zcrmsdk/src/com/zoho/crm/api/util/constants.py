...
class Constants(object):
    ...
    MANDATORY_KEY_MISSING_ERROR = "Value missing for mandatory key(s): "
    ...
    PRIMARY_KEY_MISSING_ERROR = "Value missing for required key(s) : "
    ...
    GET_TOKENS_DB_ERROR = "Exception in getTokens - DBStore"

    DELETE_TOKENS_DB_ERROR = "Exception in deleteTokens - DBStore"

    GET_TOKENS_FILE_ERROR = "Exception in getTokens - FileStore"

    DELETE_TOKENS_FILE_ERROR = "Exception in deleteTokens - FileStore"
