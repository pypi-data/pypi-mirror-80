...
if not is_binary_install():
    ...
    extensions.append(
        Extension(
            ...
            [
                "source/_Beaglebone_Black_Driver.c",
                "source/common_dht_read.c",
                "source/Beaglebone_Black/bbb_dht_read.c",
                "source/Beaglebone_Black/bbb_mmio.c",
            ],
            libraries=["rt"],
            extra_compile_args=["-std=gnu99"],
        )
