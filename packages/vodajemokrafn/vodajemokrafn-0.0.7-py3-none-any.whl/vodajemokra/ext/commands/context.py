...
from vodajemokra.party import ClientParty, PartyMember, ClientPartyMember
from vodajemokra.friend import Friend
from vodajemokra.user import ClientUser
...
class Context:
    ...
    def party(self) -> ClientParty:
        """Optional[:class:`vodajemokra.ClientParty`]: The party this message
    ...
    def author(self) -> Union[Friend, PartyMember]:
        """Optional[:class:`vodajemokra.Friend`, :class:`vodajemokra.PartyMember`]:
    ...
    def me(self) -> Union[ClientPartyMember, ClientUser]:
        """Union[:class:`vodajemokra.ClientPartyMember`, :class:`vodajemokra.ClientUser`]:
        Similar to :attr:`vodajemokra.ClientPartyMember` except that it returns
        :class:`vodajemokra.ClientUser` when not sent from a party.
        """  # noqa
