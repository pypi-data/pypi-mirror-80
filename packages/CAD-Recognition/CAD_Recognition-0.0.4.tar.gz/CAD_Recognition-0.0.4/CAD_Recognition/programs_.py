...
# sys.path.append('release/CAD_Recognition/data_load.py')
# sys.path.append('release/CAD_Recognition/features.py')
from CAD_Recognition.data_load import (load_data, load_data_, data_normalization_, data_normalization, k_folds_)
from CAD_Recognition.features import dataset_getmfcc
from CAD_Recognition.devide_no_test import data_transform
import os
...
def threshold_test(data_path, model_list, scaler1, scaler2):
    ...
    root_1, x_kf_train_1, y_kf_train_1, x_kf_valid_1, y_kf_valid_1, y_kf_true_train_1, y_kf_true_valid_1 = k_folds_(data_path, 10, sub=1)
    root_2, x_kf_train_2, y_kf_train_2, x_kf_valid_2, y_kf_valid_2, y_kf_true_train_2, y_kf_true_valid_2 = k_folds_(data_path, 10, sub=2)
    for i in range(0, 10):
