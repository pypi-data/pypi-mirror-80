...
# sys.path.append('release/imgkernelfrancis/data_load.py')
# sys.path.append('release/imgkernelfrancis/features.py')
from imgkernelfrancis.data_load import (load_data, load_data_, data_normalization_, data_normalization, k_folds_)
from imgkernelfrancis.features import (dataset_getmfcc)
import os
