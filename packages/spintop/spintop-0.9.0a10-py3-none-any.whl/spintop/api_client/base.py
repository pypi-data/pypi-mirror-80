...
class SpintopAPIClientModule(object):
    ...
    def list_orgs(self):
        return self.session.get(self.get_link('tenancy.list_orgs')).json()
    ...
    def execute_query(self, query_name, params={}):
        return self.session.put(self.get_link('analytics.execute_query', query_name=query_name), json=params).json()
