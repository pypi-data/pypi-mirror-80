...
from audit.middleware.easyaudit import get_current_request, get_current_user
from audit.models import CRUDEvent
from audit.settings import (
    REGISTERED_CLASSES,
...
from audit.utils import model_delta
