...
from .common.utils import _get_train_valid_sub_file_paths, split_train_file_if_needed
...
from ..common.utils import _exception_handler, _make_arg, \
    _merge_settings_args_defaults, _set_logging_parameters, _set_random_seed, _set_deterministic, \
    _save_image_df, _save_image_lf, is_aml_dataset_input, download_required_files
...
def train_worker(rank, settings, multilabel):
    ...
    if is_aml_dataset_input(settings):
        train_dataset_wrapper, valid_dataset_wrapper = read_aml_dataset(dataset_id,
    ...
    best_model = train_model(settings[SettingsLiterals.MODEL_NAME], strategy=settings[TrainingLiterals.STRATEGY],
