    ...
    class LustreConfigurationProperty:
        def __init__(
            ...
            *,
            ...
            copy_tags_to_backups: typing.Optional[typing.Union[builtins.bool, _IResolvable_9ceae33e]] = None,
...
class IFileSystem(_IConnectable_a587039f, typing_extensions.Protocol):
...
class _IFileSystemProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "monocdk-experiment.aws_fsx.IFileSystem"
...
class _FileSystemBaseProxy(
    FileSystemBase, jsii.proxy_for(_Resource_884d0774) # type: ignore
):
    @builtins.property # type: ignore
    @jsii.member(jsii_name="connections")
    def connections(self) -> _Connections_231f38b5:
