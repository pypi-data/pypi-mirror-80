...
class CfnStream(
    ...
    def __init__(
        ...
        *,
        ...
        stream_encryption: typing.Optional[typing.Union["StreamEncryptionProperty", _IResolvable_9ceae33e]] = None,
    ...
    def stream_encryption(
        self,
    ) -> typing.Optional[typing.Union["StreamEncryptionProperty", _IResolvable_9ceae33e]]:
    ...
    def stream_encryption(
        self,
        value: typing.Optional[typing.Union["StreamEncryptionProperty", _IResolvable_9ceae33e]],
    ) -> None:
...
class CfnStreamProps:
    def __init__(
        ...
        *,
        ...
        name: typing.Optional[builtins.str] = None,
        retention_period_hours: typing.Optional[jsii.Number] = None,
        stream_encryption: typing.Optional[typing.Union["CfnStream.StreamEncryptionProperty", _IResolvable_9ceae33e]] = None,
        tags: typing.Optional[typing.List[_CfnTag_b4661f1a]] = None,
    ) -> None:
    ...
    def stream_encryption(
        self,
    ) -> typing.Optional[typing.Union["CfnStream.StreamEncryptionProperty", _IResolvable_9ceae33e]]:
        """``AWS::Kinesis::Stream.StreamEncryption``.
...
class IStream(_IResource_72f7ee7e, typing_extensions.Protocol):
    """A Kinesis Stream.
...
class _IStreamProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "monocdk-experiment.aws_kinesis.IStream"
