...
class CfnQueue(
    ...
    def __init__(
        ...
        *,
        ...
        fifo_queue: typing.Optional[typing.Union[builtins.bool, _IResolvable_9ceae33e]] = None,
...
class IQueue(_IResource_72f7ee7e, typing_extensions.Protocol):
...
class _IQueueProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "monocdk-experiment.aws_sqs.IQueue"
...
class _QueueBaseProxy(
    QueueBase, jsii.proxy_for(_Resource_884d0774) # type: ignore
):
    @builtins.property # type: ignore
    @jsii.member(jsii_name="autoCreatePolicy")
    def _auto_create_policy(self) -> builtins.bool:
...
class Queue(
    QueueBase,
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_sqs.Queue",
):
