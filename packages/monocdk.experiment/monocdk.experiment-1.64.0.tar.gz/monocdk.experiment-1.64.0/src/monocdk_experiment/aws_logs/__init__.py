...
class FilterPattern(
    metaclass=jsii.JSIIMeta,
    jsii_type="monocdk-experiment.aws_logs.FilterPattern",
):
...
class _IFilterPatternProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "monocdk-experiment.aws_logs.IFilterPattern"
...
class ILogGroup(_IResource_72f7ee7e, typing_extensions.Protocol):
    """
    stability
    :stability: experimental
    """
...
class _ILogGroupProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "monocdk-experiment.aws_logs.ILogGroup"
...
class ILogStream(_IResource_72f7ee7e, typing_extensions.Protocol):
    """
    stability
    :stability: experimental
    """
...
class _ILogStreamProxy(
    ...
    __jsii_type__: typing.ClassVar[str] = "monocdk-experiment.aws_logs.ILogStream"
...
class _ILogSubscriptionDestinationProxy:
    ...
    __jsii_type__: typing.ClassVar[str] = "monocdk-experiment.aws_logs.ILogSubscriptionDestination"
