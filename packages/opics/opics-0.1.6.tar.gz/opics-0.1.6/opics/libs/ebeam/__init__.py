...
class DC_halfring(componentModel):
    ...
    valid_OID = [1]
    ports = 4
    def __init__(self, f=f, CoupleLength = 0, gap = 100e-9, radius = 5e-6, thickness = 220e-9, width = 500e-9, OID = 1):
...
class TunableWG(Waveguide):
    ...
    valid_OID = [1,2]
    ports = 2
    def __init__(self, length, f=f, power = 0e-3, TE_loss = 700, OID = 1):
