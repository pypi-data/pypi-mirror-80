...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '2.11.0-alpha.1600768398+577c6c2c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 2.11.0-alpha.1600768398+577c6c2c`
                """)
            else:
                raise
