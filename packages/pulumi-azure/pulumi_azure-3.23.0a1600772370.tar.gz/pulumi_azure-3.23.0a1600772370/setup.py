...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.23.0-alpha.1600772370+00b6dda6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.23.0-alpha.1600772370+00b6dda6`
                """)
            else:
                raise
