...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.23.0-alpha.1601033946+e1ff71a2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.23.0-alpha.1601033946+e1ff71a2`
                """)
            else:
                raise
