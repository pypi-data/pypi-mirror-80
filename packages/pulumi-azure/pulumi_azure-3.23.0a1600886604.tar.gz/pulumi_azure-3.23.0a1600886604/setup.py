...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.23.0-alpha.1600886604+e03b26aa'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.23.0-alpha.1600886604+e03b26aa`
                """)
            else:
                raise
