...
class GolbalAuroraRDSMaster(
    ...
    def __init__(
        ...
        *,
        ...
        :param db_user_name: RDS default Super User Name. Default: - < Mysql: admin >, < Postgres: postgres >
...
class VpcProvider(
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk-aurora-globaldatabase.VpcProvider",
):
