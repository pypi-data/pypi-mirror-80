...
class Ui_PreferencesDialog(object):
    ...
    def retranslateUi(self, PreferencesDialog):
        ...
        self.downsamplingLabel.setText(QCoreApplication.translate("PreferencesDialog", u"Downsampling", None))
        self.downsampleCheckBox.setText(QCoreApplication.translate("PreferencesDialog", u"Downsample high speed channels (for time domain graph only)", None))
