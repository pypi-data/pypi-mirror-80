...
class Ui_PlotMainWindow(object):
    def setupUi(self, PlotMainWindow):
        ...
        self.actionPause = QAction(PlotMainWindow)
        self.actionPause.setObjectName(u"actionPause")
        self.actionPause.setCheckable(True)
        self.actionResume = QAction(PlotMainWindow)
    ...
    def retranslateUi(self, PlotMainWindow):
        ...
        self.actionPause.setText(QCoreApplication.translate("PlotMainWindow", u"Pause", None))
        self.actionResume.setText(QCoreApplication.translate("PlotMainWindow", u"Resume", None))
