...
"}")
        ...
        self.gridLayout.addWidget(self.setUserTag2, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.userTag2, 3, 1, 1, 1)

        self.buildInfoLabel = QLabel(self.deviceInfoGroupBox)
        self.buildInfoLabel.setObjectName(u"buildInfoLabel")

        self.gridLayout.addWidget(self.buildInfoLabel, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.boardInfo, 1, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.buildDate, 5, 1, 1, 2)

        self.userTag1Label = QLabel(self.deviceInfoGroupBox)
        self.userTag1Label.setObjectName(u"userTag1Label")

        self.gridLayout.addWidget(self.userTag1Label, 2, 0, 1, 1)
