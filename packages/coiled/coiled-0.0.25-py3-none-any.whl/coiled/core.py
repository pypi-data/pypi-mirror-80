...
class Cloud:
    ...
    async def _create_cluster(
        ...
        if region or self._default_region:
            data["region"] = region or self._default_region
    ...
    def get_job_by_name(
        ...
        return self._sync(self._get_job_by_name, name=name, account=account, region=region)  # type: ignore
    ...
    async def _get_job_by_name(
        ...
        response = await self.session.request(
            ...
            params={"exclude_statuses": "pending,stopped", "region": region},
        )
