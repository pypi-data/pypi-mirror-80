...
=======
                ...
                if callable(items):
                    items = items()
                for item in items:
>>>>>>> bbeb837700c0626495f186112af5b286764d6189
...
<<<<<<< HEAD
        return influence._list("incpaths", provider)

    @staticmethod
    def libpaths(provider=DirectoryInfluence):
        return influence._list("libpaths", provider)

    @staticmethod
    def sources(provider=FileInfluence):
        return influence._list("sources", provider)
=======
