...
def create_option_image(data):
    option_image = '<select id="mySelect" onchange="changeimage(this.value)" style="position:absolute;;left:150px; top:124px;">'
    for name in data:
...
<p style ="position:absolute;left:105px; top:118px;" min="1">Stock</p>
<p style ="position:absolute;left:480px; top:120px;" min="1">Time-Gap</p>
<input type="range" name="rangeInput" style ="position:absolute;left:550px; top:124px;" min="1" max="10" value = "5" onchange="updateTextInput(this.value);">
<input type="text" id="textInput" value="5" size="1" style ="position:absolute;left:690px; top:124px;" >
