...
class MappingCipherBase(object):
    def __init__(self, password):
        self.password = password
        self.randomGenerator = randomutils.Random(self.password)
...
class RawDataEncoder(ResultEncoderBase):
...
class HexlifyEncoder(ResultEncoderBase):
...
class Base64Encoder(ResultEncoderBase):
...
class SafeBase64Encoder(ResultEncoderBase):
...
class Utf8Encoder(ResultEncoderBase):
