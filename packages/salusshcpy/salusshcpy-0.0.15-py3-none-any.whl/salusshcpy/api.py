...
class SHCAPI:
    ...
    async def long_polling_poll(self, wait_seconds=0):
        api_url = f"{self._api_root}/read"
        data = {"requestAttr": "readall"}
                ...
                "id": [
                    {
                        ...
                        "sIT600TH": {
                            "SetHoldType":
                                7 if mode == HVAC_MODE_OFF else device.previous_mode
                                if not device.previous_mode == HVAC_MODE_OFF else 7
                        }
                    }
                ]
            }
