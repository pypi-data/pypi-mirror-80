...
class SampleSeriesApi(object):
    ...
    def get_plot_samples(self, **kwargs):
        ...
        :param str start: A string representing the starting index of the data to be returned. The contents vary based on the series type. For time series: a ISO 8601 timestamp (YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm). For numeric (non-time) series: a double-precision number, optionally including units. For example: \"2.5ft\" or \"10 Â°C\". (required)
    ...
    def get_samples(self, **kwargs):
        ...
        :param str id: ID of the series from which to retrieve data (required)
        :param str start: A string representing the starting index of the data to be returned. The contents vary based on the series type. For time series: a ISO 8601 timestamp (YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm). For numeric (non-time) series: a double-precision number, optionally including units. For example: \"2.5ft\" or \"10 Â°C\". (required)
        :param str end: A string representing the starting index of the data to be returned. The contents vary based on the series type. For time series: a ISO 8601 timestamp (YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm). For numeric (non-time) series: a double-precisionnumber, optionally including units. For example: \"2.5ft\" or \"10 Â°C\". (required)
