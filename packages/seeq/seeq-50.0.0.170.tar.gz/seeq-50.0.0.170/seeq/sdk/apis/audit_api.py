...
class AuditApi(object):
    ...
    def get_audit_entries(self, **kwargs):
        ...
        :param str start_time: The start time for the query, formatted as an ISO 8601 timestamp (YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm)
        :param str end_time: The end time for the query, formatted as an ISO 8601 timestamp (YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm)
