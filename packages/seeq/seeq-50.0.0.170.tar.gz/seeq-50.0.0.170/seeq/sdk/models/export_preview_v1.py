...
class ExportPreviewV1(object):
    ...
    def created_at(self):
        ...
        The ISO 8601 date of when the export was created (YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm)
    ...
    def updated_at(self):
        ...
        The ISO 8601 date of when the export was updated/run (YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm)
