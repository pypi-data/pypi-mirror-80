...
class UserOutputV1(object):
    ...
    def created_at(self):
        ...
        The ISO 8601 date of when the user was created (YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm)
    ...
    def last_login_at(self):
        ...
        The ISO 8601 date of when the user last logged in (YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm)
