...
"""
    ...
    OpenAPI spec version: 50.0.0-SNAPSHOT
...
class CapsuleV1(object):
    ...
    def cursor_key(self):
        ...
        The point at which the capsule becomes uncertain. For a time, an ISO 8601 date string (YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm), or a whole number of nanoseconds since the unix epoch (if the units are nanoseconds). For a numeric (non-time), a double-precision number.
    ...
    def end(self):
        ...
        The end of the capsule. For a time, an ISO 8601 date string (YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm), or a whole number of nanoseconds since the unix epoch (if the units are nanoseconds). For a numeric (non-time), a double-precision number.
    ...
    def start(self):
        ...
        The start of the capsule. For a time, an ISO 8601 date string (YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm), or a whole number of nanoseconds since the unix epoch (if the units are nanoseconds). For a numeric (non-time), a double-precision number.
