...
class SampleInputV1(object):
    ...
    def key(self):
        ...
        The key of the sample. For a time series, this is an ISO 8601 date string(YYYY-MM-DDThh:mm:ss.sssssssssÂ±hh:mm) or an integer number of nanoseconds since January 1, 1970 in UTC time. Otherwise it is a double-precision number.
