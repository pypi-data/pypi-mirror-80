...
@click.option('--perfil', type=click.Choice(['low', 'medium', 'high'], case_sensitive=False), default='high', help='Perfil de estabilizado: bajo (peor estabilización), medio, alto (mejor estabilización).', show_default=True)
