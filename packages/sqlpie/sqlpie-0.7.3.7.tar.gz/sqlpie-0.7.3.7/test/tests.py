...
class TestClient(unittest.TestCase):
  ...
  def test_all_models_edges(self):
    ...
    edges = sorted([['example_model.example_3', 'model_2.example_1'], ['custom_prep_schema.enrich_example_1', 'model_2.example_1'], ['example_model_prep.example_1', 'model_2.example_1'], ['example_source_schema.table_3', 'custom_prep_schema.enrich_example_1'], ['example_model.example_2', 'custom_prep_schema.enrich_example_1'], ['example_source_schema.table_1', 'model_with_empty_config.query_1'], ['example_model_prep.example_1', 'example_model.example_3'], ['example_model_prep.example_1', 'example_model.example_2'], ['example_source_schema.table_1', 'example_model_prep.example_1'], ['example_source_schema.table_2', 'example_model_prep.example_1'], ['example_source_schema.table_3', 'example_model_prep.example_1']])
