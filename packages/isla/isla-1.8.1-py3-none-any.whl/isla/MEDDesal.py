...
class MEDDesal(SinkComponent):
    ...
    def __init__(
        self, fl_module, ld_module, st_module, capex=11040.0, opex_fix=0.0,
        opex_var=0.232, opex_use=0.0, life=10.0, td=0.5, ru=0,
        enr_el=2.50, enr_th=53.20, is_sink=False, **kwargs
    ):
