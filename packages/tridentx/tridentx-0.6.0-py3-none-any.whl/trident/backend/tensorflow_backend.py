...
from trident.backend.common import camel2snake, to_list, unpack_singleton, enforce_singleton, OrderedDict, get_signature,get_session,set_session
...
def try_map_args_and_call(fn, data: OrderedDict, data_feed=None,grad_tape=None):
