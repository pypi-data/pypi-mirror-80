...
import tpa_map_interface.import_veh_dyn_info
...
class MapInterface:
    ...
    def __init__(self,
        ...
        tpamap, velocity_steps = tpa_map_interface.import_veh_dyn_info.import_veh_dyn_info(
    ...
    def get_acclim_tpainterface(self,
        ...
        elif self.__bool_enable_velocitydependence and velocity_mps.size == 0:
