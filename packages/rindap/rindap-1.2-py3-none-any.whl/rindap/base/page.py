...
class Page(object):
    ...
    def process_response(cls, response):
        ...
        if response.status_code != 200:
            raise RindapException('Unable to fetch page', response)
    ...
    def load_page(self, payload):
        ...
        raise RindapException('Page Records can not be deserialized')
    ...
    def get_instance(self, payload):
        ...
        """
        raise RindapException('Page.get_instance() must be implemented in the derived class')
    ...
    def next_page(self):
        ...
        response = self._version.domain.rindap.request('GET', self.next_page_url)
        cls = type(self)
    ...
    def previous_page(self):
        ...
        response = self._version.domain.rindap.request('GET', self.previous_page_url)
        cls = type(self)
        return cls(self._version, response, self._solution)
