...
class RindapException(Exception):
    pass


class RindapRestException(RindapException):
    """ A generic 400 or 500 level exception from the Rindap API
    ...
    :param int|None code: A Rindap-specific error code for the error. This is
    ...
    def __str__(self):
        ...
        def get_uri(code):
            return "https://www.rindap.com/docs/errors/{0}".format(code)
        ...
        if hasattr(sys.stderr, 'isatty') and sys.stderr.isatty():
            msg = (
                ...
                "\n\n{rindap_returned}\n\n{message}\n".format(
                    ...
                    rindap_returned=white(
                        "Rindap returned the following information:"),
