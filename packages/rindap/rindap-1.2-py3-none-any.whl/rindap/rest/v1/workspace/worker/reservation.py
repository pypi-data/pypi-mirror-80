...
class ReservationList(ListResource):
    ...
    def stream(self, reservation_status=values.unset, limit=None, page_size=None):
        ...
        :rtype: list[rindap.rest.v1.workspace.worker.reservation.ReservationInstance]
        """
    ...
    def page(self, reservation_status=values.unset, page_token=values.unset,
        ...
        :rtype: rindap.rest.v1.workspace.worker.reservation.ReservationPage
        """
        data = values.of({
    ...
    def get(self, sid):
        ...
        :returns: rindap.rest.v1.workspace.worker.reservation.ReservationContext
        :rtype: rindap.rest.v1.workspace.worker.reservation.ReservationContext
        """
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Rindap.V1.ReservationList>'
...
class ReservationPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: rindap.rest.v1.workspace.worker.reservation.ReservationPage
        :rtype: rindap.rest.v1.workspace.worker.reservation.ReservationPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: rindap.rest.v1.workspace.worker.reservation.ReservationInstance
        :rtype: rindap.rest.v1.workspace.worker.reservation.ReservationInstance
        """
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Rindap.V1.ReservationPage>'
...
class ReservationContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        return '<Rindap.V1.ReservationContext {}>'.format(context)
