...
class WorkflowList(ListResource):
    ...
    def stream(self, friendly_name=values.unset, limit=None, page_size=None):
        ...
        :rtype: list[rindap.rest.v1.workspace.workflow.WorkflowInstance]
        """
    ...
    def page(self, friendly_name=values.unset, page_token=values.unset,
        ...
        :rtype: rindap.rest.v1.workspace.workflow.WorkflowPage
        """
        data = values.of({
    ...
    def create(self, friendly_name, configuration,
        ...
        :rtype: rindap.rest.v1.workspace.workflow.WorkflowInstance
        """
        data = values.of({
            'FriendlyName': friendly_name,
    ...
    def get(self, sid):
        ...
        :returns: rindap.rest.v1.workspace.workflow.WorkflowContext
        :rtype: rindap.rest.v1.workspace.workflow.WorkflowContext
        """
...
class WorkflowPage(Page):
    ...
    def __init__(self, version, response, solution):
        ...
        :returns: rindap.rest.v1.workspace.workflow.WorkflowPage
        :rtype: rindap.rest.v1.workspace.workflow.WorkflowPage
        """
    ...
    def get_instance(self, payload):
        ...
        :returns: rindap.rest.v1.workspace.workflow.WorkflowInstance
        :rtype: rindap.rest.v1.workspace.workflow.WorkflowInstance
        """
        return WorkflowInstance(self._version, payload, workspace_sid=self._solution['workspace_sid'], )
...
class WorkflowContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        return '<Rindap.V1.WorkflowContext {}>'.format(context)
...
class WorkflowInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Rindap.V1.WorkflowInstance {}>'.format(context)
