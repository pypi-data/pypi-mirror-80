...
id = "f253e1307b9c19b0fa974fe627651db483f38170"
date = "2020-09-11 18:02:47 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "f253e1307b9c19b0fa974fe627651db483f38170":
        return
    msg = "Program id (f253e1307b9c19b0fa974fe627651db483f38170) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
