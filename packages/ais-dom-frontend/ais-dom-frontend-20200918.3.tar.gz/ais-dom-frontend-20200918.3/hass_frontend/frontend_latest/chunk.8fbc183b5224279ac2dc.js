(self.webpackJsonp=self.webpackJsonp||[]).push([[250],{381:function(e,t,r){"use strict";r.d(t,"b",(function(){return i})),r.d(t,"a",(function(){return n})),r.d(t,"c",(function(){return o}));const i=(e,t,r)=>isNaN(e)||isNaN(t)||isNaN(r)?0:e>r?r:e<t?t:e,n=(e,t,r)=>100*(e-t)/(r-t),o=e=>Math.round(10*e)/10},396:function(e,t,r){"use strict";r.d(t,"c",(function(){return h})),r.d(t,"a",(function(){return p})),r.d(t,"d",(function(){return y})),r.d(t,"b",(function(){return v}));var i=r(0),n=r(88),o=r(381);const a=new Set(["clear-night","cloudy","fog","lightning","lightning-rainy","partlycloudy","pouring","rainy","hail","snowy","snowy-rainy","sunny","windy","windy-variant"]),s={exceptional:"hass:alert-circle-outline"},c=new Set(["partlycloudy","cloudy","fog","windy","windy-variant","hail","rainy","snowy","snowy-rainy","pouring","lightning","lightning-rainy"]),l=new Set(["hail","rainy","pouring"]),d=new Set(["windy","windy-variant"]),u=new Set(["snowy","snowy-rainy"]),f=new Set(["lightning","lightning-rainy"]),h=(e,t)=>{const r=e.config.unit_system.length||"";switch(t){case"pressure":return"km"===r?"hPa":"inHg";case"wind_speed":return r+"/h";case"length":return r;case"precipitation":return"km"===r?"mm":"in";case"humidity":case"precipitation_probability":return"%";default:return e.config.unit_system[t]||""}},p=(e,t)=>{var r;const i=m(e,t);if(i)return i;let n,a;if((null===(r=t.attributes.forecast)||void 0===r?void 0:r.length)&&void 0!==t.attributes.forecast[0].precipitation&&null!==t.attributes.forecast[0].precipitation)n=t.attributes.forecast[0].precipitation,a="precipitation";else{if(!("humidity"in t.attributes))return;n=t.attributes.humidity,a="humidity"}return`\n    ${e.localize("ui.card.weather.attributes."+a)} ${Object(o.c)(n)} ${h(e,a)}\n  `},m=(e,t)=>{var r;if(!(null===(r=t.attributes.forecast)||void 0===r?void 0:r.length))return;let i,n;const o=(new Date).getDate();for(const s of t.attributes.forecast){if(new Date(s.datetime).getDate()!==o)break;(!n||s.temperature>n)&&(n=s.temperature),(!i||s.templow&&s.templow<i)&&(i=s.templow),s.templow||i&&!(s.temperature<i)||(i=s.temperature)}if(!i&&!n)return;const a=h(e,"temperature");return`\n    ${n?`\n            ${n} ${a}\n          `:""}\n    ${i&&n?" / ":""}\n    ${i?`\n          ${i} ${a}\n        `:""}\n  `},y=i.c`
  .rain {
...
`,v=(e,t)=>{const r=getComputedStyle(t).getPropertyValue("--weather-icon-"+e);return r?i.f`
      <div
  ...
  ${f.has(e)?i.m`
    ...
    `}},{kind:"method",key:"_handleAction",value:function(e){Object(y.a)(this,this.hass,this._config,e.detail.action)}},{kind:"get",static:!0,key:"styles",value:function(){return[c.d,i.c`
      ...
      `]}}]}}),i.a)}}]);
//# sourceMappingURL=chunk.8fbc183b5224279ac2dc.js.map