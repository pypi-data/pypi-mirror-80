...
class Vision:
    ...
    def find_face(self, frame, bounding_box=True, scale_factor=1.05, min_neighbors=8, min_size=(40, 40),max_size=(320,320)):
        """
    ...
    # requires input frame that is grayscale
    def find_smile(self, frame, bounding_box=True, scale_factor=1.05, min_neighbors=8, min_size=(40, 40),max_size=(320,320)):
        """
    ...
    def find_stop_sign(self, frame, bounding_box=True, scale_factor=1.05, min_neighbors=8, min_size=(40, 40),max_size=(320,320)):
        """
