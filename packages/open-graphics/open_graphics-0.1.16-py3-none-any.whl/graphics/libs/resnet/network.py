...
class Network(nn.Module):
    ...
    def create_model(self, num_classes):
        ...
        net.fc = nn.Sequential(nn.Dropout(0.5), nn.Linear(num_feature, num_classes))    # 修改dropout比例
    ...
    def _get_lr_function(optimizer, model):
        ...
        # lr = lr_scheduler.StepLR(optimizer, step_size=10, gamma=0.8)
        # 使用cosine
        ...
        for epoch in range(num_epochs):
            ...
            for phase in ['train', 'val']:
                ...
                if phase == 'val' and epoch_acc > best_acc:
                    ...
                    # 7、保存模型
                    torch.save(model, self.model_name.split('.')[0] + "_" + str(float(best_acc)) + ".pth")
