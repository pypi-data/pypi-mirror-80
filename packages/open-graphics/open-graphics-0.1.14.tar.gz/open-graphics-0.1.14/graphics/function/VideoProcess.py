...
def video_attribute(path):
    ...
    try:
        ...
        return dict(width=clip.w,
                    height=clip.h,
                    aspect_ratio=clip.aspect_ratio,
                    duration=clip.reader.infos['duration'],
                    video_found=clip.reader.infos['video_found'],
                    video_fps=clip.reader.infos['video_fps'],
                    video_nframes=clip.reader.infos['video_nframes'],
                    audio_found=clip.reader.infos['audio_found'],
                    audio_fps=clip.reader.infos['audio_fps'])
    except ValueError:
        return None
