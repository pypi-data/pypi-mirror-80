...
RowValueType = TypeVar('RowValueType', StrictStr, StrictInt, StrictFloat,
                       StrictBool, datetime, date)
...
class Packet(Hash):
    ...
    class File(BaseModel):
        ...
        hash: StrictStr = Field(title="Хеш файла по алгоритму SHA1",
        ...
        url: Optional[Source]
        hex: StrictStr = Field(title="Содержимое файла в виде HEX строки")
