...
__version_info__ = (2019, 4, 17, 0, 6, 'dev1')
...
class GeothermalPowerPlant(Thermodynamic):
    ...
    **Class for calculating power assessment of geothermal field**
    ...
    def __str__(self):
        ...
        table2 = BeautifulTable(maxwidth=110)
        table2.border.top = '='
        ...
        table2.rows.append([10, 'recovery_factor', 'RF', '%'] +
                           get_values_ordered(self.recovery_factor))
        table2.rows.append([11, 'conversion_efficiency', 'Ce', '%'] +
                           get_values_ordered(self.conversion_efficiency))
        table2.rows.append([12, 'plant_net_capacity_factor', 'Pf', '%'] +
                           get_values_ordered(self.plant_net_capacity_factor))
        table2.rows.append([13, 'lifespan', 't', 'years'] + get_values_ordered(self.lifespan))
