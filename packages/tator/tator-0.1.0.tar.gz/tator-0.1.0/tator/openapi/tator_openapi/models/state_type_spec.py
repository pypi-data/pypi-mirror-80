...
class StateTypeSpec(object):
    ...
    def __init__(self, association=None, attribute_types=None, description=None, grouping_default=True, interpolation='latest', media_types=None, name=None, visible=None, local_vars_configuration=None):  # noqa: E501
