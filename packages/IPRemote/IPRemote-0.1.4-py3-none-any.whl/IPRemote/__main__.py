...
try:
    ...
    from IPRemote import __doc__ as doc
    from IPRemote import __title__ as title
    from IPRemote import __version__ as version
    from IPRemote import exceptions
    from IPRemote import Remote
    from IPRemote import key_mappings
    from IPRemote.config import Config
...
def _read_config():
    ...
    for directory in directories:
        pth = os.path.join(directory, "IPRemote.conf")
