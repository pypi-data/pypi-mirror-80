...
class BaseCollectionForm(KadiForm):
    ...
    visibility = SelectField(
        ...
        description=(
            _l(
                "Public visibility makes the content of this collection visible to"
...
class NewCollectionForm(BaseCollectionForm):
    ...
    copy_permission = DynamicSelectField(
        _l("Permissions"),
        coerce=int,
        description=_l("Copy the permissions of another collection."),
    )
...
class LinkResourcesForm(KadiForm):
    """A form for use in linking collections with records or groups."""
    ...
    def validate(self, extra_validators=None):
        ...
        if success and (self.records.data or self.groups.data):
            return True
