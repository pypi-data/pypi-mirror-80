...
class CollectionSchema(KadiSchema):
    ...
    :param linked_record: (optional) A record that is linked to each collection that
        ...
        actions.
    :param linked_group: (optional) A group that is linked to each collection that
        should be serialized. Will be used to build endpoints for corresponding
        actions.
    """
    ...
    def __init__(
        self, previous_collection=None, linked_record=None, linked_group=None, **kwargs
    ):
    ...
    def _generate_links(self, obj):
        links = {
            ...
            "groups": url_for("api.get_collection_groups", id=obj.id),
    ...
    def _generate_actions(self, obj):
        actions = {
            ...
            "link_group": url_for("api.add_collection_group", id=obj.id),
