...
class Group(SimpleReprMixin, SearchableMixin, TimestampMixin, db.Model):
    ...
    class Meta:
        ...
        permissions = {
            "actions": [
                ...
                ("link", "Manage links of this group with other resources."),
            ...
            "roles": [
                ...
                ("admin", ["read", "update", "link", "members", "delete"]),
            ],
            ...
            "global_actions": [
                ...
                ("link", "Manage links of any group with other resources."),
    ...
    records = db.relationship(
        "Record", secondary="group_record", lazy="dynamic", back_populates="groups"
    )

    collections = db.relationship(
        "Collection",
        secondary="group_collection",
        lazy="dynamic",
...
# Auxiliary table for fine-grained group permissions.
db.Table(
    "group_permission",
...
# Auxiliary table to associate records with groups.
db.Table(
    "group_record",
    db.Column("group_id", db.Integer, db.ForeignKey("group.id"), primary_key=True),
...
# Auxiliary table to associate collections with groups.
db.Table(
    "group_collection",
    db.Column("group_id", db.Integer, db.ForeignKey("group.id"), primary_key=True),
    db.Column(
