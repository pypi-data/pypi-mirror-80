...
from kadi.plugins import hookspecs
from kadi.plugins.utils import template_hook
...
def _load_config(app, flask_env):
    ...
    app.config["BABEL_TRANSLATION_DIRECTORIES"] = app.config[
...
def _init_plugins(app):
    ...
    for plugin in app.config["PLUGINS"]:
        plugin_manager.load_setuptools_entrypoints("kadi_plugins", name=plugin)
...
def _register_blueprints(app):
    ...
    app.plugin_manager.hook.kadi_register_blueprints(app=app)
