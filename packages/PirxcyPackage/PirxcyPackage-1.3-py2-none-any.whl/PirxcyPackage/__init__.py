...
print(crayons.cyan(f'[PartyBot] [{time()}] Never gonna give you up.'
                   'Never gonna let you down.'))
print(crayons.cyan(f'[PartyBot] [{time()}] Never gonna run around and desert you.'))
