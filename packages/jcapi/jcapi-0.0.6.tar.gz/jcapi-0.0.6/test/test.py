...
url = "https://c.jia.mn/App/a/frame/setLogin.php?hictoken=410108959-1593481883-276027368-a667cd468c-a72fb5d872"
...
class C4Account:
    ...
    async def __get_director_control_url(self):
    ...
    async def get_controller_url(self):
        ...
        Returns:
            ...
            ```
        """
        data = await self.__get_director_control_url()
        json_dict = json.loads(data)
...
lala = C4Account(username="家畅王总", password="Cmd200733!")
asyncio.run(lala.get_account_token())
asyncio.run(lala.get_controller_url())