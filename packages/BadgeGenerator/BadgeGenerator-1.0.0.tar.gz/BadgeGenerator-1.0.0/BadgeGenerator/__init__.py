...
print("\n")
def Badge(logo = None,color = None,style = None,subject = None,status = None,features = None):
    try:
        print(shield(logo=logo,color=color,style=style,subject=subject,status=status))
    except:
        pass
