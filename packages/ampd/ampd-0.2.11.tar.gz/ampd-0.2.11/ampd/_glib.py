...
class ClientGLib(_client.Client, GObject.Object):
    """
...
class ServerPropertiesGLibBase(_client.ServerPropertiesBase, GObject.Object):
    """
...
properties = {name: _client.StatusProperty(GObject.Property, name, *args) for name, *args in _client.STATUS_PROPERTIES}
