    ...
    """
{
    ...
    "package_data": {
        "cdk_serverless_lamp._jsii": [
            "cdk-serverless-lamp@1.4.23.jsii.tgz"
        ],
        "cdk_serverless_lamp": [
            "py.typed"
        ]
    ...
    "python_requires": ">=3.6",
    "install_requires": [
        "aws-cdk.aws-apigateway>=1.62.0, <2.0.0",
        "aws-cdk.aws-apigatewayv2>=1.62.0, <2.0.0",
        "aws-cdk.aws-ec2>=1.62.0, <2.0.0",
        "aws-cdk.aws-iam>=1.62.0, <2.0.0",
        "aws-cdk.aws-lambda>=1.62.0, <2.0.0",
        "aws-cdk.aws-rds>=1.62.0, <2.0.0",
        "aws-cdk.aws-secretsmanager>=1.62.0, <2.0.0",
