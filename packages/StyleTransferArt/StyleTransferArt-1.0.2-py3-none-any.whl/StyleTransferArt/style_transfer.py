def style_transfer(original_image,style_image,num_iterations,out_image):
	...
	content_img=load_image(original_image)
	...
	plt.axis('off')
	fig1 = plt.gcf()
	fig1.savefig('Falahgs_'+out_image, bbox_inches='tight')
