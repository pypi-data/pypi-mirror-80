...
class DerkEnv(gym.Env):
  ...
  * ``mode="connected"``: Connects to an environment running in "server" mode.
  ...
  Args:
    ...
    connected_host: Host to connect to in "connected" mode. Defaults to "http://localhost:8789". (Environment variable: DERK_CONNECTED_HOST)
  ...
  def __init__(self,
    ...
    self.connected_host = connected_host if connected_host is not None else os.environ.get('DERK_CONNECTED_HOST', 'http://localhost:8789')
